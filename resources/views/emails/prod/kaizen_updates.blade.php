...
<body>
    <div class="container">
        ...
        <div class="content">
            @if($kaizenCount > 0)
                <p>There have been <span class="status-message">{{ $kaizenCount }}</span> new Kaizen entries this week.</p>
                <p>For more details, visit the <a href="{{ $url }}" class="btn">Kaizen page</a>.</p>

                <div class="charts-row">
                    <div class="chart-wrapper">
                        <p><strong>Process & Status Chart (Bar):</strong></p>
                        <img src="{{ $chartImageUrl }}" alt="Kaizen Bar Chart" class="chart" />
                    </div>
                    <div class="chart-wrapper">
                        <p><strong>Kaizen Rank by Process (Donut):</strong></p>
                        <img src="{{ $rankChartImageUrl }}" alt="Kaizen Donut Chart" class="chart" />
                    </div>
                </div>
            @else
