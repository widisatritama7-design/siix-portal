...
<body class="bg-gray-100">
                ...
                <div class="bg-white rounded-xl shadow-md border border-gray-200 p-4">
                    <div class="grid grid-cols-2 gap-2.5">
                        ...
                        <div class="space-y-2.5">
                            ...
                            @endphp
                            <div class="{{ $bgColor }} border border-gray-300 rounded-lg p-3 hover:shadow-md transition-all duration-200 cursor-default relative">
                                <div class="absolute inset-0.5 rounded-lg border border-gray-200 pointer-events-none"></div>
                                
                                <div class="flex items-center justify-between relative z-10">
                                    <span class="text-base font-bold text-gray-600">{{ $number }}</span>
                                    <div class="flex items-center gap-2">
                                        <div class="w-0.5 h-5 bg-gray-300 rounded-full"></div>
                                        <div class="w-3.5 h-3.5 rounded-full {{ $color['bg'] }} shadow {{ $color['shadow'] }}"></div>
                                    </div>
                                </div>
                            </div>
                            @endforeach
    ...
    <script>
        ...
        function checkStoreNik() {
            ...
            const url = '{{ url("esd/locker/store/check") }}';
        ...
        function checkTakeCode() {
            ...
            const url = '{{ url("esd/locker/take/check") }}';
