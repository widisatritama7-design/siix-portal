    ...
    function lockerApp() {
        return {
            ...
            async fetchLockers() {
                this.loading = true;
                try {
                    const response = await fetch('{{ route("api.esd.lockers") }}');
            ...
            async checkStoreNik() {
                ...
                try {
                    const response = await fetch('{{ route("api.esd.check-nik") }}', {
                        method: 'POST',
                        headers: {
            ...
            async storeUniform() {
                ...
                try {
                    const response = await fetch('{{ route("api.esd.store-uniform") }}', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': '{{ csrf_token() }}'
            ...
            async checkTakeCode() {
                ...
                try {
                    const response = await fetch('{{ route("api.esd.check-take") }}', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': '{{ csrf_token() }}'
            ...
            async openTakeLocker() {
                ...
                try {
                    const response = await fetch('{{ route("api.esd.open-take-locker") }}', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': '{{ csrf_token() }}'
