                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div class="w-full sm:w-auto">
                        ...
                        <p class="text-xs sm:text-sm text-zinc-500 dark:text-zinc-400 mt-1">
                            Edit inspection record for line {{ $masterLine->line_number }}
                    ...
                    <div class="p-4">
                        ...
                        @if($overallStatus === 'success')
                            <p class="text-xs text-green-600 dark:text-green-500 mt-2">
                                Semua parameter valid. Status akan tetap "{{ $status }}".
                            </p>
                        @else
                                ...
                                <flux:card class="p-0 shadow-lg overflow-hidden">
                                    ...
                                    <div class="p-6 space-y-6">
                                        ...
                                        <div>
                                            <label class="text-sm font-medium text-zinc-700 dark:text-zinc-300">
                                                Clamp Pressure (9)
                                                @if($this->isFieldRequired('clamp_presure'))
                                                    <span class="text-red-500">*</span>
                                                @else
                                                    <span class="text-gray-400 text-xs font-normal">(Disabled)</span>
                                                @endif
                                            ...
                                            <input type="text" 
                                                   ...
                                                   placeholder="{{ $this->isNAAllowed() ? 'Enter value or - for NA' : 'Enter value' }}" 
                                                   class="w-full rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 {{ $this->getFieldColorClass('clamp_presure', $clamp_presure) }}" 
                                                   {{ $this->isFieldDisabled('clamp_presure') ? 'disabled' : '' }}>
                                            @php $validation = $this->validateNumericField('clamp_presure', $clamp_presure); @endphp
                                            @if(!$validation['valid'] && $clamp_presure !== null && $clamp_presure !== '' && !$this->isFieldDisabled('clamp_presure'))
                                                <p class="text-xs text-red-600 mt-1">{{ $validation['message'] }}</p>
                                            @endif
                                        </div>
                                        ...
                                        <div>
                                            <label class="text-sm font-medium text-zinc-700 dark:text-zinc-300">
                                                Squeege Upper (10)
                                                @if($this->isFieldRequired('squeege_upper'))
                                                    <span class="text-red-500">*</span>
                                                @else
                                                    <span class="text-gray-400 text-xs font-normal">(Disabled)</span>
                                                @endif
                                            ...
                                            <input type="text" 
                                                   ...
                                                   placeholder="{{ $this->isNAAllowed() ? 'Enter value or - for NA' : 'Enter value' }}" 
                                                   class="w-full rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 {{ $this->getFieldColorClass('squeege_upper', $squeege_upper) }}" 
                                                   {{ $this->isFieldDisabled('squeege_upper') ? 'disabled' : '' }}>
                                            @php $validation = $this->validateNumericField('squeege_upper', $squeege_upper); @endphp
                                            @if(!$validation['valid'] && $squeege_upper !== null && $squeege_upper !== '' && !$this->isFieldDisabled('squeege_upper'))
                                                <p class="text-xs text-red-600 mt-1">{{ $validation['message'] }}</p>
                                            @endif
                                        </div>
                                ...
                                <flux:card class="p-0 shadow-lg overflow-hidden">
                                    ...
                                    <div class="p-6 space-y-6">
                                        ...
                                        <div>
                                            <label class="text-sm font-medium text-zinc-700 dark:text-zinc-300">
                                                Vaccuum Pump (13.a)
                                                @if($this->isFieldRequired('vaccuum_pump_1'))
                                                    <span class="text-red-500">*</span>
                                                @else
                                                    <span class="text-gray-400 text-xs font-normal">(Disabled)</span>
                                                @endif
                                            ...
                                            <input type="text" 
                                                   ...
                                                   placeholder="{{ $this->isNAAllowed() ? 'Enter value or - for NA' : 'Enter value' }}" 
                                                   class="w-full rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 {{ $this->getFieldColorClass('vaccuum_pump_1', $vaccuum_pump_1) }}" 
                                                   {{ $this->isFieldDisabled('vaccuum_pump_1') ? 'disabled' : '' }}>
                                            @php $validation = $this->validateNumericField('vaccuum_pump_1', $vaccuum_pump_1); @endphp
                                            @if(!$validation['valid'] && $vaccuum_pump_1 !== null && $vaccuum_pump_1 !== '' && !$this->isFieldDisabled('vaccuum_pump_1'))
                                                <p class="text-xs text-red-600 mt-1">{{ $validation['message'] }}</p>
                                            @endif
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="flex gap-6">
                                                <label class="inline-flex items-center gap-2">
                                                    <input type="radio" wire:model.live="box_1" value="checked" class="rounded border-zinc-300 text-blue-600 focus:ring-blue-500" {{ $this->isFieldDisabled('box_1') ? 'disabled' : '' }}>
                                                    <span class="text-sm {{ $this->isFieldDisabled('box_1') ? 'text-gray-400' : '' }}">Checked ✓</span>
                                                </label>
                                                @if($this->isNAAllowed())
                                                <label class="inline-flex items-center gap-2">
                                                    <input type="radio" wire:model.live="box_1" value="na" class="rounded border-zinc-300 text-blue-600 focus:ring-blue-500" {{ $this->isFieldDisabled('box_1') ? 'disabled' : '' }}>
                                                    <span class="text-sm {{ $this->isFieldDisabled('box_1') ? 'text-gray-400' : '' }}">N/A</span>
                                                </label>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            <label class="text-sm font-medium text-zinc-700 dark:text-zinc-300">
                                                ...
                                                @if($this->isFieldRequired('vaccuum_parameter_1'))
                                                    <span class="text-red-500">*</span>
                                                @else
                                                    <span class="text-gray-400 text-xs font-normal">(Disabled)</span>
                                                @endif
                                            ...
                                            <div class="flex gap-6">
                                                <label class="inline-flex items-center gap-2">
                                                    <input type="radio" wire:model.live="vaccuum_parameter_1" value="checked" class="rounded border-zinc-300 text-blue-600 focus:ring-blue-500" {{ $this->isFieldDisabled('vaccuum_parameter_1') ? 'disabled' : '' }}>
                                                    <span class="text-sm {{ $this->isFieldDisabled('vaccuum_parameter_1') ? 'text-gray-400' : '' }}">Checked ✓</span>
                                                </label>
                                                @if($this->isNAAllowed())
                                                <label class="inline-flex items-center gap-2">
                                                    <input type="radio" wire:model.live="vaccuum_parameter_1" value="na" class="rounded border-zinc-300 text-blue-600 focus:ring-blue-500" {{ $this->isFieldDisabled('vaccuum_parameter_1') ? 'disabled' : '' }}>
                                                    <span class="text-sm {{ $this->isFieldDisabled('vaccuum_parameter_1') ? 'text-gray-400' : '' }}">N/A</span>
                                                </label>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            <label class="text-sm font-medium text-zinc-700 dark:text-zinc-300">
                                                Expire Date (14)
                                                @if($this->isFieldRequired('expire_date_1'))
                                                    <span class="text-red-500">*</span>
                                                @else
                                                    <span class="text-gray-400 text-xs font-normal">(Disabled)</span>
                                                @endif
                                            ...
                                            <div class="flex gap-6">
                                                <label class="inline-flex items-center gap-2">
                                                    <input type="radio" wire:model.live="expire_date_1" value="checked" class="rounded border-zinc-300 text-blue-600 focus:ring-blue-500" {{ $this->isFieldDisabled('expire_date_1') ? 'disabled' : '' }}>
                                                    <span class="text-sm {{ $this->isFieldDisabled('expire_date_1') ? 'text-gray-400' : '' }}">Checked ✓</span>
                                                </label>
                                                @if($this->isNAAllowed())
                                                <label class="inline-flex items-center gap-2">
                                                    <input type="radio" wire:model.live="expire_date_1" value="na" class="rounded border-zinc-300 text-blue-600 focus:ring-blue-500" {{ $this->isFieldDisabled('expire_date_1') ? 'disabled' : '' }}>
                                                    <span class="text-sm {{ $this->isFieldDisabled('expire_date_1') ? 'text-gray-400' : '' }}">N/A</span>
                                                </label>
                                                @endif
                                            </div>
                                        </div>
                                ...
                                <flux:card class="p-0 shadow-lg overflow-hidden">
                                    ...
                                    <div class="p-6">
                                        <div>
                                            <label class="text-sm font-medium text-zinc-700 dark:text-zinc-300">
                                                Fan Unit 1 (25)
                                                @if($this->isFieldRequired('fan_unit_1'))
                                                    <span class="text-red-500">*</span>
                                                @else
                                                    <span class="text-gray-400 text-xs font-normal">(Disabled)</span>
                                                @endif
                                            ...
                                            <div class="flex gap-6">
                                                <label class="inline-flex items-center gap-2">
                                                    <input type="radio" wire:model.live="fan_unit_1" value="checked" class="rounded border-zinc-300 text-blue-600 focus:ring-blue-500" {{ $this->isFieldDisabled('fan_unit_1') ? 'disabled' : '' }}>
                                                    <span class="text-sm {{ $this->isFieldDisabled('fan_unit_1') ? 'text-gray-400' : '' }}">Checked ✓</span>
                                                </label>
                                                @if($this->isNAAllowed())
                                                <label class="inline-flex items-center gap-2">
                                                    <input type="radio" wire:model.live="fan_unit_1" value="na" class="rounded border-zinc-300 text-blue-600 focus:ring-blue-500" {{ $this->isFieldDisabled('fan_unit_1') ? 'disabled' : '' }}>
                                                    <span class="text-sm {{ $this->isFieldDisabled('fan_unit_1') ? 'text-gray-400' : '' }}">N/A</span>
                                                </label>
                                                @endif
                                            </div>
                                        </div>
                                ...
                                <flux:card class="p-0 shadow-lg overflow-hidden">
                                    ...
                                    <div class="p-6">
                                        <div>
                                            <label class="text-sm font-medium text-zinc-700 dark:text-zinc-300">
                                                Fan Unit 2 (26)
                                                @if($this->isFieldRequired('fan_unit_2'))
                                                    <span class="text-red-500">*</span>
                                                @else
                                                    <span class="text-gray-400 text-xs font-normal">(Disabled)</span>
                                                @endif
                                            ...
                                            <div class="flex gap-6">
                                                <label class="inline-flex items-center gap-2">
                                                    <input type="radio" wire:model.live="fan_unit_2" value="checked" class="rounded border-zinc-300 text-blue-600 focus:ring-blue-500" {{ $this->isFieldDisabled('fan_unit_2') ? 'disabled' : '' }}>
                                                    <span class="text-sm {{ $this->isFieldDisabled('fan_unit_2') ? 'text-gray-400' : '' }}">Checked ✓</span>
                                                </label>
                                                @if($this->isNAAllowed())
                                                <label class="inline-flex items-center gap-2">
                                                    <input type="radio" wire:model.live="fan_unit_2" value="na" class="rounded border-zinc-300 text-blue-600 focus:ring-blue-500" {{ $this->isFieldDisabled('fan_unit_2') ? 'disabled' : '' }}>
                                                    <span class="text-sm {{ $this->isFieldDisabled('fan_unit_2') ? 'text-gray-400' : '' }}">N/A</span>
                                                </label>
                                                @endif
                                            </div>
                                        </div>
