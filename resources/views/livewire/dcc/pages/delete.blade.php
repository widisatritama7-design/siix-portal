            ...
            <div class="mb-6 p-4 bg-zinc-50 dark:bg-zinc-700/50 rounded-lg">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="text-sm font-medium text-zinc-900 dark:text-white">{{ $submissionToDelete->description }}</p>
                    </div>
                    <div>
                        <label class="text-xs text-zinc-500 dark:text-zinc-400">Department</label>
                        <p class="text-sm font-medium text-zinc-900 dark:text-white">{{ $submissionToDelete->department->dept_name ?? 'N/A' }}</p>
                    </div>
                    <div>
                        <label class="text-xs text-zinc-500 dark:text-zinc-400">Category</label>
                        <p class="text-sm font-medium text-zinc-900 dark:text-white">{{ $submissionToDelete->category_document }}</p>
                    </div>
                    <div>
                        <label class="text-xs text-zinc-500 dark:text-zinc-400">Created At</label>
                        <p class="text-sm font-medium text-zinc-900 dark:text-white">{{ $submissionToDelete->created_at->format('d M Y H:i') }}</p>
                    </div>
                </div>
            </div>
