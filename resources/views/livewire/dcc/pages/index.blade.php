        ...
        <div class="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-blue-700 dark:text-blue-300">{{ $totalSubmissions }}</p>
                </div>
        ...
        <div class="bg-yellow-50 dark:bg-yellow-900/20 rounded-xl p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-yellow-700 dark:text-yellow-300">{{ $waitingSubmissions }}</p>
                </div>
        ...
        <div class="bg-green-50 dark:bg-green-900/20 rounded-xl p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-green-700 dark:text-green-300">{{ $completedSubmissions }}</p>
                </div>
        ...
        <div class="bg-red-50 dark:bg-red-900/20 rounded-xl p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-red-700 dark:text-red-300">{{ $overdueSubmissions }}</p>
                </div>
