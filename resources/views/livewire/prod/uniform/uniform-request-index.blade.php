        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                    ...
                    @endphp
                    <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors" wire:key="row-{{ $index }}">
                        ...
                        <td class="px-4 py-3 text-center">
                            <div class="flex items-center gap-3">
                                <div class="w-8 h-8 rounded-full bg-gradient-to-br from-green-500 to-emerald-600 flex items-center justify-center text-white font-medium shadow-lg flex-shrink-0 text-sm">
                                    {{ strtoupper(substr($request->created_by, 0, 1)) }}
                                </div>
                                <div>
                                    <div class="text-sm font-medium text-zinc-800 dark:text-white">{{ $request->created_by }}</div>
                                </div>
                            </div>
                        </td>
                            ...
                            <div class="flex flex-col items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-zinc-500 dark:text-zinc-400 mb-4">
                                        {{ $search ? 'Try adjusting your search query' : 'Get started by creating a new request' }}
                                    </p>
                                </div>
                                @if($search)
