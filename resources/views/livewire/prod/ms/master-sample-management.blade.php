                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" wire:model="sample_ok" placeholder="Auto-generated sample OK number..."
                                            class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-500 bg-green-50 dark:bg-green-900/10 dark:border-green-800">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" wire:model="sample_ng" placeholder="Auto-generated sample NG number..."
                                            class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-red-500 bg-red-50 dark:bg-red-900/10 dark:border-red-800">
