<div class="p-1 space-y-2">
    @section('title', 'Visual Inspection Process Scan')
    ...
    <flux:breadcrumbs>
        ...
        <flux:breadcrumbs.item separator="slash" class="font-semibold text-purple-600 dark:text-purple-400">
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-2 gap-3 mt-6 pt-6 border-t border-zinc-200/60 dark:border-zinc-700/60">
                        <div class="bg-zinc-50 dark:bg-zinc-800/50 rounded-lg p-3 text-center">
                            ...
                            <div class="text-2xl font-bold text-purple-600 dark:text-purple-400 mt-1">{{ count($recentScans) }}</div>
                        </div>
                        <div class="bg-zinc-50 dark:bg-zinc-800/50 rounded-lg p-3 text-center">
                            <span class="text-xs text-zinc-500 dark:text-zinc-400">Status</span>
                            <div class="text-sm font-semibold mt-1 {{ $isSystemLocked ? 'text-red-600 dark:text-red-400' : 'text-purple-600 dark:text-purple-400' }}">
                                <!-- Lock/Unlock SVG -->
                                @if($isSystemLocked)
                ...
                <div class="p-6">
                    ...
                    <div class="mb-4 p-4 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border border-green-200 dark:border-green-800 rounded-xl text-center animate-pulse">
                        ...
                        <div class="flex justify-center gap-2 text-xs">
                            <flux:badge color="green">FCT ✓</flux:badge>
                            <flux:badge color="green">LED ✓</flux:badge>
                            <flux:badge color="green">Visual ✓</flux:badge>
                        </div>
                    </div>
                    @endif
    ...
    <script>
        ...
        document.addEventListener('livewire:initialized', function () {
            ...
            @this.on('complete-sound', function () {
            ...
            @this.on('hide-completion', function () {
                setTimeout(function() {
                    @this.hideCompletion();
                }, 8000);
            });
