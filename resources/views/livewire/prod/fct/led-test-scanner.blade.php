<div class="p-1 space-y-2">
    ...
    <flux:breadcrumbs>
        ...
        <flux:breadcrumbs.item separator="slash" class="font-semibold text-green-600 dark:text-green-400">
            LED Scan
        </flux:breadcrumbs.item>
    </flux:breadcrumbs>
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-2 gap-3 mt-6 pt-6 border-t border-zinc-200/60 dark:border-zinc-700/60">
                        <div class="bg-zinc-50 dark:bg-zinc-800/50 rounded-lg p-3 text-center">
                            ...
                            <div class="text-2xl font-bold text-green-600 dark:text-green-400 mt-1">{{ count($recentScans) }}</div>
                        </div>
                        <div class="bg-zinc-50 dark:bg-zinc-800/50 rounded-lg p-3 text-center">
