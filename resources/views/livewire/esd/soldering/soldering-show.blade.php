<section class="w-full">
    ...
    <flux:heading class="sr-only">
        {{ __('Electrostatic Discharge - Soldering Detail') }}
    </flux:heading>
        ...
        <x-slot name="heading">
            <div class="w-full">
                ...
                <flux:breadcrumbs class="mb-1">
                    ...
                    <flux:breadcrumbs.item href="{{ route('esd.solderings') }}" wire:navigate separator="slash">
                        Soldering
                    </flux:breadcrumbs.item>
                    <flux:breadcrumbs.item separator="slash" class="font-semibold text-blue-600 dark:text-blue-400">
                        View
                    ...
                    <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                        <div class="p-6">
                            ...
                            <form wire:submit="save">
                                ...
                                <input type="hidden" wire:model="soldering_id" value="{{ $soldering->id }}">
