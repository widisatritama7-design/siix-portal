                ...
                <tr>
                    <td style="width: 50%; vertical-align: top;">
                        <table style="width: 100%;">
                            ...
                            @endif
                            @if($check_body_filter !== '')
                            <tr>
                                <td>Check Body Filter</td>
                                <td colspan="3">: {{ $check_body_filter == '1' ? 'Yes (Checked)' : 'No (Not Checked)' }}</td>
                            </tr>
                            @endif
                            @if($judgement_filter)
                            <tr>
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr style="{{ $rowClass }}">
                    ...
                    <td class="text-center">{{ $detail->shower->register_no ?? 'N/A' }}</td>
                    <td class="text-center">{{ $detail->shower->area ?? '-' }}</td>
                    <td class="text-center">{{ $detail->shower->location ?? '-' }}</td>
                    ...
                    <td class="text-center">
                        <span class="{{ $isOutOfSpec ? 'velocity-ng' : 'velocity-ok' }}">
                            {{ number_format(floatval($detail->velocity), 2) }}
                        </span>
                    </td>
                    <td class="text-center">
                        @php
