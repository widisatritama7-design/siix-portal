        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">{{ $detail->magazine->register_no ?? 'N/A' }}</td>
                    <td class="text-center">{{ $detail->m1_scientific ?? '-' }}</td>
                    <td class="text-center">
                        <span class="{{ $detail->judgement_m1 == 'OK' ? 'badge-ok' : 'badge-ng' }}">
                            {{ $detail->judgement_m1 ?? '-' }}
                        </span>
                    </td>
                    <td class="text-center">
                    ...
                    <td class="text-center">
                        <span class="{{ $detail->judgement_m2 == 'OK' ? 'badge-ok' : 'badge-ng' }}">
                            {{ $detail->judgement_m2 ?? '-' }}
                        </span>
                    </td>
