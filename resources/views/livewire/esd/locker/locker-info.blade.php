        ...
        <div class="w-full lg:w-[70%]">
            <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-lg border border-zinc-200 dark:border-zinc-800 p-4">
                ...
                <div class="grid grid-cols-4 sm:grid-cols-5 md:grid-cols-6 lg:grid-cols-7 gap-2 max-h-[450px] overflow-y-auto pr-2">
                    ...
                    @endphp
                    <div class="rounded-lg {{ $statusColors[$locker->status] ?? 'bg-gray-500' }} text-white p-3 text-center font-bold shadow hover:shadow-lg transition-all duration-200 cursor-default">
                        <div class="text-sm">
                            {{ $locker->code }}
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-3 gap-2 max-w-xs mx-auto">
                            @foreach(['1','2','3','4','5','6','7','8','9','clear','0','backspace'] as $key)
                                <button type="button"
                                        ...
                                        "
                                        class="numpad-btn {{ $key === 'clear' ? 'bg-red-500 hover:bg-red-600 text-white' : ($key === 'backspace' ? 'bg-yellow-500 hover:bg-yellow-600 text-white' : 'bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-800 dark:text-white') }} py-3 rounded-lg font-bold text-xl transition">
                                    @if($key === 'clear')
                ...
                @else
                    <div class="text-center py-4">
                        ...
                        <div class="bg-zinc-50 dark:bg-zinc-800/50 rounded-xl p-5 mb-6 border border-zinc-200 dark:border-zinc-700">
                            ...
                            <p class="text-3xl font-mono font-bold text-zinc-800 dark:text-white tracking-wider">{{ $access_code }}</p>
