{{-- resources/views/livewire/esd/eg/equipment-ground-show.blade.php --}}
<section class="w-full">
    @include('partials.esd-heading')

    <flux:heading class="sr-only">
        {{ __('Electrostatic Discharge - Equipment Ground Detail') }}
    </flux:heading>
        ...
        <x-slot name="heading">
            <div class="w-full">
                ...
                <flux:breadcrumbs class="mb-1">
                    ...
                    <flux:breadcrumbs.item href="{{ route('esd.equipment-grounds') }}" wire:navigate separator="slash">
                        Equipment Ground
                    </flux:breadcrumbs.item>
                    <flux:breadcrumbs.item separator="slash" class="font-semibold text-blue-600 dark:text-blue-400">
                        View
        ...
        <div class="-mt-2">
            ...
            <flux:card class="p-0 shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden mb-6">
                ...
                <div class="p-6" x-data="{ open: false }">
                    ...
                    >
                        <div class="flex items-center gap-2">
                            <flux:icon name="bolt" class="w-5 h-5 text-blue-600 dark:text-blue-400" />
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-6">
                                ...
                                <div class="text-center">
                                    <div class="flex items-center justify-center gap-2 mb-2">
                                        <flux:icon name="beaker" class="w-4 h-4 text-green-600 dark:text-green-400" />
                                ...
                                <div class="text-center">
                                    <div class="flex items-center justify-center gap-2 mb-2">
                                        <flux:icon name="bolt" class="w-4 h-4 text-yellow-600 dark:text-yellow-400" />
                                        <label class="text-sm font-semibold text-zinc-600 dark:text-zinc-400 uppercase tracking-wider">
                                            Measurement Volts
                                        </label>
                                    </div>
                    ...
                    <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                        <div class="p-6">
                            ...
                            <form wire:submit="save">
                                ...
                                <input type="hidden" wire:model="equipment_ground_id" value="{{ $equipmentGround->id }}">
                                ...
                                <div class="mb-4 p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-2">
                                                <span class="inline-flex px-3 py-1 rounded-full text-sm font-medium {{ $judgement_ohm == 'OK' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400' }}">
                                                    {{ $judgement_ohm ?: 'Auto' }}
                                                </span>
                                            </div>
                                        </div>
                                ...
                                <div class="mb-4 p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-2">
                                                <span class="inline-flex px-3 py-1 rounded-full text-sm font-medium {{ $judgement_volts == 'OK' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400' }}">
