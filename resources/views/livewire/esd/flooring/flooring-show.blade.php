<section class="w-full">
    ...
    <flux:heading class="sr-only">
        {{ __('Electrostatic Discharge - Flooring Detail') }}
    </flux:heading>
        ...
        <x-slot name="heading">
            <div class="w-full">
                ...
                <flux:breadcrumbs class="mb-1">
                    ...
                    <flux:breadcrumbs.item href="{{ route('esd.floorings') }}" wire:navigate separator="slash">
                        Flooring
                    </flux:breadcrumbs.item>
                    <flux:breadcrumbs.item separator="slash" class="font-semibold text-blue-600 dark:text-blue-400">
                        View
        ...
        <div class="-mt-2">
            ...
            <flux:card class="p-0 shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden mb-6">
                ...
                <div class="p-6" x-data="{ open: false }">
                    ...
                    >
                        <div class="flex items-center gap-2">
                            <flux:icon name="beaker" class="w-5 h-5 text-green-600 dark:text-green-400" />
                    ...
                    <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                        <div class="p-6">
                            ...
                            <form wire:submit="save">
                                ...
                                <input type="hidden" wire:model="flooring_id" value="{{ $flooring->id }}">
