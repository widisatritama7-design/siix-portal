{{-- resources/views/livewire/esd/ionizer/ionizer-show.blade.php --}}
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <div class="bg-purple-50 dark:bg-purple-950/30 rounded-lg p-4 border border-purple-200 dark:border-purple-800">
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <span class="inline-flex ml-2 px-2 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400">
                                                NO = OK
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="bg-purple-50 dark:bg-purple-950/30 rounded-lg p-4 border border-purple-200 dark:border-purple-800">
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <span class="inline-flex ml-2 px-2 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400">
                                                NG
                                            </span>
                                        </div>
                                    </div>
                    ...
                    <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
                        <div class="p-6">
                            ...
                            <form wire:submit="save">
                                <!-- Hidden Input for ionizer_id -->
                                <input type="hidden" wire:model="ionizer_id" value="{{ $ionizer->id }}">

                                <!-- Register No, Area, Location (Readonly) -->
                                <div class="grid grid-cols-3 gap-4 mb-4">
                                    <div>
                                        <label class="block text-sm font-medium mb-1">Register No</label>
                                        <input type="text" wire:model="register_no" readonly class="w-full px-3 py-2 border rounded-lg bg-gray-100 dark:bg-zinc-800 dark:border-zinc-700">
                                    </div>
                                    <div>
