    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mt-2">
        ...
        @can('create deffect')
            <flux:button 
                ...
                x-on:click="$dispatch('open-modal-deffect')"
            >
                Add New Defect Item
            </flux:button>
        @endcan
    ...
    <div class="flex justify-end">
        <div class="w-full sm:w-80">
            <flux:input
                ...
                placeholder="Search Defect item name..."
            ...
            <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-xl w-full max-w-md">
                <div class="p-6">
                    ...
                    <form wire:submit="save" id="deffect-form">
                        <div class="mb-4">
                            <flux:label required>Defect Item Name</flux:label>
                            <flux:input 
                                wire:model="deffect_item_name" 
                                type="text" 
                                placeholder="Enter deffect item name"
                                class="uppercase"
                            />
                            @error('deffect_item_name') 
                ...
                <div class="p-6 pt-0 flex justify-end gap-2">
                    ...
                    <button type="submit" 
                        ...
                        wire:target="save">
                        <span wire:loading.remove wire:target="save">{{ $deffect_id ? 'Update' : 'Create' }}</span>
                ...
                <div class="p-6">
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <p class="text-sm font-semibold text-zinc-800 dark:text-white mt-1">{{ $viewData->deffect_item_name }}</p>
                        </div>
                        <div>
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
            <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-xl w-full max-w-md p-6">
                ...
                <p class="text-gray-600 dark:text-gray-400 mb-4 text-center">
                    Are you sure you want to delete Defect item <span class="font-semibold">{{ $deffectToDelete?->deffect_item_name }}</span>?
                </p>
