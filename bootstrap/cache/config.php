<?php return array (
  ...
  array (
    ...
    'env' => 'local',
    'debug' => false,
    'url' => 'https://portal.siix-ems.co.id',
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'url' => 'https://portal.siix-ems.co.id/storage',
        'visibility' => 'public',
        'throw' => false,
        'report' => false,
      ),
  ...
  array (
    ...
    'passkeys' => 
    array (
      'relying_party_id' => 'portal.siix-ems.co.id',
      'allowed_origins' => 
      array (
        0 => 'https://portal.siix-ems.co.id',
      ),
      'user_handle_secret' => 'base64:ouHtJ4/IehtmsbPBCX9zTEPmxyhGw3LwC6bn3QdNQCg=',
      'timeout' => 60000,
    ),
    'features' => 
    array (
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'timeout' => NULL,
        'local_domain' => 'portal.siix-ems.co.id',
      ),
      'ses' => 
      array (
        'transport' => 'ses',
