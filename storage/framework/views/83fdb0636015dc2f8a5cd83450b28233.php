...
<section class="w-full">
    ...
    <?php ob_start(); ?><div class="font-medium [:where(&amp;)]:text-zinc-800 [:where(&amp;)]:dark:text-white text-sm [&amp;:has(+[data-flux-subheading])]:mb-2 [[data-flux-subheading]+&amp;]:mt-2 sr-only" data-flux-heading><?php ob_start(); ?>
        <?php echo e(__('Electrostatic Discharge - Soldering Detail')); ?>
...
<?php if (isset($__slots028777b3eb06dbd0c29b11890d068895)) { $__slotsStack028777b3eb06dbd0c29b11890d068895[] = $__slots028777b3eb06dbd0c29b11890d068895; } ?>
<?php if (isset($__attrs028777b3eb06dbd0c29b11890d068895)) { $__attrsStack028777b3eb06dbd0c29b11890d068895[] = $__attrs028777b3eb06dbd0c29b11890d068895; } ?>
<?php $__attrs028777b3eb06dbd0c29b11890d068895 = ['href' => e(route('esd.solderings')),'wire:navigate' => true,'separator' => 'slash']; ?>
<?php $__slots028777b3eb06dbd0c29b11890d068895 = []; ?>
<?php $__blaze->pushData($__attrs028777b3eb06dbd0c29b11890d068895); ?>
<?php ob_start(); ?>
                        Soldering
                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div class="w-full sm:w-auto">
                        ...
                        <p class="text-xs sm:text-sm text-zinc-500 dark:text-zinc-400 mt-1">
                            View detailed information about ESD soldering equipment
                        </p>
                    </div>
    ...
    <?php ob_start(); ?>
                ...
                <div class="bg-orange-600 dark:bg-orange-500 px-6 py-4">
                    <div class="flex items-center gap-2">
                        ...
                        <h3 class="font-semibold text-base text-white">Soldering Information</h3>
                    </div>
                </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex justify-center">
                                <?php
                                    ...
                                    $statusColor = $statusConfig[$soldering->status] ?? 'bg-gray-100 text-gray-800';
                                ?>
                                <span class="inline-flex px-3 py-1 rounded-full text-sm font-medium <?php echo e($statusColor); ?>">
                                    <?php echo e($soldering->status); ?>
    ...
    <?php ob_start(); ?>
                ...
                <div class="bg-orange-600 dark:bg-orange-500 px-6 py-4">
                    <div class="flex items-center gap-2">
                        ...
                        <h3 class="font-semibold text-base text-white">Standard ESD Of Soldering</h3>
                    </div>
                </div>
                    ...
                    <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                        <div class="p-6">
                            ...
                            <form wire:submit="save">
                                <!-- Hidden Input for soldering_id -->
                                <input type="hidden" wire:model="soldering_id" value="<?php echo e($soldering->id); ?>">
...
<?php endif; ?>
</section><?php /**PATH /www/wwwroot/testings.siix-ems.co.id/siix-portal/resources/views/livewire/esd/soldering/soldering-show.blade.php ENDPATH**/ ?>