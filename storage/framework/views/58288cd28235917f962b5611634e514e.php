...
<body style="font-family: Arial, sans-serif; background-color: #f4f4f7; margin: 0; padding: 0;">
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width: 600px; margin: 40px auto; background-color: #ffffff; border-radius: 8px; padding: 30px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
        <tr>
            <td>
                <h2 style="color: #333333; margin-bottom: 20px;">Halo <?php echo e($user->name); ?>,</h2>

                <p style="font-size: 16px; color: #555555; line-height: 1.5;">
                    Anda memiliki total 
                    <strong style="color: #000000;"><?php echo e($total); ?></strong> 
                    Master Sample yang perlu segera di 
                    <strong style="color: #000000;"><?php echo e($type); ?></strong>.
                </p>
...
<?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/resources/views/emails/prod/pending-master-sample-single.blade.php ENDPATH**/ ?>