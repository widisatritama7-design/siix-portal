    ...
    <?php ob_start(); ?>
        ...
        <div class="mb-4 flex gap-2 flex-wrap">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('feedback uniform request costing')): ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($costingReady && !$allCostingCompleted): ?>
                    <div class="flex gap-2">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasManualItems && $hasRegularPendingItems): ?>
                    ...
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php elseif($costingReady && $allCostingCompleted): ?>
                    <div class="text-sm text-green-600 bg-green-50 dark:bg-green-900/20 px-3 py-2 rounded-lg whitespace-nowrap">
                        ✓ All costing feedbacks have been filled
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasRejectedItems): ?>
                            <span class="text-xs text-zinc-500 ml-1">(Rejected items skipped)</span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                <?php elseif(!$allVerificationFilled && !$hasManualItems): ?>
                    <div class="text-sm text-yellow-600 bg-yellow-50 dark:bg-yellow-900/20 px-3 py-2 rounded-lg whitespace-nowrap">
                        ...
                        (<?php echo e(collect($itemsDetail)->where('verification_status', null)->count()); ?> item(s) pending)
                    </div>
                <?php elseif($allVerificationFilled && !$hasApprovedItems && !$hasManualItems): ?>
                    <div class="text-sm text-blue-600 bg-blue-50 dark:bg-blue-900/20 px-3 py-2 rounded-lg whitespace-nowrap">
                        ℹ️ All items are rejected. No costing feedback needed.
                    </div>
                <?php elseif($hasManualItems && !$hasApprovedItems && $allVerificationFilled): ?>
                    <div class="text-sm text-blue-600 bg-blue-50 dark:bg-blue-900/20 px-3 py-2 rounded-lg whitespace-nowrap">
                ...
                <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                    ...
                    <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors">
                        ...
                        <td class="px-3 py-2 text-center text-sm whitespace-nowrap">
                            <div class="space-y-1">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item['admin_feedback']): ?>
                                    ...
                                    <div class="text-[10px] text-zinc-400 whitespace-nowrap"><?php echo e(\Carbon\Carbon::parse($item['admin_feedback_datetime'])->format('d/m/Y H:i')); ?></div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php else: ?>
                        ...
                        <td class="px-3 py-2 text-center text-sm whitespace-nowrap">
                            <div class="space-y-1">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item['costing_feedback']): ?>
                                    <div class="text-xs whitespace-nowrap"><?php echo e($item['costing_feedback']); ?></div>
                                    ...
                                    <div class="text-[10px] text-zinc-400 whitespace-nowrap"><?php echo e(\Carbon\Carbon::parse($item['costing_feedback_datetime'])->format('d/m/Y H:i')); ?></div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php else: ?>
                                    <?php
                                        $isManual = isset($item['is_manual']) && $item['is_manual'];
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isManual): ?>
                                        ...
                                        <span class="text-xs text-zinc-400 italic whitespace-nowrap">Waiting</span>
                                    <?php elseif(isset($item['verification_status']) && $item['verification_status'] === 'rejected'): ?>
                        ...
                        <td class="px-3 py-2 text-center text-sm whitespace-nowrap">
                            ...
                            @mouseleave="showTooltip = false">
                                ...
                                <?php else: ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($item['verification_status']) && $item['verification_status'] === 'rejected'): ?>
                                        <span class="text-xs text-zinc-400 italic whitespace-nowrap">-</span>
                                    <?php else: ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sign uniform request')): ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($item['costing_feedback']) && $item['costing_feedback']): ?>
                                                <button type="button" 
