    ...
    <?php ob_start(); ?>
                            ...
                            <div class="p-6 space-y-6">
                                ...
                                <div>
                                    ...
                                    <div class="flex gap-6">
                                        <label class="inline-flex items-center gap-2">
                                            <input type="radio" wire:model.live="flashlight" value="checked" class="rounded border-zinc-300 text-blue-600 focus:ring-blue-500">
                                            <span class="text-sm">Checked ✓</span>
                                        </label>
                                        <label class="inline-flex items-center gap-2">
...
</style><?php /**PATH /www/wwwroot/testings.siix-ems.co.id/siix-portal/resources/views/livewire/mtc/daily/panasonic/daily-panasonic-create.blade.php ENDPATH**/ ?>