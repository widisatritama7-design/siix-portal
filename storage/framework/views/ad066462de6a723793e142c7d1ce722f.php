                                    ...
                                    <div class="grid grid-cols-12 gap-2 items-center px-3 py-3 bg-white dark:bg-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-700/50 transition-colors cursor-pointer border-b border-zinc-100 dark:border-zinc-700 last:border-b-0"
                                        ...
                                        <div class="col-span-2 flex justify-center">
                                            <div class="w-15 h-6 bg-blue-500 rounded-lg flex items-center justify-center text-white font-bold text-xs shadow-md flex-shrink-0">
                                                SMT <?php echo e($line->line_number); ?>
                                        ...
                                        <div class="col-span-2 flex justify-center">
                                            <span class="inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium whitespace-nowrap <?php echo e($this->getDailyCheckColor($line->daily_check_status)); ?>">
                                                ...
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                <span class="truncate"><?php echo e($line->daily_check_status); ?></span>
                                            </span>
                                        </div>
...
<?php endif; ?>
    ...
    <?php $__env->stopPush(); ?>
</section><?php /**PATH /www/wwwroot/testings.siix-ems.co.id/siix-portal/resources/views/livewire/mtc/dashboard/daily-dashboard.blade.php ENDPATH**/ ?>