<?php
if (!function_exists('_771118a2c3a1243e88827b134eb2df88')):
function _771118a2c3a1243e88827b134eb2df88($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php _7f261f80665a6ca1a2fa9cf7c808fea9($__blaze, ['attributes' => $paginationAttributes], [], ['attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
    <?php endif; ?>
</div>
<?php
echo ltrim(ob_get_clean());
} endif; ?><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/stubs/resources/views/flux/table/index.blade.php ENDPATH**/ ?>