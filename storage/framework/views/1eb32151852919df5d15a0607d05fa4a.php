...
<?php # [BlazeFolded]:{flux::icon}:{/www/wwwroot/testings.siix-ems.co.id/siix-portal/vendor/livewire/flux/src/../stubs/resources/views/flux/icon/index.blade.php}:{1776985208} ?>
<?php # [BlazeFolded]:{flux::card}:{/www/wwwroot/testings.siix-ems.co.id/siix-portal/vendor/livewire/flux/src/../stubs/resources/views/flux/card/index.blade.php}:{1776985208} ?>
<div class="p-1 space-y-3" <?php if($isStarted && !$isFinished): ?> wire:poll.3s="syncTimer" <?php endif; ?>>
    <!-- Breadcrumbs -->
...
<?php $__attrsdc7b41944d7ad01d0a093ce0d326337c = ['size' => 'sm','color' => e($sc[$blindTest->status] ?? 'gray')]; ?>
...
<?php _5ae551d98c08f0bc67bd05455e08306c($__blaze, ['wire:model' => 'userAnswers.'.e($i).'.component_location','placeholder' => 'Component location (e.g. CN4)','class' => 'uppercase'], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                </div>
                    ...
                    <div class="px-4 py-3 bg-gradient-to-r from-red-500 to-rose-500 text-white flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <div class="text-[10px] text-white/80">
                                Result: <?php echo e($blindTest->first_attempt_result ?? '-'); ?> —
                                <?php echo e(count($firstVisible)); ?> jawaban salah
                            </div>
                        </div>
                    </div>
                    <div class="overflow-x-auto bg-white dark:bg-zinc-900">
                        <table class="w-full" style="min-width: 500px;">
                            ...
                            <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $firstVisible; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <?php
...
</div><?php /**PATH /www/wwwroot/testings.siix-ems.co.id/siix-portal/resources/views/livewire/qaqc/blind-test/blind-test-execution.blade.php ENDPATH**/ ?>