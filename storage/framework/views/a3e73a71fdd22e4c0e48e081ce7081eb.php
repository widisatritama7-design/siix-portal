<div class="p-1 space-y-2">
                    ...
                    <div class="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 p-3 shadow-sm hover:shadow-md transition-shadow">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-2">
                                <span class="text-xl font-bold text-zinc-700 dark:text-zinc-300"><?php echo e($number); ?></span>
                            </div>
                            <!-- Bulat indikator diperbesar menjadi w-5 h-5 -->
                            <div class="w-5 h-5 rounded-full <?php echo e($color['bg']); ?> shadow-lg <?php echo e($color['shadow']); ?>"></div>
                        </div>
                    </div>
    ...
    <div x-data="{ 
        ...
        storePhone: <?php if ((object) ('store_phone') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('store_phone'->value()); ?>')<?php echo e('store_phone'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('store_phone'); ?>')<?php endif; ?>.live || '',
        activeInput: 'nik',
        countdown: 10,
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['store_phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> 
                                            ...
                                            @click="
                                                if ('<?php echo e($key); ?>' === 'clear') {
                                                    ...
                                                    if (activeInput === 'nik') {
                                                        ...
                                                        let newPhone = (storePhone || '') + '<?php echo e($key); ?>';
                                                ...
                                                $wire.set('store_phone', storePhone || '');
                                            "
                                            class="numpad-btn <?php echo e($key === 'clear' ? 'bg-red-500 hover:bg-red-600 text-white' : ($key === 'backspace' ? 'bg-yellow-500 hover:bg-yellow-600 text-white' : 'bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-800 dark:text-white')); ?> py-1.5 rounded-lg font-black text-2xl transition active:scale-95 h-[48px] shadow-sm hover:shadow-md flex items-center justify-center">
                            ...
                            <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl p-4 animate-fade-in">
                                ...
                                <div class="space-y-1 text-sm text-zinc-700 dark:text-zinc-300">
                                    ...
                                    <div class="flex justify-between py-1">
                                        ...
                                        <span>+<?php echo e($store_phone); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-col items-center justify-center py-2 animate-fade-in">
                        ...
                        <div class="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-3 mb-3 border border-blue-200 dark:border-blue-800 w-full max-w-md">
                            <div class="flex items-center justify-center gap-2 text-sm text-zinc-600 dark:text-zinc-400">
                                ...
                                <span>Seragam berhasil disimpan di locker <strong class="text-blue-600 dark:text-blue-400"><?php echo e($locker_code); ?></strong></span>
                            </div>
