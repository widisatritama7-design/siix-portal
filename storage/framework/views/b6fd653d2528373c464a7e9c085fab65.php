    ...
    <div x-data="{ showFilters: false }">
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            >
                ...
                <span x-show="<?php echo e($search || $departmentFilter || $shiftFilter || $dateFrom || $dateUntil || $yearFilter || $monthFilter); ?>" 
            ...
            <div class="flex gap-2">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($search || $departmentFilter || $shiftFilter || $dateFrom || $dateUntil || $yearFilter || $monthFilter): ?>
...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <?php ob_start(); ?>
        <div class="overflow-x-auto">
            <table class="w-full whitespace-nowrap">
                ...
                <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $comelateEmployees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'comelate-'.e($item->id).''; ?>wire:key="comelate-<?php echo e($item->id); ?>">
                        <td class="px-4 py-3 whitespace-nowrap">
                            <span class="font-mono text-sm text-zinc-700 dark:text-zinc-300">
                                <?php echo e($item->employee->nik ?? $item->nik); ?>

                            </span>
                        </td>
                        <td class="px-4 py-3 whitespace-nowrap">
                            <span class="text-sm font-semibold text-zinc-800 dark:text-white">
                                <?php echo e($item->employee->Display_Name ?? $item->name); ?>
        ...
        <?php ob_start(); ?>
                                <?php echo e($item->employee->Departement ?? $item->department); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
        ...
        <?php ob_start(); ?>
                                <?php echo e($this->formatShift($item->shift)); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
                        ...
                        <td class="px-4 py-3 text-sm text-zinc-500 whitespace-nowrap">
                            <?php echo e($item->jam ? \Carbon\Carbon::parse($item->jam)->format('H:i') : '-'); ?>
...
<?php $__blaze->popData(); ?>
                        ...
                        <td class="px-4 py-3 text-sm text-zinc-500 whitespace-nowrap max-w-xs truncate" title="<?php echo e($item->alasan_terlambat); ?>">
                            <?php echo e(Str::limit($item->alasan_terlambat, 30)); ?>

                        </td>
                        <td class="px-4 py-3 text-sm text-zinc-500 whitespace-nowrap">
                            <?php echo e($item->nama_security); ?>
                        ...
                        <td class="px-4 py-3 text-right whitespace-nowrap">
                            <div class="flex items-center justify-end gap-1">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit comelate employee')): ?>
                                    <?php
...
<?php echo ltrim(ob_get_clean()); ?>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete comelate employee')): ?>
                                <?php ob_start(); ?><button type="button" class="relative items-center font-medium justify-center gap-2 whitespace-nowrap disabled:opacity-75 dark:disabled:opacity-75 disabled:cursor-default disabled:pointer-events-none justify-center h-8 text-sm rounded-md w-8 inline-flex  bg-white hover:bg-zinc-50 dark:bg-zinc-700 dark:hover:bg-zinc-600/75 text-zinc-800 dark:text-white border border-zinc-200 hover:border-zinc-200 border-b-zinc-300/80 dark:border-zinc-600 dark:hover:border-zinc-600 shadow-xs [[data-flux-button-group]_&amp;]:border-s-0 [:is([data-flux-button-group]&gt;&amp;:first-child,_[data-flux-button-group]_:first-child&gt;&amp;)]:border-s-[1px] *:transition-opacity [&amp;[data-loading]&gt;:not([data-flux-loading-indicator])]:opacity-0 [&amp;[data-flux-loading]&gt;:not([data-flux-loading-indicator])]:opacity-0 [&amp;[data-loading]&gt;[data-flux-loading-indicator]]:opacity-100 [&amp;[data-flux-loading]&gt;[data-flux-loading-indicator]]:opacity-100 data-loading:pointer-events-none data-flux-loading:pointer-events-none  !p-1.5 text-red-600 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-950/50" data-flux-button="data-flux-button" data-flux-group-target="data-flux-group-target" wire:target="confirmDelete(<?php echo e($item->id); ?>)" wire:loading.attr="data-flux-loading" wire:click="confirmDelete(<?php echo e($item->id); ?>)" title="Delete record">
        <div class="absolute inset-0 flex items-center justify-center opacity-0" data-flux-loading-indicator>
                <svg class="shrink-0 [:where(&amp;)]:size-5 animate-spin" data-flux-icon xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" aria-hidden="true" data-slot="icon">
    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
        ...
        <?php echo ltrim(ob_get_clean()); ?>
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-zinc-500 dark:text-zinc-400 mb-4">
                                        <?php echo e($search ? 'Try adjusting your search query' : 'No comelate employee data available'); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
        ...
        <!-- Pagination -->
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($comelateEmployees->hasPages()): ?>
        <div class="p-4 border-t border-zinc-200 dark:border-zinc-700">
            <?php echo e($comelateEmployees->links()); ?>
    ...
    >
        ...
        <div class="flex flex-col max-h-[85vh]">
            <div class="flex justify-between items-center px-6 py-4 border-b border-zinc-200 dark:border-zinc-700">
                ...
                <?php ob_start(); ?><button type="button" class="relative items-center font-medium justify-center gap-2 whitespace-nowrap disabled:opacity-75 dark:disabled:opacity-75 disabled:cursor-default disabled:pointer-events-none justify-center h-8 text-sm rounded-md w-8 inline-flex  bg-transparent hover:bg-zinc-800/5 dark:hover:bg-white/15 text-zinc-800 dark:text-white    *:transition-opacity [&amp;[data-loading]&gt;:not([data-flux-loading-indicator])]:opacity-0 [&amp;[data-flux-loading]&gt;:not([data-flux-loading-indicator])]:opacity-0 [&amp;[data-loading]&gt;[data-flux-loading-indicator]]:opacity-100 [&amp;[data-flux-loading]&gt;[data-flux-loading-indicator]]:opacity-100 data-loading:pointer-events-none data-flux-loading:pointer-events-none  !p-1" data-flux-button="data-flux-button" wire:target="$set('showViewModal', false)" wire:loading.attr="data-flux-loading" wire:click="$set('showViewModal', false)">
        <div class="absolute inset-0 flex items-center justify-center opacity-0" data-flux-loading-indicator>
                <svg class="shrink-0 [:where(&amp;)]:size-5 animate-spin" data-flux-icon xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" aria-hidden="true" data-slot="icon">
    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
...
<?php echo ltrim(ob_get_clean()); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedComelate): ?>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="space-y-2 bg-zinc-50 dark:bg-zinc-800/30 rounded-lg p-4">
                            <div class="flex justify-between items-center">
                                ...
                                <span class="font-mono text-sm text-zinc-800 dark:text-white"><?php echo e($selectedComelate->employee->nik ?? $selectedComelate->nik); ?></span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-sm text-zinc-500 dark:text-zinc-400">Name</span>
                                <span class="text-sm font-semibold text-zinc-800 dark:text-white"><?php echo e($selectedComelate->employee->name ?? $selectedComelate->name); ?></span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-sm text-zinc-500 dark:text-zinc-400">Department</span>
                                <span class="text-sm text-zinc-800 dark:text-white"><?php echo e($selectedComelate->employee->department ?? $selectedComelate->department); ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="space-y-2 bg-zinc-50 dark:bg-zinc-800/30 rounded-lg p-4">
                            <div class="flex justify-between items-center">
                                ...
                                <?php ob_start(); ?><div data-flux-badge="data-flux-badge" class="inline-flex items-center font-medium whitespace-nowrap  [print-color-adjust:exact] text-xs py-1 **:data-flux-badge-icon:me-1 rounded-md px-2 text-blue-800 [&amp;_button]:text-blue-800! dark:text-blue-200 dark:[&amp;_button]:text-blue-200! bg-blue-400/20 dark:bg-blue-400/40 [&amp;:is(button)]:hover:bg-blue-400/30 dark:[button]:hover:bg-blue-400/50">
        <?php ob_start(); ?><?php echo e($this->formatShift($selectedComelate->shift)); ?><?php echo trim(ob_get_clean()); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <span class="text-sm text-zinc-800 dark:text-white"><?php echo e($selectedComelate->jam_masuk ?? '-'); ?></span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-sm text-zinc-500 dark:text-zinc-400">Jam Datang</span>
                                <span class="text-sm text-zinc-800 dark:text-white"><?php echo e($selectedComelate->jam ? \Carbon\Carbon::parse($selectedComelate->jam)->format('H:i') : '-'); ?></span>
                            </div>
                            <div class="flex justify-between items-center">
        ...
        <?php ob_start(); ?><?php echo e($this->formatCountJam($selectedComelate->count_jam)); ?><?php echo trim(ob_get_clean()); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <span class="text-sm text-zinc-800 dark:text-white"><?php echo e(\Carbon\Carbon::parse($selectedComelate->tanggal)->format('d F Y')); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="space-y-3 bg-zinc-50 dark:bg-zinc-800/30 rounded-lg p-4">
                        <div>
                            ...
                            <div class="text-sm text-zinc-800 dark:text-white bg-white dark:bg-zinc-700/50 p-3 rounded-lg border border-zinc-200 dark:border-zinc-600">
                                <?php echo e($selectedComelate->alasan_terlambat); ?>
                        ...
                        <div>
                            ...
                            <div class="text-sm text-zinc-800 dark:text-white bg-white dark:bg-zinc-700/50 p-3 rounded-lg border border-zinc-200 dark:border-zinc-600">
                                <?php echo e($selectedComelate->nama_security); ?>

                            </div>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedComelate->remarks): ?>
                        <div>
                            <div class="text-sm font-medium text-zinc-500 dark:text-zinc-400 mb-1">Remarks</div>
                            <div class="text-sm text-zinc-800 dark:text-white bg-white dark:bg-zinc-700/50 p-3 rounded-lg border border-zinc-200 dark:border-zinc-600">
                                <?php echo e($selectedComelate->remarks); ?>
                ...
                <div class="text-xs text-zinc-400 dark:text-zinc-500 pt-2 border-t border-zinc-200 dark:border-zinc-700">
                    <div class="flex items-center gap-2">
                        ...
                        Created: <?php echo e($selectedComelate->created_at ? \Carbon\Carbon::parse($selectedComelate->created_at)->format('d M Y H:i') : '-'); ?> by <?php echo e($selectedComelate->creator->name ?? '-'); ?>

                    </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedComelate->updated_at && $selectedComelate->updated_at != $selectedComelate->created_at): ?>
                    <div class="flex items-center gap-2 mt-1">
                        <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"></path>
                        </svg>
                        Updated: <?php echo e($selectedComelate->updated_at ? \Carbon\Carbon::parse($selectedComelate->updated_at)->format('d M Y H:i') : '-'); ?> by <?php echo e($selectedComelate->updater->name ?? '-'); ?>
            ...
            <div class="flex justify-end gap-2 px-6 py-4 border-t border-zinc-200 dark:border-zinc-700">
                ...
                ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canEditModal): ?>
                <?php ob_start(); ?><a href="<?php echo e(route('hr.comelate.edit', $selectedComelate->id)); ?>" data-flux-button="data-flux-button" class="relative items-center font-medium justify-center gap-2 whitespace-nowrap disabled:opacity-75 dark:disabled:opacity-75 disabled:cursor-default disabled:pointer-events-none justify-center h-10 text-sm rounded-lg ps-4 pe-4 inline-flex  bg-[var(--color-accent)] hover:bg-[color-mix(in_oklab,_var(--color-accent),_transparent_10%)] text-[var(--color-accent-foreground)] border border-black/10 dark:border-0 shadow-[inset_0px_1px_--theme(--color-white/.2)] [[data-flux-button-group]_&amp;]:border-e-0 [:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-e-[1px] dark:[:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-e-0 dark:[:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-s-[1px] [:is([data-flux-button-group]&gt;&amp;:not(:first-child),_[data-flux-button-group]_:not(:first-child)&gt;&amp;)]:border-s-[color-mix(in_srgb,var(--color-accent-foreground),transparent_85%)]" data-flux-group-target="data-flux-group-target" wire:navigate="">
        <?php ob_start(); ?>
                    Edit Record
                <?php echo trim(ob_get_clean()); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
                <textarea 
                    ...
                    rows="3"
                    class="w-full px-3 py-2 border border-zinc-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 dark:bg-zinc-800 dark:border-zinc-600 dark:text-white <?php $__errorArgs = ['reason_to_delete'];
...
</div><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/resources/views/livewire/hr/comelate-employee/index.blade.php ENDPATH**/ ?>