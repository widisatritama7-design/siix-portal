...
<div class="p-1 space-y-2">
    <?php $__env->startSection('title', 'FCT Process Scan'); ?>
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-2 gap-3 mt-6 pt-6 border-t border-zinc-200/60 dark:border-zinc-700/60">
                        <div class="bg-zinc-50 dark:bg-zinc-800/50 rounded-lg p-3 text-center">
                            ...
                            <div class="text-2xl font-bold text-blue-600 dark:text-blue-400 mt-1"><?php echo e(count($recentScans)); ?></div>
                        </div>
                        <div class="bg-zinc-50 dark:bg-zinc-800/50 rounded-lg p-3 text-center">
...
</style><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/resources/views/livewire/prod/fct/fct-scanner.blade.php ENDPATH**/ ?>