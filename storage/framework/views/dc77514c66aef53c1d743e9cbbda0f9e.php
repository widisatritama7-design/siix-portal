...
<div class="p-1 space-y-2">
    <?php $__env->startSection('title', 'Stock Transactions - Uniform'); ?>
...
<?php if (isset($__slots028777b3eb06dbd0c29b11890d068895)) { $__slotsStack028777b3eb06dbd0c29b11890d068895[] = $__slots028777b3eb06dbd0c29b11890d068895; } ?>
<?php if (isset($__attrs028777b3eb06dbd0c29b11890d068895)) { $__attrsStack028777b3eb06dbd0c29b11890d068895[] = $__attrs028777b3eb06dbd0c29b11890d068895; } ?>
<?php $__attrs028777b3eb06dbd0c29b11890d068895 = ['href' => e(route('prod.uniform.master')),'wire:navigate' => true,'separator' => 'slash']; ?>
<?php $__slots028777b3eb06dbd0c29b11890d068895 = []; ?>
<?php $__blaze->pushData($__attrs028777b3eb06dbd0c29b11890d068895); ?>
<?php ob_start(); ?>
            Master Uniform
...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mt-2">
        ...
        <div>
            <a href="<?php echo e(route('prod.uniform.stock.manage')); ?>" wire:navigate
...
<?php $__blaze->pushData(['wire:model.live.debounce.300ms' => 'search','placeholder' => 'Search...','icon' => 'magnifying-glass','clearable' => true]); ?>
<?php _5ae551d98c08f0bc67bd05455e08306c($__blaze, ['wire:model.live.debounce.300ms' => 'search','placeholder' => 'Search...','icon' => 'magnifying-glass','clearable' => true], [], ['clearable'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
        </div>
        <div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($search || $transactionType || $uniformStatus || $dateFrom || $dateTo): ?>
    ...
    <?php ob_start(); ?>
        <div class="flex justify-between items-center mb-4">
            <div class="text-sm text-zinc-500 dark:text-zinc-400">
                Showing <strong><?php echo e($transactions->firstItem() ?? 0); ?></strong> - <strong><?php echo e($transactions->lastItem() ?? 0); ?></strong> of <strong><?php echo e($transactions->total() ?? 0); ?></strong> transactions
            </div>
            <div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors">
                            ...
                            <td class="px-3 py-2 text-center text-xs font-mono whitespace-nowrap">
                                <?php echo e($transaction->uniform->item_code ?? '-'); ?>

                            </td>
                            <td class="px-3 py-2 text-center text-xs whitespace-nowrap">
                                <?php echo e($transaction->uniform->description ?? '-'); ?>

                            </td>
                            <td class="px-3 py-2 text-center whitespace-nowrap">
                                <?php ob_start(); ?><div data-flux-badge="data-flux-badge" class="inline-flex items-center font-medium whitespace-nowrap  [print-color-adjust:exact] text-sm py-1 **:data-flux-badge-icon:me-1.5 rounded-md px-2 text-purple-700 [&amp;_button]:text-purple-700! dark:text-purple-200 dark:[&amp;_button]:text-purple-200! bg-purple-400/20 dark:bg-purple-400/40 [&amp;:is(button)]:hover:bg-purple-400/30 dark:[button]:hover:bg-purple-400/50 text-xs">
        <?php ob_start(); ?><?php echo e($transaction->uniform->size ?? '-'); ?><?php echo trim(ob_get_clean()); ?>

    </div>
<?php echo ltrim(ob_get_clean()); ?>
                            </td>
                            <td class="px-3 py-2 text-center whitespace-nowrap">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($transaction->uniform): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($transaction->uniform->status == 'Manual'): ?>
...
<?php echo ltrim(ob_get_clean()); ?>
                                    <?php elseif($transaction->uniform->status == 'System'): ?>
...
<?php echo ltrim(ob_get_clean()); ?>
                                    <?php elseif($transaction->uniform->status == 'Not Use'): ?>
...
<?php echo ltrim(ob_get_clean()); ?>
        ...
        <?php ob_start(); ?><?php echo e($transaction->uniform->status); ?><?php echo trim(ob_get_clean()); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
                            ...
                            <td class="px-3 py-2 text-center text-xs font-mono whitespace-nowrap"><?php echo e($transaction->qty_before); ?></td>
                            <td class="px-3 py-2 text-center text-xs font-mono whitespace-nowrap"><?php echo e($transaction->qty_after); ?></td>
                            ...
                            <td class="px-3 py-2 text-center text-xs whitespace-nowrap"><?php echo e($transaction->performed_by ?? '-'); ?></td>
                            <td class="px-3 py-2 text-center text-xs whitespace-nowrap">
                                <span class="font-mono" title="<?php echo e($transaction->reference_id ?? '-'); ?>">
...
</div><?php /**PATH /www/wwwroot/testings.siix-ems.co.id/siix-portal/resources/views/livewire/prod/uniform/uniform-stock-transaction-index.blade.php ENDPATH**/ ?>