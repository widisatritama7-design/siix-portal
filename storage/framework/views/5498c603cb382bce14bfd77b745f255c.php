<div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($distributingSubmission): ?>
    ...
    <div class="bg-white dark:bg-zinc-800 rounded-xl shadow-sm border border-zinc-200 dark:border-zinc-700">
        <form wire:submit="processDistribute" class="p-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-medium text-zinc-900 dark:text-white">
                            <?php echo e($distributingSubmission->description); ?>
                    ...
                    <div>
                        ...
                        <p class="text-sm font-medium text-zinc-900 dark:text-white">
                            <?php echo e(optional($distributingSubmission->department)->dept_name ?? 'N/A'); ?>
                    ...
                    <div>
                        ...
                        <p class="text-sm font-medium text-zinc-900 dark:text-white">
                            <?php echo e($distributingSubmission->category_document); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_array($emails) && count($emails) > 0): ?>
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/resources/views/livewire/dcc/pages/distribute.blade.php ENDPATH**/ ?>