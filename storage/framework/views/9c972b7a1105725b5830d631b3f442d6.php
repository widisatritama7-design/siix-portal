...
<?php echo ltrim(ob_get_clean()); ?>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z"/>
        ...
        <?php ob_start(); ?>
                                        <?php echo e($item->employee->department ?? $item->department); ?>
...
<?php if (isset($__slotse7738cfa973d7ff62d132f5dce92a05c)) { $__slotsStacke7738cfa973d7ff62d132f5dce92a05c[] = $__slotse7738cfa973d7ff62d132f5dce92a05c; } ?>
<?php if (isset($__attrse7738cfa973d7ff62d132f5dce92a05c)) { $__attrsStacke7738cfa973d7ff62d132f5dce92a05c[] = $__attrse7738cfa973d7ff62d132f5dce92a05c; } ?>
<?php $__attrse7738cfa973d7ff62d132f5dce92a05c = ['size' => 'sm','color' => $item->count_jam > 0 ? 'yellow' : 'green']; ?>
<?php $__slotse7738cfa973d7ff62d132f5dce92a05c = []; ?>
<?php $__blaze->pushData($__attrse7738cfa973d7ff62d132f5dce92a05c); ?>
<?php ob_start(); ?>
                                        <?php
...
<?php $__blaze->popData(); ?>
                                ...
                                <td class="px-4 py-3 text-sm max-w-xs truncate" title="<?php echo e($item->alasan_terlambat); ?>">
...
<?php echo ltrim(ob_get_clean()); ?>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div><?php /**PATH D:\laragon\www\siix-portal-new\resources\views\livewire\hr\comelate-employee\report.blade.php ENDPATH**/ ?>