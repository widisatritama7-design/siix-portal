<?php
if (!function_exists('_6d513db8eda4e61a6dac116ebca89cfb')):
function _6d513db8eda4e61a6dac116ebca89cfb($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
} endif; ?><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/stubs/resources/views/flux/icon/pause-circle.blade.php ENDPATH**/ ?>