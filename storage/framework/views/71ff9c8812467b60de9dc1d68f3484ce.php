...
<div class="space-y-1 p-2" wire:poll.5s="loadDashboardData">
    <!-- Breadcrumbs -->
    ...
    <div class="flex flex-col md:flex-row items-center justify-between gap-4">
        <div>
            <h1 class="text-3xl font-bold text-zinc-800 dark:text-white">
                Master Sample In Use Dashboard
            </h1>
            <p class="text-sm text-zinc-500 dark:text-zinc-400 mt-1">
                Real-time monitoring of samples currently in use
            </p>
        </div>
            ...
            <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-xl w-full max-w-lg max-h-[85vh] overflow-y-auto">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lineDetail): ?>
                    <div class="space-y-3">
                        ...
                        <div class="sticky bottom-0 bg-white dark:bg-zinc-900 px-5 py-3 border-t border-zinc-200 dark:border-zinc-700 flex justify-end">
                            <button type="button" 
                                @click="open = false; $wire.closeLineModal()"
                                class="px-3 py-1.5 text-xs border border-zinc-300 dark:border-zinc-700 rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors">
                                Close
                            </button>
                        </div>
                    </div>
