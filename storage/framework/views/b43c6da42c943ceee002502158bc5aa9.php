        ...
        <div class="grid grid-cols-3 gap-3 min-w-[600px] md:min-w-0">
            ...
            <div class="status-card status-card-open">
                <div>
                    ...
                    <div class="status-value status-value-open"><?php echo e($statusCounts['Open'] ?? 0); ?></div>
                </div>
            ...
            <div class="status-card status-card-progress">
                <div>
                    ...
                    <div class="status-value status-value-progress"><?php echo e($statusCounts['In Progress'] ?? 0); ?></div>
                </div>
            ...
            <div class="status-card status-card-finished">
                <div>
                    ...
                    <div class="status-value status-value-finished"><?php echo e($statusCounts['Finished'] ?? 0); ?></div>
                </div>
...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <div x-data="{ 
        open: false, 
        searchModel: '',
        selectedModel: <?php if ((object) ('model') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('model'->value()); ?>')<?php echo e('model'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('model'); ?>')<?php endif; ?>,
        models: <?php echo \Illuminate\Support\Js::from($availableModels->toArray())->toHtml() ?>
    }" 
    x-show="open" 
