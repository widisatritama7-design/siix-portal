            ...
            <div x-data="{ 
                ...
                async savePhoto() {
                    if (this.capturedPhoto && !this.isSaving) {
                        ...
                        try {
                            await window.Livewire.find('<?php echo e($_instance->getId()); ?>').call('addCapturedPhoto', this.capturedPhoto);
                            this.capturedPhoto = null;
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-4">
                                        ...
                                        <div x-show="!showCamera && !capturedPhoto" class="text-center py-8">
                                            <?php ob_start(); ?><svg class="shrink-0 [:where(&amp;)]:size-6 w-16 h-16 text-gray-400 mx-auto mb-3" data-flux-icon xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
                                            ...
                                            <div class="relative">
                                                ...
                                                <div class="flex gap-3 justify-center mt-4">
                                                    <button type="button" 
                                                        ...
                                                        <?php ob_start(); ?><svg class="shrink-0 [:where(&amp;)]:size-6 w-5 h-5 inline mr-1" data-flux-icon xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
  <path stroke-linecap="round" stroke-linejoin="round" d="M6.827 6.175A2.31 2.31 0 0 1 5.186 7.23c-.38.054-.757.112-1.134.175C2.999 7.58 2.25 8.507 2.25 9.574V18a2.25 2.25 0 0 0 2.25 2.25h15A2.25 2.25 0 0 0 21.75 18V9.574c0-1.067-.75-1.994-1.802-2.169a47.865 47.865 0 0 0-1.134-.175 2.31 2.31 0 0 1-1.64-1.055l-.822-1.316a2.192 2.192 0 0 0-1.736-1.039 48.774 48.774 0 0 0-5.232 0 2.192 2.192 0 0 0-1.736 1.039l-.821 1.316Z"/>
  <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 12.75a4.5 4.5 0 1 1-9 0 4.5 4.5 0 0 1 9 0ZM18.75 10.5h.008v.008h-.008V10.5Z"/>
</svg>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 6 6 9-13.5"/>
        ...
        <?php echo ltrim(ob_get_clean()); ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($capturedPhotos) && count($capturedPhotos) > 0): ?>
                                        <div class="mt-4">
                                            <label class="block text-xs font-medium text-gray-500 mb-2">New Photos (<?php echo e(count($capturedPhotos)); ?>):</label>
                                            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $capturedPhotos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                    <div class="relative border rounded-lg p-2 bg-gray-50 dark:bg-zinc-800">
                                                        <div class="relative">
                                                            <img src="<?php echo e($photo['preview']); ?>" 
                                                                alt="Captured <?php echo e($index + 1); ?>" 
                                                                class="w-full h-32 object-cover rounded">
                                                            
                                                            <!-- Tombol Remove SELALU terlihat -->
                                                            <button type="button" 
                                                                    wire:click="removeCapturedPhoto(<?php echo e($index); ?>)"
                                                                    class="absolute top-1 right-1 bg-red-500 text-white rounded-full p-1 hover:bg-red-600 transition-colors shadow-lg">
                                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                                                                </svg>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['capturedPhotos'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
