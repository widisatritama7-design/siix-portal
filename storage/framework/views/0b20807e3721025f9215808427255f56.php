...
<?php # [BlazeFolded]:{flux::modal.close}:{/www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/src/../stubs/resources/views/flux/modal/close.blade.php}:{1776985208} ?>
<?php
if (!function_exists('_0b20807e3721025f9215808427255f56')):
function _0b20807e3721025f9215808427255f56($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
} endif; ?><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/stubs/resources/views/flux/modal/index.blade.php ENDPATH**/ ?>