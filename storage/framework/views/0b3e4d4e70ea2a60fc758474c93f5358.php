...
<?php # [BlazeFolded]:{flux::dropdown}:{D:\laragon\www\siix-portal-new\vendor\livewire\flux\src/../stubs/resources/views/flux/dropdown.blade.php}:{1774988736} ?>
<?php # [BlazeFolded]:{flux::icon.chevron-down}:{D:\laragon\www\siix-portal-new\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/chevron-down.blade.php}:{1774988736} ?>
<?php # [BlazeFolded]:{flux::icon.chevron-right}:{D:\laragon\www\siix-portal-new\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/chevron-right.blade.php}:{1774988736} ?>
<?php
if (!function_exists('_0b3e4d4e70ea2a60fc758474c93f5358')):
function _0b3e4d4e70ea2a60fc758474c93f5358($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php _0f2a77fb6d4d542c1b97a0147f9e29a8($__blaze, ['icon' => $icon,'variant' => $iconVariant,'class' => 'size-4'], [], ['icon', 'variant'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php _0f2a77fb6d4d542c1b97a0147f9e29a8($__blaze, ['icon' => $icon,'variant' => $iconVariant,'class' => 'in-data-flux-menu:text-zinc-400 in-data-flux-menu:dark:text-white/80 in-data-flux-menu:[[data-flux-sidebar-group-dropdown]>button:hover_&]:text-current size-4'], [], ['icon', 'variant'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?><?php $blaze_memoized_html = ob_get_clean(); ?><?php if ($blaze_memoized_key !== null) { \Livewire\Blaze\Memoizer\Memo::put($blaze_memoized_key, $blaze_memoized_html); } ?><?php echo $blaze_memoized_html; ?><?php endif; ?>
                        <?php else: ?>
                            <?php echo e($icon); ?>
                ...
                <div class="hidden in-data-flux-menu:block">
                    <?php $__blaze->ensureRequired('D:\laragon\www\siix-portal-new\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/chevron-right.blade.php', $__blaze->compiledPath.'/149500595a77ad7a646ba97a5cf2abdc.php'); ?>
...
<?php _149500595a77ad7a646ba97a5cf2abdc($__blaze, ['variant' => $iconVariant,'class' => 'ms-auto size-4 text-zinc-400 [[data-flux-sidebar-group-dropdown]>button:hover_&]:text-current rtl:hidden'], [], ['variant'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                    <?php $__blaze->ensureRequired('D:\laragon\www\siix-portal-new\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/chevron-left.blade.php', $__blaze->compiledPath.'/712d60082573c33d108a5b2a2660560c.php'); ?>
...
<?php _712d60082573c33d108a5b2a2660560c($__blaze, ['variant' => $iconVariant,'class' => 'ms-auto size-4 text-zinc-400 [[data-flux-sidebar-group-dropdown]>button:hover_&]:text-current hidden rtl:inline'], [], ['variant'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                </div>
            </button>
...
>
    <?php ob_start(); ?>
                <?php $__blaze->ensureRequired('D:\laragon\www\siix-portal-new\vendor\livewire\flux\src/../stubs/resources/views/flux/menu/group.blade.php', $__blaze->compiledPath.'/a33e0e197e96527cf87590c6ede9de8f.php'); ?>
<?php if (isset($__slotsa33e0e197e96527cf87590c6ede9de8f)) { $__slotsStacka33e0e197e96527cf87590c6ede9de8f[] = $__slotsa33e0e197e96527cf87590c6ede9de8f; } ?>
<?php if (isset($__attrsa33e0e197e96527cf87590c6ede9de8f)) { $__attrsStacka33e0e197e96527cf87590c6ede9de8f[] = $__attrsa33e0e197e96527cf87590c6ede9de8f; } ?>
<?php $__attrsa33e0e197e96527cf87590c6ede9de8f = ['heading' => $heading]; ?>
<?php $__slotsa33e0e197e96527cf87590c6ede9de8f = []; ?>
<?php $__blaze->pushData($__attrsa33e0e197e96527cf87590c6ede9de8f); ?>
<?php ob_start(); ?>
                    <?php echo e($slot); ?>

                <?php $__slotsa33e0e197e96527cf87590c6ede9de8f['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slotsa33e0e197e96527cf87590c6ede9de8f); ?>
<?php _a33e0e197e96527cf87590c6ede9de8f($__blaze, $__attrsa33e0e197e96527cf87590c6ede9de8f, $__slotsa33e0e197e96527cf87590c6ede9de8f, ['heading'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStacka33e0e197e96527cf87590c6ede9de8f)) { $__slotsa33e0e197e96527cf87590c6ede9de8f = array_pop($__slotsStacka33e0e197e96527cf87590c6ede9de8f); } ?>
<?php if (! empty($__attrsStacka33e0e197e96527cf87590c6ede9de8f)) { $__attrsa33e0e197e96527cf87590c6ede9de8f = array_pop($__attrsStacka33e0e197e96527cf87590c6ede9de8f); } ?>
<?php $__blaze->popData(); ?>
...
} endif; ?><?php /**PATH D:\laragon\www\siix-portal-new\vendor\livewire\flux\stubs\resources\views\flux\sidebar\group.blade.php ENDPATH**/ ?>