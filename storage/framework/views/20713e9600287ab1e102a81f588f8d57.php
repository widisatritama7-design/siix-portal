                    ...
                    <?php elseif($returnStep == 2): ?>
                        <div class="space-y-6">
                            ...
                            <div class="bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-xl p-4">
                                ...
                                <!-- Hasil Pencarian -->
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($returnShowGarmentList && $returnGarmentResults->count() > 0): ?>
                                <div class="mt-3 max-h-48 overflow-y-auto space-y-2">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $returnGarmentResults; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $garment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <div wire:click="selectReturnGarment(<?php echo e($garment->id); ?>)"
                                        class="bg-white dark:bg-zinc-800 rounded-lg p-3 border-2 cursor-pointer transition-all hover:shadow-md text-sm
                                            <?php echo e($returnSelectedGarmentId == $garment->id ? 'border-purple-500 dark:border-purple-400 shadow-md' : 'border-purple-200 dark:border-purple-700 hover:border-purple-300'); ?>">
                                        <div class="flex justify-between items-center">
                                            <div>
                                                <span class="font-semibold text-zinc-800 dark:text-white">
                                                    <?php echo e($garment->employee_name ?? $garment->name ?? '-'); ?>

                                                </span>
                                                <span class="text-xs text-zinc-500 dark:text-zinc-400 ml-2">
                                                    NIK: <?php echo e($garment->employee_nik ?? '-'); ?>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($returnSelectedGarmentId == $garment->id): ?>
                                        ...
                                        <div class="grid grid-cols-4 gap-2 mt-2 text-xs">
                                            <div>
                                                ...
                                                <span class="font-medium text-zinc-800 dark:text-white"><?php echo e($garment->d1_scientific ?? '-'); ?></span>
                                                <span class="ml-1 px-1.5 py-0.5 rounded text-[10px] font-semibold 
                                                    <?php echo e(($garment->judgement_d1 ?? '') == 'OK' ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300' : 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-300'); ?>">
                                                    <?php echo e($garment->judgement_d1 ?? '-'); ?>

                                                </span>
                                            </div>
                                            <div>
                                                <span class="text-zinc-500 dark:text-zinc-400">D2:</span>
                                                <span class="font-medium text-zinc-800 dark:text-white"><?php echo e($garment->d2_scientific ?? '-'); ?></span>
                                                <span class="ml-1 px-1.5 py-0.5 rounded text-[10px] font-semibold 
                                                    <?php echo e(($garment->judgement_d2 ?? '') == 'OK' ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300' : 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-300'); ?>">
                                                    <?php echo e($garment->judgement_d2 ?? '-'); ?>

                                                </span>
                                            </div>
                                            <div>
                                                <span class="text-zinc-500 dark:text-zinc-400">D3:</span>
                                                <span class="font-medium text-zinc-800 dark:text-white"><?php echo e($garment->d3_scientific ?? '-'); ?></span>
                                                <span class="ml-1 px-1.5 py-0.5 rounded text-[10px] font-semibold 
                                                    <?php echo e(($garment->judgement_d3 ?? '') == 'OK' ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300' : 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-300'); ?>">
                                                    <?php echo e($garment->judgement_d3 ?? '-'); ?>

                                                </span>
                                            </div>
                                            <div>
                                                <span class="text-zinc-500 dark:text-zinc-400">D4:</span>
                                                <span class="font-medium text-zinc-800 dark:text-white"><?php echo e($garment->d4_scientific ?? '-'); ?></span>
                                                <span class="ml-1 px-1.5 py-0.5 rounded text-[10px] font-semibold 
                                                    <?php echo e(($garment->judgement_d4 ?? '') == 'OK' ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300' : 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-300'); ?>">
                                                    <?php echo e($garment->judgement_d4 ?? '-'); ?>

                                                </span>
                                            </div>
                                        </div>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($garment->next_date): ?>
                                        <div class="mt-2 text-[10px] text-zinc-500 dark:text-zinc-400 border-t border-zinc-200 dark:border-zinc-700 pt-1.5">
                                            <span class="font-medium">Next Date:</span> <?php echo e($garment->next_date); ?>
                                ...
                                <?php elseif($returnShowGarmentList && $returnGarmentResults->count() == 0): ?>
                                ...
                                <!-- Data Terpilih -->
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($returnSelectedGarment): ?>
                                <div class="mt-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-2.5">
                                    <p class="text-sm text-green-700 dark:text-green-300 flex items-center gap-2">
                                        ...
                                        <span><?php echo e($returnSelectedGarment->employee_name ?? $returnSelectedGarment->name ?? '-'); ?></span>
                                        <span class="text-xs text-zinc-500">(<?php echo e($returnSelectedGarment->employee_nik ?? '-'); ?>)</span>
                            ...
                            <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl p-4">
                                ...
                                <div class="grid grid-cols-2 gap-2 text-sm">
                                    <div class="bg-white dark:bg-zinc-800 rounded-lg p-2.5 border border-green-200 dark:border-green-700 text-center">
                                        ...
                                        <p class="text-sm font-semibold text-zinc-800 dark:text-white"><?php echo e($returnSelectedGarment->d1_scientific ?? '-'); ?></p>
                                        <span class="inline-block px-2 py-0.5 rounded-full text-[10px] font-semibold 
                                            <?php echo e(($returnSelectedGarment->judgement_d1 ?? '') == 'OK' ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300' : 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-300'); ?>">
                                            <?php echo e($returnSelectedGarment->judgement_d1 ?? '-'); ?>

                                        </span>
                                    </div>
                                    <div class="bg-white dark:bg-zinc-800 rounded-lg p-2.5 border border-green-200 dark:border-green-700 text-center">
                                        <p class="text-[10px] text-green-600 dark:text-green-400 font-medium uppercase">D2</p>
                                        <p class="text-sm font-semibold text-zinc-800 dark:text-white"><?php echo e($returnSelectedGarment->d2_scientific ?? '-'); ?></p>
                                        <span class="inline-block px-2 py-0.5 rounded-full text-[10px] font-semibold 
                                            <?php echo e(($returnSelectedGarment->judgement_d2 ?? '') == 'OK' ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300' : 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-300'); ?>">
                                            <?php echo e($returnSelectedGarment->judgement_d2 ?? '-'); ?>

                                        </span>
                                    </div>
                                    <div class="bg-white dark:bg-zinc-800 rounded-lg p-2.5 border border-green-200 dark:border-green-700 text-center">
                                        <p class="text-[10px] text-green-600 dark:text-green-400 font-medium uppercase">D3</p>
                                        <p class="text-sm font-semibold text-zinc-800 dark:text-white"><?php echo e($returnSelectedGarment->d3_scientific ?? '-'); ?></p>
                                        <span class="inline-block px-2 py-0.5 rounded-full text-[10px] font-semibold 
                                            <?php echo e(($returnSelectedGarment->judgement_d3 ?? '') == 'OK' ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300' : 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-300'); ?>">
                                            <?php echo e($returnSelectedGarment->judgement_d3 ?? '-'); ?>

                                        </span>
                                    </div>
                                    <div class="bg-white dark:bg-zinc-800 rounded-lg p-2.5 border border-green-200 dark:border-green-700 text-center">
                                        <p class="text-[10px] text-green-600 dark:text-green-400 font-medium uppercase">D4</p>
                                        <p class="text-sm font-semibold text-zinc-800 dark:text-white"><?php echo e($returnSelectedGarment->d4_scientific ?? '-'); ?></p>
                                        <span class="inline-block px-2 py-0.5 rounded-full text-[10px] font-semibold 
                                            <?php echo e(($returnSelectedGarment->judgement_d4 ?? '') == 'OK' ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300' : 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-300'); ?>">
                                            <?php echo e($returnSelectedGarment->judgement_d4 ?? '-'); ?>

                                        </span>
                                    </div>
                                </div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($returnSelectedGarment->next_date): ?>
                                <div class="mt-2 text-xs text-zinc-600 dark:text-zinc-400 border-t border-green-200 dark:border-green-700 pt-2 text-center">
                                    <span class="font-medium">Next Date:</span> <?php echo e($returnSelectedGarment->next_date); ?>
                            ...
                            <div class="flex gap-3">
                                <button wire:click="returnUniform" 
                                        wire:loading.attr="disabled"
                                        <?php if(!$returnSelectedGarment): ?> disabled <?php endif; ?>
                                        class="flex-1 py-3 px-4 rounded-lg transition duration-200 font-medium shadow-lg text-sm
                                            <?php echo e($returnSelectedGarment ? 'bg-green-600 hover:bg-green-700 text-white shadow-green-600/20' : 'bg-gray-300 dark:bg-gray-700 text-gray-500 dark:text-gray-400 cursor-not-allowed'); ?>">
