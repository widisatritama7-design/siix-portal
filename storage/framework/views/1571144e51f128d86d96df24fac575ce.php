...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <?php ob_start(); ?>
        <div class="mb-6 pb-4 border-b">
            ...
            <p class="font-mono font-semibold text-xl"><?php echo e($request->request_number); ?></p>
            <p class="text-sm text-zinc-500 mt-1">Prepared by <?php echo e($request->created_by); ?> at <?php echo e($request->created_at ? $request->created_at->format('d M Y H:i') : '-'); ?></p>
        </div>
            ...
            <table class="w-full text-sm border" style="min-width: 1400px;">
                ...
                <tbody>
                    ...
                    <tr class="border-t hover:bg-zinc-50 dark:hover:bg-zinc-800/50">
                        ...
                        <td class="px-3 py-2 whitespace-nowrap"><?php echo e($item['employee_nik']); ?></td>
                        <td class="px-3 py-2 whitespace-nowrap"><?php echo e($item['employee_name']); ?></td>
                        <td class="px-3 py-2 whitespace-nowrap"><?php echo e($item['item_code']); ?></td>
                        <td class="px-3 py-2 whitespace-nowrap"><?php echo e($item['description']); ?></td>
                        <td class="px-3 py-2 whitespace-nowrap"><?php echo e($item['size']); ?></td>
                        <td class="px-3 py-2 text-center"><?php echo e($item['qty']); ?></td>
                        <td class="px-3 py-2 whitespace-nowrap"><?php echo e($item['group']); ?></td>
                        <td class="px-3 py-2 whitespace-nowrap"><?php echo e(\Carbon\Carbon::parse($item['request_date'])->format('d/m/Y')); ?></td>
                        <td class="px-3 py-2 min-w-[150px]"><?php echo e($item['reason']); ?></td>
                        <td class="px-3 py-2 min-w-[100px]"><?php echo e($item['remarks'] ?? '-'); ?></td>
                        ...
                        <td class="px-3 py-2 min-w-[180px]">
                            <div class="space-y-1">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item['admin_feedback']): ?>
                                    <div class="text-xs"><?php echo e($item['admin_feedback']); ?></div>
                                    ...
                                    <div class="text-[10px] text-zinc-400"><?php echo e(\Carbon\Carbon::parse($item['admin_feedback_datetime'])->format('d/m/Y H:i')); ?></div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php else: ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('feedback uniform request admin')): ?>
                                        <div class="mt-2">
                                            <button type="button" 
                                                wire:click="openAdminFeedbackModal(<?php echo e($item['index']); ?>)" 
                                    ...
                                    <?php else: ?>
                                        <div class="text-xs text-zinc-400 italic">No feedback</div>
                                    <?php endif; ?>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        </td>
                        ...
                        <td class="px-3 py-2 min-w-[180px]">
                            <div class="space-y-1">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item['costing_feedback']): ?>
                                    <div class="text-xs"><?php echo e($item['costing_feedback']); ?></div>
                                    ...
                                    <div class="text-[10px] text-zinc-400"><?php echo e(\Carbon\Carbon::parse($item['costing_feedback_datetime'])->format('d/m/Y H:i')); ?></div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php else: ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('feedback uniform request costing')): ?>
                                        <div class="mt-2">
                                            <button type="button" 
                                                wire:click="openCostingFeedbackModal(<?php echo e($item['index']); ?>)" 
                                                class="inline-flex items-center gap-1 px-2 py-1 text-xs font-medium text-green-700 bg-green-100 rounded-lg hover:bg-green-200 dark:bg-green-900/30 dark:text-green-300 dark:hover:bg-green-900/50 transition-colors">
                                                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                                                </svg>
                                                Add Feedback
...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <!-- MODAL FEEDBACK - Menggunakan x-show dari Livewire $showModal -->
    <div x-data="{ 
