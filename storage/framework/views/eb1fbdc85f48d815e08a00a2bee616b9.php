...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-lg border border-zinc-200 dark:border-zinc-800 p-4 sm:p-6">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4">
            ...
            <div>
                ...
                <select wire:model="monthFilter" class="w-full px-3 py-2 border border-zinc-300 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-zinc-800 dark:border-zinc-600 dark:text-white">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $months; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $month): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        ...
        <div class="flex flex-wrap justify-end gap-2 mt-4 pt-4 border-t border-zinc-200 dark:border-zinc-700">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasFiltered): ?>
            <button 
    ...
    <?php ob_start(); ?>
            <div class="flex flex-wrap justify-between items-center mb-4 gap-2">
                ...
                <span class="px-2 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded-full text-xs font-medium">
                    Total: <?php echo e(number_format($totalRecords)); ?> records
                </span>
            </div>
            
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($previewData->isEmpty()): ?>
                ...
                <div class="overflow-x-auto flex-1">
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $previewData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <?php
...
<?php $__attrs6b0011e2f83d04930b97e5f6feda22dd = ['size' => 'sm','color' => e($statusColors[$item->status] ?? 'gray')]; ?>
<?php $__slots6b0011e2f83d04930b97e5f6feda22dd = []; ?>
<?php $__blaze->pushData($__attrs6b0011e2f83d04930b97e5f6feda22dd); ?>
<?php ob_start(); ?>
                                        <?php echo e($statusTexts[$item->status] ?? ucfirst($item->status)); ?>
...
<?php $__blaze->popData(); ?>
                                ...
                                <td class="px-4 py-3 text-sm text-zinc-600 dark:text-zinc-400">
                                    <?php echo e(number_format($item->rejected_qty ?? 0)); ?>

                                </td>
                                <td class="px-4 py-3">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->failure_rate): ?>
                                        <span class="text-sm font-semibold <?php echo e($item->failure_rate > 10 ? 'text-red-600' : ($item->failure_rate > 5 ? 'text-orange-600' : 'text-green-600')); ?>">
                                            <?php echo e(number_format($item->failure_rate, 2)); ?>%
                                        </span>
                                    <?php else: ?>
                                ...
                                <td class="px-4 py-3">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($defectCount > 0): ?>
                                        <button 
                                            wire:click="viewDetail(<?php echo e($item->id); ?>)"
                                            ...
                                            <?php echo e($defectCount); ?> detail(s)
                                        </button>
                                    <?php else: ?>
                                ...
                                <td class="px-4 py-3 text-sm text-zinc-600 dark:text-zinc-400">
                                    <?php echo e($item->created_at ? \Carbon\Carbon::parse($item->created_at)->format('d/m/Y H:i') : '-'); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
    <?php else: ?>
        <div class="flex flex-col items-center justify-center gap-3 min-h-[400px] bg-white dark:bg-zinc-900 rounded-xl shadow-lg border border-zinc-200 dark:border-zinc-800 p-12">
            <div class="w-20 h-20 rounded-full bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center">
                <?php $blaze_memoized_key = \Livewire\Blaze\Memoizer\Memo::key("flux::icon", ['name' => 'no-symbol', 'class' => 'w-10 h-10 text-zinc-400 dark:text-zinc-500']); ?><?php if ($blaze_memoized_key !== null && \Livewire\Blaze\Memoizer\Memo::has($blaze_memoized_key)) : ?><?php echo \Livewire\Blaze\Memoizer\Memo::get($blaze_memoized_key); ?><?php else : ?><?php ob_start(); ?><?php $__blaze->ensureRequired('/www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/src/../stubs/resources/views/flux/icon/index.blade.php', $__blaze->compiledPath.'/ebfb27feae87a3d873cb5ef75a09aacc.php'); ?>
<?php $__blaze->pushData(['name' => 'no-symbol','class' => 'w-10 h-10 text-zinc-400 dark:text-zinc-500']); ?>
<?php _ebfb27feae87a3d873cb5ef75a09aacc($__blaze, ['name' => 'no-symbol','class' => 'w-10 h-10 text-zinc-400 dark:text-zinc-500'], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?><?php $blaze_memoized_html = ob_get_clean(); ?><?php if ($blaze_memoized_key !== null) { \Livewire\Blaze\Memoizer\Memo::put($blaze_memoized_key, $blaze_memoized_html); } ?><?php echo $blaze_memoized_html; ?><?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showDetailModal && $selectedDetail): ?>
    <div x-data="{ open: true }" 
        x-init="open = true"
        x-show="open"
        x-cloak
        @keydown.escape.window="open = false; window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('showDetailModal', false)">

        <div class="fixed inset-0 bg-black/50 z-40" @click="open = false; window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('showDetailModal', false)"></div>
                    ...
                    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20 rounded-lg border border-blue-200 dark:border-blue-800 p-4 mb-4">
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <p class="font-semibold text-lg text-zinc-800 dark:text-white"><?php echo e($selectedDetail->ncp_number ?? '-'); ?></p>
                            </div>
...
<?php if (isset($__slots6b0011e2f83d04930b97e5f6feda22dd)) { $__slotsStack6b0011e2f83d04930b97e5f6feda22dd[] = $__slots6b0011e2f83d04930b97e5f6feda22dd; } ?>
<?php if (isset($__attrs6b0011e2f83d04930b97e5f6feda22dd)) { $__attrsStack6b0011e2f83d04930b97e5f6feda22dd[] = $__attrs6b0011e2f83d04930b97e5f6feda22dd; } ?>
<?php $__attrs6b0011e2f83d04930b97e5f6feda22dd = ['size' => 'md','color' => e($statusColors[$selectedDetail->status] ?? 'gray')]; ?>
<?php $__slots6b0011e2f83d04930b97e5f6feda22dd = []; ?>
<?php $__blaze->pushData($__attrs6b0011e2f83d04930b97e5f6feda22dd); ?>
<?php ob_start(); ?>
                                        <?php echo e($statusTexts[$selectedDetail->status] ?? ucfirst($selectedDetail->status)); ?>
...
<?php $__blaze->popData(); ?>
                        ...
                        <div class="p-4">
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p class="text-sm text-zinc-800 dark:text-white mt-1 font-semibold"><?php echo e($selectedDetail->part_number ?? '-'); ?></p>
                                </div>
                                <div>
                                    <span class="text-xs text-zinc-500 dark:text-zinc-400">Part Description</span>
                                    <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($selectedDetail->part_description ?? '-'); ?></p>
                                </div>
                                <div>
                                    <span class="text-xs text-zinc-500 dark:text-zinc-400">Supplier</span>
                                    <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($selectedDetail->supplier ?? '-'); ?></p>
                                </div>
                                <div>
                                    <span class="text-xs text-zinc-500 dark:text-zinc-400">Customer</span>
                                    <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($selectedDetail->customer ?? '-'); ?></p>
                                </div>
                                <div>
                                    <span class="text-xs text-zinc-500 dark:text-zinc-400">Model Affected</span>
                                    <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($selectedDetail->model_affected ?? '-'); ?></p>
                                </div>
                                <div>
                                    <span class="text-xs text-zinc-500 dark:text-zinc-400">Section</span>
                                    <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($selectedDetail->section ?? '-'); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="p-4">
                            <div class="grid grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($selectedDetail->lot_no ?? '-'); ?></p>
                                </div>
                                <div>
                                    <span class="text-xs text-zinc-500 dark:text-zinc-400">Lot Qty</span>
                                    <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e(number_format($selectedDetail->lot_qty ?? 0)); ?></p>
                                </div>
                                <div>
                                    <span class="text-xs text-zinc-500 dark:text-zinc-400">Rejected Qty</span>
                                    <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e(number_format($selectedDetail->rejected_qty ?? 0)); ?></p>
                                </div>
                            </div>
                            <div class="mt-3 pt-3 border-t border-zinc-200 dark:border-zinc-700">
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <p class="text-sm font-semibold <?php echo e(($selectedDetail->failure_rate ?? 0) > 10 ? 'text-red-600' : (($selectedDetail->failure_rate ?? 0) > 5 ? 'text-orange-600' : 'text-green-600')); ?>">
                                            <?php echo e(number_format($selectedDetail->failure_rate ?? 0, 2)); ?>%
                                        </p>
                                    </div>
                                    <div>
                                        <span class="text-xs text-zinc-500 dark:text-zinc-400">DO No</span>
                                        <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($selectedDetail->do_no ?? '-'); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-white dark:bg-zinc-800/50 rounded-lg border border-zinc-200 dark:border-zinc-700 mb-4 shadow-sm overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($defects)): ?>
                                <div class="overflow-x-auto">
                                    <table class="w-full border border-zinc-200 dark:border-zinc-700 rounded-lg">
                                        ...
                                        <tbody>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $defects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $defect): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            <tr class="border-t border-zinc-200 dark:border-zinc-700">
                                                <td class="px-3 py-2 text-sm text-zinc-600 dark:text-zinc-400"><?php echo e($defect['serial_number'] ?? '-'); ?></td>
                                                <td class="px-3 py-2 text-sm text-zinc-600 dark:text-zinc-400"><?php echo e($defect['defect_description'] ?? '-'); ?></td>
                                                <td class="px-3 py-2 text-sm text-zinc-600 dark:text-zinc-400"><?php echo e($defect['quantity'] ?? '-'); ?></td>
                                                <td class="px-3 py-2 text-sm text-zinc-600 dark:text-zinc-400"><?php echo e($defect['defect_remarks'] ?? '-'); ?></td>
                                            </tr>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                        </tbody>
                                    </table>
                        ...
                        <div class="p-4">
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($selectedDetail->packing_list_no ?? '-'); ?></p>
                                </div>
                                <div>
                                    <span class="text-xs text-zinc-500 dark:text-zinc-400">Remarks</span>
                                    <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($selectedDetail->remarks ?? '-'); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-zinc-800/50 rounded-lg border border-zinc-200 dark:border-zinc-700 mb-4 shadow-sm overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedDetail->disposition): ?>
                                <div class="flex flex-wrap gap-2">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = explode(', ', $selectedDetail->disposition); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $disp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <?php
...
<?php if (isset($__slots6b0011e2f83d04930b97e5f6feda22dd)) { $__slotsStack6b0011e2f83d04930b97e5f6feda22dd[] = $__slots6b0011e2f83d04930b97e5f6feda22dd; } ?>
<?php if (isset($__attrs6b0011e2f83d04930b97e5f6feda22dd)) { $__attrsStack6b0011e2f83d04930b97e5f6feda22dd[] = $__attrs6b0011e2f83d04930b97e5f6feda22dd; } ?>
<?php $__attrs6b0011e2f83d04930b97e5f6feda22dd = ['size' => 'md','color' => e($dispositionColors[$type] ?? 'gray')]; ?>
<?php $__slots6b0011e2f83d04930b97e5f6feda22dd = []; ?>
<?php $__blaze->pushData($__attrs6b0011e2f83d04930b97e5f6feda22dd); ?>
<?php ob_start(); ?>
                                                <?php echo e($type); ?>
...
<?php $__blaze->popData(); ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($detail): ?>
                                                <span class="text-xs text-zinc-500 dark:text-zinc-400 ml-1">: <?php echo e($detail); ?></span>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                </div>
                        ...
                        <div class="p-4">
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($selectedDetail->employee->nik ?? '-'); ?></p>
                                </div>
                                <div>
                                    <span class="text-xs text-zinc-500 dark:text-zinc-400">Name</span>
                                    <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($selectedDetail->employee->name ?? '-'); ?></p>
                                </div>
                                <div>
                                    <span class="text-xs text-zinc-500 dark:text-zinc-400">Department</span>
                                    <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($selectedDetail->employee->department ?? '-'); ?></p>
                                </div>
                                <div>
                                    <span class="text-xs text-zinc-500 dark:text-zinc-400">Section</span>
                                    <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($selectedDetail->section ?? '-'); ?></p>
                        ...
                        <div class="p-4">
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($selectedDetail->creator->name ?? '-'); ?></p>
                                </div>
                                <div>
                                    <span class="text-xs text-zinc-500 dark:text-zinc-400">Created At</span>
                                    <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($selectedDetail->created_at ? \Carbon\Carbon::parse($selectedDetail->created_at)->format('d/m/Y H:i') : '-'); ?></p>
                                </div>
                                <div>
                                    <span class="text-xs text-zinc-500 dark:text-zinc-400">Approved By</span>
                                    <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($selectedDetail->approver->name ?? '-'); ?></p>
                                </div>
                                <div>
                                    <span class="text-xs text-zinc-500 dark:text-zinc-400">Updated At</span>
                                    <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($selectedDetail->updated_at ? \Carbon\Carbon::parse($selectedDetail->updated_at)->format('d/m/Y H:i') : '-'); ?></p>
                                </div>
                            </div>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedDetail->file): ?>
                            <div class="mt-3 pt-3 border-t border-zinc-200 dark:border-zinc-700">
                                <a href="<?php echo e(asset('storage/' . $selectedDetail->file)); ?>" target="_blank" class="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 flex items-center gap-2">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="p-6 pt-4 border-t border-zinc-200 dark:border-zinc-700">
                    <div class="flex justify-end gap-2">
                        <button type="button" 
                                @click="open = false; window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('showDetailModal', false)"
...
</div><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/resources/views/livewire/qaqc/ncp-report.blade.php ENDPATH**/ ?>