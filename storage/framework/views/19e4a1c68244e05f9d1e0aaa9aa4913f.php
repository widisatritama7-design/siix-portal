...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <?php ob_start(); ?><div class="[:where(&amp;)]:bg-white dark:[:where(&amp;)]:bg-white/10 border border-zinc-200 dark:border-white/10 [:where(&amp;)]:p-6 [:where(&amp;)]:rounded-xl p-0 overflow-hidden" x-data="{ open: false }" data-flux-card>
    <?php ob_start(); ?>
        <!-- Header -->
        ...
        <div x-show="open" x-collapse.duration.300ms class="p-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
                ...
                <div class="space-y-3">
                    ...
                    <a href="<?php echo e(route('prod.wip.add-sheet')); ?>" wire:navigate
                    ...
                    <a href="<?php echo e(route('prod.wip.add-column')); ?>" wire:navigate
