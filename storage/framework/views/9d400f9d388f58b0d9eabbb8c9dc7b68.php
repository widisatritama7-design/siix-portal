...
<?php # [BlazeFolded]:{flux::icon.star}:{/www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/src/../stubs/resources/views/flux/icon/star.blade.php}:{1774988736} ?>
<?php # [BlazeFolded]:{flux::icon.star}:{/www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/src/../stubs/resources/views/flux/icon/star.blade.php}:{1774988736} ?>
<?php # [BlazeFolded]:{flux::icon.arrow-right}:{/www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/src/../stubs/resources/views/flux/icon/arrow-right.blade.php}:{1774988736} ?>
...
<?php _ebfb27feae87a3d873cb5ef75a09aacc($__blaze, ['name' => $notification->icon,'class' => 'w-4 h-4 mr-1.5'], [], ['name'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php _ebfb27feae87a3d873cb5ef75a09aacc($__blaze, ['name' => $notification->icon,'class' => 'w-5 h-5'], [], ['name'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?><?php $blaze_memoized_html = ob_get_clean(); ?><?php if ($blaze_memoized_key !== null) { \Livewire\Blaze\Memoizer\Memo::put($blaze_memoized_key, $blaze_memoized_html); } ?><?php echo $blaze_memoized_html; ?><?php endif; ?>
                    <?php endif; ?>
                <?php else: ?>
...
<?php _ebfb27feae87a3d873cb5ef75a09aacc($__blaze, ['name' => $notification->icon,'class' => 'w-5 h-5 '.e($notification->getIconColorClasses())], [], ['name'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?><?php $blaze_memoized_html = ob_get_clean(); ?><?php if ($blaze_memoized_key !== null) { \Livewire\Blaze\Memoizer\Memo::put($blaze_memoized_key, $blaze_memoized_html); } ?><?php echo $blaze_memoized_html; ?><?php endif; ?>
                                <?php endif; ?>
                            <?php else: ?>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3"/>
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/resources/views/livewire/settings/header-badge.blade.php ENDPATH**/ ?>