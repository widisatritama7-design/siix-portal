...
<?php # [BlazeFolded]:{flux::icon}:{D:\laragon\www\siix-portal\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/index.blade.php}:{1776934808} ?>
<?php
if (!function_exists('_3307f3fa286eb4573b0b443e25863146')):
function _3307f3fa286eb4573b0b443e25863146($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php _4b299ad09af08d7d3e7b543d4657af88($__blaze, ['icon' => $icon,'variant' => $iconVariant,'class' => e($iconClasses)], [], ['icon', 'variant'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php _4b299ad09af08d7d3e7b543d4657af88($__blaze, ['icon' => $separator,'variant' => 'mini','class' => e($separatorClasses)], [], ['icon'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?><?php $blaze_memoized_html = ob_get_clean(); ?><?php if ($blaze_memoized_key !== null) { \Livewire\Blaze\Memoizer\Memo::put($blaze_memoized_key, $blaze_memoized_html); } ?><?php echo $blaze_memoized_html; ?><?php endif; ?>
