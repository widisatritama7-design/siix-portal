<?php
if (!function_exists('_dc7b41944d7ad01d0a093ce0d326337c')):
function _dc7b41944d7ad01d0a093ce0d326337c($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php $__blaze->ensureRequired('/www/wwwroot/testings.siix-ems.co.id/siix-portal/vendor/livewire/flux/src/../stubs/resources/views/flux/button-or-div.blade.php', $__blaze->compiledPath.'/a6c001055010a0015fed4ce3d128af92.php'); ?>
<?php if (isset($__slotsa6c001055010a0015fed4ce3d128af92)) { $__slotsStacka6c001055010a0015fed4ce3d128af92[] = $__slotsa6c001055010a0015fed4ce3d128af92; } ?>
<?php if (isset($__attrsa6c001055010a0015fed4ce3d128af92)) { $__attrsStacka6c001055010a0015fed4ce3d128af92[] = $__attrsa6c001055010a0015fed4ce3d128af92; } ?>
<?php $__attrsa6c001055010a0015fed4ce3d128af92 = ['attributes' => $attributes->class($classes),'dataFluxBadge' => true]; ?>
<?php $__slotsa6c001055010a0015fed4ce3d128af92 = []; ?>
<?php $__blaze->pushData($__attrsa6c001055010a0015fed4ce3d128af92); ?>
<?php ob_start(); ?>
...
<?php _b462ffebaca45ac18a5d2c5540ab64d7($__blaze, ['icon' => $icon,'variant' => $iconVariant,'class' => $iconClasses,'dataFluxBadgeIcon' => true], [], ['icon', 'variant', 'class', 'dataFluxBadgeIcon'], ['dataFluxBadgeIcon' => 'data-flux-badge-icon'], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php $__blaze->popData(); ?><?php $blaze_memoized_html = ob_get_clean(); ?><?php if ($blaze_memoized_key !== null) { \Livewire\Blaze\Memoizer\Memo::put($blaze_memoized_key, $blaze_memoized_html); } ?><?php echo $blaze_memoized_html; ?><?php endif; ?>
    ...
    <?php endif; ?>
<?php $__slotsa6c001055010a0015fed4ce3d128af92['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slotsa6c001055010a0015fed4ce3d128af92); ?>
<?php _a6c001055010a0015fed4ce3d128af92($__blaze, $__attrsa6c001055010a0015fed4ce3d128af92, $__slotsa6c001055010a0015fed4ce3d128af92, ['attributes', 'dataFluxBadge'], ['dataFluxBadge' => 'data-flux-badge'], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStacka6c001055010a0015fed4ce3d128af92)) { $__slotsa6c001055010a0015fed4ce3d128af92 = array_pop($__slotsStacka6c001055010a0015fed4ce3d128af92); } ?>
<?php if (! empty($__attrsStacka6c001055010a0015fed4ce3d128af92)) { $__attrsa6c001055010a0015fed4ce3d128af92 = array_pop($__attrsStacka6c001055010a0015fed4ce3d128af92); } ?>
<?php $__blaze->popData(); ?>
<?php
echo ltrim(ob_get_clean());
} endif; ?><?php /**PATH /www/wwwroot/testings.siix-ems.co.id/siix-portal/vendor/livewire/flux/src/../stubs/resources/views/flux/badge/index.blade.php ENDPATH**/ ?>