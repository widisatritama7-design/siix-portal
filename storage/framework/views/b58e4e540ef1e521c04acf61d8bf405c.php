...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="bg-white dark:bg-zinc-800/50 rounded-lg border border-zinc-200 dark:border-zinc-700 mb-4 shadow-sm overflow-hidden">
                            ...
                            <div class="p-4">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ncp_id && $employee_id): ?>
                                    <div class="mb-4">
                                        <div class="overflow-x-auto">
                                            <table class="w-full border border-zinc-200 dark:border-zinc-700 rounded-lg">
                                                <thead class="bg-zinc-50 dark:bg-zinc-800">
    ...
    <?php ob_start(); ?>NIK and Name<?php echo trim(ob_get_clean()); ?>
