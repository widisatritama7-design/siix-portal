...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mt-2">
        ...
        <!-- Tombol Add NCP -->
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create ncp')): ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasValidRecord): ?>
...
<?php echo ltrim(ob_get_clean()); ?>
            <?php else: ?>
                <?php ob_start(); ?><button type="button" class="relative items-center font-medium justify-center gap-2 whitespace-nowrap disabled:opacity-75 dark:disabled:opacity-75 disabled:cursor-default disabled:pointer-events-none justify-center h-10 text-sm rounded-lg ps-3 pe-4 inline-flex  bg-[var(--color-accent)] hover:bg-[color-mix(in_oklab,_var(--color-accent),_transparent_10%)] text-[var(--color-accent-foreground)] border border-black/10 dark:border-0 shadow-[inset_0px_1px_--theme(--color-white/.2)] [[data-flux-button-group]_&amp;]:border-e-0 [:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-e-[1px] dark:[:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-e-0 dark:[:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-s-[1px] [:is([data-flux-button-group]&gt;&amp;:not(:first-child),_[data-flux-button-group]_:not(:first-child)&gt;&amp;)]:border-s-[color-mix(in_srgb,var(--color-accent-foreground),transparent_85%)]   bg-gray-400 cursor-not-allowed" data-flux-button="data-flux-button" data-flux-group-target="data-flux-group-target" disabled="disabled" title="You need a valid employee record to create NCP">
        <svg class="shrink-0 [:where(&amp;)]:size-4" data-flux-icon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true" data-slot="icon">
  <path d="M8.75 3.75a.75.75 0 0 0-1.5 0v3.5h-3.5a.75.75 0 0 0 0 1.5h3.5v3.5a.75.75 0 0 0 1.5 0v-3.5h3.5a.75.75 0 0 0 0-1.5h-3.5v-3.5Z"/>
</svg>
...
<?php $__blaze->pushData(['wire:model.live.debounce.300ms' => 'search','placeholder' => 'Search NCP number or section...','icon' => 'magnifying-glass','clearable' => true]); ?>
<?php _f9ce25dced5c86c906351e8ca96b9cbb($__blaze, ['wire:model.live.debounce.300ms' => 'search','placeholder' => 'Search NCP number or section...','icon' => 'magnifying-glass','clearable' => true], [], ['clearable'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
        </div>
    </div>
            ...
            <div class="overflow-x-auto flex-1" style="overflow-x: auto !important; -webkit-overflow-scrolling: touch;">
                <table class="w-full" style="min-width: 1200px; white-space: nowrap;">
                    ...
                    <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $ncps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $ncp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'ncp-'.e($ncp->id).''; ?>wire:key="ncp-<?php echo e($ncp->id); ?>">
                            <td class="px-4 py-3 text-sm text-zinc-500 dark:text-zinc-400 text-center">
                                <?php echo e($ncps->firstItem() + $index); ?>
                                ...
                                <div class="flex items-center justify-center gap-3">
                                    <div>
                                        <span class="text-sm font-semibold text-zinc-800 dark:text-white block">
                                            <?php echo e($ncp->ncp_number); ?>

                                        </span>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeTab === 'deleted' && $ncp->deleted_reason): ?>
                                        <span class="text-xs text-red-500 dark:text-red-400">
                                            Deleted Date : <?php echo e(\Carbon\Carbon::parse($ncp->deleted_at)->format('d/m/Y H:i')); ?>
                            ...
                            <td class="px-4 py-3 text-center">
                                <div class="flex items-center justify-center gap-3">
                                    <span class="text-sm font-semibold text-zinc-800 dark:text-white block"><?php echo e($ncp->employee->nik ?? 'N/A'); ?></span>
                                </div>
                            </td>
                            <td class="px-4 py-3 text-left">
                                <div class="flex items-left justify-left gap-3">
                                    <span class="text-sm font-semibold text-zinc-800 dark:text-white block"><?php echo e($ncp->employee->name ?? 'N/A'); ?></span>
                                </div>
                            </td>
                            <td class="px-4 py-3 text-center">
                                <div class="flex items-center justify-center gap-3">
                                    <span class="text-sm font-semibold text-zinc-800 dark:text-white block"><?php echo e($ncp->employee->department ?? '-'); ?></span>
                                </div>
                            </td>
                            <td class="px-4 py-3 text-center">
                                <?php
...
<?php $__attrs6b0011e2f83d04930b97e5f6feda22dd = ['size' => 'sm','color' => e($statusColors[$ncp->status] ?? 'gray')]; ?>
<?php $__slots6b0011e2f83d04930b97e5f6feda22dd = []; ?>
<?php $__blaze->pushData($__attrs6b0011e2f83d04930b97e5f6feda22dd); ?>
<?php ob_start(); ?>
                                        <?php echo e($statusTexts[$ncp->status] ?? ucfirst($ncp->status)); ?>
...
<?php $__blaze->popData(); ?>
                            ...
                            <td class="px-4 py-3 text-center">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($remarks !== '-'): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isLong): ?>
...
<?php echo ltrim(ob_get_clean()); ?>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit ncp')): ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!in_array($ncp->status, ['closed', 'rejected'])): ?>
                                        <?php ob_start(); ?><ui-tooltip position="top center"  data-flux-tooltip >
        <?php ob_start(); ?>
                                            <?php ob_start(); ?><button type="button" class="relative items-center font-medium justify-center gap-2 whitespace-nowrap disabled:opacity-75 dark:disabled:opacity-75 disabled:cursor-default disabled:pointer-events-none justify-center h-8 text-sm rounded-md w-8 inline-flex  bg-[var(--color-accent)] hover:bg-[color-mix(in_oklab,_var(--color-accent),_transparent_10%)] text-[var(--color-accent-foreground)] border border-black/10 dark:border-0 shadow-[inset_0px_1px_--theme(--color-white/.2)] [[data-flux-button-group]_&amp;]:border-e-0 [:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-e-[1px] dark:[:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-e-0 dark:[:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-s-[1px] [:is([data-flux-button-group]&gt;&amp;:not(:first-child),_[data-flux-button-group]_:not(:first-child)&gt;&amp;)]:border-s-[color-mix(in_srgb,var(--color-accent-foreground),transparent_85%)] *:transition-opacity [&amp;[data-loading]&gt;:not([data-flux-loading-indicator])]:opacity-0 [&amp;[data-flux-loading]&gt;:not([data-flux-loading-indicator])]:opacity-0 [&amp;[data-loading]&gt;[data-flux-loading-indicator]]:opacity-100 [&amp;[data-flux-loading]&gt;[data-flux-loading-indicator]]:opacity-100 data-loading:pointer-events-none data-flux-loading:pointer-events-none [--color-accent:var(--color-yellow-400)] [--color-accent-content:var(--color-yellow-600)] [--color-accent-foreground:var(--color-yellow-950)] dark:[--color-accent:var(--color-yellow-400)] dark:[--color-accent-content:var(--color-yellow-400)] dark:[--color-accent-foreground:var(--color-yellow-950)] !p-2 flex-shrink-0" data-flux-button="data-flux-button" data-flux-group-target="data-flux-group-target" wire:target="edit(<?php echo e($ncp->id); ?>)" wire:loading.attr="data-flux-loading" wire:click="edit(<?php echo e($ncp->id); ?>)">
        <div class="absolute inset-0 flex items-center justify-center opacity-0" data-flux-loading-indicator>
                <svg class="shrink-0 [:where(&amp;)]:size-5 animate-spin" data-flux-icon xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" aria-hidden="true" data-slot="icon">
    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
...
<?php echo ltrim(ob_get_clean()); ?>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete ncp')): ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!in_array($ncp->status, ['closed', 'rejected'])): ?>
                                        <?php ob_start(); ?><ui-tooltip position="top center"  data-flux-tooltip >
        <?php ob_start(); ?>
                                            <?php ob_start(); ?><button type="button" class="relative items-center font-medium justify-center gap-2 whitespace-nowrap disabled:opacity-75 dark:disabled:opacity-75 disabled:cursor-default disabled:pointer-events-none justify-center h-8 text-sm rounded-md w-8 inline-flex  bg-[var(--color-accent)] hover:bg-[color-mix(in_oklab,_var(--color-accent),_transparent_10%)] text-[var(--color-accent-foreground)] border border-black/10 dark:border-0 shadow-[inset_0px_1px_--theme(--color-white/.2)] [[data-flux-button-group]_&amp;]:border-e-0 [:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-e-[1px] dark:[:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-e-0 dark:[:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-s-[1px] [:is([data-flux-button-group]&gt;&amp;:not(:first-child),_[data-flux-button-group]_:not(:first-child)&gt;&amp;)]:border-s-[color-mix(in_srgb,var(--color-accent-foreground),transparent_85%)] *:transition-opacity [&amp;[data-loading]&gt;:not([data-flux-loading-indicator])]:opacity-0 [&amp;[data-flux-loading]&gt;:not([data-flux-loading-indicator])]:opacity-0 [&amp;[data-loading]&gt;[data-flux-loading-indicator]]:opacity-100 [&amp;[data-flux-loading]&gt;[data-flux-loading-indicator]]:opacity-100 data-loading:pointer-events-none data-flux-loading:pointer-events-none [--color-accent:var(--color-red-500)] [--color-accent-content:var(--color-red-600)] [--color-accent-foreground:var(--color-white)] dark:[--color-accent:var(--color-red-500)] dark:[--color-accent-content:var(--color-red-400)] dark:[--color-accent-foreground:var(--color-white)] !p-2 flex-shrink-0" data-flux-button="data-flux-button" data-flux-group-target="data-flux-group-target" wire:target="confirmDelete(<?php echo e($ncp->id); ?>)" wire:loading.attr="data-flux-loading" wire:click="confirmDelete(<?php echo e($ncp->id); ?>)">
        <div class="absolute inset-0 flex items-center justify-center opacity-0" data-flux-loading-indicator>
                <svg class="shrink-0 [:where(&amp;)]:size-5 animate-spin" data-flux-icon xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" aria-hidden="true" data-slot="icon">
    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
...
<?php echo ltrim(ob_get_clean()); ?>
                        ...
                        <tr>
                            <td colspan="<?php echo e($activeTab === 'deleted' ? '11' : '10'); ?>" class="px-4 py-8 text-center">
        ...
        <?php echo ltrim(ob_get_clean()); ?>
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-zinc-500 dark:text-zinc-400">
                                            <?php echo e($search ? 'Try adjusting your search query' : 'Get started by creating a new NCP record'); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
            ...
            <!-- Pagination -->
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ncps->hasPages()): ?>
            <div class="p-4 border-t border-zinc-200 dark:border-zinc-700 mt-auto">
                <?php echo e($ncps->links()); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <?php ob_start(); ?>PART DESCRIPTION<?php echo trim(ob_get_clean()); ?>
...
<?php _f9ce25dced5c86c906351e8ca96b9cbb($__blaze, ['wire:model' => 'part_description','type' => 'text','placeholder' => 'Enter part description'], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                                            </div>
                                            <div>
                                                <?php ob_start(); ?><ui-label class="inline-flex items-center text-sm font-medium  [:where(&amp;)]:text-zinc-800 [:where(&amp;)]:dark:text-white [&amp;:has([data-flux-label-trailing])]:flex" data-flux-label>
    <?php ob_start(); ?>MODEL AFFECTED<?php echo trim(ob_get_clean()); ?>
...
<?php _f9ce25dced5c86c906351e8ca96b9cbb($__blaze, ['wire:model' => 'model_affected','type' => 'text','placeholder' => 'Enter model affected'], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="grid grid-cols-2 gap-4 mb-4">
                                            <div>
                                                <?php ob_start(); ?><ui-label class="inline-flex items-center text-sm font-medium  [:where(&amp;)]:text-zinc-800 [:where(&amp;)]:dark:text-white [&amp;:has([data-flux-label-trailing])]:flex" data-flux-label>
    <?php ob_start(); ?>PART NUMBER<?php echo trim(ob_get_clean()); ?>
...
<?php _f9ce25dced5c86c906351e8ca96b9cbb($__blaze, ['wire:model' => 'part_number','type' => 'text','placeholder' => 'Enter part number'], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                                            </div>
                                            <div>
                                                <?php ob_start(); ?><ui-label class="inline-flex items-center text-sm font-medium  [:where(&amp;)]:text-zinc-800 [:where(&amp;)]:dark:text-white [&amp;:has([data-flux-label-trailing])]:flex" data-flux-label>
    <?php ob_start(); ?>LOT NO.<?php echo trim(ob_get_clean()); ?>
...
<?php _f9ce25dced5c86c906351e8ca96b9cbb($__blaze, ['wire:model' => 'lot_no','type' => 'text','placeholder' => 'Enter lot number'], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="grid grid-cols-2 gap-4">
                                            <div>
                                                <?php ob_start(); ?><ui-label class="inline-flex items-center text-sm font-medium  [:where(&amp;)]:text-zinc-800 [:where(&amp;)]:dark:text-white [&amp;:has([data-flux-label-trailing])]:flex" data-flux-label>
    <?php ob_start(); ?>SUPPLIER<?php echo trim(ob_get_clean()); ?>
...
<?php _f9ce25dced5c86c906351e8ca96b9cbb($__blaze, ['wire:model' => 'supplier','type' => 'text','placeholder' => 'Enter supplier name'], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                                            </div>
                                            <div>
                                                <?php ob_start(); ?><ui-label class="inline-flex items-center text-sm font-medium  [:where(&amp;)]:text-zinc-800 [:where(&amp;)]:dark:text-white [&amp;:has([data-flux-label-trailing])]:flex" data-flux-label>
    <?php ob_start(); ?>LOT QTY<?php echo trim(ob_get_clean()); ?>
...
<?php _f9ce25dced5c86c906351e8ca96b9cbb($__blaze, ['wire:model.live' => 'lot_qty','type' => 'number','min' => '0','placeholder' => 'Enter lot quantity'], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                                            </div>
                                        </div>
                                    </div>
...
<?php _f9ce25dced5c86c906351e8ca96b9cbb($__blaze, ['wire:model' => 'customer','type' => 'text','placeholder' => 'Enter customer name'], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                                            </div>
                                            <div>
                                                <div class="grid grid-cols-2 gap-2">
                                                    <div>
                                                        <?php ob_start(); ?><ui-label class="inline-flex items-center text-sm font-medium  [:where(&amp;)]:text-zinc-800 [:where(&amp;)]:dark:text-white [&amp;:has([data-flux-label-trailing])]:flex" data-flux-label>
    <?php ob_start(); ?>REJECTED QTY<?php echo trim(ob_get_clean()); ?>
...
<?php _f9ce25dced5c86c906351e8ca96b9cbb($__blaze, ['wire:model.live' => 'rejected_qty','type' => 'number','min' => '0','placeholder' => 'Enter rejected quantity'], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                                                    </div>
                                                    <div>
                                                        <?php ob_start(); ?><ui-label class="inline-flex items-center text-sm font-medium  [:where(&amp;)]:text-zinc-800 [:where(&amp;)]:dark:text-white [&amp;:has([data-flux-label-trailing])]:flex" data-flux-label>
    <?php ob_start(); ?>FAILURE RATE<?php echo trim(ob_get_clean()); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
                                                        <div class="px-3 py-2 bg-zinc-100 dark:bg-zinc-800 rounded-lg text-center font-semibold">
                                                            <?php echo e($failure_rate ? number_format((float)$failure_rate, 2, '.', '') . '%' : '0.00%'); ?>
...
<?php _f9ce25dced5c86c906351e8ca96b9cbb($__blaze, ['wire:model' => 'defect_details.'.e($index).'.serial_number','type' => 'text','placeholder' => 'S/N','size' => 'sm'], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                                                    </td>
                                                    <td class="px-3 py-2">
                                                        <?php $__blaze->ensureRequired('/www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/src/../stubs/resources/views/flux/input/index.blade.php', $__blaze->compiledPath.'/f9ce25dced5c86c906351e8ca96b9cbb.php'); ?>
...
<?php _f9ce25dced5c86c906351e8ca96b9cbb($__blaze, ['wire:model' => 'defect_details.'.e($index).'.defect_description','type' => 'text','placeholder' => 'Defect description','size' => 'sm'], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                                                    </td>
                                                    <td class="px-3 py-2">
                                                        <?php $__blaze->ensureRequired('/www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/src/../stubs/resources/views/flux/input/index.blade.php', $__blaze->compiledPath.'/f9ce25dced5c86c906351e8ca96b9cbb.php'); ?>
<?php $__blaze->pushData(['wire:model' => 'defect_details.'.e($index).'.quantity','type' => 'number','min' => '1','placeholder' => 'Qty','size' => 'sm']); ?>
<?php _f9ce25dced5c86c906351e8ca96b9cbb($__blaze, ['wire:model' => 'defect_details.'.e($index).'.quantity','type' => 'number','min' => '1','placeholder' => 'Qty','size' => 'sm'], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                                                    </td>
                                                    <td class="px-3 py-2">
                                                        <?php $__blaze->ensureRequired('/www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/src/../stubs/resources/views/flux/input/index.blade.php', $__blaze->compiledPath.'/f9ce25dced5c86c906351e8ca96b9cbb.php'); ?>
<?php $__blaze->pushData(['wire:model' => 'defect_details.'.e($index).'.defect_remarks','type' => 'text','placeholder' => 'Remarks','size' => 'sm']); ?>
<?php _f9ce25dced5c86c906351e8ca96b9cbb($__blaze, ['wire:model' => 'defect_details.'.e($index).'.defect_remarks','type' => 'text','placeholder' => 'Remarks','size' => 'sm'], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                                                    </td>
                            ...
                            <div class="bg-white dark:bg-zinc-800/50 rounded-lg border border-zinc-200 dark:border-zinc-700 mb-4 shadow-sm overflow-hidden">
                                ...
                                <div class="p-4">
                                    <div class="grid grid-cols-2 gap-4 mb-4">
                                        <div>
                                            <?php ob_start(); ?><ui-label class="inline-flex items-center text-sm font-medium  [:where(&amp;)]:text-zinc-800 [:where(&amp;)]:dark:text-white [&amp;:has([data-flux-label-trailing])]:flex" data-flux-label>
    <?php ob_start(); ?>DO No.<?php echo trim(ob_get_clean()); ?>
...
<?php _f9ce25dced5c86c906351e8ca96b9cbb($__blaze, ['wire:model' => 'do_no','type' => 'text','placeholder' => 'Enter DO number'], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                                        </div>
                                        <div>
                                            <?php ob_start(); ?><ui-label class="inline-flex items-center text-sm font-medium  [:where(&amp;)]:text-zinc-800 [:where(&amp;)]:dark:text-white [&amp;:has([data-flux-label-trailing])]:flex" data-flux-label>
    <?php ob_start(); ?>Packing List No./Invoice No.<?php echo trim(ob_get_clean()); ?>
...
<?php _f9ce25dced5c86c906351e8ca96b9cbb($__blaze, ['wire:model' => 'packing_list_no','type' => 'text','placeholder' => 'Enter packing list or invoice number'], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                                        </div>
                                    </div>
...
<?php echo ltrim(ob_get_clean()); ?>
                                        <?php $__blaze->ensureRequired('/www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/src/../stubs/resources/views/flux/textarea.blade.php', $__blaze->compiledPath.'/94345100219c384088bc615bcd8fde6c.php'); ?>
<?php $__blaze->pushData(['wire:model' => 'remarks','rows' => '3','placeholder' => 'Enter remarks...']); ?>
<?php _94345100219c384088bc615bcd8fde6c($__blaze, ['wire:model' => 'remarks','rows' => '3','placeholder' => 'Enter remarks...'], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-white dark:bg-zinc-800/50 rounded-lg border border-zinc-200 dark:border-zinc-700 mb-4 shadow-sm overflow-hidden">
                                ...
                                <div class="p-4">
                                    ...
                                    <div class="space-y-3">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $dispositionOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <div class="border-b border-zinc-100 dark:border-zinc-700 pb-3 last:border-0">
                                            <label class="flex items-start gap-2 mb-2">
                                                ...
                                                <span class="text-sm font-medium text-zinc-700 dark:text-zinc-300"><?php echo e($option); ?></span>
                                            </label>
...
<?php _94345100219c384088bc615bcd8fde6c($__blaze, ['wire:model' => 'disposition_details.'.e($option),'rows' => '2','placeholder' => 'Additional details for \''.e($option).'\' (optional)...','class' => 'text-sm'], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                                            </div>
                                        </div>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['disposition'];
                            ...
                            <div class="bg-white dark:bg-zinc-800/50 rounded-lg border border-zinc-200 dark:border-zinc-700 mb-4 shadow-sm overflow-hidden">
                                ...
                                <div class="p-4">
                                    <div class="grid grid-cols-2 gap-4">
                                        <div>
                                            <?php ob_start(); ?><ui-label class="inline-flex items-center text-sm font-medium  [:where(&amp;)]:text-zinc-800 [:where(&amp;)]:dark:text-white [&amp;:has([data-flux-label-trailing])]:flex" data-flux-label>
    <?php ob_start(); ?>Status<?php echo trim(ob_get_clean()); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
                                            <?php ob_start(); ?><?php $__blaze->pushData(['wire:model' => 'status']); $__env->pushConsumableComponentData(['wire:model' => 'status']); ?><select
    class="appearance-none [:where(&amp;)]:w-full ps-3 pe-10 block h-10 py-2 text-base sm:text-sm leading-[1.375rem] rounded-lg shadow-xs border bg-white dark:bg-white/10 dark:disabled:bg-white/[7%] text-zinc-700 dark:text-zinc-300 disabled:text-zinc-500 dark:disabled:text-zinc-400 has-[option.placeholder:checked]:text-zinc-400 dark:has-[option.placeholder:checked]:text-zinc-400 dark:[&amp;&gt;option]:bg-zinc-700 dark:[&amp;&gt;option]:text-white disabled:shadow-none border border-zinc-200 border-b-zinc-300/80 dark:border-white/10" wire:model="status"
...
>
    ...
    <?php ob_start(); ?>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                    <?php ob_start(); ?><option
...
<?php $__blaze->popData(); $__env->popConsumableComponentData(); ?><?php echo ltrim(ob_get_clean()); ?>
                                        ...
                                        <div>
                                            <?php ob_start(); ?><ui-label class="inline-flex items-center text-sm font-medium  [:where(&amp;)]:text-zinc-800 [:where(&amp;)]:dark:text-white [&amp;:has([data-flux-label-trailing])]:flex" data-flux-label>
    <?php ob_start(); ?>File Attachment<?php echo trim(ob_get_clean()); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($existingFile && !$removeFile): ?>
                                                <div class="mb-2 p-2 bg-zinc-100 dark:bg-zinc-800 rounded-lg flex items-center justify-between">
                                                    <div class="flex items-center gap-2">
                                                        <svg class="w-5 h-5 text-zinc-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                                        </svg>
                                                        <a href="<?php echo e(Storage::url($existingFile)); ?>" target="_blank" class="text-blue-600 hover:underline text-sm">
                                                            Current File
                                                        </a>
                                                    </div>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$removeFile): ?>
                                    ...
                                    <div class="mb-4">
                                        <div class="overflow-x-auto">
                                            <table class="w-full border border-zinc-200 dark:border-zinc-700 rounded-lg">
                                                ...
                                                <tbody>
                                                    <tr class="border-t border-zinc-200 dark:border-zinc-700">
                                                        <td class="px-3 py-2 text-sm"><?php echo e($nik ?? '-'); ?></td>
                                                        <td class="px-3 py-2 text-sm"><?php echo e($name); ?></td>
                                                        <td class="px-3 py-2 text-sm"><?php echo e($department); ?></td>
                                                        <td class="px-3 py-2 text-sm"><?php echo e($section); ?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
...
<?php _f9ce25dced5c86c906351e8ca96b9cbb($__blaze, ['wire:model.live' => 'section','type' => 'text','placeholder' => 'Enter section','class' => 'uppercase'], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                                    </div>
                        ...
                        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20 rounded-lg border border-blue-200 dark:border-blue-800 p-4 mb-4">
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p class="font-semibold text-lg text-zinc-800 dark:text-white"><?php echo e($viewData->ncp_number); ?></p>
                                </div>
...
<?php if (isset($__slots6b0011e2f83d04930b97e5f6feda22dd)) { $__slotsStack6b0011e2f83d04930b97e5f6feda22dd[] = $__slots6b0011e2f83d04930b97e5f6feda22dd; } ?>
<?php if (isset($__attrs6b0011e2f83d04930b97e5f6feda22dd)) { $__attrsStack6b0011e2f83d04930b97e5f6feda22dd[] = $__attrs6b0011e2f83d04930b97e5f6feda22dd; } ?>
<?php $__attrs6b0011e2f83d04930b97e5f6feda22dd = ['size' => 'md','color' => e($statusColors[$viewData->status] ?? 'gray')]; ?>
<?php $__slots6b0011e2f83d04930b97e5f6feda22dd = []; ?>
<?php $__blaze->pushData($__attrs6b0011e2f83d04930b97e5f6feda22dd); ?>
<?php ob_start(); ?>
                                            <?php echo e($statusTexts[$viewData->status] ?? ucfirst($viewData->status)); ?>
...
<?php $__blaze->popData(); ?>
                            ...
                            <div class="p-4">
                                <div class="grid grid-cols-2 gap-4 mb-4">
                                    <div>
                                        ...
                                        <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($viewData->part_description ?? '-'); ?></p>
                                    </div>
                                    <div>
                                        <span class="text-xs text-zinc-500 dark:text-zinc-400">MODEL AFFECTED</span>
                                        <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($viewData->model_affected ?? '-'); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-2 gap-4 mb-4">
                                    <div>
                                        ...
                                        <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($viewData->part_number ?? '-'); ?></p>
                                    </div>
                                    <div>
                                        <span class="text-xs text-zinc-500 dark:text-zinc-400">LOT NO.</span>
                                        <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($viewData->lot_no ?? '-'); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-2 gap-4 mb-4">
                                    <div>
                                        ...
                                        <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($viewData->supplier ?? '-'); ?></p>
                                    </div>
                                    <div>
                                        <span class="text-xs text-zinc-500 dark:text-zinc-400">LOT QTY</span>
                                        <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($viewData->lot_qty ?? '-'); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($viewData->customer ?? '-'); ?></p>
                                    </div>
                                    <div>
                                        <div class="grid grid-cols-2 gap-2">
                                            <div>
                                                <span class="text-xs text-zinc-500 dark:text-zinc-400">REJECTED QTY</span>
                                                <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($viewData->rejected_qty ?? '-'); ?></p>
                                            </div>
                                            <div>
                                                <span class="text-xs text-zinc-500 dark:text-zinc-400">FAILURE RATE</span>
                                                <p class="text-sm font-semibold text-zinc-800 dark:text-white mt-1"><?php echo e($viewData->failure_rate ? $viewData->failure_rate . '%' : '0%'); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="bg-white dark:bg-zinc-800/50 rounded-lg border border-zinc-200 dark:border-zinc-700 mb-4 shadow-sm overflow-hidden">
                            ...
                            <div class="p-4">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($viewData->defect_details && count($viewData->defect_details) > 0): ?>
                                    <div class="overflow-x-auto">
                                        <table class="w-full border border-zinc-200 dark:border-zinc-700 rounded-lg">
                                            <thead class="bg-zinc-50 dark:bg-zinc-800">
                                                <tr>
                                            ...
                                            <tbody>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $viewData->defect_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $defect): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                <tr class="border-t border-zinc-200 dark:border-zinc-700">
                                                    <td class="px-3 py-2 text-sm"><?php echo e($defect['serial_number'] ?? '-'); ?></td>
                                                    <td class="px-3 py-2 text-sm"><?php echo e($defect['defect_description'] ?? '-'); ?></td>
                                                    <td class="px-3 py-2 text-sm"><?php echo e($defect['quantity'] ?? '-'); ?></td>
                                                    <td class="px-3 py-2 text-sm"><?php echo e($defect['defect_remarks'] ?? '-'); ?></td>
                                                </tr>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                            </tbody>
                                        </table>
                            ...
                            <div class="p-4">
                                <div class="grid grid-cols-3 gap-4">
                                    <div>
                                        ...
                                        <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($viewData->do_no ?? '-'); ?></p>
                                    </div>
                                    <div>
                                        <span class="text-xs text-zinc-500 dark:text-zinc-400">Packing List No./Invoice No.</span>
                                        <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($viewData->packing_list_no ?? '-'); ?></p>
                                    </div>
                                    <div>
                                        <span class="text-xs text-zinc-500 dark:text-zinc-400">REMARKS</span>
                                        <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($viewData->remarks ?? '-'); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white dark:bg-zinc-800/50 rounded-lg border border-zinc-200 dark:border-zinc-700 mb-4 shadow-sm overflow-hidden">
                            ...
                            <div class="p-4">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($dispositionData) > 0): ?>
                                    <div class="flex flex-wrap gap-3">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $dispositionData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            <div class="inline-flex flex-col">
                                                <?php $__blaze->ensureRequired('/www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/src/../stubs/resources/views/flux/badge/index.blade.php', $__blaze->compiledPath.'/6b0011e2f83d04930b97e5f6feda22dd.php'); ?>
<?php if (isset($__slots6b0011e2f83d04930b97e5f6feda22dd)) { $__slotsStack6b0011e2f83d04930b97e5f6feda22dd[] = $__slots6b0011e2f83d04930b97e5f6feda22dd; } ?>
<?php if (isset($__attrs6b0011e2f83d04930b97e5f6feda22dd)) { $__attrsStack6b0011e2f83d04930b97e5f6feda22dd[] = $__attrs6b0011e2f83d04930b97e5f6feda22dd; } ?>
<?php $__attrs6b0011e2f83d04930b97e5f6feda22dd = ['size' => 'md','color' => e($dispositionColors[$item['type']] ?? 'gray'),'class' => 'mb-1']; ?>
<?php $__slots6b0011e2f83d04930b97e5f6feda22dd = []; ?>
<?php $__blaze->pushData($__attrs6b0011e2f83d04930b97e5f6feda22dd); ?>
<?php ob_start(); ?>
...
<?php $__blaze->popData(); ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($viewData->file): ?>
                        <div class="bg-white dark:bg-zinc-800/50 rounded-lg border border-zinc-200 dark:border-zinc-700 mb-4 shadow-sm overflow-hidden">
                            <div class="px-4 py-3 border-b" style="background-color: #fde68a;">
                                <h3 class="text-md font-semibold flex items-center gap-2 text-zinc-800">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="p-4">
                                <a href="<?php echo e(Storage::url($viewData->file)); ?>" target="_blank" class="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 flex items-center gap-2">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="p-4">
                                <div class="overflow-x-auto">
                                    <table class="w-full border border-zinc-200 dark:border-zinc-700 rounded-lg">
                                        ...
                                        <tbody>
                                            <tr class="border-t border-zinc-200 dark:border-zinc-700">
                                                <td class="px-3 py-2 text-sm"><?php echo e($viewData->employee->nik ?? '-'); ?></td>
                                                <td class="px-3 py-2 text-sm"><?php echo e($viewData->employee->name ?? '-'); ?></td>
                                                <td class="px-3 py-2 text-sm"><?php echo e($viewData->employee->department ?? '-'); ?></td>
                                                <td class="px-3 py-2 text-sm"><?php echo e($viewData->section ?? '-'); ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($viewData->deleted_at): ?>
                            ...
                            <div class="p-4">
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($viewData->deleter->name ?? '-'); ?></p>
                                    </div>
                                    <div>
                                        <span class="text-xs text-zinc-500 dark:text-zinc-400">Deleted At</span>
                                        <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($viewData->deleted_at ? $viewData->deleted_at->format('d/m/Y H:i') : '-'); ?></p>
                                    </div>
                                    <div class="col-span-2">
                                        <span class="text-xs text-zinc-500 dark:text-zinc-400">Deletion Reason</span>
                                        <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($viewData->deleted_reason ?? '-'); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
            <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-xl w-full max-w-md p-6">
                ...
                <p class="text-gray-600 dark:text-gray-400 mb-4 text-center">
                    Are you sure you want to delete NCP <span class="font-semibold"><?php echo e($ncpToDelete?->ncp_number); ?></span>?
                </p>
...
<?php _94345100219c384088bc615bcd8fde6c($__blaze, ['wire:model' => 'deleteReason','rows' => '3','placeholder' => 'Please provide a reason why this NCP is being deleted...','class' => 'w-full'], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
</div><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/resources/views/livewire/qaqc/ncp-management.blade.php ENDPATH**/ ?>