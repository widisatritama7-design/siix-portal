<?php
if (!function_exists('_dcccfbc79f37f8071e592679fa797fcd')):
function _dcccfbc79f37f8071e592679fa797fcd($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
} endif; ?><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/stubs/resources/views/flux/icon/arrow-turn-down-right.blade.php ENDPATH**/ ?>