...
<?php _5ae551d98c08f0bc67bd05455e08306c($__blaze, ['wire:model.live.debounce.300ms' => 'search','placeholder' => 'Search users by name, NIK, or email...','icon' => 'magnifying-glass','clearable' => true], [], ['clearable'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
        </div>
    </div>
...
<?php $__attrsdc7b41944d7ad01d0a093ce0d326337c = ['size' => 'sm','color' => e($role->name == 'super-admin' ? 'purple' : ($role->name == 'admin' ? 'blue' : 'gray')),'class' => 'whitespace-nowrap']; ?>
...
</div><?php /**PATH /www/wwwroot/testings.siix-ems.co.id/siix-portal/resources/views/livewire/user/user-management.blade.php ENDPATH**/ ?>