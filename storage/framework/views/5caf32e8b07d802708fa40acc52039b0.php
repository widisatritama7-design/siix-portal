...
<?php $__blaze->pushData(['wire:model.live.debounce.300ms' => 'search','placeholder' => 'Search model or customer...','icon' => 'magnifying-glass','clearable' => true]); ?>
<?php _5ae551d98c08f0bc67bd05455e08306c($__blaze, ['wire:model.live.debounce.300ms' => 'search','placeholder' => 'Search model or customer...','icon' => 'magnifying-glass','clearable' => true], [], ['clearable'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
        </div>
    </div>
            ...
            <table class="w-full" style="min-width: 900px; white-space: nowrap;">
                <thead>
                    <tr class="bg-zinc-50 dark:bg-zinc-800/50">
                        ...
                        <th class="px-4 py-3 text-left text-xs font-medium text-zinc-500 dark:text-zinc-400 uppercase tracking-wider" style="min-width: 200px;">Customer</th>
                        <th class="px-4 py-3 text-left text-xs font-medium text-zinc-500 dark:text-zinc-400 uppercase tracking-wider" style="min-width: 200px;">Model Name</th>
                ...
                <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $models; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $model): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php $isUsed = in_array((int) $model->id, $usedIds, true); ?>
                    <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'model-'.e($model->id).''; ?>wire:key="model-<?php echo e($model->id); ?>">
                        <td class="px-4 py-3 text-sm text-zinc-500 dark:text-zinc-400 text-center">
                            <?php echo e($models->firstItem() + $index); ?>

                        </td>
                        <td class="px-4 py-3 text-left">
                            <span class="text-sm font-semibold text-zinc-800 dark:text-white">
                                <?php echo e($model->customer->customer_name ?? '-'); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete model')): ?>
                                    ...
                                    <?php ob_start(); ?><ui-tooltip position="top center"  data-flux-tooltip >
        <?php ob_start(); ?>
                                        <?php ob_start(); ?><button type="button" class="relative items-center font-medium justify-center gap-2 whitespace-nowrap disabled:opacity-75 dark:disabled:opacity-75 disabled:cursor-default disabled:pointer-events-none justify-center h-8 text-sm rounded-md w-8 inline-flex  bg-[var(--color-accent)] hover:bg-[color-mix(in_oklab,_var(--color-accent),_transparent_10%)] text-[var(--color-accent-foreground)] border border-black/10 dark:border-0 shadow-[inset_0px_1px_--theme(--color-white/.2)] [[data-flux-button-group]_&amp;]:border-e-0 [:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-e-[1px] dark:[:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-e-0 dark:[:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-s-[1px] [:is([data-flux-button-group]&gt;&amp;:not(:first-child),_[data-flux-button-group]_:not(:first-child)&gt;&amp;)]:border-s-[color-mix(in_srgb,var(--color-accent-foreground),transparent_85%)] *:transition-opacity [&amp;[data-loading]&gt;:not([data-flux-loading-indicator])]:opacity-0 [&amp;[data-flux-loading]&gt;:not([data-flux-loading-indicator])]:opacity-0 [&amp;[data-loading]&gt;[data-flux-loading-indicator]]:opacity-100 [&amp;[data-flux-loading]&gt;[data-flux-loading-indicator]]:opacity-100 data-loading:pointer-events-none data-flux-loading:pointer-events-none [--color-accent:var(--color-red-500)] [--color-accent-content:var(--color-red-600)] [--color-accent-foreground:var(--color-white)] dark:[--color-accent:var(--color-red-500)] dark:[--color-accent-content:var(--color-red-400)] dark:[--color-accent-foreground:var(--color-white)] !p-2 flex-shrink-0" data-flux-button="data-flux-button" data-flux-group-target="data-flux-group-target" wire:target="confirmDelete(<?php echo e($model->id); ?>)" wire:loading.attr="data-flux-loading" wire:click="confirmDelete(<?php echo e($model->id); ?>)">
        <div class="absolute inset-0 flex items-center justify-center opacity-0" data-flux-loading-indicator>
                <svg class="shrink-0 [:where(&amp;)]:size-5 animate-spin" data-flux-icon xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" aria-hidden="true" data-slot="icon">
    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
        ...
        <?php echo ltrim(ob_get_clean()); ?>
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-zinc-500 dark:text-zinc-400">
                                        <?php echo e($search ? 'Try adjusting your search query' : 'Get started by creating a new model'); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($models->hasPages()): ?>
...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <div x-data="{ open: false }" 
        x-on:open-modal-model.window="open = true"
        x-on:close-modal-model.window="open = false"
        x-show="open"
        x-cloak
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
            <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-xl w-full max-w-md">
                <div class="p-6">
                    ...
                    <form wire:submit="save" id="model-form">
                        <div class="mb-4">
...
<?php echo ltrim(ob_get_clean()); ?>
                            <?php ob_start(); ?><?php $__blaze->pushData(['wire:model' => 'customer_id', 'placeholder' => 'Select customer...']); $__env->pushConsumableComponentData(['wire:model' => 'customer_id', 'placeholder' => 'Select customer...']); ?><select
    class="appearance-none [:where(&amp;)]:w-full ps-3 pe-10 block h-10 py-2 text-base sm:text-sm leading-[1.375rem] rounded-lg shadow-xs border bg-white dark:bg-white/10 dark:disabled:bg-white/[7%] text-zinc-700 dark:text-zinc-300 disabled:text-zinc-500 dark:disabled:text-zinc-400 has-[option.placeholder:checked]:text-zinc-400 dark:has-[option.placeholder:checked]:text-zinc-400 dark:[&amp;&gt;option]:bg-zinc-700 dark:[&amp;&gt;option]:text-white disabled:shadow-none border border-zinc-200 border-b-zinc-300/80 dark:border-white/10" wire:model="customer_id"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="mb-4">
                            <?php ob_start(); ?><ui-label class="inline-flex items-center text-sm font-medium  [:where(&amp;)]:text-zinc-800 [:where(&amp;)]:dark:text-white [&amp;:has([data-flux-label-trailing])]:flex" required="required" data-flux-label>
    <?php ob_start(); ?>Model Name<?php echo trim(ob_get_clean()); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
                            <?php $__blaze->ensureRequired('/www/wwwroot/testings.siix-ems.co.id/siix-portal/vendor/livewire/flux/src/../stubs/resources/views/flux/input/index.blade.php', $__blaze->compiledPath.'/5ae551d98c08f0bc67bd05455e08306c.php'); ?>
<?php $__blaze->pushData(['wire:model' => 'model_name','type' => 'text','placeholder' => 'Enter model name','class' => 'uppercase']); ?>
<?php _5ae551d98c08f0bc67bd05455e08306c($__blaze, ['wire:model' => 'model_name','type' => 'text','placeholder' => 'Enter model name','class' => 'uppercase'], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="p-6 pt-0 flex justify-end gap-2">
                    ...
                    <button type="submit" 
                        ...
                        wire:target="save">
                        <span wire:loading.remove wire:target="save"><?php echo e($model_id ? 'Update' : 'Create'); ?></span>
    ...
    <div x-data="{ open: false }" 
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
            <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-xl w-full max-w-lg">
                <div class="p-6">
                    <h2 class="text-xl font-bold mb-4">Model Detail</h2>
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <p class="text-sm font-semibold text-zinc-800 dark:text-white mt-1"><?php echo e($viewData->customer->customer_name ?? '-'); ?></p>
                        </div>
                        <div>
                            <span class="text-xs text-zinc-500 dark:text-zinc-400">Model Name</span>
                            <p class="text-sm font-semibold text-zinc-800 dark:text-white mt-1"><?php echo e($viewData->model_name); ?></p>
                        </div>
                        <div>
                            <span class="text-xs text-zinc-500 dark:text-zinc-400">Created By</span>
                            <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($viewData->creator->name ?? '-'); ?></p>
                        </div>
                        <div>
                            <span class="text-xs text-zinc-500 dark:text-zinc-400">Created At</span>
                            <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($viewData->created_at ? $viewData->created_at->format('d/m/Y H:i') : '-'); ?></p>
                        </div>
                        <div>
                            <span class="text-xs text-zinc-500 dark:text-zinc-400">Updated By</span>
                            <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($viewData->updater->name ?? '-'); ?></p>
                        </div>
                        <div>
                            <span class="text-xs text-zinc-500 dark:text-zinc-400">Updated At</span>
                            <p class="text-sm text-zinc-800 dark:text-white mt-1"><?php echo e($viewData->updated_at ? $viewData->updated_at->format('d/m/Y H:i') : '-'); ?></p>
                        </div>
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
    ...
    <div x-data="{ open: false }" 
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
            <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-xl w-full max-w-md p-6">
                ...
                <h3 class="text-lg font-bold mb-2 text-center">Delete Model</h3>
                <p class="text-gray-600 dark:text-gray-400 mb-4 text-center">
                    Are you sure you want to delete model <span class="font-semibold"><?php echo e($modelToDelete?->model_name); ?></span>?
                </p>
...
</div><?php /**PATH /www/wwwroot/testings.siix-ems.co.id/siix-portal/resources/views/livewire/qaqc/blind-test/model-management.blade.php ENDPATH**/ ?>