...
<?php # [BlazeFolded]:{flux::icon.clipboard-document-list}:{D:\laragon\www\siix-portal-new\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/clipboard-document-list.blade.php}:{1774988736} ?>
...
<?php # [BlazeFolded]:{flux::icon.server-stack}:{D:\laragon\www\siix-portal-new\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/server-stack.blade.php}:{1774988736} ?>
<?php # [BlazeFolded]:{flux::card}:{D:\laragon\www\siix-portal-new\vendor\livewire\flux\src/../stubs/resources/views/flux/card/index.blade.php}:{1774988736} ?>
<?php # [BlazeFolded]:{flux::icon.beaker}:{D:\laragon\www\siix-portal-new\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/beaker.blade.php}:{1774988736} ?>
...
<?php ob_start(); ?>Dashboard<?php $__slotsff33ec4157565e312cea64d93aa61979['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
...
<?php $__blaze->popData(); ?>
        <?php ob_start(); ?><div class="flex items-center text-sm font-medium group/breadcrumb font-semibold text-blue-600 dark:text-blue-400" data-flux-breadcrumbs-item>
            <div class="text-gray-500 dark:text-white/80">
                            <?php ob_start(); ?>PROD<?php echo trim(ob_get_clean()); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
        <?php ob_start(); ?><div class="flex items-center text-sm font-medium group/breadcrumb font-semibold text-blue-600 dark:text-blue-400" data-flux-breadcrumbs-item>
            <div class="text-gray-500 dark:text-white/80">
                            <?php ob_start(); ?>MS<?php echo trim(ob_get_clean()); ?>
...
<?php if (isset($__slotsff33ec4157565e312cea64d93aa61979)) { $__slotsStackff33ec4157565e312cea64d93aa61979[] = $__slotsff33ec4157565e312cea64d93aa61979; } ?>
<?php if (isset($__attrsff33ec4157565e312cea64d93aa61979)) { $__attrsStackff33ec4157565e312cea64d93aa61979[] = $__attrsff33ec4157565e312cea64d93aa61979; } ?>
<?php $__attrsff33ec4157565e312cea64d93aa61979 = ['href' => e(route('prod.ms.master-sample')),'wire:navigate' => true,'separator' => 'slash']; ?>
<?php $__slotsff33ec4157565e312cea64d93aa61979 = []; ?>
<?php $__blaze->pushData($__attrsff33ec4157565e312cea64d93aa61979); ?>
<?php ob_start(); ?>Master Sample<?php $__slotsff33ec4157565e312cea64d93aa61979['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slotsff33ec4157565e312cea64d93aa61979); ?>
<?php _ff33ec4157565e312cea64d93aa61979($__blaze, $__attrsff33ec4157565e312cea64d93aa61979, $__slotsff33ec4157565e312cea64d93aa61979, ['wire:navigate'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStackff33ec4157565e312cea64d93aa61979)) { $__slotsff33ec4157565e312cea64d93aa61979 = array_pop($__slotsStackff33ec4157565e312cea64d93aa61979); } ?>
<?php if (! empty($__attrsStackff33ec4157565e312cea64d93aa61979)) { $__attrsff33ec4157565e312cea64d93aa61979 = array_pop($__attrsStackff33ec4157565e312cea64d93aa61979); } ?>
<?php $__blaze->popData(); ?>
        <?php ob_start(); ?><div class="flex items-center text-sm font-medium group/breadcrumb font-semibold text-blue-600 dark:text-blue-400" data-flux-breadcrumbs-item>
            <div class="text-gray-500 dark:text-white/80">
                            <?php ob_start(); ?>View<?php echo trim(ob_get_clean()); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
  ...
  <path fill-rule="evenodd" d="M14 8a.75.75 0 0 1-.75.75H4.56l3.22 3.22a.75.75 0 1 1-1.06 1.06l-4.5-4.5a.75.75 0 0 1 0-1.06l4.5-4.5a.75.75 0 0 1 1.06 1.06L4.56 7.25h8.69A.75.75 0 0 1 14 8Z" clip-rule="evenodd"/>
            ...
            <span><?php ob_start(); ?>Back<?php echo trim(ob_get_clean()); ?></span>
    </a>
<?php echo ltrim(ob_get_clean()); ?>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <?php ob_start(); ?><div class="[:where(&amp;)]:bg-white dark:[:where(&amp;)]:bg-white/10 border border-zinc-200 dark:border-white/10 [:where(&amp;)]:p-6 [:where(&amp;)]:rounded-xl p-0 overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300" data-flux-card>
    <?php ob_start(); ?>
            ...
            <div class="p-4">
                <div class="space-y-2 text-sm">
                    <div class="flex justify-between items-center">
                        ...
                        <span class="text-zinc-800 dark:text-zinc-200 font-semibold"><?php echo e($masterSample->model_name); ?></span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-zinc-500 dark:text-zinc-400 font-medium">Customer:</span>
                        <span class="text-zinc-800 dark:text-zinc-200"><?php echo e($masterSample->customer); ?></span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-zinc-500 dark:text-zinc-400 font-medium">Name/MC:</span>
                        <span class="text-zinc-800 dark:text-zinc-200"><?php echo e($masterSample->name_or_mc); ?></span>
                    </div>
                </div>
            </div>
        <?php echo trim(ob_get_clean()); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M5.25 14.25h13.5m-13.5 0a3 3 0 0 1-3-3m3 3a3 3 0 1 0 0 6h13.5a3 3 0 1 0 0-6m-16.5-3a3 3 0 0 1 3-3h13.5a3 3 0 0 1 3 3m-19.5 0a4.5 4.5 0 0 1 .9-2.7L5.737 5.1a3.375 3.375 0 0 1 2.7-1.35h7.126c1.062 0 2.062.5 2.7 1.35l2.587 3.45a4.5 4.5 0 0 1 .9 2.7m0 0a3 3 0 0 1-3 3m0 3h.008v.008h-.008v-.008Zm0-6h.008v.008h-.008v-.008Zm-3 6h.008v.008h-.008v-.008Zm0-6h.008v.008h-.008v-.008Z"/>
        ...
        <?php echo ltrim(ob_get_clean()); ?>
            ...
            <div class="p-4">
                <div class="space-y-2 text-sm">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($masterSample->rack): ?>
                    <div class="flex justify-between items-center">
                        <span class="text-zinc-500 dark:text-zinc-400 font-medium">Rack Type:</span>
                        <span class="text-zinc-800 dark:text-zinc-200"><?php echo e($masterSample->rack->type_rack); ?></span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-zinc-500 dark:text-zinc-400 font-medium">Rack Column:</span>
                        <span class="text-zinc-800 dark:text-zinc-200"><?php echo e($masterSample->rack->column_rack); ?></span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-zinc-500 dark:text-zinc-400 font-medium">Rack Sheet:</span>
                        <span class="text-zinc-800 dark:text-zinc-200"><?php echo e($masterSample->rack->sheet_rack); ?></span>
                    </div>
                    <?php else: ?>
                    <div class="text-center text-zinc-500 dark:text-zinc-400 py-4">No rack assigned</div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($masterSample->rack_backup): ?>
                    <div class="flex justify-between items-center pt-2 border-t border-zinc-200 dark:border-zinc-700">
                        ...
                        <span class="text-amber-600 dark:text-amber-400 font-semibold"><?php echo e($masterSample->rack_backup); ?></span>
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
                ...
                <div class="space-y-2 text-sm">
                    <div class="flex justify-between items-center">
                        ...
                        <div class="flex items-center gap-1">
                            <span class="text-green-600 dark:text-green-400 font-semibold"><?php echo e($masterSample->sample_ok ?? '-'); ?></span>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($masterSample->sample_ok_backup): ?>
                            <?php ob_start(); ?><div data-flux-badge="data-flux-badge" class="inline-flex items-center font-medium whitespace-nowrap  [print-color-adjust:exact] text-xs py-1 **:data-flux-badge-icon:me-1 rounded-md px-2 text-green-800 [&amp;_button]:text-green-800! dark:text-green-200 dark:[&amp;_button]:text-green-200! bg-green-400/20 dark:bg-green-400/40 [&amp;:is(button)]:hover:bg-green-400/30 dark:[button]:hover:bg-green-400/50 text-xs">
        <?php ob_start(); ?>Backup<?php echo trim(ob_get_clean()); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <div class="flex items-center gap-1">
                            <span class="text-red-600 dark:text-red-400 font-semibold"><?php echo e($masterSample->sample_ng ?? '-'); ?></span>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($masterSample->sample_blank): ?>
                            <?php ob_start(); ?><div data-flux-badge="data-flux-badge" class="inline-flex items-center font-medium whitespace-nowrap  [print-color-adjust:exact] text-xs py-1 **:data-flux-badge-icon:me-1 rounded-md px-2 text-red-700 [&amp;_button]:text-red-700! dark:text-red-200 dark:[&amp;_button]:text-red-200! bg-red-400/20 dark:bg-red-400/40 [&amp;:is(button)]:hover:bg-red-400/30 dark:[button]:hover:bg-red-400/50 text-xs">
        <?php ob_start(); ?>Blank<?php echo trim(ob_get_clean()); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <div class="mt-6 border-b border-zinc-200 dark:border-zinc-700">
        <div class="flex justify-center gap-6">
            <a href="<?php echo e(route('prod.ms.master-sample.show', ['id' => $masterSample->id, 'tab' => 'history'])); ?>" 
            wire:navigate 
            class="group flex items-center gap-2 pb-3 px-1 text-sm font-medium relative transition-colors <?php echo e($activeRelationTab === 'history' ? 'text-blue-600 dark:text-blue-400 border-b-2 border-blue-600 dark:border-blue-400' : 'text-zinc-500 dark:text-zinc-400 hover:text-zinc-700 dark:hover:text-zinc-300'); ?>">
                ...
                <span class="ml-1 px-1.5 py-0.5 text-xs rounded-full bg-zinc-200 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-400 font-medium">
                    <?php echo e($histories->total()); ?>

                </span>
            </a>
            <a href="<?php echo e(route('prod.ms.master-sample.show', ['id' => $masterSample->id, 'tab' => 'details'])); ?>" 
            wire:navigate 
            class="group flex items-center gap-2 pb-3 px-1 text-sm font-medium relative transition-colors <?php echo e($activeRelationTab === 'details' ? 'text-blue-600 dark:text-blue-400 border-b-2 border-blue-600 dark:border-blue-400' : 'text-zinc-500 dark:text-zinc-400 hover:text-zinc-700 dark:hover:text-zinc-300'); ?>">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
    ...
    <!-- Tab: Loan History -->
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeRelationTab === 'history'): ?>
    <div>
        <div class="flex justify-end mb-3">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canAddLoan): ?>
            <a href="<?php echo e(route('prod.ms.master-sample.loan.create', $masterSample->id)); ?>" class="px-3 py-2 bg-green-600 text-white rounded-lg text-sm hover:bg-green-700 transition">+ New Loan Application</a>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
                        ...
                        <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors">
                            <td class="px-4 py-3 text-center">
                                <div class="flex items-center justify-center gap-1">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $this->safeDecodeType($history->type); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <span class="px-2 py-0.5 text-xs rounded-full <?php echo e($t === 'sample_ok' ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400' : 
                                        ...
                                        <?php echo e(strtoupper(str_replace('sample_', '', str_replace('_backup', ' BACKUP', $t)))); ?>

                                    </span>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                </div>
                            </td>
                            <td class="px-4 py-3 text-sm text-zinc-600 dark:text-zinc-300 text-center whitespace-nowrap"><?php echo e($history->out_date ? \Carbon\Carbon::parse($history->out_date)->format('d M Y H:i') : '-'); ?></td>
                            <td class="px-4 py-3 text-sm text-zinc-600 dark:text-zinc-300 text-center whitespace-nowrap"><?php echo e($history->in_date ? \Carbon\Carbon::parse($history->in_date)->format('d M Y H:i') : '-'); ?></td>
                            <td class="px-4 py-3 text-sm text-zinc-600 dark:text-zinc-300 text-center"><?php echo e($history->employee->name ?? '-'); ?></td>
                            <td class="px-4 py-3 text-center">
...
<?php $__attrse7738cfa973d7ff62d132f5dce92a05c = ['size' => 'sm','color' => e($history->status === 'in_use' ? 'green' : 
...
<?php ob_start(); ?>
                                    <?php echo e($history->status === 'in_use' ? 'In Use' : 
...
<?php $__blaze->popData(); ?>
                            ...
                            <td class="px-4 py-3 text-sm text-zinc-600 dark:text-zinc-300 text-center">
                                <?php echo e($history->masterLine?->location?->location_name ?? '-'); ?> 
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($history->masterLine?->line_number): ?> 
                                    <span class="text-zinc-400">|</span> Line <?php echo e($history->masterLine->line_number); ?> 
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </td>
                            <td class="px-4 py-3 text-sm text-zinc-600 dark:text-zinc-300 text-center"><?php echo e($history->remarks ?? '-'); ?></td>
                            <td class="px-4 py-3 text-right">
                                <div class="flex items-center justify-end gap-1">
                                <!-- View Ac    tivity Button -->
                                    <?php ob_start(); ?><ui-tooltip position="bottom center"  data-flux-tooltip >
        <?php ob_start(); ?>
                                        <button wire:click="viewActivity(<?php echo e($history->id); ?>, 'history')"
...
<?php echo ltrim(ob_get_clean()); ?>
                                    ...
                                    ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showUpdateInDateButton): ?>
                                    <?php ob_start(); ?><ui-tooltip position="bottom center"  data-flux-tooltip >
        <?php ob_start(); ?>
                                        <button wire:click="openUpdateInDateModal(<?php echo e($history->id); ?>)"
...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <!-- Tab: Expired History -->
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeRelationTab === 'details'): ?>
    <div>
        <div class="flex justify-end mb-3">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canAddExpired): ?>
            <a href="<?php echo e(route('prod.ms.master-sample.expired.create', $masterSample->id)); ?>" class="px-3 py-2 bg-green-600 text-white rounded-lg text-sm hover:bg-green-700 transition">+ Add Expired History</a>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
        <?php ob_start(); ?><div class="[:where(&amp;)]:bg-white dark:[:where(&amp;)]:bg-white/10 border border-zinc-200 dark:border-white/10 [:where(&amp;)]:p-6 [:where(&amp;)]:rounded-xl p-6 h-full shadow-lg hover:shadow-xl transition-shadow duration-300" data-flux-card>
    <?php ob_start(); ?>
            <div class="overflow-x-auto">
                <table class="min-w-full whitespace-nowrap">
                    ...
                    <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors">
                            <td class="px-4 py-3 text-sm text-zinc-600 dark:text-zinc-300 text-center whitespace-nowrap"><?php echo e($detail->updated_date ? \Carbon\Carbon::parse($detail->updated_date)->format('d M Y') : '-'); ?></td>
                            <td class="px-4 py-3 text-sm text-zinc-600 dark:text-zinc-300 text-center whitespace-nowrap"><?php echo e($detail->expired_date ? \Carbon\Carbon::parse($detail->expired_date)->format('d M Y') : '-'); ?></td>
                            <td class="px-4 py-3 text-sm text-zinc-600 dark:text-zinc-300 text-center whitespace-nowrap"><?php echo e($detail->date_alarm ? \Carbon\Carbon::parse($detail->date_alarm)->format('d M Y') : '-'); ?></td>
                            <td class="px-4 py-3 text-sm text-zinc-600 dark:text-zinc-300 text-center"><?php echo e($detail->days_left ?? '-'); ?></td>
                            <td class="px-4 py-3 text-center">
                                <?php $__blaze->ensureRequired('D:\laragon\www\siix-portal-new\vendor\livewire\flux\src/../stubs/resources/views/flux/badge/index.blade.php', $__blaze->compiledPath.'/e7738cfa973d7ff62d132f5dce92a05c.php'); ?>
<?php if (isset($__slotse7738cfa973d7ff62d132f5dce92a05c)) { $__slotsStacke7738cfa973d7ff62d132f5dce92a05c[] = $__slotse7738cfa973d7ff62d132f5dce92a05c; } ?>
<?php if (isset($__attrse7738cfa973d7ff62d132f5dce92a05c)) { $__attrsStacke7738cfa973d7ff62d132f5dce92a05c[] = $__attrse7738cfa973d7ff62d132f5dce92a05c; } ?>
<?php $__attrse7738cfa973d7ff62d132f5dce92a05c = ['size' => 'sm','color' => e((!$detail->expired_date || \Carbon\Carbon::parse($detail->expired_date)->isFuture()) ? 'green' : 'red')]; ?>
<?php $__slotse7738cfa973d7ff62d132f5dce92a05c = []; ?>
<?php $__blaze->pushData($__attrse7738cfa973d7ff62d132f5dce92a05c); ?>
<?php ob_start(); ?>
                                    <?php echo e((!$detail->expired_date || \Carbon\Carbon::parse($detail->expired_date)->isFuture()) ? 'Active' : 'Expired'); ?>
...
<?php $__blaze->popData(); ?>
                            ...
                            <td class="px-4 py-3 text-center">
                                <div class="text-sm text-zinc-600 dark:text-zinc-300"><?php echo e($detail->checkedBy->name ?? '-'); ?></div>
                                <div class="text-xs text-zinc-400 dark:text-zinc-500"><?php echo e($detail->check_date ? \Carbon\Carbon::parse($detail->check_date)->format('d M Y H:i') : 'Waiting'); ?></div>
                            </td>
                            <td class="px-4 py-3 text-center">
                                <div class="text-sm text-zinc-600 dark:text-zinc-300"><?php echo e($detail->knowladgeBy->name ?? '-'); ?></div>
                                <div class="text-xs text-zinc-400 dark:text-zinc-500"><?php echo e($detail->knowladge_date ? \Carbon\Carbon::parse($detail->knowladge_date)->format('d M Y H:i') : 'Waiting'); ?></div>
                            </td>
                            <td class="px-4 py-3 text-center">
                                <div class="text-sm text-zinc-600 dark:text-zinc-300"><?php echo e($detail->approvedBy->name ?? '-'); ?></div>
                                <div class="text-xs text-zinc-400 dark:text-zinc-500"><?php echo e($detail->approve_date ? \Carbon\Carbon::parse($detail->approve_date)->format('d M Y H:i') : 'Waiting'); ?></div>
                            </td>
                            <td class="px-4 py-3 text-right">
                                <div class="flex items-center justify-end gap-1">
                                    ...
                                    <?php ob_start(); ?><ui-tooltip position="bottom center"  data-flux-tooltip >
        <?php ob_start(); ?>
                                        <button wire:click="viewActivity(<?php echo e($detail->id); ?>, 'detail')"
                                                class="inline-flex items-center justify-center p-2 text-purple-600 hover:bg-purple-100 dark:hover:bg-purple-900/30 rounded-lg transition-colors">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                                            </svg>
                    ...
                    <div class="relative mb-4">
                        ...
                        >
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <div 
                                    x-show="'<?php echo e(strtolower($employee->name)); ?>'.includes(search.toLowerCase()) 
                                            || '<?php echo e(strtolower($employee->nik)); ?>'.includes(search.toLowerCase())"
                                    
                                    @click="
                                        $wire.set('selectedNik', '<?php echo e($employee->id); ?>'); 
                                        search = '<?php echo e(addslashes($employee->nik . ' - ' . $employee->name)); ?>'; 
                                        show = false;
                                    "
                                ...
                                >
                                    <div class="text-sm font-medium text-zinc-800 dark:text-zinc-200">
                                        <?php echo e($employee->nik); ?> - <?php echo e($employee->name); ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['selectedNik'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <!-- MODAL ACTIVITY LOG -->
    <?php $__blaze->ensureRequired('D:\laragon\www\siix-portal-new\vendor\livewire\flux\src/../stubs/resources/views/flux/modal/index.blade.php', $__blaze->compiledPath.'/af3f4f96c83cd3334e2986d7000c0e0a.php'); ?>
<?php if (isset($__slotsaf3f4f96c83cd3334e2986d7000c0e0a)) { $__slotsStackaf3f4f96c83cd3334e2986d7000c0e0a[] = $__slotsaf3f4f96c83cd3334e2986d7000c0e0a; } ?>
<?php if (isset($__attrsaf3f4f96c83cd3334e2986d7000c0e0a)) { $__attrsStackaf3f4f96c83cd3334e2986d7000c0e0a[] = $__attrsaf3f4f96c83cd3334e2986d7000c0e0a; } ?>
<?php $__attrsaf3f4f96c83cd3334e2986d7000c0e0a = ['wire:model' => 'showActivityModal','class' => 'w-full max-w-5xl']; ?>
<?php $__slotsaf3f4f96c83cd3334e2986d7000c0e0a = []; ?>
<?php $__blaze->pushData($__attrsaf3f4f96c83cd3334e2986d7000c0e0a); ?>
<?php ob_start(); ?>
            ...
            <div class="flex justify-between items-center px-6 py-4 border-b border-zinc-200 dark:border-zinc-700 flex-shrink-0">
                <div>
                    ...
                    <p class="text-sm text-zinc-500 dark:text-zinc-400 mt-1">
                        Record Type: <span class="font-semibold"><?php echo e(ucfirst(str_replace('-', ' ', $selectedRecordType))); ?></span>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedRecordType === 'history'): ?>
                            | ID: <span class="font-semibold">#<?php echo e($selectedRecordForActivity->id); ?></span>
                        <?php else: ?>
                            | ID: <span class="font-semibold">#<?php echo e($selectedRecordForActivity->id); ?></span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </p>
...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <?php $__slotsaf3f4f96c83cd3334e2986d7000c0e0a['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slotsaf3f4f96c83cd3334e2986d7000c0e0a); ?>
<?php _af3f4f96c83cd3334e2986d7000c0e0a($__blaze, $__attrsaf3f4f96c83cd3334e2986d7000c0e0a, $__slotsaf3f4f96c83cd3334e2986d7000c0e0a, [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStackaf3f4f96c83cd3334e2986d7000c0e0a)) { $__slotsaf3f4f96c83cd3334e2986d7000c0e0a = array_pop($__slotsStackaf3f4f96c83cd3334e2986d7000c0e0a); } ?>
<?php if (! empty($__attrsStackaf3f4f96c83cd3334e2986d7000c0e0a)) { $__attrsaf3f4f96c83cd3334e2986d7000c0e0a = array_pop($__attrsStackaf3f4f96c83cd3334e2986d7000c0e0a); } ?>
<?php $__blaze->popData(); ?>
...
</div><?php /**PATH D:\laragon\www\siix-portal-new\resources\views/livewire/prod/ms/sample/master-sample-show.blade.php ENDPATH**/ ?>