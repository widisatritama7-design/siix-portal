        ...
        <div id="print-area">
            <div class="label">
                ...
                <div class="label-header">
                    ...
                    <span class="label-locker"><?php echo e($transaction->locker->code); ?></span>
                </div>
                ...
                <div class="label-body">
                    <div class="label-info-item">
                        ...
                        <span class="value"><?php echo e($transaction->employee->nik); ?></span>
                    </div>
                    <div class="label-info-item">
                        <span class="label-text">Name</span>
                        <span class="value"><?php echo e($transaction->employee->name); ?></span>
                    </div>
                    <div class="label-info-item">
                        <span class="label-text">Dept</span>
                        <span class="value"><?php echo e($transaction->employee->department); ?></span>
                    </div>
                    <div class="label-info-item" style="padding-top: 1.5mm; border-bottom: none;">
                        <span class="label-text">Code</span>
                        <span class="value value-code"><?php echo e($transaction->access_code); ?></span>
                    </div>
                </div>

                <!-- QR CODE -->
                <div class="label-qr">
                    <?php echo DNS2D::getBarcodeHTML($transaction->access_code, 'QRCODE', 5, 5); ?>
...
</html><?php /**PATH /www/wwwroot/testings.siix-ems.co.id/siix-portal/resources/views/livewire/esd/locker/print-label.blade.php ENDPATH**/ ?>