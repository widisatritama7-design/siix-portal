...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div class="flex gap-2">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showResults && count($data) > 0): ?>
...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <!-- Filter Card -->
    <?php ob_start(); ?><div class="[:where(&amp;)]:bg-white dark:[:where(&amp;)]:bg-white/10 border border-zinc-200 dark:border-white/10 [:where(&amp;)]:p-6 [:where(&amp;)]:rounded-xl p-0 overflow-hidden" data-flux-card>
    <?php ob_start(); ?>
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    <div class="flex items-center justify-between">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($selectedModels) > 0): ?>
                            <div class="flex gap-2">
                    ...
                    >
                        ...
                        <button type="button"
                            ...
                            <span>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($selectedModels) > 0): ?>
                                    <span class="font-medium text-blue-600"><?php echo e(count($selectedModels)); ?></span> 
                        ...
                        <div x-show="open"
                            ...
                            <div class="max-h-60 overflow-y-auto">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $filteredModels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $model): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <label class="flex items-center px-3 py-2 hover:bg-gray-100 dark:hover:bg-zinc-700 cursor-pointer transition-colors">
                                        <input type="checkbox"
                                            wire:change="toggleModel('<?php echo e($model['id']); ?>')"
                                            <?php if(in_array($model['id'], $selectedModels)): echo 'checked'; endif; ?>
                                            class="w-4 h-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500 mr-3">
                                        <span class="text-sm text-gray-700 dark:text-gray-300"><?php echo e($model['name']); ?></span>
                                    </label>
                ...
                <div class="space-y-2">
                    <div class="flex items-center justify-between">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($selectedModels) && count($selectedPrdOrds) > 0): ?>
                            <div class="flex gap-2">
                        ...
                        <?php elseif(!empty($selectedModels)): ?>
                            <button wire:click="selectAllPrdOrds" class="text-xs text-blue-600 hover:text-blue-700 transition">Pilih Semua</button>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(empty($selectedModels)): ?>
                    ...
                    <?php elseif(empty($availablePrdOrds)): ?>
                    ...
                    <?php else: ?>
                        ...
                        >
                            ...
                            <button type="button"
                                ...
                                class="w-full px-4 py-2 text-left border rounded-lg bg-white dark:bg-zinc-800 dark:border-zinc-700 flex items-center justify-between hover:border-blue-400 transition">
                                <span>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($selectedPrdOrds) > 0): ?>
                                        <span class="font-medium text-blue-600"><?php echo e(count($selectedPrdOrds)); ?></span>
                            ...
                            <div x-show="open"
                                ...
                                <!-- LIST -->
                                <div class="max-h-60 overflow-y-auto">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $filteredPrdOrds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prdOrd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <label class="flex items-center px-3 py-2 hover:bg-gray-100 dark:hover:bg-zinc-700 cursor-pointer transition-colors">
                                            <input type="checkbox"
                                                wire:click="togglePrdOrd('<?php echo e($prdOrd['name']); ?>')"
                                                <?php if(in_array($prdOrd['name'], $selectedPrdOrds)): echo 'checked'; endif; ?>
                                                class="w-4 h-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500 mr-3">
                                            <span class="text-sm font-mono text-gray-700 dark:text-gray-300"><?php echo e($prdOrd['name']); ?></span>
                                        </label>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            ...
            <div class="flex justify-between items-center mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
                <button wire:click="filter" 
                        wire:loading.attr="disabled"
                        <?php if(empty($selectedModels) || empty($selectedPrdOrds)): ?> disabled <?php endif; ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showResults): ?>
                    <span class="px-3 py-1 bg-green-100 text-green-700 rounded-full text-sm font-medium">
                        <?php echo e(count($data)); ?> data ditemukan
                    </span>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </div>
                        ...
                        <tbody class="divide-y divide-zinc-100 dark:divide-zinc-800">
                            ...
                            <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/40 transition-colors duration-150">
                                <td class="px-4 py-3 text-sm text-zinc-500 dark:text-zinc-400 whitespace-nowrap text-center">
                                    <?php echo e($data->count() - $loop->index); ?>

                                </td>
                                <td class="px-4 py-3 whitespace-nowrap">
                                    <span class="font-medium text-zinc-800 dark:text-zinc-200"><?php echo e($item->masterWip->model ?? '-'); ?></span>
                                </td>
                                <td class="px-4 py-3 whitespace-nowrap">
                                    <span class="text-sm text-zinc-600 dark:text-zinc-400"><?php echo e($item->masterWip->part_number ?? '-'); ?></span>
                                </td>
                                <td class="px-4 py-3 whitespace-nowrap">
                                    <code class="text-xs font-mono bg-zinc-100 dark:bg-zinc-800 px-2 py-1 rounded-md text-zinc-700 dark:text-zinc-300">
                                        <?php echo e($item->masterWip->dj ?? '-'); ?>
                                ...
                                <td class="px-4 py-3 whitespace-nowrap">
                                    <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400">
                                        <?php echo e(number_format($item->ng_count)); ?>

                                    </span>
                                </td>
                                <td class="px-4 py-3 whitespace-nowrap">
                                    <span class="font-semibold text-zinc-800 dark:text-zinc-200"><?php echo e(number_format($item->acm)); ?></span>
                                </td>
                                <td class="px-4 py-3 whitespace-nowrap">
                                    <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold <?php echo e($item->balance > 0 ? 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400' : 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400'); ?>">
                                        <?php echo e(number_format($item->balance)); ?>

                                    </span>
                                </td>
                                <td class="px-4 py-3 whitespace-nowrap">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->status === 'Finished'): ?>
                                ...
                                <td class="px-4 py-3 whitespace-nowrap">
                                    <span class="text-sm text-zinc-500 dark:text-zinc-400"><?php echo e($item->remarks ?? '-'); ?></span>
                                </td>
                                <td class="px-4 py-3 whitespace-nowrap">
                                    <span class="text-sm text-zinc-500 dark:text-zinc-400"><?php echo e($item->created_at?->format('d/m/Y H:i:s') ?? '-'); ?></span>
                                </td>
                                <td class="px-4 py-3 whitespace-nowrap">
                                    <div class="flex items-center gap-2">
                                        <div class="w-6 h-6 rounded-full bg-gradient-to-r from-blue-500 to-blue-600 flex items-center justify-center shadow-sm">
                                            <span class="text-xs font-bold text-white">
                                                <?php echo e(substr($item->creator?->name ?? 'U', 0, 1)); ?>

                                            </span>
                                        </div>
                                        <span class="text-sm font-medium text-zinc-700 dark:text-zinc-300"><?php echo e($item->creator?->name ?? '-'); ?></span>
                                    </div>
                                </td>
                            </tr>
...
</div><?php /**PATH /www/wwwroot/testings.siix-ems.co.id/siix-portal/resources/views/livewire/prod/wip/history-wip-transaction.blade.php ENDPATH**/ ?>