<?php
if (!function_exists('_3059005211c9a4d7f51edb043c7f69a6')):
function _3059005211c9a4d7f51edb043c7f69a6($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
} endif; ?><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/stubs/resources/views/flux/icon/cog-6-tooth.blade.php ENDPATH**/ ?>