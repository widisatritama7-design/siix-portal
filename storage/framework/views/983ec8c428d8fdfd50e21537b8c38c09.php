...
<?php # [BlazeFolded]:{flux::link}:{/www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/src/../stubs/resources/views/flux/link.blade.php}:{1774988736} ?>
...
<?php _f9ce25dced5c86c906351e8ca96b9cbb($__blaze, ['name' => 'name','label' => __('Name'),'value' => old('name'),'type' => 'text','required' => true,'autofocus' => true,'autocomplete' => 'name','placeholder' => __('Full name')], [], ['label', 'value', 'required', 'autofocus', 'placeholder'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php _f9ce25dced5c86c906351e8ca96b9cbb($__blaze, ['name' => 'email','label' => __('Email address'),'value' => old('email'),'type' => 'email','required' => true,'autocomplete' => 'email','placeholder' => 'email@example.com'], [], ['label', 'value', 'required'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php _f9ce25dced5c86c906351e8ca96b9cbb($__blaze, ['name' => 'password','label' => __('Password'),'type' => 'password','required' => true,'autocomplete' => 'new-password','placeholder' => __('Password'),'viewable' => true], [], ['label', 'required', 'placeholder', 'viewable'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php _f9ce25dced5c86c906351e8ca96b9cbb($__blaze, ['name' => 'password_confirmation','label' => __('Confirm password'),'type' => 'password','required' => true,'autocomplete' => 'new-password','placeholder' => __('Confirm password'),'viewable' => true], [], ['label', 'required', 'placeholder', 'viewable'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php endif; ?>
<?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/resources/views/livewire/auth/register.blade.php ENDPATH**/ ?>