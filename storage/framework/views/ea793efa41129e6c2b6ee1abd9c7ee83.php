<?php # [BlazeFolded]:{flux::separator}:{D:\laragon\www\siix-portal\vendor\livewire\flux\src/../stubs/resources/views/flux/separator.blade.php}:{1776934808} ?>
...
<?php # [BlazeFolded]:{flux::navbar}:{D:\laragon\www\siix-portal\vendor\livewire\flux\src/../stubs/resources/views/flux/navbar/index.blade.php}:{1776934808} ?>
<?php # [BlazeFolded]:{flux::header}:{D:\laragon\www\siix-portal\vendor\livewire\flux\src/../stubs/resources/views/flux/header.blade.php}:{1776934808} ?>
<!DOCTYPE html>
    ...
    <div x-data="sidebarPersistence()" x-init="init()" x-cloak class="flex min-h-screen">
        ...
        <aside x-ref="sidebar"
            ...
            <nav class="p-3 h-[calc(100%-4rem)] overflow-y-auto sidebar-scroll" style="overflow-y: auto !important; max-height: calc(100vh - 4rem);">
                ...
                <div class="mb-2">
                    ...
                    <div x-show="((sidebarOpen || isMobile) || (isHovering && !sidebarPinned)) && groups.maintenance.open" 
                        ...
                        <div class="space-y-1 ml-[30px]">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view locker')): ?>
                            <div class="relative w-full">
                                ...
                                <div x-show="((sidebarOpen || isMobile) || (isHovering && !sidebarPinned)) && groups.lockerMonitoring.open" 
                                    ...
                                    <div class="space-y-1 ml-[24px]">
                                        ...
                                        <!-- Locker Management -->
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view locker')): ?>
                                        <a href="<?php echo e(route('esd.locker-management')); ?>" wire:navigate
                                        class="flex items-center gap-2 px-3 py-2 text-sm rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-600 dark:text-zinc-400 transition-colors <?php echo e(request()->routeIs('esd.locker-management') ? 'menu-active' : ''); ?>">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4">
                                                <path fill-rule="evenodd" d="M12 1.5a5.25 5.25 0 0 0-5.25 5.25v3a3 3 0 0 0-3 3v6.75a3 3 0 0 0 3 3h10.5a3 3 0 0 0 3-3v-6.75a3 3 0 0 0-3-3v-3c0-2.9-2.35-5.25-5.25-5.25Zm3.75 8.25v-3a3.75 3.75 0 1 0-7.5 0v3h7.5Z" clip-rule="evenodd" />
                                            </svg>
                                        ...
                                        <!-- Uniform Management -->
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view esd uniform')): ?>
                                        <a href="<?php echo e(route('esd.uniform-recipients')); ?>" wire:navigate
                                        class="flex items-center gap-2 px-3 py-2 text-sm rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-600 dark:text-zinc-400 transition-colors <?php echo e(request()->routeIs('esd.uniform-recipients') ? 'menu-active' : ''); ?>">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4">
                ...
                <div class="mb-2">
                    ...
                    <div x-show="((sidebarOpen || isMobile) || (isHovering && !sidebarPinned)) && groups.production.open" 
                        ...
                        <div class="space-y-1 ml-[30px]">
                            ...
                            <!-- FCT Monitoring as SUB GROUP -->
                            <div class="relative w-full">
                                <button @click="toggleGroup('fctMonitoring')" 
                                        class="w-full flex items-center justify-between px-3 py-2 rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors">
                                    <div class="flex items-center gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4">
                                        ...
                                        <span x-show="(sidebarOpen || isMobile) || (isHovering && !sidebarPinned)" 
                                            class="text-sm font-medium text-zinc-700 dark:text-zinc-300 whitespace-nowrap">FCT Monitoring</span>
                                    </div>
                                    <svg x-show="(sidebarOpen || isMobile) || (isHovering && !sidebarPinned)" 
                                        class="w-4 h-4 transition-transform duration-200 text-zinc-500 flex-shrink-0"
                                        :class="{'rotate-180': groups.fctMonitoring.open}"
                                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                                    </svg>
                                </button>
                                
                                <!-- Sub-group items for FCT Monitoring -->
                                <div x-show="((sidebarOpen || isMobile) || (isHovering && !sidebarPinned)) && groups.fctMonitoring.open" 
                                    x-collapse 
                                    class="mt-1 relative">
                                    <!-- Sub garis vertikal untuk FCT items -->
                                    <div class="absolute top-0 bottom-0 w-px bg-zinc-200 dark:bg-zinc-700 left-[20px]"></div>
                                    
                                    <div class="space-y-1 ml-[24px]">
                                        <!-- FCT -->
                                        <a href="<?php echo e(route('pcb-scan.fct')); ?>" wire:navigate
                                        class="flex items-center gap-2 px-3 py-2 text-sm rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-600 dark:text-zinc-400 transition-colors <?php echo e(request()->routeIs('pcb-scan.fct') ? 'menu-active' : ''); ?>">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4">
                                                <path d="M16.5 7.5h-9v9h9v-9Z" />
                                                <path fill-rule="evenodd" d="M8.25 2.25A.75.75 0 0 1 9 3v.75h2.25V3a.75.75 0 0 1 1.5 0v.75H15V3a.75.75 0 0 1 1.5 0v.75h.75a3 3 0 0 1 3 3v.75H21A.75.75 0 0 1 21 9h-.75v2.25H21a.75.75 0 0 1 0 1.5h-.75V15H21a.75.75 0 0 1 0 1.5h-.75v.75a3 3 0 0 1-3 3h-.75V21a.75.75 0 0 1-1.5 0v-.75h-2.25V21a.75.75 0 0 1-1.5 0v-.75H9V21a.75.75 0 0 1-1.5 0v-.75h-.75a3 3 0 0 1-3-3v-.75H3A.75.75 0 0 1 3 15h.75v-2.25H3a.75.75 0 0 1 0-1.5h.75V9H3a.75.75 0 0 1 0-1.5h.75v-.75a3 3 0 0 1 3-3h.75V3a.75.75 0 0 1 .75-.75ZM6 6.75A.75.75 0 0 1 6.75 6h10.5a.75.75 0 0 1 .75.75v10.5a.75.75 0 0 1-.75.75H6.75a.75.75 0 0 1-.75-.75V6.75Z" clip-rule="evenodd" />
                                            </svg>
                                            <span class="truncate">FCT</span>
                                        </a>
                                        
                                        <!-- LED Test -->
                                        <a href="<?php echo e(route('pcb-scan.led-test')); ?>" wire:navigate
                                        class="flex items-center gap-2 px-3 py-2 text-sm rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-600 dark:text-zinc-400 transition-colors <?php echo e(request()->routeIs('pcb-scan.led-test') ? 'menu-active' : ''); ?>">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4">
                                            ...
                                            <span class="truncate">LED Test</span>
                                        </a>
                                        
                                        <!-- Visual Inspection -->
                                        <a href="<?php echo e(route('pcb-scan.visual-inspection')); ?>" wire:navigate
                                        class="flex items-center gap-2 px-3 py-2 text-sm rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-600 dark:text-zinc-400 transition-colors <?php echo e(request()->routeIs('pcb-scan.visual-inspection') ? 'menu-active' : ''); ?>">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4">
                                                <path d="M12 15a3 3 0 100-6 3 3 0 000 6z" />
                                                <path fill-rule="evenodd" d="M1.323 11.447C2.811 6.976 7.028 3.75 12.001 3.75c4.97 0 9.185 3.223 10.675 7.69.12.362.12.752 0 1.113-1.49 4.467-5.705 7.69-10.675 7.69-4.973 0-9.19-3.223-10.678-7.69a2.25 2.25 0 010-1.113zM17.25 12a5.25 5.25 0 11-10.5 0 5.25 5.25 0 0110.5 0z" clip-rule="evenodd" />
                                            </svg>
                                            <span class="truncate">Visual Inspection</span>
                                        </a>
                                        
                                        <!-- Leader -->
                                        <a href="<?php echo e(route('pcb-scan.leader.index')); ?>" wire:navigate
                                        class="flex items-center gap-2 px-3 py-2 text-sm rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-600 dark:text-zinc-400 transition-colors <?php echo e(request()->routeIs('pcb-scan.leader.index') ? 'menu-active' : ''); ?>">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4">
                                                <path fill-rule="evenodd" d="M12.516 2.17a.75.75 0 00-1.032 0 11.209 11.209 0 01-7.877 3.08.75.75 0 00-.722.515A12.74 12.74 0 002.25 9.75c0 5.942 4.064 10.933 9.563 12.348a.749.749 0 00.374 0c5.499-1.415 9.563-6.406 9.563-12.348 0-1.39-.223-2.73-.635-3.985a.75.75 0 00-.722-.516 11.209 11.209 0 01-7.877-3.08zM12 9a.75.75 0 01.75.75v2.25h2.25a.75.75 0 010 1.5h-2.25v2.25a.75.75 0 01-1.5 0v-2.25H9a.75.75 0 010-1.5h2.25V9.75A.75.75 0 0112 9z" clip-rule="evenodd" />
                                            </svg>
                                            <span class="truncate">Leader</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
                ...
                <!-- Group: HR -->
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['view employee', 'view comelate employee', 'view violation employee', 'view employee call', 'view uniform request','view uniform request one user', 'view absence report'])): ?>
                <div class="mb-2">
                    <div class="relative w-full">
                    ...
                    <div x-show="((sidebarOpen || isMobile) || (isHovering && !sidebarPinned)) && groups.hr.open" 
                        ...
                        <div class="space-y-1 ml-[30px]">
                            ...
                            <!-- ========== SUB GROUP: FORM ========== -->
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['view comelate employee', 'view violation employee', 'view employee call'])): ?>
                            <div class="relative w-full">
                            ...
                            <!-- Uniform Group -->
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['view uniform request', 'view uniform request one user'])): ?>
                            <div class="relative w-full">
                            ...
                            <div class="relative w-full">
                                <button @click="toggleGroup('absenceMonitoring')" 
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span x-show="(sidebarOpen || isMobile) || (isHovering && !sidebarPinned)" 
                                            class="text-sm font-medium text-zinc-700 dark:text-zinc-300 whitespace-nowrap">Attendance</span>
                                    </div>
                                    <svg x-show="(sidebarOpen || isMobile) || (isHovering && !sidebarPinned)" 
                                        class="w-4 h-4 transition-transform duration-200 text-zinc-500 flex-shrink-0"
                ...
                <div class="mb-2">
                    ...
                    <div x-show="((sidebarOpen || isMobile) || (isHovering && !sidebarPinned)) && groups.qaqc.open" 
                        ...
                        <div class="space-y-1 ml-[30px]">
                            ...
                            <!-- ========== SUB GROUP: MASTER ========== -->
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['view qaqc master'])): ?>
                            <div class="relative w-full">
                                ...
                                <div x-show="((sidebarOpen || isMobile) || (isHovering && !sidebarPinned)) && groups.qaqcMaster.open" 
                                    ...
                                    <div class="space-y-1 ml-[24px]">
                                        <!-- Customer -->
                                        <a href="<?php echo e(route('qaqc.master.customer')); ?>" wire:navigate
                                        class="flex items-center gap-2 px-3 py-2 text-sm rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-600 dark:text-zinc-400 transition-colors <?php echo e(request()->routeIs('qaqc.master.customer') ? 'menu-active' : ''); ?>">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4">
                                                <path d="M4.5 6.375a4.125 4.125 0 1 1 8.25 0 4.125 4.125 0 0 1-8.25 0ZM14.25 8.625a3.375 3.375 0 1 1 6.75 0 3.375 3.375 0 0 1-6.75 0ZM1.5 19.125a7.125 7.125 0 0 1 14.25 0v.003l-.001.119a.75.75 0 0 1-.363.63 13.067 13.067 0 0 1-6.761 1.873c-2.472 0-4.786-.684-6.76-1.873a.75.75 0 0 1-.364-.63l-.001-.122ZM17.25 19.128l-.001.144a2.25 2.25 0 0 1-.233.96 10.088 10.088 0 0 0 5.06-1.01.75.75 0 0 0 .42-.643 4.875 4.875 0 0 0-6.957-4.611 8.586 8.586 0 0 1 1.71 5.157v.003Z" />
                                            </svg>
                                        ...
                                        <!-- Model -->
                                        <a href="<?php echo e(route('qaqc.master.model')); ?>" wire:navigate
                                        class="flex items-center gap-2 px-3 py-2 text-sm rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-600 dark:text-zinc-400 transition-colors <?php echo e(request()->routeIs('qaqc.master.model') ? 'menu-active' : ''); ?>">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4">
                                                <path d="M3.375 3C2.339 3 1.5 3.84 1.5 4.875v.75c0 1.036.84 1.875 1.875 1.875h17.25c1.035 0 1.875-.84 1.875-1.875v-.75C22.5 3.839 21.66 3 20.625 3H3.375Z" />
                                                <path fill-rule="evenodd" d="m3.087 9 .54 9.176A3 3 0 0 0 6.62 21h10.757a3 3 0 0 0 2.995-2.824L20.913 9H3.087Zm6.163 3.75A.75.75 0 0 1 10 12h4a.75.75 0 0 1 0 1.5h-4a.75.75 0 0 1-.75-.75Z" clip-rule="evenodd" />
                                            </svg>
                                        ...
                                        <!-- Deffect Item -->
                                        <a href="<?php echo e(route('qaqc.master.deffect')); ?>" wire:navigate
                                        class="flex items-center gap-2 px-3 py-2 text-sm rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-600 dark:text-zinc-400 transition-colors <?php echo e(request()->routeIs('qaqc.master.deffect') ? 'menu-active' : ''); ?>">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4">
                                                <path fill-rule="evenodd" d="M9.401 3.003c1.155-2 4.043-2 5.197 0l7.355 12.748c1.154 2-.29 4.5-2.599 4.5H4.645c-2.309 0-3.752-2.5-2.598-4.5L9.4 3.003ZM12 8.25a.75.75 0 0 1 .75.75v3.75a.75.75 0 0 1-1.5 0V9a.75.75 0 0 1 .75-.75Zm0 8.25a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Z" clip-rule="evenodd" />
                                            </svg>
                                        ...
                                        <!-- Deffect Item -->
                                        <a href="<?php echo e(route('qaqc.master.question')); ?>" wire:navigate
                                        class="flex items-center gap-2 px-3 py-2 text-sm rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-600 dark:text-zinc-400 transition-colors <?php echo e(request()->routeIs('qaqc.master.question') ? 'menu-active' : ''); ?>">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4">
                            ...
                            <!-- ========== SUB GROUP: FORM ========== -->
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['view ncp', 'view blind test'])): ?>
                            <div class="relative w-full">
                                ...
                                <div x-show="((sidebarOpen || isMobile) || (isHovering && !sidebarPinned)) && groups.qaqcForm.open" 
                                    ...
                                    <div class="space-y-1 ml-[24px]">
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view blind test')): ?>
                                        <!-- Blind Test Management -->
                                        <a href="<?php echo e(route('qaqc.blind-test')); ?>" wire:navigate
                                        class="flex items-center gap-2 px-3 py-2 text-sm rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-600 dark:text-zinc-400 transition-colors <?php echo e(request()->routeIs('qaqc.blind-test') ? 'menu-active' : ''); ?>">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4">
                            ...
                            <!-- ========== SUB GROUP: REPORT ========== -->
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['view ncp all', 'view blind test'])): ?>
                            <div class="relative w-full">
                                ...
                                <div x-show="((sidebarOpen || isMobile) || (isHovering && !sidebarPinned)) && groups.qaqcReport.open" 
                                    ...
                                    <div class="space-y-1 ml-[24px]">
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view blind test')): ?>
                                        <a href="<?php echo e(route('qaqc.blind-test.report')); ?>" wire:navigate
                                        class="flex items-center gap-2 px-3 py-2 text-sm rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-600 dark:text-zinc-400 transition-colors <?php echo e(request()->routeIs('qaqc.blind-test.report') ? 'menu-active' : ''); ?>">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-sheet-icon lucide-sheet"><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><line x1="3" x2="21" y1="9" y2="9"/><line x1="3" x2="21" y1="15" y2="15"/><line x1="9" x2="9" y1="9" y2="21"/><line x1="15" x2="15" y1="9" y2="21"/></svg>
                                        ...
                                        <a href="<?php echo e(route('qaqc.blind-test.deffect-report')); ?>" wire:navigate
                                        class="flex items-center gap-2 px-3 py-2 text-sm rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-600 dark:text-zinc-400 transition-colors <?php echo e(request()->routeIs('qaqc.blind-test.deffect-report') ? 'menu-active' : ''); ?>">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4">
                                                <path fill-rule="evenodd" d="M9.401 3.003c1.155-2 4.043-2 5.197 0l7.355 12.748c1.154 2-.29 4.5-2.599 4.5H4.645c-2.309 0-3.752-2.5-2.598-4.5L9.4 3.003ZM12 8.25a.75.75 0 0 1 .75.75v3.75a.75.75 0 0 1-1.5 0V9a.75.75 0 0 1 .75-.75Zm0 8.25a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Z" clip-rule="evenodd" />
                                            </svg>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1187823693-0', $__key);
...
</html><?php /**PATH D:\laragon\www\siix-portal\resources\views/layouts/app/sidebar.blade.php ENDPATH**/ ?>