<?php # [BlazeFolded]:{flux::menu.separator}:{/www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/src/../stubs/resources/views/flux/menu/separator.blade.php}:{1774988736} ?>
<?php # [BlazeFolded]:{flux::menu.heading}:{/www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/src/../stubs/resources/views/flux/menu/heading.blade.php}:{1774988736} ?>
<?php # [BlazeFolded]:{flux::menu.separator}:{/www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/src/../stubs/resources/views/flux/menu/separator.blade.php}:{1774988736} ?>
<?php
if (!function_exists('_1cd7a4866eeb9225b289cff97ed9a33a')):
function _1cd7a4866eeb9225b289cff97ed9a33a($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
} endif; ?><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/stubs/resources/views/flux/menu/group.blade.php ENDPATH**/ ?>