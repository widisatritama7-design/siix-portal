<?php
if (!function_exists('_31c2ca2df5903ae1f72c7f26ed543039')):
function _31c2ca2df5903ae1f72c7f26ed543039($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php _4b299ad09af08d7d3e7b543d4657af88($__blaze, ['icon' => $icon,'variant' => $iconVariant,'class' => $iconClasses,'dataFluxBadgeIcon' => true], [], ['icon', 'variant', 'class', 'dataFluxBadgeIcon'], ['dataFluxBadgeIcon' => 'data-flux-badge-icon'], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php $__blaze->popData(); ?><?php $blaze_memoized_html = ob_get_clean(); ?><?php if ($blaze_memoized_key !== null) { \Livewire\Blaze\Memoizer\Memo::put($blaze_memoized_key, $blaze_memoized_html); } ?><?php echo $blaze_memoized_html; ?><?php endif; ?>
    ...
    <?php endif; ?>
<?php $__slots9ddcf173402241844ac21ef9c6ff1565['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slots9ddcf173402241844ac21ef9c6ff1565); ?>
<?php _9ddcf173402241844ac21ef9c6ff1565($__blaze, $__attrs9ddcf173402241844ac21ef9c6ff1565, $__slots9ddcf173402241844ac21ef9c6ff1565, ['attributes', 'dataFluxBadge'], ['dataFluxBadge' => 'data-flux-badge'], $__this ?? (isset($this) ? $this : null)); ?>
