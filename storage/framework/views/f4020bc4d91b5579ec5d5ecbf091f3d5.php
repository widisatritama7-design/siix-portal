...
<?php echo ltrim(ob_get_clean()); ?>
        ...
        <div class="bg-blue-600 rounded-xl shadow-md p-4 stat-card">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-white"><?php echo e($totalStats['total']); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-green-600 rounded-xl shadow-md p-4 stat-card">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-white"><?php echo e($totalStats['available']); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-red-600 rounded-xl shadow-md p-4 stat-card">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-white"><?php echo e($totalStats['used']); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-orange-600 rounded-xl shadow-md p-4 stat-card">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-white"><?php echo e($totalStats['totalWip']); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <?php ob_start(); ?><div class="[:where(&amp;)]:bg-white dark:[:where(&amp;)]:bg-white/10 border border-zinc-200 dark:border-white/10 [:where(&amp;)]:p-6 [:where(&amp;)]:rounded-xl p-0 overflow-hidden" x-data="{ open: true }" data-flux-card>
    <?php ob_start(); ?>
        <!-- Header - Bisa diklik -->
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-3">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="text-xs text-zinc-500">
                            Total slot: <?php echo e($newRackSheetCount * $newRackColumnCount); ?> column
                        </div>
                ...
                <div class="space-y-3 border-l border-zinc-200 dark:border-zinc-700 pl-6">
                    ...
                    <div class="space-y-4">
                            ...
                            <select wire:model.live="selectedRackNo" 
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $availableRacksForDelete; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rack): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <option value="<?php echo e($rack->no_rack); ?>">
                                        <?php echo e($rack->no_rack); ?> (<?php echo e($rack->available_slots); ?> slot available)
                                    </option>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            </select>
                        </div>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($selectedRackNo)): ?>
                            <div>
                                <label class="text-xs font-medium text-zinc-700 dark:text-zinc-300 mb-1 block">
                                ...
                                <select wire:model.live="selectedSheetForDelete" 
                                    ...
                                    ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $availableSheets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sheetName => $slots): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <option value="<?php echo e($sheetName); ?>">
                                            <?php echo e($sheetName); ?> (<?php echo e($slots->count()); ?> column available)
                                        </option>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                </select>
                            </div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($selectedRackNo) && !empty($selectedSheetForDelete)): ?>
                            <div>
                                ...
                                <div class="grid grid-cols-2 sm:grid-cols-4 gap-2 p-3 bg-zinc-50 dark:bg-zinc-800/50 rounded-lg border">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $filteredSlots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                ...
                                <div class="mt-2 text-xs text-zinc-500 text-right">
                                    <?php echo e(count($selectedColumnsForDelete)); ?> column terpilih
                                </div>
                            </div>

                            <button wire:click="deleteColumns" type="button"
                                    wire:confirm="Yakin ingin menghapus <?php echo e(count($selectedColumnsForDelete)); ?> column?"
                                    <?php if(empty($selectedColumnsForDelete)): echo 'disabled'; endif; ?>
...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <!-- Rack Container -->
    <div class="space-y-4">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $racks->groupBy('no_rack'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rackName => $rackGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        <div class="bg-white dark:bg-zinc-900 rounded-xl border shadow-sm overflow-hidden">
            <div class="px-6 py-3 bg-zinc-100 dark:bg-zinc-800 border-b text-center">
                <h3 class="text-base font-semibold"><?php echo e($rackName); ?></h3>
                <span class="text-xs text-zinc-500"><?php echo e($rackGroup->count()); ?> slot</span>
            </div>
            ...
            <div class="p-4">
                ...
                <div class="space-y-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $groupedBySheet; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sheetName => $columns): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div class="border rounded-lg p-3">
                        <div class="text-sm font-medium mb-2 pb-1 border-b"><?php echo e($sheetName); ?></div>
                        
                        <div class="flex flex-row gap-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $columns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rack): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div class="flex-1 min-w-0">
                                <button wire:click="showDetail(<?php echo e($rack->id); ?>)" 
                                    ...
                                    <div class="text-center">
                                        <div class="text-xs font-semibold"><?php echo e($rack->column_rack); ?></div>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rack->isUsed() && $rack->detailWip): ?>
                                            <div class="text-xs mt-1 truncate"><?php echo e($rack->detailWip->masterWip->model ?? '-'); ?></div>
                                            <div class="text-[10px]"><?php echo e(number_format($rack->detailWip->qty)); ?> pcs</div>
                                        <?php else: ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($i = $columns->count(); $i < 4; $i++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
    ...
    <!-- Modal Detail -->
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showDetailModal && $selectedRack): ?>
    <div class="fixed inset-0 z-50 overflow-y-auto" x-data="{ open: true }" x-show="open" x-cloak>
        <div class="flex items-center justify-center min-h-screen px-4">
            ...
            <div class="relative bg-white dark:bg-zinc-900 rounded-xl shadow-xl w-full max-w-lg">
                <div class="px-6 py-4 bg-gradient-to-r from-orange-600 to-orange-700 rounded-t-xl flex justify-between items-center">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-orange-100"><?php echo e($selectedRack->display_name ?? $selectedRack->no_rack . ' - ' . $selectedRack->sheet_rack . ' - ' . $selectedRack->column_rack); ?></p>
                        </div>
                    </div>
                ...
                <div class="p-6">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedRack->detailWip): ?>
                        <div class="space-y-4">
                            <div class="grid grid-cols-2 gap-3">
                                <div class="p-3 bg-zinc-50 dark:bg-zinc-800 rounded-lg">
                                    ...
                                    <p class="font-medium text-zinc-900 dark:text-white">
                                        <?php echo e($selectedRack->detailWip->masterWip->model ?? '-'); ?>
                                ...
                                <div class="p-3 bg-zinc-50 dark:bg-zinc-800 rounded-lg">
                                    ...
                                    <p class="font-medium text-zinc-900 dark:text-white">
                                        <?php echo e($selectedRack->detailWip->masterWip->part_number ?? '-'); ?>
                                ...
                                <div class="p-3 bg-zinc-50 dark:bg-zinc-800 rounded-lg">
                                    ...
                                    <p class="font-medium text-zinc-900 dark:text-white">
                                        <?php echo e(number_format($selectedRack->detailWip->qty)); ?>
                                ...
                                <div class="p-3 bg-zinc-50 dark:bg-zinc-800 rounded-lg">
                                    ...
                                    <p class="font-medium text-zinc-900 dark:text-white">
                                        <?php echo e($selectedRack->detailWip->creator->name ?? '-'); ?>

                                    </p>
                                    <p class="text-xs text-zinc-400 mt-1">
                                        <?php echo e($selectedRack->detailWip->created_at ? $selectedRack->detailWip->created_at->format('d/m/Y H:i:s') : '-'); ?>
                            ...
                            <div class="flex justify-center gap-3 pt-2">
                                <button wire:click="releaseRack(<?php echo e($selectedRack->id); ?>)"
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedRack->detailWip && $selectedRack->detailWip->masterWip): ?>
                                    <a href="<?php echo e(route('prod.wip.show', $selectedRack->detailWip->masterWip->id)); ?>"
                                        wire:navigate
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div><?php /**PATH /www/wwwroot/testings.siix-ems.co.id/siix-portal/resources/views/livewire/prod/wip/master-rack-lose-pack.blade.php ENDPATH**/ ?>