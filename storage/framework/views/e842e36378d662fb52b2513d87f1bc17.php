    ...
    <table class="checklist-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="item-standard">Standard: No Dust and clean</td>
                <td class="item-value <?php echo e(getValueClass($dailyFuji->lamp_alarm_change_model, 'checked')); ?>">
                    <?php echo e(displayValue($dailyFuji->lamp_alarm_change_model)); ?>

                </td>
                <td class="item-status">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dailyFuji->lamp_alarm_change_model === 'checked'): ?>
                        <span class="status-badge status-checked">OK</span>
                    <?php elseif($dailyFuji->lamp_alarm_change_model === 'na'): ?>
                        <span class="status-badge status-na">N/A</span>
                    <?php else: ?>
                        <span style="color: #dc3545;">NOT CHECKED</span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <tr>
                ...
                <td class="item-value <?php echo e(getValueClass($dailyFuji->flashlight, 'on')); ?>">
                    <?php echo e(displayValue($dailyFuji->flashlight)); ?>

                </td>
                <td class="item-status">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dailyFuji->flashlight === 'on'): ?>
                        <span class="status-badge status-checked">OK</span>
                    <?php elseif($dailyFuji->flashlight === 'na'): ?>
                        <span class="status-badge status-na">N/A</span>
