...
<body>
    ...
    <div class="info-grid">
        <div class="info-item">
            ...
            <div class="info-value"><?php echo e($dailyFuji->masterLine->line_number ?? 'N/A'); ?></div>
        </div>

        <div class="info-item">
            <div class="info-label">GROUP</div>
            <div class="info-value"><?php echo e($dailyFuji->group); ?></div>
        </div>
        ...
        <div class="info-item">
            ...
            <div class="info-value">
                <span class="status-badge badge-success">
                    <?php echo e($dailyFuji->run_time ? $dailyFuji->run_time->format('H:i') : '-'); ?>
        ...
        <div class="info-item">
            ...
            <div class="info-value">
                <span class="status-badge badge-danger">
                    <?php echo e($dailyFuji->stop_time ? $dailyFuji->stop_time->format('H:i') : '-'); ?>
        ...
        <div class="info-item">
            ...
            <div class="info-value"><?php echo e($dailyFuji->approvedBy->name ?? '-'); ?></div>
        </div>

        <div class="info-item">
            <div class="info-label">CHECK BY</div>
            <div class="info-value"><?php echo e($dailyFuji->updater->name ?? $dailyFuji->creator->name ?? '-'); ?></div>
        </div>

        <div class="info-item">
            <div class="info-label">START INSPECTION</div>
            <div class="info-value"><?php echo e($dailyFuji->created_at->format('d/m/Y H:i')); ?></div>
        </div>

        <div class="info-item">
            <div class="info-label">FINISH INSPECTION</div>
            <div class="info-value"><?php echo e($dailyFuji->updated_at->format('d/m/Y H:i')); ?></div>
        </div>
    </div>
    ...
    <table class="checklist-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="item-value"><?php echo e(displayValue($dailyFuji->body_cover)); ?></td>
                <td class="item-status"><?php echo getStatusBadge($dailyFuji->body_cover); ?></td>
            </tr>
            <tr>
                <td class="item-name">Lamp Alarm & Change Model</td>
                <td class="item-standard">Standard: No Dust and clean</td>
                <td class="item-value"><?php echo e(displayValue($dailyFuji->lamp_alarm_change_model)); ?></td>
                <td class="item-status"><?php echo getStatusBadge($dailyFuji->lamp_alarm_change_model); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-value"><?php echo e(displayValue($dailyFuji->cylinder)); ?></td>
                <td class="item-status"><?php echo getStatusBadge($dailyFuji->cylinder); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-standard">Standard: No Dust and clean</td>
                <td class="item-value"><?php echo e(displayValue($dailyFuji->rail_and_magazine_pcb)); ?></td>
                <td class="item-status"><?php echo getStatusBadge($dailyFuji->rail_and_magazine_pcb); ?></td>
            </tr>
            <tr>
                <td class="item-name">Cover Magazine (1.b)</td>
                <td class="item-standard">Standard: No Dust and clean</td>
                <td class="item-value"><?php echo e(displayValue($dailyFuji->cover_magazine)); ?></td>
                <td class="item-status"><?php echo getStatusBadge($dailyFuji->cover_magazine); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-value"><?php echo e(displayValue($dailyFuji->brush)); ?></td>
                <td class="item-status"><?php echo getStatusBadge($dailyFuji->brush); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-status"><?php echo getNumericStatusBadge($dailyFuji->air_presure, 0.45, 0.54); ?></td>
            </tr>
            <tr>
                ...
                <td class="item-status"><?php echo getNumericStatusBadge($dailyFuji->vacume_presure_unitech, 0.45, 0.54); ?></td>
            </tr>
            <tr>
                ...
                <td class="item-status"><?php echo getNumericStatusBadge($dailyFuji->vacume_presure_nix, 0.60, 0.70); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-standard">Standard: Rotation</td>
                <td class="item-value"><?php echo e(displayValue($dailyFuji->vacume_brush)); ?></td>
                <td class="item-status"><?php echo getStatusBadge($dailyFuji->vacume_brush); ?></td>
            </tr>
            <tr>
                <td class="item-name">Cleaning Roller (4)</td>
                <td class="item-standard">Standard: Smooth rotation & Clean</td>
                <td class="item-value"><?php echo e(displayValue($dailyFuji->cleaning_roller)); ?></td>
                <td class="item-status"><?php echo getStatusBadge($dailyFuji->cleaning_roller); ?></td>
            </tr>
            <tr>
                <td class="item-name">Ionizer (5)</td>
                <td class="item-standard">Standard: 5 Times to push cleaner</td>
                <td class="item-value"><?php echo e(displayValue($dailyFuji->ionizer)); ?></td>
                <td class="item-status"><?php echo getStatusBadge($dailyFuji->ionizer); ?></td>
            </tr>
            <tr>
                <td class="item-name">Air Pressure Ionizer (5.a)</td>
                <td class="item-standard">Standard: 0.05 Mpa - 0.10 Mpa</td>
                <td class="item-value <?php echo e(getValueClass($dailyFuji->ionizer_air_presure, '0.05-0.10')); ?>">
                    <?php echo e(displayValue($dailyFuji->ionizer_air_presure)); ?>

                </td>
                <td class="item-status"><?php echo getNumericStatusBadge($dailyFuji->ionizer_air_presure, 0.05, 0.10); ?></td>
            </tr>
            <tr>
                ...
                <td class="item-status"><?php echo getNumericStatusBadge($dailyFuji->conveyor_speed, null, 40); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-value"><?php echo e(displayValue($dailyFuji->ipa_solvent)); ?></td>
                <td class="item-status"><?php echo getStatusBadge($dailyFuji->ipa_solvent); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-status"><?php echo getNumericStatusBadge($dailyFuji->temperature_control_1, 23, 27); ?></td>
            </tr>
            <tr>
                ...
                <td class="item-status"><?php echo getNumericStatusBadge($dailyFuji->humidity_control_1, 35, 70); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-status"><?php echo getNumericStatusBadge($dailyFuji->clamp_presure, 0.20, 0.40); ?></td>
            </tr>
            <tr>
                ...
                <td class="item-status"><?php echo getNumericStatusBadge($dailyFuji->squeege_upper, 0.11, 0.13); ?></td>
            </tr>
            <tr>
                ...
                <td class="item-status"><?php echo getNumericStatusBadge($dailyFuji->cleaning_solvent, 0.19, 0.21); ?></td>
            </tr>
            <tr>
                ...
                <td class="item-status"><?php echo getNumericStatusBadge($dailyFuji->air_presure_meter, 0.50, 0.55); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-status"><?php echo getNumericStatusBadge($dailyFuji->air_presure_meter_parmi, 0.40, 0.50); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-value <?php echo e(getValueClass($dailyFuji->capability_index, '>1.33')); ?>">
                    <?php echo e(displayValue($dailyFuji->capability_index)); ?>

                </td>
                <td class="item-status">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dailyFuji->capability_index !== null && $dailyFuji->capability_index !== '' && $dailyFuji->capability_index !== 'na' && $dailyFuji->capability_index !== '-'): ?>
                        <?php $isOk = floatval($dailyFuji->capability_index) > 1.33; ?>
            ...
            <tr>
                ...
                <td class="item-status"><?php echo getNumericStatusBadge($dailyFuji->air_presure_supply, 0.49, 0.54); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-status"><?php echo getNumericStatusBadge($dailyFuji->vaccuum_pump_1, -100, -87); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-value"><?php echo e(displayValue($dailyFuji->box_1)); ?></td>
                <td class="item-status"><?php echo getStatusBadge($dailyFuji->box_1); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-value"><?php echo e(displayValue($dailyFuji->vaccuum_parameter_1)); ?></td>
                <td class="item-status"><?php echo getStatusBadge($dailyFuji->vaccuum_parameter_1); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-value"><?php echo e(displayValue($dailyFuji->expire_date_1)); ?></td>
                <td class="item-status"><?php echo getStatusBadge($dailyFuji->expire_date_1); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-status"><?php echo getNumericStatusBadge($dailyFuji->air_presure_supply_2, 0.49, 0.54); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-status"><?php echo getNumericStatusBadge($dailyFuji->vaccuum_pump_2, -100, -87); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-standard">Standard: No components</td>
                <td class="item-value"><?php echo e(displayValue($dailyFuji->box_2)); ?></td>
                <td class="item-status"><?php echo getStatusBadge($dailyFuji->box_2); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-standard">Standard: No Yellow initial (display)</td>
                <td class="item-value"><?php echo e(displayValue($dailyFuji->vaccuum_parameter_2)); ?></td>
                <td class="item-status"><?php echo getStatusBadge($dailyFuji->vaccuum_parameter_2); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-standard">Standard: No Expired</td>
                <td class="item-value"><?php echo e(displayValue($dailyFuji->expire_date_2)); ?></td>
                <td class="item-status"><?php echo getStatusBadge($dailyFuji->expire_date_2); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-value"><?php echo e(displayValue($dailyFuji->abandonment)); ?></td>
                <td class="item-status"><?php echo getStatusBadge($dailyFuji->abandonment); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-value"><?php echo e(displayValue($dailyFuji->fire_posibilty)); ?></td>
                <td class="item-status"><?php echo getStatusBadge($dailyFuji->fire_posibilty); ?></td>
            </tr>
            <tr>
                <td class="item-name">Flashlight (17.b)</td>
                <td class="item-standard">Standard: On</td>
                <td class="item-value"><?php echo e(displayValue($dailyFuji->flashlight)); ?></td>
                <td class="item-status">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dailyFuji->flashlight === 'on' || $dailyFuji->flashlight === 'na' || $dailyFuji->flashlight === '-'): ?>
                        <span class="status-badge status-ok">OK</span>
                    <?php elseif($dailyFuji->flashlight === 'off'): ?>
            ...
            <tr>
                ...
                <td class="item-value"><?php echo e(displayValue($dailyFuji->rail_and_transfer_unit)); ?></td>
                <td class="item-status"><?php echo getStatusBadge($dailyFuji->rail_and_transfer_unit); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-status"><?php echo getNumericStatusBadge($dailyFuji->n2_presure, 0.4, 0.5); ?></td>
            </tr>
            <tr>
                ...
                <td class="item-status"><?php echo getNumericStatusBadge($dailyFuji->oxygent_density_sek, 1200, 1800); ?></td>
            </tr>
            <tr>
                ...
                <td class="item-status"><?php echo getNumericStatusBadge($dailyFuji->oxygent_density_special, 500, 1000); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-standard">Standard: No Paper, No plastic</td>
                <td class="item-value"><?php echo e(displayValue($dailyFuji->fire_posibilty_2)); ?></td>
                <td class="item-status"><?php echo getStatusBadge($dailyFuji->fire_posibilty_2); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-status"><?php echo getNumericStatusBadge($dailyFuji->air_presure_2, 0.40, 0.50); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-standard">Standard: Smooth and center</td>
                <td class="item-value"><?php echo e(displayValue($dailyFuji->cylinder_2)); ?></td>
                <td class="item-status"><?php echo getStatusBadge($dailyFuji->cylinder_2); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-standard">Standard: No Dust and clean</td>
                <td class="item-value"><?php echo e(displayValue($dailyFuji->rail_and_magazine_pcb_2)); ?></td>
                <td class="item-status"><?php echo getStatusBadge($dailyFuji->rail_and_magazine_pcb_2); ?></td>
            </tr>
            <tr>
                <td class="item-name">Cover Magazine (21.b)</td>
                <td class="item-standard">Standard: No Dust and clean</td>
                <td class="item-value"><?php echo e(displayValue($dailyFuji->cover_magazine_2)); ?></td>
                <td class="item-status"><?php echo getStatusBadge($dailyFuji->cover_magazine_2); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-value"><?php echo e(displayValue($dailyFuji->angle_and_filter)); ?></td>
                <td class="item-status"><?php echo getStatusBadge($dailyFuji->angle_and_filter); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-value"><?php echo e(displayValue($dailyFuji->lamp_indicator)); ?></td>
                <td class="item-status"><?php echo getStatusBadge($dailyFuji->lamp_indicator); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-status"><?php echo getNumericStatusBadge($dailyFuji->temperature_chiller, 17, 23); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-status"><?php echo getNumericStatusBadge($dailyFuji->temperature_control_3, 290, 310); ?></td>
            </tr>
            <tr>
                ...
                <td class="item-value"><?php echo e(displayValue($dailyFuji->n2_air_presure_valve)); ?></td>
                <td class="item-status"><?php echo getStatusBadge($dailyFuji->n2_air_presure_valve); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-value"><?php echo e(displayValue($dailyFuji->fan_unit_1)); ?></td>
                <td class="item-status"><?php echo getStatusBadge($dailyFuji->fan_unit_1); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-standard">Standard: Clean</td>
                <td class="item-value"><?php echo e(displayValue($dailyFuji->fan_unit_2)); ?></td>
                <td class="item-status"><?php echo getStatusBadge($dailyFuji->fan_unit_2); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-status"><?php echo getNumericStatusBadge($dailyFuji->air_presure_3, 0.40, 0.50); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-status"><?php echo getNumericStatusBadge($dailyFuji->temperature_control_4, 23, 27); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-value"><?php echo e(displayValue($dailyFuji->water_reservoirs)); ?></td>
                <td class="item-status"><?php echo getStatusBadge($dailyFuji->water_reservoirs); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-standard">Standard: Clean</td>
                <td class="item-value"><?php echo e(displayValue($dailyFuji->filter)); ?></td>
                <td class="item-status"><?php echo getStatusBadge($dailyFuji->filter); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td class="item-standard">Standard: No dirt / no dust</td>
                <td class="item-value"><?php echo e(displayValue($dailyFuji->angle_and_filter_2)); ?></td>
                <td class="item-status"><?php echo getStatusBadge($dailyFuji->angle_and_filter_2); ?></td>
            </tr>
...
</html><?php /**PATH /www/wwwroot/testings.siix-ems.co.id/siix-portal/resources/views/livewire/mtc/daily/fuji/daily-fuji-print.blade.php ENDPATH**/ ?>