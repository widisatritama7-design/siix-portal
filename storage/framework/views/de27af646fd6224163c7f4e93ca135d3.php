...
<?php $__attrs6b0011e2f83d04930b97e5f6feda22dd = ['size' => 'xs','color' => e($isAlreadyAdded ? 'gray' : 'sky')]; ?>
<?php $__slots6b0011e2f83d04930b97e5f6feda22dd = []; ?>
<?php $__blaze->pushData($__attrs6b0011e2f83d04930b97e5f6feda22dd); ?>
<?php ob_start(); ?><?php echo e($employee['department']); ?><?php $__slots6b0011e2f83d04930b97e5f6feda22dd['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
                                ...
                                <table class="w-full text-sm" style="min-width: 650px;">
                                    ...
                                    <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                                        ...
                                        <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors">
                                            <td class="px-3 py-2 text-sm font-mono whitespace-nowrap"><?php echo e($uniform->item_code); ?></td>
...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <?php ob_start(); ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($current_uniforms) > 0): ?>
                                        ...
                                        <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors">
                                            <td class="px-2 py-1.5">
                                                <div class="flex flex-col">
                                                    <span class="text-xs font-medium text-blue-600 dark:text-blue-400"><?php echo e($uniform['item_code']); ?></span>
                                                    <span class="text-[10px] text-zinc-500 truncate max-w-[100px]"><?php echo e($uniform['description']); ?></span>
                                                    <span class="text-[10px] text-zinc-400"><?php echo e($uniform['size']); ?></span>
                                                </div>
                                            </td>
                                            <td class="px-2 py-1.5 text-center">
                                                <span class="text-xs font-semibold text-blue-600 dark:text-blue-400">x <?php echo e($uniform['qty']); ?></span>
                                            </td>
                                            <td class="px-2 py-1.5 text-center">
                                                <button type="button" 
                        ...
                        <div class="mt-2 pt-2 border-t border-zinc-200 dark:border-zinc-700">
                            <div class="flex justify-between text-xs">
                                ...
                                <span class="font-semibold text-zinc-700 dark:text-zinc-300"><?php echo e(count($current_uniforms)); ?></span>
                            </div>
                            <div class="flex justify-between text-xs">
                                <span class="text-zinc-500">Total Quantity:</span>
                                <span class="font-semibold text-zinc-700 dark:text-zinc-300"><?php echo e(array_sum(array_column($current_uniforms, 'qty'))); ?></span>
                            </div>
                        </div>
                    <?php else: ?>
                    ...
                    <div class="border-t pt-3 mt-3">
                        <button type="button" 
                            wire:click="addRow" 
                            class="w-full px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium text-sm <?php echo e(!$hasCartItems ? 'opacity-50 cursor-not-allowed' : ''); ?>"
                            ...
                            + Add Employee Request (<?php echo e(count($current_uniforms)); ?> uniform(s))
                        </button>
                    </div>
                <?php echo trim(ob_get_clean()); ?>
    ...
    <?php ob_start(); ?>
            ...
            <div class="overflow-x-auto" style="overflow-x: auto !important; white-space: nowrap !important;">
                <table class="w-full text-sm border" style="min-width: 1600px;">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $paginatedRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="border-t hover:bg-zinc-50 dark:hover:bg-zinc-800/50">
                            <td class="px-3 py-2 whitespace-nowrap">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($row['is_manual']) && $row['is_manual']): ?>
                                    <div class="flex items-center gap-1">
                                        ...
                                        <span><?php echo e($row['manual_nik'] ?? $row['employee_nik']); ?></span>
                                    </div>
                                <?php else: ?>
                                    <?php echo e($row['employee_nik']); ?>

                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </td>
                            <td class="px-3 py-2 whitespace-nowrap">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($row['is_manual']) && $row['is_manual']): ?>
                                    <?php echo e($row['manual_name'] ?? $row['employee_name']); ?>
                            ...
                            <td class="px-3 py-2 whitespace-nowrap">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($row['is_manual']) && $row['is_manual']): ?>
                                    <?php echo e($row['manual_department'] ?? $row['employee_department']); ?>

                                <?php else: ?>
                                    <?php echo e($row['employee_department']); ?>
...
</div><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/resources/views/livewire/prod/uniform/uniform-request-form.blade.php ENDPATH**/ ?>