    ...
    <?php ob_start(); ?>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="mb-4">
                        <div x-data="{ show: false, search: <?php if ((object) ('employeeSearch') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('employeeSearch'->value()); ?>')<?php echo e('employeeSearch'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('employeeSearch'); ?>')<?php endif; ?> }" class="relative">
                            ...
                            >
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $this->employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <div 
                                        ...
                                        @click="
                                            $wire.set('current_employee_id', '<?php echo e($value); ?>'); 
                                            $wire.set('employeeSearch', '<?php echo e($label); ?>');
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="mb-4">
                        <div x-data="{ show: false, search: <?php if ((object) ('uniformSearch') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('uniformSearch'->value()); ?>')<?php echo e('uniformSearch'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('uniformSearch'); ?>')<?php endif; ?> }" class="relative">
                            ...
                            <div 
                                ...
                                style="display: none;"
                            >
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $this->uniforms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <div 
                                        x-show="'<?php echo e(strtolower($label)); ?>'.includes(search.toLowerCase()) 
                                                || '<?php echo e($value); ?>'.includes(search)"
                                        @click="
                                            $wire.set('current_master_uniform_id', '<?php echo e($value); ?>'); 
                                            $wire.set('uniformSearch', '<?php echo e($label); ?>');
                                            search = '<?php echo e($label); ?>'; 
                                            show = false;
                                        "
                                        class="px-3 py-2 hover:bg-zinc-100 dark:hover:bg-zinc-700 cursor-pointer text-sm"
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['current_master_uniform_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> 
    ...
    <?php ob_start(); ?>
            <div class="flex justify-between items-center mb-4">
                ...
                <div class="text-sm text-zinc-500">
                    Total: <?php echo e($totalRows); ?> row(s)
                </div>
            </div>
                ...
                <table class="w-full text-sm border" style="min-width: 1400px;">
                    ...
                    <tbody>
                        ...
                        <tr class="border-t hover:bg-zinc-50 dark:hover:bg-zinc-800/50">
                            <td class="px-3 py-2 whitespace-nowrap"><?php echo e($row['employee_nik']); ?></td>
                            <td class="px-3 py-2 whitespace-nowrap"><?php echo e($row['employee_name']); ?></td>
                            ...
                            <td class="px-3 py-2 min-w-[150px]">
                                <div class="space-y-1">
                                    <span class="text-xs"><?php echo e($row['admin_feedback'] ?? '-'); ?></span>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($row['admin_feedback_datetime']): ?>
                                    <br><span class="text-[10px] text-zinc-400"><?php echo e(\Carbon\Carbon::parse($row['admin_feedback_datetime'])->format('d/m/Y H:i')); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </td>
                            <td class="px-3 py-2 min-w-[150px]">
                                <div class="space-y-1">
                                    <span class="text-xs"><?php echo e($row['costing_feedback'] ?? '-'); ?></span>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($row['costing_feedback_datetime']): ?>
                                    <br><span class="text-[10px] text-zinc-400"><?php echo e(\Carbon\Carbon::parse($row['costing_feedback_datetime'])->format('d/m/Y H:i')); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </td>
            ...
            <div class="flex justify-between items-center mt-4 pt-4 border-t">
                <div class="text-sm text-zinc-500">
                    Showing <?php echo e(($currentPage - 1) * $perPage + 1); ?> to <?php echo e(min($currentPage * $perPage, $totalRows)); ?> of <?php echo e($totalRows); ?> rows
                </div>
                <div class="flex gap-2">
                    <button type="button" 
                        wire:click="$set('page', <?php echo e($currentPage - 1); ?>)" 
                        <?php if($currentPage <= 1): ?> disabled <?php endif; ?>
                        class="px-3 py-1 border rounded-lg hover:bg-gray-50 dark:hover:bg-zinc-800 <?php echo e($currentPage <= 1 ? 'opacity-50 cursor-not-allowed' : ''); ?>">
                        Previous
                    </button>
                    ...
                    <button type="button" 
                        ...
                        class="px-3 py-1 border rounded-lg hover:bg-gray-50 dark:hover:bg-zinc-800 <?php echo e($currentPage >= $lastPage ? 'opacity-50 cursor-not-allowed' : ''); ?>">
                        Next
                    </button>
                </div>
            </div>
