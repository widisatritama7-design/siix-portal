<?php
if (!function_exists('_1f805fe987b2f73db7a100c32bf248a2')):
function _1f805fe987b2f73db7a100c32bf248a2($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
} endif; ?><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/stubs/resources/views/flux/icon/bell.blade.php ENDPATH**/ ?>