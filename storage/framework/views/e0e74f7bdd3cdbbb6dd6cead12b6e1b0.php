<?php
if (!function_exists('_e0e74f7bdd3cdbbb6dd6cead12b6e1b0')):
function _e0e74f7bdd3cdbbb6dd6cead12b6e1b0($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
} endif; ?><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/stubs/resources/views/flux/icon/percent-badge.blade.php ENDPATH**/ ?>