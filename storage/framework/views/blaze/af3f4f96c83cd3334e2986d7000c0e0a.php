<?php
if (!function_exists('__af3f4f96c83cd3334e2986d7000c0e0a')):
function __af3f4f96c83cd3334e2986d7000c0e0a($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<ui-modal <?php echo e($attributes); ?> data-flux-modal>
    ...
    <dialog
        ...
        [STARTCOMPILEDUNBLAZE:G1rwYBl95v]<?php \Livewire\Blaze\Unblaze::storeScope("G1rwYBl95v", scope: ['name' => $name]) ?>[ENDCOMPILEDUNBLAZE:G1rwYBl95v]
                ...
                <div <?php echo e($contentAttributes->class($contentClasses)); ?> data-flux-modal-content>
                    ...
                    <?php if ($closable): ?>
                        <div class="absolute top-0 end-0 mt-4 me-4">
                            <?php $__blaze->ensureRequired('D:\laragon\www\siix-portal-new\vendor\livewire\flux\src/../stubs/resources/views/flux/modal/close.blade.php', $__blaze->compiledPath.'/b0984f13a8ef7220f0915a3293790728.php'); ?>
<?php if (isset($__slotsb0984f13a8ef7220f0915a3293790728)) { $__slotsStackb0984f13a8ef7220f0915a3293790728[] = $__slotsb0984f13a8ef7220f0915a3293790728; } ?>
<?php if (isset($__attrsb0984f13a8ef7220f0915a3293790728)) { $__attrsStackb0984f13a8ef7220f0915a3293790728[] = $__attrsb0984f13a8ef7220f0915a3293790728; } ?>
<?php $__attrsb0984f13a8ef7220f0915a3293790728 = []; ?>
<?php $__slotsb0984f13a8ef7220f0915a3293790728 = []; ?>
<?php $__blaze->pushData($__attrsb0984f13a8ef7220f0915a3293790728); ?>
<?php ob_start(); ?>
...
<?php $__attrsa35b24e3885f01762aff8c840e2c3d4c = ['variant' => 'ghost','icon' => 'x-mark','size' => 'sm','ariaLabel' => 'Close modal','class' => 'text-zinc-400! hover:text-zinc-800! dark:text-zinc-500! dark:hover:text-white!']; ?>
<?php $__slotsa35b24e3885f01762aff8c840e2c3d4c = []; ?>
<?php $__blaze->pushData($__attrsa35b24e3885f01762aff8c840e2c3d4c); ?>
<?php ob_start(); ?><?php $__slotsa35b24e3885f01762aff8c840e2c3d4c['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slotsa35b24e3885f01762aff8c840e2c3d4c); ?>
<?php __a35b24e3885f01762aff8c840e2c3d4c($__blaze, $__attrsa35b24e3885f01762aff8c840e2c3d4c, $__slotsa35b24e3885f01762aff8c840e2c3d4c, [], ['ariaLabel' => 'aria-label'], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php $__blaze->popData(); ?>
                            <?php $__slotsb0984f13a8ef7220f0915a3293790728['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slotsb0984f13a8ef7220f0915a3293790728); ?>
<?php __b0984f13a8ef7220f0915a3293790728($__blaze, $__attrsb0984f13a8ef7220f0915a3293790728, $__slotsb0984f13a8ef7220f0915a3293790728, [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStackb0984f13a8ef7220f0915a3293790728)) { $__slotsb0984f13a8ef7220f0915a3293790728 = array_pop($__slotsStackb0984f13a8ef7220f0915a3293790728); } ?>
<?php if (! empty($__attrsStackb0984f13a8ef7220f0915a3293790728)) { $__attrsb0984f13a8ef7220f0915a3293790728 = array_pop($__attrsStackb0984f13a8ef7220f0915a3293790728); } ?>
<?php $__blaze->popData(); ?>
                        </div>
                    <?php endif; ?>
                </div>
...
} endif; ?><?php /**PATH D:\laragon\www\siix-portal-new\vendor\livewire\flux\src/../stubs/resources/views/flux/modal/index.blade.php ENDPATH**/ ?>