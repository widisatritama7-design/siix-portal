<?php
if (!function_exists('__028777b3eb06dbd0c29b11890d068895')):
function __028777b3eb06dbd0c29b11890d068895($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php __b462ffebaca45ac18a5d2c5540ab64d7($__blaze, ['icon' => $icon,'variant' => $iconVariant,'class' => e($iconClasses)], [], ['icon', 'variant'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
            <?php else: ?>
                <?php echo e($slot); ?>
...
<?php __b462ffebaca45ac18a5d2c5540ab64d7($__blaze, ['icon' => 'chevron-right','variant' => 'mini','class' => e($separatorClasses->add('rtl:hidden'))], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
        <?php $__blaze->ensureRequired('/www/wwwroot/testings.siix-ems.co.id/siix-portal/vendor/livewire/flux/src/../stubs/resources/views/flux/icon/index.blade.php', $__blaze->compiledPath.'/b462ffebaca45ac18a5d2c5540ab64d7.php'); ?>
<?php $__blaze->pushData(['icon' => 'chevron-left','variant' => 'mini','class' => e($separatorClasses->add('hidden rtl:inline'))]); ?>
<?php __b462ffebaca45ac18a5d2c5540ab64d7($__blaze, ['icon' => 'chevron-left','variant' => 'mini','class' => e($separatorClasses->add('hidden rtl:inline'))], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php __b462ffebaca45ac18a5d2c5540ab64d7($__blaze, ['icon' => 'slash','variant' => 'mini','class' => e($separatorClasses->add('rtl:-scale-x-100'))], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
    <?php else: ?>
        <?php $__blaze->ensureRequired('/www/wwwroot/testings.siix-ems.co.id/siix-portal/vendor/livewire/flux/src/../stubs/resources/views/flux/icon/index.blade.php', $__blaze->compiledPath.'/b462ffebaca45ac18a5d2c5540ab64d7.php'); ?>
<?php $__blaze->pushData(['icon' => $separator,'variant' => 'mini','class' => e($separatorClasses)]); ?>
<?php __b462ffebaca45ac18a5d2c5540ab64d7($__blaze, ['icon' => $separator,'variant' => 'mini','class' => e($separatorClasses)], [], ['icon'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div>
<?php
echo $__blaze->processPassthroughContent('ltrim', ltrim(ob_get_clean()));
} endif; ?><?php /**PATH /www/wwwroot/testings.siix-ems.co.id/siix-portal/vendor/livewire/flux/src/../stubs/resources/views/flux/breadcrumbs/item.blade.php ENDPATH**/ ?>