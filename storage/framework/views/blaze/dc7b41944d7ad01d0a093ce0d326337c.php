<?php
if (!function_exists('__dc7b41944d7ad01d0a093ce0d326337c')):
function __dc7b41944d7ad01d0a093ce0d326337c($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php __b462ffebaca45ac18a5d2c5540ab64d7($__blaze, ['icon' => $icon,'variant' => $iconVariant,'class' => $iconClasses,'dataFluxBadgeIcon' => true], [], ['icon', 'variant', 'class', 'dataFluxBadgeIcon'], ['dataFluxBadgeIcon' => 'data-flux-badge-icon'], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
    <?php else: ?>
        <?php echo e($icon); ?>
...
<?php $__blaze->popData(); ?>
    ...
    <?php endif; ?>
<?php $__slotsa6c001055010a0015fed4ce3d128af92['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slotsa6c001055010a0015fed4ce3d128af92); ?>
<?php __a6c001055010a0015fed4ce3d128af92($__blaze, $__attrsa6c001055010a0015fed4ce3d128af92, $__slotsa6c001055010a0015fed4ce3d128af92, ['attributes', 'dataFluxBadge'], ['dataFluxBadge' => 'data-flux-badge'], $__this ?? (isset($this) ? $this : null)); ?>
