<?php
if (!function_exists('__31c2ca2df5903ae1f72c7f26ed543039')):
function __31c2ca2df5903ae1f72c7f26ed543039($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php $__blaze->ensureRequired('D:\laragon\www\siix-portal\vendor\livewire\flux\src/../stubs/resources/views/flux/button-or-div.blade.php', $__blaze->compiledPath.'/9ddcf173402241844ac21ef9c6ff1565.php'); ?>
<?php if (isset($__slots9ddcf173402241844ac21ef9c6ff1565)) { $__slotsStack9ddcf173402241844ac21ef9c6ff1565[] = $__slots9ddcf173402241844ac21ef9c6ff1565; } ?>
<?php if (isset($__attrs9ddcf173402241844ac21ef9c6ff1565)) { $__attrsStack9ddcf173402241844ac21ef9c6ff1565[] = $__attrs9ddcf173402241844ac21ef9c6ff1565; } ?>
<?php $__attrs9ddcf173402241844ac21ef9c6ff1565 = ['attributes' => $attributes->class($classes),'dataFluxBadge' => true]; ?>
<?php $__slots9ddcf173402241844ac21ef9c6ff1565 = []; ?>
<?php $__blaze->pushData($__attrs9ddcf173402241844ac21ef9c6ff1565); ?>
<?php ob_start(); ?>
...
<?php __4b299ad09af08d7d3e7b543d4657af88($__blaze, ['icon' => $icon,'variant' => $iconVariant,'class' => $iconClasses,'dataFluxBadgeIcon' => true], [], ['icon', 'variant', 'class', 'dataFluxBadgeIcon'], ['dataFluxBadgeIcon' => 'data-flux-badge-icon'], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
    <?php else: ?>
        <?php echo e($icon); ?>
...
<?php $__blaze->popData(); ?>
    ...
    <?php endif; ?>
<?php $__slots9ddcf173402241844ac21ef9c6ff1565['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slots9ddcf173402241844ac21ef9c6ff1565); ?>
<?php __9ddcf173402241844ac21ef9c6ff1565($__blaze, $__attrs9ddcf173402241844ac21ef9c6ff1565, $__slots9ddcf173402241844ac21ef9c6ff1565, ['attributes', 'dataFluxBadge'], ['dataFluxBadge' => 'data-flux-badge'], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStack9ddcf173402241844ac21ef9c6ff1565)) { $__slots9ddcf173402241844ac21ef9c6ff1565 = array_pop($__slotsStack9ddcf173402241844ac21ef9c6ff1565); } ?>
<?php if (! empty($__attrsStack9ddcf173402241844ac21ef9c6ff1565)) { $__attrs9ddcf173402241844ac21ef9c6ff1565 = array_pop($__attrsStack9ddcf173402241844ac21ef9c6ff1565); } ?>
<?php $__blaze->popData(); ?>
<?php
echo $__blaze->processPassthroughContent('ltrim', ltrim(ob_get_clean()));
} endif; ?><?php /**PATH D:\laragon\www\siix-portal\vendor\livewire\flux\src/../stubs/resources/views/flux/badge/index.blade.php ENDPATH**/ ?>