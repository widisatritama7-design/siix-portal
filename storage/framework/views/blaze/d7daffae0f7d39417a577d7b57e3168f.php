<?php
if (!function_exists('__d7daffae0f7d39417a577d7b57e3168f')):
function __d7daffae0f7d39417a577d7b57e3168f($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<ui-modal <?php echo e($attributes); ?> data-flux-modal>
    ...
    <dialog
        ...
        [STARTCOMPILEDUNBLAZE:BXQWHnojvy]<?php \Livewire\Blaze\Unblaze::storeScope("BXQWHnojvy", scope: ['name' => $name]) ?>[ENDCOMPILEDUNBLAZE:BXQWHnojvy]
                ...
                <div <?php echo e($contentAttributes->class($contentClasses)); ?> data-flux-modal-content>
                    ...
                    <?php if ($closable): ?>
                        <div class="absolute top-0 end-0 mt-4 me-4">
                            <?php $__blaze->ensureRequired('/www/wwwroot/testings.siix-ems.co.id/siix-portal/vendor/livewire/flux/src/../stubs/resources/views/flux/modal/close.blade.php', $__blaze->compiledPath.'/689cf60f243a62e9169e194fabc20cb6.php'); ?>
<?php if (isset($__slots689cf60f243a62e9169e194fabc20cb6)) { $__slotsStack689cf60f243a62e9169e194fabc20cb6[] = $__slots689cf60f243a62e9169e194fabc20cb6; } ?>
<?php if (isset($__attrs689cf60f243a62e9169e194fabc20cb6)) { $__attrsStack689cf60f243a62e9169e194fabc20cb6[] = $__attrs689cf60f243a62e9169e194fabc20cb6; } ?>
<?php $__attrs689cf60f243a62e9169e194fabc20cb6 = []; ?>
<?php $__slots689cf60f243a62e9169e194fabc20cb6 = []; ?>
<?php $__blaze->pushData($__attrs689cf60f243a62e9169e194fabc20cb6); ?>
<?php ob_start(); ?>
...
<?php $__attrs487eed12f4c62537fd888f693822b25a = ['variant' => 'ghost','icon' => 'x-mark','size' => 'sm','ariaLabel' => e(__('Close modal')),'class' => 'text-zinc-400! hover:text-zinc-800! dark:text-zinc-500! dark:hover:text-white!']; ?>
<?php $__slots487eed12f4c62537fd888f693822b25a = []; ?>
<?php $__blaze->pushData($__attrs487eed12f4c62537fd888f693822b25a); ?>
<?php ob_start(); ?><?php $__slots487eed12f4c62537fd888f693822b25a['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slots487eed12f4c62537fd888f693822b25a); ?>
<?php __487eed12f4c62537fd888f693822b25a($__blaze, $__attrs487eed12f4c62537fd888f693822b25a, $__slots487eed12f4c62537fd888f693822b25a, [], ['ariaLabel' => 'aria-label'], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php $__blaze->popData(); ?>
                            <?php $__slots689cf60f243a62e9169e194fabc20cb6['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slots689cf60f243a62e9169e194fabc20cb6); ?>
<?php __689cf60f243a62e9169e194fabc20cb6($__blaze, $__attrs689cf60f243a62e9169e194fabc20cb6, $__slots689cf60f243a62e9169e194fabc20cb6, [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStack689cf60f243a62e9169e194fabc20cb6)) { $__slots689cf60f243a62e9169e194fabc20cb6 = array_pop($__slotsStack689cf60f243a62e9169e194fabc20cb6); } ?>
<?php if (! empty($__attrsStack689cf60f243a62e9169e194fabc20cb6)) { $__attrs689cf60f243a62e9169e194fabc20cb6 = array_pop($__attrsStack689cf60f243a62e9169e194fabc20cb6); } ?>
<?php $__blaze->popData(); ?>
                        </div>
                    <?php endif; ?>
                </div>
...
} endif; ?><?php /**PATH /www/wwwroot/testings.siix-ems.co.id/siix-portal/vendor/livewire/flux/src/../stubs/resources/views/flux/modal/index.blade.php ENDPATH**/ ?>