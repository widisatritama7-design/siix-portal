...
<?php $__blaze->popData(); ?>
            ...
            <input
                ...
                [STARTCOMPILEDUNBLAZE:WeOFYBxUij]<?php \Livewire\Blaze\Unblaze::storeScope("WeOFYBxUij", scope: ['name' => $name ?? null, 'invalid' => $invalid ?? false]) ?>[ENDCOMPILEDUNBLAZE:WeOFYBxUij]
                data-flux-control
