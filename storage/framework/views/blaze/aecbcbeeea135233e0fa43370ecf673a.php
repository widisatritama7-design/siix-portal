<?php
if (!function_exists('__aecbcbeeea135233e0fa43370ecf673a')):
function __aecbcbeeea135233e0fa43370ecf673a($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php ob_start(); ?>
    <textarea
        ...
        [STARTCOMPILEDUNBLAZE:P30a0DkP2N]<?php \Livewire\Blaze\Unblaze::storeScope("P30a0DkP2N", scope: ['name' => $name ?? null, 'invalid' => $invalid ?? false]) ?>[ENDCOMPILEDUNBLAZE:P30a0DkP2N]
        data-flux-control
        data-flux-textarea
...
<?php __2ec4b91a52d2097625d50fdf8533857e($__blaze, $__attrs2ec4b91a52d2097625d50fdf8533857e, $__slots2ec4b91a52d2097625d50fdf8533857e, ['attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
