...
<?php ob_start(); ?>
    <textarea
        ...
        [STARTCOMPILEDUNBLAZE:G3DBBPE8L3]<?php \Livewire\Blaze\Unblaze::storeScope("G3DBBPE8L3", scope: ['name' => $name ?? null, 'invalid' => $invalid ?? false]) ?>[ENDCOMPILEDUNBLAZE:G3DBBPE8L3]
        data-flux-control
        data-flux-textarea
