...
<?php ob_start(); ?>
    <textarea
        ...
        [STARTCOMPILEDUNBLAZE:Gvs1KZEelc]<?php \Livewire\Blaze\Unblaze::storeScope("Gvs1KZEelc", scope: ['name' => $name ?? null, 'invalid' => $invalid ?? false]) ?>[ENDCOMPILEDUNBLAZE:Gvs1KZEelc]
        data-flux-control
        data-flux-textarea
