...
<?php ob_start(); ?>
    <textarea
        ...
        [STARTCOMPILEDUNBLAZE:GQLigPWaue]<?php \Livewire\Blaze\Unblaze::storeScope("GQLigPWaue", scope: ['name' => $name ?? null, 'invalid' => $invalid ?? false]) ?>[ENDCOMPILEDUNBLAZE:GQLigPWaue]
        data-flux-control
        data-flux-textarea
