...
<?php ob_start(); ?>
    <textarea
        ...
        [STARTCOMPILEDUNBLAZE:O5VFMLQdYN]<?php \Livewire\Blaze\Unblaze::storeScope("O5VFMLQdYN", scope: ['name' => $name ?? null, 'invalid' => $invalid ?? false]) ?>[ENDCOMPILEDUNBLAZE:O5VFMLQdYN]
        data-flux-control
        data-flux-textarea
