...
<?php ob_start(); ?>
    <textarea
        ...
        [STARTCOMPILEDUNBLAZE:3MTRd5umLX]<?php \Livewire\Blaze\Unblaze::storeScope("3MTRd5umLX", scope: ['name' => $name ?? null, 'invalid' => $invalid ?? false]) ?>[ENDCOMPILEDUNBLAZE:3MTRd5umLX]
        data-flux-control
        data-flux-textarea
