<?php
if (!function_exists('__2ec4b91a52d2097625d50fdf8533857e')):
function __2ec4b91a52d2097625d50fdf8533857e($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php ob_start(); ?><?php echo e($label); ?><?php $__slotsa8e578f2b3679dd4e1765673ff96f156['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slotsa8e578f2b3679dd4e1765673ff96f156); ?>
<?php __a8e578f2b3679dd4e1765673ff96f156($__blaze, $__attrsa8e578f2b3679dd4e1765673ff96f156, $__slotsa8e578f2b3679dd4e1765673ff96f156, ['attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php ob_start(); ?><?php echo e($description); ?><?php $__slotsa0134a28e4c98b93887f246e675b9d51['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slotsa0134a28e4c98b93887f246e675b9d51); ?>
<?php __a0134a28e4c98b93887f246e675b9d51($__blaze, $__attrsa0134a28e4c98b93887f246e675b9d51, $__slotsa0134a28e4c98b93887f246e675b9d51, ['attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php $__blaze->popData(); ?>
        ...
        [STARTCOMPILEDUNBLAZE:jkInhw48P9]<?php \Livewire\Blaze\Unblaze::storeScope("jkInhw48P9", scope: ['attributes' => $errorAttributes->getAttributes()]) ?>[ENDCOMPILEDUNBLAZE:jkInhw48P9]
...
<?php $__slotsa0134a28e4c98b93887f246e675b9d51 = []; ?>
<?php $__blaze->pushData($__attrsa0134a28e4c98b93887f246e675b9d51); ?>
<?php ob_start(); ?><?php echo e($descriptionTrailing); ?><?php $__slotsa0134a28e4c98b93887f246e675b9d51['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slotsa0134a28e4c98b93887f246e675b9d51); ?>
<?php __a0134a28e4c98b93887f246e675b9d51($__blaze, $__attrsa0134a28e4c98b93887f246e675b9d51, $__slotsa0134a28e4c98b93887f246e675b9d51, ['attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStacka0134a28e4c98b93887f246e675b9d51)) { $__slotsa0134a28e4c98b93887f246e675b9d51 = array_pop($__slotsStacka0134a28e4c98b93887f246e675b9d51); } ?>
<?php if (! empty($__attrsStacka0134a28e4c98b93887f246e675b9d51)) { $__attrsa0134a28e4c98b93887f246e675b9d51 = array_pop($__attrsStacka0134a28e4c98b93887f246e675b9d51); } ?>
<?php $__blaze->popData(); ?>
        <?php endif; ?>
    <?php $__slotsc093426d3d64f836efe2aac101899db6['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slotsc093426d3d64f836efe2aac101899db6); ?>
<?php __c093426d3d64f836efe2aac101899db6($__blaze, $__attrsc093426d3d64f836efe2aac101899db6, $__slotsc093426d3d64f836efe2aac101899db6, ['attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
