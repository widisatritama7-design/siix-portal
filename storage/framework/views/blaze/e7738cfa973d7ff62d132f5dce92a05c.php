<?php
if (!function_exists('__e7738cfa973d7ff62d132f5dce92a05c')):
function __e7738cfa973d7ff62d132f5dce92a05c($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php $__blaze->ensureRequired('D:\laragon\www\siix-portal-new\vendor\livewire\flux\src/../stubs/resources/views/flux/button-or-div.blade.php', $__blaze->compiledPath.'/a707556c65f262d60ed9ba2d3f6fce52.php'); ?>
<?php if (isset($__slotsa707556c65f262d60ed9ba2d3f6fce52)) { $__slotsStacka707556c65f262d60ed9ba2d3f6fce52[] = $__slotsa707556c65f262d60ed9ba2d3f6fce52; } ?>
<?php if (isset($__attrsa707556c65f262d60ed9ba2d3f6fce52)) { $__attrsStacka707556c65f262d60ed9ba2d3f6fce52[] = $__attrsa707556c65f262d60ed9ba2d3f6fce52; } ?>
<?php $__attrsa707556c65f262d60ed9ba2d3f6fce52 = ['attributes' => $attributes->class($classes),'dataFluxBadge' => true]; ?>
<?php $__slotsa707556c65f262d60ed9ba2d3f6fce52 = []; ?>
<?php $__blaze->pushData($__attrsa707556c65f262d60ed9ba2d3f6fce52); ?>
<?php ob_start(); ?>
...
<?php __0f2a77fb6d4d542c1b97a0147f9e29a8($__blaze, ['icon' => $icon,'variant' => $iconVariant,'class' => $iconClasses,'dataFluxBadgeIcon' => true], [], ['icon', 'variant', 'class', 'dataFluxBadgeIcon'], ['dataFluxBadgeIcon' => 'data-flux-badge-icon'], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
    <?php else: ?>
        <?php echo e($icon); ?>
...
<?php $__blaze->popData(); ?>
    ...
    <?php endif; ?>
<?php $__slotsa707556c65f262d60ed9ba2d3f6fce52['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slotsa707556c65f262d60ed9ba2d3f6fce52); ?>
<?php __a707556c65f262d60ed9ba2d3f6fce52($__blaze, $__attrsa707556c65f262d60ed9ba2d3f6fce52, $__slotsa707556c65f262d60ed9ba2d3f6fce52, ['attributes', 'dataFluxBadge'], ['dataFluxBadge' => 'data-flux-badge'], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStacka707556c65f262d60ed9ba2d3f6fce52)) { $__slotsa707556c65f262d60ed9ba2d3f6fce52 = array_pop($__slotsStacka707556c65f262d60ed9ba2d3f6fce52); } ?>
<?php if (! empty($__attrsStacka707556c65f262d60ed9ba2d3f6fce52)) { $__attrsa707556c65f262d60ed9ba2d3f6fce52 = array_pop($__attrsStacka707556c65f262d60ed9ba2d3f6fce52); } ?>
<?php $__blaze->popData(); ?>
<?php
echo $__blaze->processPassthroughContent('ltrim', ltrim(ob_get_clean()));
} endif; ?><?php /**PATH D:\laragon\www\siix-portal-new\vendor\livewire\flux\src/../stubs/resources/views/flux/badge/index.blade.php ENDPATH**/ ?>