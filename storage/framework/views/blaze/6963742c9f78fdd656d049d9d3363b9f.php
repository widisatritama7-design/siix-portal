<?php
if (!function_exists('__6963742c9f78fdd656d049d9d3363b9f')):
function __6963742c9f78fdd656d049d9d3363b9f($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<div class="<?php echo e($containerClasses); ?>">
    ...
    <?php if ($paginate): ?>
        ...
        <?php $__blaze->ensureRequired('/www/wwwroot/testings.siix-ems.co.id/siix-portal/vendor/livewire/flux/src/../stubs/resources/views/flux/pagination.blade.php', $__blaze->compiledPath.'/825cdaaa4d31bc720eb08e48f03baf1f.php'); ?>
<?php $__blaze->pushData(['attributes' => $paginationAttributes]); ?>
<?php __825cdaaa4d31bc720eb08e48f03baf1f($__blaze, ['attributes' => $paginationAttributes], [], ['attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
    <?php endif; ?>
</div>
<?php
echo $__blaze->processPassthroughContent('ltrim', ltrim(ob_get_clean()));
} endif; ?><?php /**PATH /www/wwwroot/testings.siix-ems.co.id/siix-portal/vendor/livewire/flux/src/../stubs/resources/views/flux/table/index.blade.php ENDPATH**/ ?>