...
<?php ob_start(); ?>
    <textarea
        ...
        [STARTCOMPILEDUNBLAZE:tXLBhwjtp3]<?php \Livewire\Blaze\Unblaze::storeScope("tXLBhwjtp3", scope: ['name' => $name ?? null, 'invalid' => $invalid ?? false]) ?>[ENDCOMPILEDUNBLAZE:tXLBhwjtp3]
        data-flux-control
        data-flux-textarea
