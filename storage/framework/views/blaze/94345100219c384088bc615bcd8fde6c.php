...
<?php ob_start(); ?>
    <textarea
        ...
        [STARTCOMPILEDUNBLAZE:DdTbhvGEiF]<?php \Livewire\Blaze\Unblaze::storeScope("DdTbhvGEiF", scope: ['name' => $name ?? null, 'invalid' => $invalid ?? false]) ?>[ENDCOMPILEDUNBLAZE:DdTbhvGEiF]
        data-flux-control
        data-flux-textarea
