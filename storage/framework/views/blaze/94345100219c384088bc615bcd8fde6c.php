...
<?php ob_start(); ?>
    <textarea
        ...
        [STARTCOMPILEDUNBLAZE:uANDwbwxCB]<?php \Livewire\Blaze\Unblaze::storeScope("uANDwbwxCB", scope: ['name' => $name ?? null, 'invalid' => $invalid ?? false]) ?>[ENDCOMPILEDUNBLAZE:uANDwbwxCB]
        data-flux-control
        data-flux-textarea
