...
<?php ob_start(); ?>
    <textarea
        ...
        [STARTCOMPILEDUNBLAZE:SF9boKYO6B]<?php \Livewire\Blaze\Unblaze::storeScope("SF9boKYO6B", scope: ['name' => $name ?? null, 'invalid' => $invalid ?? false]) ?>[ENDCOMPILEDUNBLAZE:SF9boKYO6B]
        data-flux-control
        data-flux-textarea
