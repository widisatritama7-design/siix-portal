...
<?php ob_start(); ?>
    <textarea
        ...
        [STARTCOMPILEDUNBLAZE:MvTmXIqY1E]<?php \Livewire\Blaze\Unblaze::storeScope("MvTmXIqY1E", scope: ['name' => $name ?? null, 'invalid' => $invalid ?? false]) ?>[ENDCOMPILEDUNBLAZE:MvTmXIqY1E]
        data-flux-control
        data-flux-textarea
