...
<?php ob_start(); ?>
    <textarea
        ...
        [STARTCOMPILEDUNBLAZE:mwvqtTBPnW]<?php \Livewire\Blaze\Unblaze::storeScope("mwvqtTBPnW", scope: ['name' => $name ?? null, 'invalid' => $invalid ?? false]) ?>[ENDCOMPILEDUNBLAZE:mwvqtTBPnW]
        data-flux-control
        data-flux-textarea
