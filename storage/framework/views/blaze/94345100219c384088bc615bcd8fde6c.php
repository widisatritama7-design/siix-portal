...
<?php ob_start(); ?>
    <textarea
        ...
        [STARTCOMPILEDUNBLAZE:2WL8YiAYU6]<?php \Livewire\Blaze\Unblaze::storeScope("2WL8YiAYU6", scope: ['name' => $name ?? null, 'invalid' => $invalid ?? false]) ?>[ENDCOMPILEDUNBLAZE:2WL8YiAYU6]
        data-flux-control
        data-flux-textarea
