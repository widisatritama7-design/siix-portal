...
<?php ob_start(); ?>
    <textarea
        ...
        [STARTCOMPILEDUNBLAZE:AICChbg5Xw]<?php \Livewire\Blaze\Unblaze::storeScope("AICChbg5Xw", scope: ['name' => $name ?? null, 'invalid' => $invalid ?? false]) ?>[ENDCOMPILEDUNBLAZE:AICChbg5Xw]
        data-flux-control
        data-flux-textarea
