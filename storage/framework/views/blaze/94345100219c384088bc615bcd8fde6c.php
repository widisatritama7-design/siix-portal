...
<?php ob_start(); ?>
    <textarea
        ...
        [STARTCOMPILEDUNBLAZE:qB6MPEKsXe]<?php \Livewire\Blaze\Unblaze::storeScope("qB6MPEKsXe", scope: ['name' => $name ?? null, 'invalid' => $invalid ?? false]) ?>[ENDCOMPILEDUNBLAZE:qB6MPEKsXe]
        data-flux-control
        data-flux-textarea
