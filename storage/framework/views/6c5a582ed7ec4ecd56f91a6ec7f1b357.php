...
<?php $__blaze->popData(); $__env->popConsumableComponentData(); ?><?php echo ltrim(ob_get_clean()); ?>
                    ...
                    <?php ob_start(); ?><?php $__blaze->pushData(['wire:model.live' => 'perPage', 'class' => 'w-40']); $__env->pushConsumableComponentData(['wire:model.live' => 'perPage', 'class' => 'w-40']); ?><select
    class="appearance-none [:where(&amp;)]:w-full ps-3 pe-10 block h-10 py-2 text-base sm:text-sm leading-[1.375rem] rounded-lg shadow-xs border bg-white dark:bg-white/10 dark:disabled:bg-white/[7%] text-zinc-700 dark:text-zinc-300 disabled:text-zinc-500 dark:disabled:text-zinc-400 has-[option.placeholder:checked]:text-zinc-400 dark:has-[option.placeholder:checked]:text-zinc-400 dark:[&amp;&gt;option]:bg-zinc-700 dark:[&amp;&gt;option]:text-white disabled:shadow-none border border-zinc-200 border-b-zinc-300/80 dark:border-white/10 w-40" wire:model.live="perPage"
...
<?php $__attrse7738cfa973d7ff62d132f5dce92a05c = ['size' => 'sm','color' => $statusColor]; ?>
...
<?php _e7738cfa973d7ff62d132f5dce92a05c($__blaze, $__attrse7738cfa973d7ff62d132f5dce92a05c, $__slotse7738cfa973d7ff62d132f5dce92a05c, ['color'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php endif; ?>
</section><?php /**PATH D:\laragon\www\siix-portal-new\resources\views\livewire\esd\garment\garment-management.blade.php ENDPATH**/ ?>