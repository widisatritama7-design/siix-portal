...
<div class="p-1 space-y-2">
    <?php $__env->startSection('title', 'Absence Report Details'); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
        <?php ob_start(); ?><div class="flex items-center text-sm font-medium group/breadcrumb font-semibold text-blue-600" data-flux-breadcrumbs-item>
            <div class="text-gray-500 dark:text-white/80">
                            <?php ob_start(); ?>Absence<?php echo trim(ob_get_clean()); ?>
...
<?php if (isset($__slotsb843a539037c1542dedc5bd82236e28a)) { $__slotsStackb843a539037c1542dedc5bd82236e28a[] = $__slotsb843a539037c1542dedc5bd82236e28a; } ?>
<?php if (isset($__attrsb843a539037c1542dedc5bd82236e28a)) { $__attrsStackb843a539037c1542dedc5bd82236e28a[] = $__attrsb843a539037c1542dedc5bd82236e28a; } ?>
<?php $__attrsb843a539037c1542dedc5bd82236e28a = ['href' => e(route('prod.absence.report.index')),'wire:navigate' => true,'separator' => 'slash']; ?>
<?php $__slotsb843a539037c1542dedc5bd82236e28a = []; ?>
<?php $__blaze->pushData($__attrsb843a539037c1542dedc5bd82236e28a); ?>
<?php ob_start(); ?>Report<?php $__slotsb843a539037c1542dedc5bd82236e28a['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slotsb843a539037c1542dedc5bd82236e28a); ?>
<?php _b843a539037c1542dedc5bd82236e28a($__blaze, $__attrsb843a539037c1542dedc5bd82236e28a, $__slotsb843a539037c1542dedc5bd82236e28a, ['wire:navigate'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStackb843a539037c1542dedc5bd82236e28a)) { $__slotsb843a539037c1542dedc5bd82236e28a = array_pop($__slotsStackb843a539037c1542dedc5bd82236e28a); } ?>
<?php if (! empty($__attrsStackb843a539037c1542dedc5bd82236e28a)) { $__attrsb843a539037c1542dedc5bd82236e28a = array_pop($__attrsStackb843a539037c1542dedc5bd82236e28a); } ?>
...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mt-2">
        <div>
            <h1 class="text-3xl font-bold text-zinc-800 dark:text-white">Absence Report Details</h1>
            <div class="flex items-center gap-2 mt-1">
                <span class="text-sm text-zinc-500"><?php echo e($report->report_number); ?></span>
                <?php
                    $statusConfig = [
                ...
                ?>
                <span class="inline-flex items-center gap-1 px-2 py-1 text-xs font-medium rounded-full <?php echo e($statusConfig[$report->status]['bg']); ?> <?php echo e($statusConfig[$report->status]['text']); ?>">
                    <span><?php echo e(ucfirst($report->status)); ?></span>
                </span>
            </div>
        </div>
        <div class="flex gap-2">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($report->status === 'draft'): ?>
            <a href="<?php echo e(route('prod.absence.report.edit', $report->id)); ?>" wire:navigate 
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <!-- Main Info Card -->
        <?php ob_start(); ?><div class="[:where(&amp;)]:bg-white dark:[:where(&amp;)]:bg-white/10 border border-zinc-200 dark:border-white/10 [:where(&amp;)]:p-6 [:where(&amp;)]:rounded-xl p-6 lg:col-span-2 shadow-lg hover:shadow-xl transition-shadow" data-flux-card>
    <?php ob_start(); ?>
            <div class="flex items-center justify-between mb-6 pb-4 border-b border-zinc-200 dark:border-zinc-700">
                ...
                <div class="flex items-center gap-3">
                    <div class="w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white font-bold text-lg shadow-md">
                        <?php echo e(strtoupper(substr($report->report_number, 0, 1))); ?>
                ...
                <div class="text-right">
                    <p class="font-medium text-zinc-800 dark:text-white">
                        Prepared By : <?php echo e($report->created_by); ?>

                    </p>

                    <p class="text-xs text-zinc-400">
                        <?php echo e($report->created_at ? $report->created_at->format('d M Y H:i') : '-'); ?>
            ...
            <div class="mt-4">
                <div class="flex justify-between items-center mb-3">
                    ...
                    <span class="text-xs text-zinc-500 bg-zinc-100 dark:bg-zinc-800 px-2 py-1 rounded-full">
                        Total: <?php echo e(count($itemsDetail)); ?> employee(s)
                    </span>
                </div>
                <div class="overflow-x-auto overflow-y-auto max-h-[400px] rounded-lg border border-zinc-200 dark:border-zinc-700">
                    <table class="min-w-max w-full text-sm whitespace-nowrap">
                        ...
                        <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $itemsDetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors">
                                
                                <td class="px-4 py-3 font-mono text-xs">
                                    <?php echo e($item['employee_nik']); ?>
                                ...
                                <td class="px-4 py-3 font-mono text-xs">
                                    <?php echo e($item['employee_department']); ?>
                                ...
                                <td class="px-4 py-3 font-mono text-xs">
                                    ...
                                    <span class="inline-flex px-2 py-1 font-mono text-xs rounded-full <?php echo e($colorClass); ?>">
                                        <?php echo e($display); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <?php ob_start(); ?>
            ...
            <div class="space-y-4">
                <!-- Step 1: Check -->
                <div class="flex items-center gap-4 p-4 rounded-xl <?php echo e($report->check_by ? 'bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800' : 'bg-gray-50 dark:bg-gray-800/30'); ?> transition-all">
                    <div class="w-10 h-10 rounded-full flex items-center justify-center text-white font-bold text-sm <?php echo e($report->check_by ? 'bg-green-500' : 'bg-gray-400'); ?> shadow-md">
                        1
                    </div>
                    <div class="flex-1">
                        <div class="flex items-center gap-2">
                            <p class="font-semibold text-zinc-800 dark:text-white">Check</p>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($report->check_by): ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($report->check_by): ?>
                            <p class="text-sm text-green-600 dark:text-green-400">By : <?php echo e($report->check_by); ?></p>
                            <p class="text-xs text-zinc-500"><?php echo e($report->check_at ? $report->check_at->format('d M Y H:i') : '-'); ?></p>
                        <?php else: ?>
                            <p class="text-sm text-gray-500">Waiting for check</p>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('check absence report')): ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($report->status === 'draft' && !$report->check_by): ?>
                ...
                <!-- Step 2: Approve -->
                <div class="flex items-center gap-4 p-4 rounded-xl <?php echo e($report->approved_by ? 'bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800' : ($report->check_by ? 'bg-yellow-50 dark:bg-yellow-900/20' : 'bg-gray-50 dark:bg-gray-800/30')); ?> transition-all">
                    <div class="w-10 h-10 rounded-full flex items-center justify-center text-white font-bold text-sm <?php echo e($report->approved_by ? 'bg-green-500' : ($report->check_by ? 'bg-yellow-500' : 'bg-gray-400')); ?> shadow-md">
                        2
                    </div>
                    <div class="flex-1">
                        <div class="flex items-center gap-2">
                            <p class="font-semibold text-zinc-800 dark:text-white">Approve</p>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($report->approved_by): ?>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4">
                                    <path fill-rule="evenodd" d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12Zm13.36-1.814a.75.75 0 1 0-1.22-.872l-3.236 4.53L9.53 12.22a.75.75 0 0 0-1.06 1.06l2.25 2.25a.75.75 0 0 0 1.14-.094l3.75-5.25Z" clip-rule="evenodd" />
                                </svg>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($report->approved_by): ?>
                            <p class="text-sm text-green-600 dark:text-green-400">By : <?php echo e($report->approved_by); ?></p>
                            <p class="text-xs text-zinc-500"><?php echo e($report->approved_at ? $report->approved_at->format('d M Y H:i') : '-'); ?></p>
                        <?php elseif($report->check_by): ?>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('approve absence report')): ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($report->status === 'checked' && !$report->approved_by): ?>
                ...
                <!-- Step 3: Accept -->
                <div class="flex items-center gap-4 p-4 rounded-xl <?php echo e($report->accepted_by ? 'bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800' : ($report->approved_by ? 'bg-blue-50 dark:bg-blue-900/20' : 'bg-gray-50 dark:bg-gray-800/30')); ?> transition-all">
                    <div class="w-10 h-10 rounded-full flex items-center justify-center text-white font-bold text-sm <?php echo e($report->accepted_by ? 'bg-green-500' : ($report->approved_by ? 'bg-blue-500' : 'bg-gray-400')); ?> shadow-md">
                        3
                    </div>
                    <div class="flex-1">
                        <div class="flex items-center gap-2">
                            <p class="font-semibold text-zinc-800 dark:text-white">Accept</p>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($report->accepted_by): ?>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4">
                                    <path fill-rule="evenodd" d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12Zm13.36-1.814a.75.75 0 1 0-1.22-.872l-3.236 4.53L9.53 12.22a.75.75 0 0 0-1.06 1.06l2.25 2.25a.75.75 0 0 0 1.14-.094l3.75-5.25Z" clip-rule="evenodd" />
                                </svg>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($report->accepted_by): ?>
                            <p class="text-sm text-green-600 dark:text-green-400">By : <?php echo e($report->accepted_by); ?></p>
                            <p class="text-xs text-zinc-500"><?php echo e($report->accepted_at ? $report->accepted_at->format('d M Y H:i') : '-'); ?></p>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('accept absence report')): ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($report->status === 'approved' && !$report->accepted_by): ?>
...
</div><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/resources/views/livewire/prod/absence/absence-report-show.blade.php ENDPATH**/ ?>