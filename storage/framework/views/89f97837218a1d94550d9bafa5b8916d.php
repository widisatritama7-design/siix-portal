...
<?php # [BlazeFolded]:{flux::icon.eye}:{/www/wwwroot/testings.siix-ems.co.id/siix-portal/vendor/livewire/flux/src/../stubs/resources/views/flux/icon/eye.blade.php}:{1776985208} ?>
<?php # [BlazeFolded]:{flux::icon.arrow-top-right-on-square}:{/www/wwwroot/testings.siix-ems.co.id/siix-portal/vendor/livewire/flux/src/../stubs/resources/views/flux/icon/arrow-top-right-on-square.blade.php}:{1776985208} ?>
<?php # [BlazeFolded]:{flux::icon.chart-bar}:{/www/wwwroot/testings.siix-ems.co.id/siix-portal/vendor/livewire/flux/src/../stubs/resources/views/flux/icon/chart-bar.blade.php}:{1776985208} ?>
...
<?php echo ltrim(ob_get_clean()); ?>
                                ...
                                <a href="<?php echo e(url($page->page)); ?>" target="_blank" rel="noopener noreferrer" class="block group">
                                    <div class="flex items-center gap-3 p-3 rounded-lg hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-all duration-200">
                                        ...
                                        <div class="flex items-center gap-1 flex-shrink-0">
                                            <?php ob_start(); ?><svg class="shrink-0 [:where(&amp;)]:size-6 w-3.5 h-3.5 text-zinc-400 flex-shrink-0" data-flux-icon xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"/>
        ...
        <?php echo ltrim(ob_get_clean()); ?>
                                        ...
                                        <?php ob_start(); ?><svg class="shrink-0 [:where(&amp;)]:size-6 w-4 h-4 text-zinc-400 opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0" data-flux-icon xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
