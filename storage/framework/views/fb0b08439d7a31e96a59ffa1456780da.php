<?php
if (!function_exists('_fb0b08439d7a31e96a59ffa1456780da')):
function _fb0b08439d7a31e96a59ffa1456780da($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
} endif; ?><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/stubs/resources/views/flux/icon/arrow-turn-left-up.blade.php ENDPATH**/ ?>