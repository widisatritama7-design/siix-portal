...
<?php # [BlazeFolded]:{flux::icon.eye}:{D:\laragon\www\siix-portal-new\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/eye.blade.php}:{1774988736} ?>
<?php # [BlazeFolded]:{flux::icon.arrow-top-right-on-square}:{D:\laragon\www\siix-portal-new\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/arrow-top-right-on-square.blade.php}:{1774988736} ?>
<?php # [BlazeFolded]:{flux::icon.chart-bar}:{D:\laragon\www\siix-portal-new\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/chart-bar.blade.php}:{1774988736} ?>
...
<?php echo ltrim(ob_get_clean()); ?>
                    ...
                    <div class="space-y-2">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $topPages->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
    ...
    <?php ob_start(); ?>
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-white dark:text-white mt-1"><?php echo e(number_format($todayPageViews)); ?></p>
                            </div>
    ...
    <?php ob_start(); ?>
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-white dark:text-white mt-1"><?php echo e(number_format($todaySessions)); ?></p>
                            </div>
                            <div class="w-10 h-10 rounded-full bg-white/20 dark:bg-white/10 backdrop-blur-sm flex items-center justify-center">
                                <?php ob_start(); ?><svg class="shrink-0 [:where(&amp;)]:size-6 w-5 h-5 text-white dark:text-white" data-flux-icon xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<?php echo ltrim(ob_get_clean()); ?>
        ...
        <?php ob_start(); ?>In 60 Hours<?php echo trim(ob_get_clean()); ?>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <div class="text-center mt-1">
                                ...
                                <span class="text-xs text-zinc-500 dark:text-zinc-400"><?php echo e(number_format($pageViewsDistribution['0_5'])); ?> views</span>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <div class="text-center mt-1">
                                ...
                                <span class="text-xs text-zinc-500 dark:text-zinc-400"><?php echo e(number_format($pageViewsDistribution['5_10'])); ?> views</span>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <div class="text-center mt-1">
                                ...
                                <span class="text-xs text-zinc-500 dark:text-zinc-400"><?php echo e(number_format($pageViewsDistribution['10_30'])); ?> views</span>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <div class="text-center mt-1">
                                ...
                                <span class="text-xs text-zinc-500 dark:text-zinc-400"><?php echo e(number_format($pageViewsDistribution['30_60'])); ?> views</span>
                            </div>
                        </div>
                    </div>
                <?php echo trim(ob_get_clean()); ?>
...
<?php endif; ?><?php /**PATH D:\laragon\www\siix-portal-new\resources\views\home\dashboard.blade.php ENDPATH**/ ?>