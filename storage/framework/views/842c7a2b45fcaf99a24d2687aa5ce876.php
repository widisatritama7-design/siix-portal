<?php
if (!function_exists('_842c7a2b45fcaf99a24d2687aa5ce876')):
function _842c7a2b45fcaf99a24d2687aa5ce876($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php ob_start(); ?><?php echo e($content); ?><?php $__slotse16894c1c9557e8a57590996b6e212be['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
...
} endif; ?><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/stubs/resources/views/flux/tooltip/index.blade.php ENDPATH**/ ?>