<?php
if (!function_exists('_0883cf70866635a034fc7761823557bd')):
function _0883cf70866635a034fc7761823557bd($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
} endif; ?><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/stubs/resources/views/flux/icon/play-pause.blade.php ENDPATH**/ ?>