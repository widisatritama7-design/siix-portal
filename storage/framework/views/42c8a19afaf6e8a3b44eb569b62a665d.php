<?php
if (!function_exists('_42c8a19afaf6e8a3b44eb569b62a665d')):
function _42c8a19afaf6e8a3b44eb569b62a665d($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
} endif; ?><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/stubs/resources/views/flux/icon/h3.blade.php ENDPATH**/ ?>