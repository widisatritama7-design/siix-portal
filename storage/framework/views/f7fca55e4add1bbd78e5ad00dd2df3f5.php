<?php
if (!function_exists('_f7fca55e4add1bbd78e5ad00dd2df3f5')):
function _f7fca55e4add1bbd78e5ad00dd2df3f5($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
} endif; ?><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/stubs/resources/views/flux/icon/document-arrow-down.blade.php ENDPATH**/ ?>