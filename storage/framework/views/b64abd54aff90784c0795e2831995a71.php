...
<div class="p-1 space-y-2">
    <?php $__env->startSection('title', 'Leader Panel - NG Box Management'); ?>
...
<?php $__attrsb843a539037c1542dedc5bd82236e28a = ['href' => e(route('pcb-scan.dashboard')),'wire:navigate' => true,'separator' => 'slash']; ?>
...
<?php echo ltrim(ob_get_clean()); ?>
  ...
  <path fill-rule="evenodd" d="M12.528 3.047a.75.75 0 0 1 .449.961L8.433 16.504a.75.75 0 1 1-1.41-.512l4.544-12.496a.75.75 0 0 1 .961-.449Z" clip-rule="evenodd"/>
            ...
            <!--[if ENDBLOCK]><![endif]--></div>
<?php echo ltrim(ob_get_clean()); ?>
        <?php ob_start(); ?><div class="flex items-center text-sm font-medium group/breadcrumb font-semibold text-red-600 dark:text-red-400" data-flux-breadcrumbs-item>
            <div class="text-gray-500 dark:text-white/80">
                            <?php ob_start(); ?>
            Leader Panel
        <?php echo trim(ob_get_clean()); ?>
...
<?php $__blaze->pushData(['xData' => true,'xInit' => '$el.value = \'\'','wire:model.live.debounce.300ms' => 'search','placeholder' => 'Search serial number...','icon' => 'magnifying-glass','clearable' => true,'autocomplete' => 'off']); ?>
<?php _f9ce25dced5c86c906351e8ca96b9cbb($__blaze, ['xData' => true,'xInit' => '$el.value = \'\'','wire:model.live.debounce.300ms' => 'search','placeholder' => 'Search serial number...','icon' => 'magnifying-glass','clearable' => true,'autocomplete' => 'off'], [], ['xData', 'clearable'], ['xData' => 'x-data', 'xInit' => 'x-init'], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
        </div>
    </div>
            ...
            <div class="overflow-x-auto scrollbar-hide">
                <div class="flex flex-nowrap gap-1 justify-center">
                    ...
                    <button wire:click="switchTab('ng')" 
                            class="px-5 py-2.5 text-sm font-medium transition-all duration-200 relative whitespace-nowrap <?php echo e($activeTab === 'ng' ? 'text-red-600 dark:text-red-400' : 'text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200'); ?>">
                        <svg class="inline w-4 h-4 mr-1.5 -mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path>
                        </svg>
                        NG Boxes
                        <span class="ml-2 px-2 py-0.5 text-xs rounded-full <?php echo e($activeTab === 'ng' ? 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-300' : 'bg-gray-100 text-gray-600 dark:bg-zinc-800 dark:text-gray-400'); ?>">
                            <?php echo e($ngBoxes->total()); ?>

                        </span>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeTab === 'ng'): ?>
                    ...
                    <button wire:click="switchTab('progress')" 
                            class="px-5 py-2.5 text-sm font-medium transition-all duration-200 relative whitespace-nowrap <?php echo e($activeTab === 'progress' ? 'text-yellow-600 dark:text-yellow-400' : 'text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200'); ?>">
                        <svg class="inline w-4 h-4 mr-1.5 -mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                        In Progress
                        <span class="ml-2 px-2 py-0.5 text-xs rounded-full <?php echo e($activeTab === 'progress' ? 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-300' : 'bg-gray-100 text-gray-600 dark:bg-zinc-800 dark:text-gray-400'); ?>">
                            <?php echo e($inProgressPcbs->total()); ?>

                        </span>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeTab === 'progress'): ?>
                    ...
                    <button wire:click="switchTab('completed')" 
                            class="px-5 py-2.5 text-sm font-medium transition-all duration-200 relative whitespace-nowrap <?php echo e($activeTab === 'completed' ? 'text-green-600 dark:text-green-400' : 'text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200'); ?>">
                        <svg class="inline w-4 h-4 mr-1.5 -mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                        Completed
                        <span class="ml-2 px-2 py-0.5 text-xs rounded-full <?php echo e($activeTab === 'completed' ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300' : 'bg-gray-100 text-gray-600 dark:bg-zinc-800 dark:text-gray-400'); ?>">
                            <?php echo e($completedPcbs->total()); ?>
    ...
    <?php ob_start(); ?>
            <div class="overflow-x-auto">
                <table class="min-w-full whitespace-nowrap">
                    ...
                    <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $ngBoxes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $box): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'box-'.e($box->id).''; ?>wire:key="box-<?php echo e($box->id); ?>">
                            <td class="px-4 py-3 text-center text-sm text-zinc-500 dark:text-zinc-400">
                                <?php echo e($loop->iteration + (($ngBoxes->currentPage() - 1) * $ngBoxes->perPage())); ?>

                            </td>
                            <td class="px-4 py-3 text-center">
                                <span class="text-sm font-mono font-medium text-zinc-800 dark:text-zinc-200"><?php echo e($box->serial_number); ?></span>
                            </td>
                            <td class="px-4 py-3 text-center">
        ...
        <?php ob_start(); ?>
                                    <?php echo e(strtoupper(str_replace('_', ' ', $box->blocked_at_process))); ?>
...
<?php $__attrs6b0011e2f83d04930b97e5f6feda22dd = ['color' => e($box->pcb && $box->pcb->fct_completed ? 'green' : 'gray'),'size' => 'xs']; ?>
<?php $__slots6b0011e2f83d04930b97e5f6feda22dd = []; ?>
<?php $__blaze->pushData($__attrs6b0011e2f83d04930b97e5f6feda22dd); ?>
<?php ob_start(); ?>F<?php $__slots6b0011e2f83d04930b97e5f6feda22dd['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
...
<?php if (isset($__slots6b0011e2f83d04930b97e5f6feda22dd)) { $__slotsStack6b0011e2f83d04930b97e5f6feda22dd[] = $__slots6b0011e2f83d04930b97e5f6feda22dd; } ?>
<?php if (isset($__attrs6b0011e2f83d04930b97e5f6feda22dd)) { $__attrsStack6b0011e2f83d04930b97e5f6feda22dd[] = $__attrs6b0011e2f83d04930b97e5f6feda22dd; } ?>
<?php $__attrs6b0011e2f83d04930b97e5f6feda22dd = ['color' => e($box->pcb && $box->pcb->led_test_completed ? 'green' : 'gray'),'size' => 'xs']; ?>
<?php $__slots6b0011e2f83d04930b97e5f6feda22dd = []; ?>
<?php $__blaze->pushData($__attrs6b0011e2f83d04930b97e5f6feda22dd); ?>
<?php ob_start(); ?>L<?php $__slots6b0011e2f83d04930b97e5f6feda22dd['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slots6b0011e2f83d04930b97e5f6feda22dd); ?>
<?php _6b0011e2f83d04930b97e5f6feda22dd($__blaze, $__attrs6b0011e2f83d04930b97e5f6feda22dd, $__slots6b0011e2f83d04930b97e5f6feda22dd, [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStack6b0011e2f83d04930b97e5f6feda22dd)) { $__slots6b0011e2f83d04930b97e5f6feda22dd = array_pop($__slotsStack6b0011e2f83d04930b97e5f6feda22dd); } ?>
<?php if (! empty($__attrsStack6b0011e2f83d04930b97e5f6feda22dd)) { $__attrs6b0011e2f83d04930b97e5f6feda22dd = array_pop($__attrsStack6b0011e2f83d04930b97e5f6feda22dd); } ?>
...
<?php if (isset($__slots6b0011e2f83d04930b97e5f6feda22dd)) { $__slotsStack6b0011e2f83d04930b97e5f6feda22dd[] = $__slots6b0011e2f83d04930b97e5f6feda22dd; } ?>
<?php if (isset($__attrs6b0011e2f83d04930b97e5f6feda22dd)) { $__attrsStack6b0011e2f83d04930b97e5f6feda22dd[] = $__attrs6b0011e2f83d04930b97e5f6feda22dd; } ?>
<?php $__attrs6b0011e2f83d04930b97e5f6feda22dd = ['color' => e($box->pcb && $box->pcb->visual_inspection_completed ? 'green' : 'gray'),'size' => 'xs']; ?>
<?php $__slots6b0011e2f83d04930b97e5f6feda22dd = []; ?>
<?php $__blaze->pushData($__attrs6b0011e2f83d04930b97e5f6feda22dd); ?>
<?php ob_start(); ?>V<?php $__slots6b0011e2f83d04930b97e5f6feda22dd['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slots6b0011e2f83d04930b97e5f6feda22dd); ?>
<?php _6b0011e2f83d04930b97e5f6feda22dd($__blaze, $__attrs6b0011e2f83d04930b97e5f6feda22dd, $__slots6b0011e2f83d04930b97e5f6feda22dd, [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStack6b0011e2f83d04930b97e5f6feda22dd)) { $__slots6b0011e2f83d04930b97e5f6feda22dd = array_pop($__slotsStack6b0011e2f83d04930b97e5f6feda22dd); } ?>
<?php if (! empty($__attrsStack6b0011e2f83d04930b97e5f6feda22dd)) { $__attrs6b0011e2f83d04930b97e5f6feda22dd = array_pop($__attrsStack6b0011e2f83d04930b97e5f6feda22dd); } ?>
<?php $__blaze->popData(); ?>
                                    ...
                                    <span class="text-xs text-zinc-500">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($box->pcb): ?>
                                            <?php echo e(($box->pcb->fct_completed ? 1 : 0) + ($box->pcb->led_test_completed ? 1 : 0) + ($box->pcb->visual_inspection_completed ? 1 : 0)); ?>/3
                                        <?php else: ?>
                                            0/3
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </span>
                            ...
                            <td class="px-4 py-3 text-center">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($box->is_locked): ?>
                                <?php ob_start(); ?><div data-flux-badge="data-flux-badge" class="inline-flex items-center font-medium whitespace-nowrap  [print-color-adjust:exact] text-xs py-1 **:data-flux-badge-icon:me-1 rounded-md px-2 text-red-700 [&amp;_button]:text-red-700! dark:text-red-200 dark:[&amp;_button]:text-red-200! bg-red-400/20 dark:bg-red-400/40 [&amp;:is(button)]:hover:bg-red-400/30 dark:[button]:hover:bg-red-400/50">
        <?php ob_start(); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
                                <?php else: ?>
                                <?php ob_start(); ?><div data-flux-badge="data-flux-badge" class="inline-flex items-center font-medium whitespace-nowrap  [print-color-adjust:exact] text-xs py-1 **:data-flux-badge-icon:me-1 rounded-md px-2 text-green-800 [&amp;_button]:text-green-800! dark:text-green-200 dark:[&amp;_button]:text-green-200! bg-green-400/20 dark:bg-green-400/40 [&amp;:is(button)]:hover:bg-green-400/30 dark:[button]:hover:bg-green-400/50">
        <?php ob_start(); ?>
                                    <svg class="inline w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php echo ltrim(ob_get_clean()); ?>
                            ...
                            <td class="px-4 py-3 text-center text-sm text-zinc-500 dark:text-zinc-400">
                                <?php echo e($box->created_at->format('d M Y H:i:s')); ?>

                            </td>
                            <td class="px-4 py-3 text-center text-sm text-zinc-500 dark:text-zinc-400">
                                <?php echo e($box->created_at->diffForHumans()); ?>

                            </td>
                            <td class="px-4 py-3 text-center">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($box->is_locked): ?>
                                <button type="button"
                                        wire:click="showUnlockCode(<?php echo e($box->id); ?>)"
...
<?php echo ltrim(ob_get_clean()); ?>
                            ...
                            <td colspan="9" class="px-4 py-12 text-center">
                                <div class="flex flex-col items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-zinc-500 dark:text-zinc-400"><?php echo e($search ? 'Try adjusting your search query' : 'No NG records available'); ?></p>
                                    </div>
    ...
    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
            ...
            <span><?php ob_start(); ?>Clear Search<?php echo trim(ob_get_clean()); ?></span>
    </button>
<?php echo ltrim(ob_get_clean()); ?>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ngBoxes->hasPages()): ?>
            <div class="p-4 border-t border-zinc-200 dark:border-zinc-700">
                <?php echo e($ngBoxes->links()); ?>
    ...
    <?php ob_start(); ?>
            <div class="overflow-x-auto">
                <table class="min-w-full whitespace-nowrap">
                    ...
                    <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $allPcbs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pcb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'pcb-'.e($pcb->id).''; ?>wire:key="pcb-<?php echo e($pcb->id); ?>">
                            <td class="px-4 py-3 text-center text-sm text-zinc-500 dark:text-zinc-400">
                                <?php echo e($loop->iteration + (($allPcbs->currentPage() - 1) * $allPcbs->perPage())); ?>

                            </td>
                            <td class="px-4 py-3 text-center">
                                <span class="text-sm font-mono font-medium text-zinc-800 dark:text-zinc-200"><?php echo e($pcb->serial_number); ?></span>
                            </td>
                            <td class="px-4 py-3 text-center">
                                <?php
                                    $statusColors = [
...
<?php if (isset($__slots6b0011e2f83d04930b97e5f6feda22dd)) { $__slotsStack6b0011e2f83d04930b97e5f6feda22dd[] = $__slots6b0011e2f83d04930b97e5f6feda22dd; } ?>
<?php if (isset($__attrs6b0011e2f83d04930b97e5f6feda22dd)) { $__attrsStack6b0011e2f83d04930b97e5f6feda22dd[] = $__attrs6b0011e2f83d04930b97e5f6feda22dd; } ?>
<?php $__attrs6b0011e2f83d04930b97e5f6feda22dd = ['color' => e($statusColors[$pcb->status] ?? 'gray'),'size' => 'sm']; ?>
<?php $__slots6b0011e2f83d04930b97e5f6feda22dd = []; ?>
<?php $__blaze->pushData($__attrs6b0011e2f83d04930b97e5f6feda22dd); ?>
<?php ob_start(); ?>
                                    <?php echo e(ucfirst(str_replace('_', ' ', $pcb->status))); ?>
...
<?php $__blaze->popData(); ?>
                            ...
                            <td class="px-4 py-3 text-center text-sm text-zinc-500 dark:text-zinc-400">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pcb->current_process): ?>
                                    <?php echo e(strtoupper(str_replace('_', ' ', $pcb->current_process))); ?>
...
<?php if (isset($__slots6b0011e2f83d04930b97e5f6feda22dd)) { $__slotsStack6b0011e2f83d04930b97e5f6feda22dd[] = $__slots6b0011e2f83d04930b97e5f6feda22dd; } ?>
<?php if (isset($__attrs6b0011e2f83d04930b97e5f6feda22dd)) { $__attrsStack6b0011e2f83d04930b97e5f6feda22dd[] = $__attrs6b0011e2f83d04930b97e5f6feda22dd; } ?>
<?php $__attrs6b0011e2f83d04930b97e5f6feda22dd = ['color' => e($pcb->fct_completed ? 'green' : 'gray'),'size' => 'xs']; ?>
<?php $__slots6b0011e2f83d04930b97e5f6feda22dd = []; ?>
<?php $__blaze->pushData($__attrs6b0011e2f83d04930b97e5f6feda22dd); ?>
<?php ob_start(); ?>F<?php $__slots6b0011e2f83d04930b97e5f6feda22dd['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slots6b0011e2f83d04930b97e5f6feda22dd); ?>
...
<?php if (isset($__slots6b0011e2f83d04930b97e5f6feda22dd)) { $__slotsStack6b0011e2f83d04930b97e5f6feda22dd[] = $__slots6b0011e2f83d04930b97e5f6feda22dd; } ?>
<?php if (isset($__attrs6b0011e2f83d04930b97e5f6feda22dd)) { $__attrsStack6b0011e2f83d04930b97e5f6feda22dd[] = $__attrs6b0011e2f83d04930b97e5f6feda22dd; } ?>
<?php $__attrs6b0011e2f83d04930b97e5f6feda22dd = ['color' => e($pcb->led_test_completed ? 'green' : 'gray'),'size' => 'xs']; ?>
<?php $__slots6b0011e2f83d04930b97e5f6feda22dd = []; ?>
<?php $__blaze->pushData($__attrs6b0011e2f83d04930b97e5f6feda22dd); ?>
<?php ob_start(); ?>L<?php $__slots6b0011e2f83d04930b97e5f6feda22dd['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slots6b0011e2f83d04930b97e5f6feda22dd); ?>
...
<?php if (isset($__slots6b0011e2f83d04930b97e5f6feda22dd)) { $__slotsStack6b0011e2f83d04930b97e5f6feda22dd[] = $__slots6b0011e2f83d04930b97e5f6feda22dd; } ?>
<?php if (isset($__attrs6b0011e2f83d04930b97e5f6feda22dd)) { $__attrsStack6b0011e2f83d04930b97e5f6feda22dd[] = $__attrs6b0011e2f83d04930b97e5f6feda22dd; } ?>
<?php $__attrs6b0011e2f83d04930b97e5f6feda22dd = ['color' => e($pcb->visual_inspection_completed ? 'green' : 'gray'),'size' => 'xs']; ?>
<?php $__slots6b0011e2f83d04930b97e5f6feda22dd = []; ?>
<?php $__blaze->pushData($__attrs6b0011e2f83d04930b97e5f6feda22dd); ?>
<?php ob_start(); ?>V<?php $__slots6b0011e2f83d04930b97e5f6feda22dd['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slots6b0011e2f83d04930b97e5f6feda22dd); ?>
...
<?php $__blaze->popData(); ?>
                                    ...
                                    <span class="text-xs text-zinc-500">
                                        <?php echo e(($pcb->fct_completed ? 1 : 0) + ($pcb->led_test_completed ? 1 : 0) + ($pcb->visual_inspection_completed ? 1 : 0)); ?>/3
                                    </span>
                                </div>
                            </td>
                            <td class="px-4 py-3 text-center text-sm text-zinc-500 dark:text-zinc-400">
                                <?php echo e($pcb->updated_at ? $pcb->updated_at->diffForHumans() : '-'); ?>

                            </td>
                            <td class="px-4 py-3 text-right">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pcb->status === 'blocked' || $pcb->status === 'ng'): ?>
                                    <?php
                                        $ngBox = $pcb->ngBoxes()->where('is_locked', true)->first();
                                    ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ngBox): ?>
                                    <?php ob_start(); ?><button type="button" class="relative items-center font-medium justify-center gap-2 whitespace-nowrap disabled:opacity-75 dark:disabled:opacity-75 disabled:cursor-default disabled:pointer-events-none justify-center h-8 text-sm rounded-md px-3 inline-flex  bg-[var(--color-accent)] hover:bg-[color-mix(in_oklab,_var(--color-accent),_transparent_10%)] text-[var(--color-accent-foreground)] border border-black/10 dark:border-0 shadow-[inset_0px_1px_--theme(--color-white/.2)] [[data-flux-button-group]_&amp;]:border-e-0 [:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-e-[1px] dark:[:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-e-0 dark:[:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-s-[1px] [:is([data-flux-button-group]&gt;&amp;:not(:first-child),_[data-flux-button-group]_:not(:first-child)&gt;&amp;)]:border-s-[color-mix(in_srgb,var(--color-accent-foreground),transparent_85%)] *:transition-opacity [&amp;[data-loading]&gt;:not([data-flux-loading-indicator])]:opacity-0 [&amp;[data-flux-loading]&gt;:not([data-flux-loading-indicator])]:opacity-0 [&amp;[data-loading]&gt;[data-flux-loading-indicator]]:opacity-100 [&amp;[data-flux-loading]&gt;[data-flux-loading-indicator]]:opacity-100 data-loading:pointer-events-none data-flux-loading:pointer-events-none [--color-accent:var(--color-blue-500)] [--color-accent-content:var(--color-blue-600)] [--color-accent-foreground:var(--color-white)] dark:[--color-accent:var(--color-blue-500)] dark:[--color-accent-content:var(--color-blue-400)] dark:[--color-accent-foreground:var(--color-white)]" data-flux-button="data-flux-button" data-flux-group-target="data-flux-group-target" wire:target="openUnlockModal(<?php echo e($ngBox->id); ?>)" wire:loading.attr="data-flux-loading" wire:click="openUnlockModal(<?php echo e($ngBox->id); ?>)">
        <div class="absolute inset-0 flex items-center justify-center opacity-0" data-flux-loading-indicator>
                <svg class="shrink-0 [:where(&amp;)]:size-4 animate-spin" data-flux-icon xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" aria-hidden="true" data-slot="icon">
    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                            ...
                            <td colspan="7" class="px-4 py-12 text-center">
                                <div class="flex flex-col items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-zinc-500 dark:text-zinc-400"><?php echo e($search ? 'Try adjusting your search query' : 'No data available'); ?></p>
                                    </div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($search): ?>
                                        <?php ob_start(); ?><button type="button" class="relative items-center font-medium justify-center gap-2 whitespace-nowrap disabled:opacity-75 dark:disabled:opacity-75 disabled:cursor-default disabled:pointer-events-none justify-center h-8 text-sm rounded-md px-3 inline-flex  bg-white hover:bg-zinc-50 dark:bg-zinc-700 dark:hover:bg-zinc-600/75 text-zinc-800 dark:text-white border border-zinc-200 hover:border-zinc-200 border-b-zinc-300/80 dark:border-zinc-600 dark:hover:border-zinc-600 shadow-xs [[data-flux-button-group]_&amp;]:border-s-0 [:is([data-flux-button-group]&gt;&amp;:first-child,_[data-flux-button-group]_:first-child&gt;&amp;)]:border-s-[1px] *:transition-opacity [&amp;[data-loading]&gt;:not([data-flux-loading-indicator])]:opacity-0 [&amp;[data-flux-loading]&gt;:not([data-flux-loading-indicator])]:opacity-0 [&amp;[data-loading]&gt;[data-flux-loading-indicator]]:opacity-100 [&amp;[data-flux-loading]&gt;[data-flux-loading-indicator]]:opacity-100 data-loading:pointer-events-none data-flux-loading:pointer-events-none" data-flux-button="data-flux-button" data-flux-group-target="data-flux-group-target" wire:target="$set('search', '')" wire:loading.attr="data-flux-loading" wire:click="$set('search', '')">
        <div class="absolute inset-0 flex items-center justify-center opacity-0" data-flux-loading-indicator>
...
<?php echo ltrim(ob_get_clean()); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($allPcbs->hasPages()): ?>
            <div class="p-4 border-t border-zinc-200 dark:border-zinc-700">
                <?php echo e($allPcbs->links()); ?>
    ...
    <?php ob_start(); ?>
            <div class="overflow-x-auto">
                <table class="min-w-full whitespace-nowrap">
                    ...
                    <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $inProgressPcbs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pcb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'progress-'.e($pcb->id).''; ?>wire:key="progress-<?php echo e($pcb->id); ?>">
                            <td class="px-4 py-3 text-center text-sm text-zinc-500 dark:text-zinc-400">
                                <?php echo e($loop->iteration + (($inProgressPcbs->currentPage() - 1) * $inProgressPcbs->perPage())); ?>
        ...
        <?php ob_start(); ?>
                                    <?php echo e($pcb->current_process ? strtoupper(str_replace('_', ' ', $pcb->current_process)) : 'Pending'); ?>
...
<?php if (isset($__slots6b0011e2f83d04930b97e5f6feda22dd)) { $__slotsStack6b0011e2f83d04930b97e5f6feda22dd[] = $__slots6b0011e2f83d04930b97e5f6feda22dd; } ?>
<?php if (isset($__attrs6b0011e2f83d04930b97e5f6feda22dd)) { $__attrsStack6b0011e2f83d04930b97e5f6feda22dd[] = $__attrs6b0011e2f83d04930b97e5f6feda22dd; } ?>
<?php $__attrs6b0011e2f83d04930b97e5f6feda22dd = ['color' => e($nextStep == 'Completed' ? 'green' : 'blue'),'size' => 'sm']; ?>
<?php $__slots6b0011e2f83d04930b97e5f6feda22dd = []; ?>
<?php $__blaze->pushData($__attrs6b0011e2f83d04930b97e5f6feda22dd); ?>
<?php ob_start(); ?>
                                    <?php echo e($nextStep); ?>
...
<?php $__blaze->popData(); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($inProgressPcbs->hasPages()): ?>
            <div class="p-4 border-t border-zinc-200 dark:border-zinc-700">
                <?php echo e($inProgressPcbs->links()); ?>
    ...
    <?php ob_start(); ?>
            <div class="overflow-x-auto">
                <table class="min-w-full whitespace-nowrap">
                    ...
                    <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $completedPcbs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pcb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'completed-'.e($pcb->id).''; ?>wire:key="completed-<?php echo e($pcb->id); ?>">
                            <td class="px-4 py-3 text-center text-sm text-zinc-500 dark:text-zinc-400">
                                <?php echo e($loop->iteration + (($completedPcbs->currentPage() - 1) * $completedPcbs->perPage())); ?>
                            ...
                            <td class="px-4 py-3 text-center text-sm text-zinc-500 dark:text-zinc-400">
                                <?php echo e($pcb->updated_at ? $pcb->updated_at->format('d M Y H:i:s') : '-'); ?>

                            </td>
                            <td class="px-4 py-3 text-center text-sm text-zinc-500 dark:text-zinc-400">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pcb->created_at && $pcb->updated_at): ?>
                                    <?php echo e($pcb->created_at->diff($pcb->updated_at)->format('%h hours, %i minutes')); ?>
                            ...
                            <td class="px-4 py-3 text-center">
                                <div class="flex justify-center gap-1">
                                    <?php ob_start(); ?><div data-flux-badge="data-flux-badge" class="inline-flex items-center font-medium whitespace-nowrap  [print-color-adjust:exact] text-xs py-1 **:data-flux-badge-icon:me-1 rounded-md px-2 text-green-800 [&amp;_button]:text-green-800! dark:text-green-200 dark:[&amp;_button]:text-green-200! bg-green-400/20 dark:bg-green-400/40 [&amp;:is(button)]:hover:bg-green-400/30 dark:[button]:hover:bg-green-400/50">
        <?php ob_start(); ?>F<?php echo trim(ob_get_clean()); ?>

    </div>
<?php echo ltrim(ob_get_clean()); ?>
                                    <?php ob_start(); ?><div data-flux-badge="data-flux-badge" class="inline-flex items-center font-medium whitespace-nowrap  [print-color-adjust:exact] text-xs py-1 **:data-flux-badge-icon:me-1 rounded-md px-2 text-green-800 [&amp;_button]:text-green-800! dark:text-green-200 dark:[&amp;_button]:text-green-200! bg-green-400/20 dark:bg-green-400/40 [&amp;:is(button)]:hover:bg-green-400/30 dark:[button]:hover:bg-green-400/50">
        <?php ob_start(); ?>L<?php echo trim(ob_get_clean()); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($completedPcbs->hasPages()): ?>
            <div class="p-4 border-t border-zinc-200 dark:border-zinc-700">
                <?php echo e($completedPcbs->links()); ?>
            ...
            <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-xl w-full max-w-md">
                <div class="p-6">
                    ...
                    <div class="bg-zinc-50 dark:bg-zinc-800/50 rounded-lg p-4 mb-4">
                        <div class="grid grid-cols-2 gap-2 text-sm">
                            <div>
                                ...
                                <div class="font-mono font-bold text-zinc-800 dark:text-zinc-200"><?php echo e($selectedBox->serial_number ?? '-'); ?></div>
                            </div>
                            <div>
                                <span class="text-zinc-500 dark:text-zinc-400">Blocked Process</span>
                                <div class="font-bold text-zinc-800 dark:text-zinc-200 uppercase"><?php echo e(isset($selectedBox) ? str_replace('_', ' ', $selectedBox->blocked_at_process) : '-'); ?></div>
                            </div>
                            <div>
                                <span class="text-zinc-500 dark:text-zinc-400">Locked Since</span>
                                <div class="text-zinc-800 dark:text-zinc-200"><?php echo e(isset($selectedBox) ? $selectedBox->created_at->format('d M Y H:i:s') : '-'); ?></div>
                            </div>
                            <div>
                                <span class="text-zinc-500 dark:text-zinc-400">Duration</span>
                                <div class="text-zinc-800 dark:text-zinc-200"><?php echo e(isset($selectedBox) ? $selectedBox->created_at->diffForHumans() : '-'); ?></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['unlockCode'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($unlockMessage): ?>
                    <div class="mb-4 p-3 rounded-lg <?php echo e($unlockMessageType === 'success' ? 'bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 text-green-700 dark:text-green-400' : 
                        ...
                        <div class="flex items-center text-sm">
                            <svg class="w-4 h-4 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($unlockMessageType === 'success'): ?>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                <?php elseif($unlockMessageType === 'error'): ?>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                <?php else: ?>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </svg>
                            <span><?php echo e($unlockMessage); ?></span>
                        </div>
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-xl w-full max-w-md">
                <div class="p-6">
                    ...
                    <div class="mb-4">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['passwordInput'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm mt-1 block text-center"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($passwordError): ?>
                        <span class="text-red-500 text-sm mt-1 block text-center"><?php echo e($passwordError); ?></span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showCodeResult && $displayedCode): ?>
                    <div class="mb-4 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg text-center animate-slideDown">
                        ...
                        <div class="relative inline-block group">
                            <p class="text-3xl font-mono font-bold text-green-700 dark:text-green-400 tracking-widest select-all"><?php echo e($displayedCode); ?></p>
                            <button onclick="copyToClipboard('<?php echo e($displayedCode); ?>')" 
    ...
    document.addEventListener('livewire:initialized', function () {
        ...
        window.Livewire.find('<?php echo e($_instance->getId()); ?>').on('reset-search', function () {
        ...
        window.Livewire.find('<?php echo e($_instance->getId()); ?>').on('close-modal-delay', function () {
            setTimeout(function() {
                window.Livewire.find('<?php echo e($_instance->getId()); ?>').closeUnlockModal();
            }, 1500);
        });

        window.Livewire.find('<?php echo e($_instance->getId()); ?>').on('show-code', function (data) {
...
</div><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/resources/views/livewire/prod/fct/leader-panel.blade.php ENDPATH**/ ?>