<?php
if (!function_exists('_6a35a1491e2def324188945eef66d9f7')):
function _6a35a1491e2def324188945eef66d9f7($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php _0f2a77fb6d4d542c1b97a0147f9e29a8($__blaze, ['icon' => $icon,'attributes' => $iconAttributes], [], ['icon', 'attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
} endif; ?><?php /**PATH D:\laragon\www\siix-portal-new\vendor\livewire\flux\stubs\resources\views\flux\checkbox\variants\buttons.blade.php ENDPATH**/ ?>