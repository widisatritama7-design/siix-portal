...
<?php # [BlazeFolded]:{flux::icon}:{D:\laragon\www\siix-portal-new\vendor\livewire\flux\src/../stubs/resources/views/flux/icon/index.blade.php}:{1774988736} ?>
<?php
if (!function_exists('_ff33ec4157565e312cea64d93aa61979')):
function _ff33ec4157565e312cea64d93aa61979($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php _0f2a77fb6d4d542c1b97a0147f9e29a8($__blaze, ['icon' => $icon,'variant' => $iconVariant,'class' => e($iconClasses)], [], ['icon', 'variant'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php _0f2a77fb6d4d542c1b97a0147f9e29a8($__blaze, ['icon' => $separator,'variant' => 'mini','class' => e($separatorClasses)], [], ['icon'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?><?php $blaze_memoized_html = ob_get_clean(); ?><?php if ($blaze_memoized_key !== null) { \Livewire\Blaze\Memoizer\Memo::put($blaze_memoized_key, $blaze_memoized_html); } ?><?php echo $blaze_memoized_html; ?><?php endif; ?>
