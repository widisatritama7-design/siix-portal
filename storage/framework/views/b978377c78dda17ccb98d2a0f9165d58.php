                ...
                <tr>
                    <td style="width: 50%; vertical-align: top;">
                        <table style="width: 100%;">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($material_filter): ?>
                            <tr>
                                <td>Material Filter</td>
                                <td colspan="3">: <?php echo e($material_filter); ?></td>
                            </tr>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($category_filter): ?>
                            <tr>
                                <td>Category Filter</td>
                                <td colspan="3">: <?php echo e($category_filter); ?></td>
                            </tr>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="wrap-text"><?php echo e($detail->packaging->material ?? 'N/A'); ?></td>
                    <td class="text-center"><?php echo e($detail->packaging->category ?? '-'); ?></td>
                    <td class="text-center"><?php echo e($detail->packaging->project ?? '-'); ?></td>
                    <td class="text-center"><?php echo e($detail->packaging->model ?? '-'); ?></td>
                    <td class="text-center"><?php echo e($detail->f1_scientific ?? '-'); ?></td>
                    <td class="text-center">
                        <span class="<?php echo e($detail->judgement_f1 == 'OK' ? 'badge-ok' : 'badge-ng'); ?>">
                    ...
                    <td class="text-center">
                        <span class="<?php echo e($detail->judgement_f2 == 'OK' ? 'badge-ok' : 'badge-ng'); ?>">
...
</html><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/resources/views/livewire/esd/packaging/packaging-detail-pdf.blade.php ENDPATH**/ ?>