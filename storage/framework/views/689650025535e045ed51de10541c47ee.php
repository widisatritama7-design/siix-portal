                ...
                <tr>
                    <td style="width: 50%; vertical-align: top;">
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td>Area Filter</td>
                                <td colspan="3">: <?php echo e($area); ?></td>
                            </tr>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <tr>
                                ...
                                <td colspan="3">: <?php echo e($location); ?></td>
                            </tr>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center"><?php echo e($detail->groundMonitorBox->register_no ?? 'N/A'); ?></td>
                    <td class="wrap-text"><?php echo e($detail->groundMonitorBox->area ?? 'N/A'); ?></td>
                    <td class="wrap-text"><?php echo e($detail->groundMonitorBox->location ?? 'N/A'); ?></td>
                    <td class="text-center">
                        <span class="<?php echo e($detail->g_3 == 'YES' ? 'badge-yes' : 'badge-no'); ?>">
                            <?php echo e($detail->g_3 ?? '-'); ?>

                        </span>
                    </td>
                    <td class="text-center">
                        <span class="<?php echo e($detail->g_4 == 'YES' ? 'badge-yes' : 'badge-no'); ?>">
...
</html><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/resources/views/livewire/esd/gb/ground-monitor-box-detail-pdf.blade.php ENDPATH**/ ?>