<?php
if (!function_exists('_6ef54f22b09b36b2469b5328389046d8')):
function _6ef54f22b09b36b2469b5328389046d8($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
} endif; ?><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/stubs/resources/views/flux/icon/document-check.blade.php ENDPATH**/ ?>