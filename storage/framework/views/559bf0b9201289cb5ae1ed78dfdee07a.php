...
<div class="p-1 space-y-2">
    <?php $__env->startSection('title', 'Uniform Request'); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
        <?php ob_start(); ?><div class="flex items-center text-sm font-medium group/breadcrumb font-semibold text-blue-600" data-flux-breadcrumbs-item>
            <div class="text-gray-500 dark:text-white/80">
                            <?php ob_start(); ?>Request Uniform<?php echo trim(ob_get_clean()); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mt-2">
        ...
        <div class="flex items-center gap-2">
            <!-- Bulk Action Button -->
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($selectedRequests) > 0): ?>
                <button wire:click="openBulkModal" 
                    ...
                    View All Items For Request (<?php echo e(count($selectedRequests)); ?>)
                </button>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create uniform request')): ?>
                <?php
                ...
                <div class="flex items-center gap-2">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isLocked): ?>
                        ...
                        <div x-data="{ 
                            expiresAt: <?php echo e($lockExpiresAt); ?>,
                            timeLeft: 0,
                            interval: null,
                            init() {
                                this.updateTimer();
                        ...
                        class="flex items-center gap-2">
                            <!-- User Info + Countdown -->
                            <div class="flex items-center gap-2 <?php echo e($isOwnEditLock ? 'bg-yellow-50 dark:bg-yellow-900/20 border-yellow-200 dark:border-yellow-800' : 'bg-red-50 dark:bg-red-900/20 border-red-200 dark:border-red-800'); ?> border rounded-lg px-3 py-2 h-10">
                                <!-- User Avatar/Icon -->
                                <div class="flex-shrink-0">
                                    <svg class="w-5 h-5 <?php echo e($isOwnEditLock ? 'text-yellow-500' : 'text-red-500'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                    </svg>
                                </div>
                                <div class="flex items-center gap-1">
                                    <span class="text-xs <?php echo e($isOwnEditLock ? 'text-yellow-700 dark:text-yellow-300' : 'text-red-700 dark:text-red-300'); ?> font-medium">
                                        <?php echo e($isOwnEditLock ? 'You:' : 'Used By:'); ?>

                                    </span>
                                    <span class="text-xs font-bold <?php echo e($isOwnEditLock ? 'text-yellow-800 dark:text-yellow-200' : 'text-red-800 dark:text-red-200'); ?>"><?php echo e($lockUserName); ?></span>
                                </div>
                                <div class="w-px h-6 <?php echo e($isOwnEditLock ? 'bg-yellow-300 dark:bg-yellow-700' : 'bg-red-300 dark:bg-red-700'); ?>"></div>
                                <!-- Countdown -->
                                <div class="flex items-center gap-1.5">
                                    <svg class="w-4 h-4 <?php echo e($isOwnEditLock ? 'text-yellow-500' : 'text-red-500'); ?>" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                        <circle cx="12" cy="12" r="10" stroke="currentColor"/>
                                        <polyline points="12 6 12 12 16 14" stroke="currentColor"/>
                                    </svg>
                                    <span x-text="formatTime(timeLeft)" class="font-mono font-bold <?php echo e($isOwnEditLock ? 'text-yellow-700 dark:text-yellow-300' : 'text-red-700 dark:text-red-300'); ?> tabular-nums"></span>
                                </div>
                            </div>
                            
                            <!-- Tombol End Session (hanya untuk lock milik sendiri - edit) -->
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isOwnEditLock): ?>
                            ...
                            <div x-data="{ showTooltip: false }" class="relative inline-block">
                                ...
                                <div x-show="showTooltip" 
                                    ...
                                    <p class="font-semibold flex items-center justify-center gap-2">
                                        ...
                                        <?php echo e($lockMessage); ?>

                                    </p>
                                    <p class="mt-1">Oleh: <strong class="text-blue-400"><?php echo e($lockUserName); ?></strong></p>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('feedback uniform request admin')): ?>
                                        <div class="mt-2 pt-2 border-t border-zinc-700">
                                            <button wire:click="forceReleaseAllLocks()" 
                                                onclick="if(confirm('Yakin ingin melepas semua lock secara paksa?')){ window.Livewire.find('<?php echo e($_instance->getId()); ?>').call('forceReleaseAllLocks') }"
                    ...
                    <?php elseif($isOwnLock): ?>
                        <!-- Lock milik sendiri (create) - tampilkan user + countdown hijau + tombol aktif -->
                        <div x-data="{ 
                            expiresAt: <?php echo e($createLock ? $createLock->expires_at->timestamp : 'null'); ?>,
                            timeLeft: 0,
                            interval: null,
                            init() {
                                if (this.expiresAt) {
                        ...
                        class="flex items-center gap-2">
                            ...
                            <div class="flex items-center gap-2 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg px-3 py-2 h-10">
                                ...
                                <div class="flex items-center gap-1">
                                    ...
                                    <span class="text-xs font-bold text-green-800 dark:text-green-200"><?php echo e(auth()->user()->name); ?></span>
                                </div>
...
<?php $__blaze->pushData(['wire:model.live.debounce.300ms' => 'search','placeholder' => 'Search by request #...','icon' => 'magnifying-glass','clearable' => true]); ?>
<?php _5ae551d98c08f0bc67bd05455e08306c($__blaze, ['wire:model.live.debounce.300ms' => 'search','placeholder' => 'Search by request #...','icon' => 'magnifying-glass','clearable' => true], [], ['clearable'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
            </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($adminFeedbackFilter|| $misscStatusFilter || $verificationFilter || $signatureFilter || $dateFrom || $dateTo || $search): ?>
        ...
        <div class="overflow-x-auto">
            <table class="w-full" style="min-width: max-content;">
                <thead>
                    <tr class="bg-zinc-50 dark:bg-zinc-800/50">
                        <th class="px-2 py-3 text-center">
                            ...
                            ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canSelectAll): ?>
                                <input type="checkbox" 
                ...
                <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $requests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php
                    ...
                    <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors">
                        <td class="px-2 py-3 text-center">
                            ...
                            ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canSelect): ?>
                                <input type="checkbox" 
                        ...
                        <td class="px-4 py-3 text-center whitespace-nowrap">
                            <span class="text-sm font-semibold"><?php echo e($request->request_number); ?></span>
                        </td>
                        ...
                        <td class="px-4 py-3 text-center whitespace-nowrap">
                            <span class="inline-flex items-center gap-1 px-2 py-1 text-sm font-medium bg-blue-100 text-blue-700 rounded-full dark:bg-blue-900/30 dark:text-blue-300 whitespace-nowrap">
                                ...
                                <span><?php echo e(count($request->items)); ?> employee(s)</span>
                            </span>
                        </td>
                        
                        <td class="px-4 py-3 text-center whitespace-nowrap">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($adminStatus['status'] == 'N/A'): ?>
    ...
    All items are manual input (no admin feedback needed)

    </div>
            </ui-tooltip>
<?php echo ltrim(ob_get_clean()); ?>
                                </span>
                            <?php elseif($adminStatus['status'] == 'Checked'): ?>
                            ...
                            <?php elseif($adminStatus['status'] == 'On Process'): ?>
                        ...
                        <td class="px-4 py-3 text-center whitespace-nowrap">
                            ...
                            ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($verifStatus == 'N/A'): ?>
                                <span class="inline-flex items-center gap-1 px-2 py-1 text-sm font-medium rounded-full bg-gray-100 text-gray-600 dark:bg-gray-800 dark:text-gray-400 whitespace-nowrap">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4 shrink-0">
                                        <path fill-rule="evenodd" d="<?php echo e($verifIcon); ?>" clip-rule="evenodd" />
                                    </svg>
                                    N/A
                                    <?php ob_start(); ?><ui-tooltip position="top center"  data-flux-tooltip >
        <?php ob_start(); ?>
                    ...
                    <div popover="manual" class="relative py-2 px-2.5 rounded-md text-xs text-white font-medium bg-zinc-800 dark:bg-zinc-700 dark:border dark:border-white/10 p-0 overflow-visible" data-flux-tooltip-content>
    All items are manual input (no verification needed)

    </div>
            </ui-tooltip>
<?php echo ltrim(ob_get_clean()); ?>
                                </span>
                            <?php elseif($verifStatus == 'Waiting'): ?>
        ...
        <?php ob_start(); ?>
                    ...
                    <div popover="manual" class="relative py-2 px-2.5 rounded-md text-xs text-white font-medium bg-zinc-800 dark:bg-zinc-700 dark:border dark:border-white/10 p-0 overflow-visible" data-flux-tooltip-content>
    All items are waiting for verification

    </div>
            </ui-tooltip>
<?php echo ltrim(ob_get_clean()); ?>
                                </span>
                            <?php elseif($verifStatus == 'On Process'): ?>
        ...
        <?php ob_start(); ?>
                    ...
                    <div popover="manual" class="relative py-2 px-2.5 rounded-md text-xs text-white font-medium bg-zinc-800 dark:bg-zinc-700 dark:border dark:border-white/10 p-0 overflow-visible" data-flux-tooltip-content>
    Some items have been verified, some are still pending

    </div>
            </ui-tooltip>
<?php echo ltrim(ob_get_clean()); ?>
                                </span>
                            <?php elseif($verifStatus == 'Approved'): ?>
...
<?php echo ltrim(ob_get_clean()); ?>
                            ...
                            <?php elseif($verifStatus == 'Completed'): ?>
        ...
        <?php ob_start(); ?>
                    ...
                    <div popover="manual" class="relative py-2 px-2.5 rounded-md text-xs text-white font-medium bg-zinc-800 dark:bg-zinc-700 dark:border dark:border-white/10 p-0 overflow-visible" data-flux-tooltip-content>
    Process completed with some rejected or manual items
...
<?php echo ltrim(ob_get_clean()); ?>
                        ...
                        <td class="px-4 py-3 text-center whitespace-nowrap">
                            <div class="flex flex-col items-center gap-1">
                                <span class="inline-flex items-center gap-1 px-2 py-1 text-sm font-medium rounded-full bg-<?php echo e($misscColor); ?>-100 text-<?php echo e($misscColor); ?>-700 dark:bg-<?php echo e($misscColor); ?>-900/30 dark:text-<?php echo e($misscColor); ?>-300 whitespace-nowrap">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4 shrink-0">
                                        <path fill-rule="evenodd" d="<?php echo e($misscIcon); ?>" clip-rule="evenodd" />
                                    </svg>
                                    <?php echo e($misscStatus); ?>

                                </span>
                                
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($misscStatus == 'Accepted' && $request->missc_accept_at): ?>
                                    <span class="text-xs text-gray-500 dark:text-gray-400 whitespace-nowrap">
                                        <?php echo e($request->missc_accept_at->format('d M Y H:i')); ?>
                        ...
                        <td class="px-4 py-3 text-center whitespace-nowrap">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($signatureStatus['status'] == 'Signed'): ?>
                                <span class="inline-flex items-center gap-1 px-2 py-1 text-sm font-medium rounded-full bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300 whitespace-nowrap">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4 shrink-0">
                                        <path fill-rule="evenodd" d="<?php echo e($signatureIcon); ?>" clip-rule="evenodd" />
                                    </svg>
                                    Signed
                                </span>
                            <?php elseif($signatureStatus['status'] == 'Completed'): ?>
                                <span class="inline-flex items-center gap-1 px-2 py-1 text-sm font-medium rounded-full bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300 whitespace-nowrap">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4 shrink-0">
                                        <path fill-rule="evenodd" d="<?php echo e($signatureIcon); ?>" clip-rule="evenodd" />
                                    </svg>
                            ...
                            <?php elseif($signatureStatus['status'] == 'On Process'): ?>
                                <span class="inline-flex items-center gap-1 px-2 py-1 text-sm font-medium rounded-full bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-300 whitespace-nowrap">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4 shrink-0">
                                        <path fill-rule="evenodd" d="M4.755 10.059a7.5 7.5 0 0 1 12.548-3.364l1.903 1.903h-3.183a.75.75 0 1 0 0 1.5h4.992a.75.75 0 0 0 .75-.75V4.356a.75.75 0 0 0-1.5 0v3.18l-1.9-1.9A9 9 0 0 0 3.306 9.67a.75.75 0 1 0 1.45.388Zm15.408 3.352a.75.75 0 0 0-.919.53 7.5 7.5 0 0 1-12.548 3.364l-1.902-1.903h3.183a.75.75 0 0 0 0-1.5H2.984a.75.75 0 0 0-.75.75v4.992a.75.75 0 0 0 1.5 0v-3.18l1.9 1.9a9 9 0 0 0 15.059-4.035.75.75 0 0 0-.53-.918Z" clip-rule="evenodd" />
                                    </svg>
                        ...
                        <td class="px-4 py-3 text-center whitespace-nowrap">
                            <span class="text-sm font-semibold"><?php echo e($request->created_by); ?></span>
                        </td>
                        
                        <td class="px-4 py-3 text-center whitespace-nowrap">
                            <span class="text-sm font-semibold"><?php echo e($request->created_at ? $request->created_at->format('d M Y H:i') : '-'); ?></span>
                        </td>
...
<?php echo ltrim(ob_get_clean()); ?>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update uniform request missc status')): ?>
                                    <?php
                                        $verificationStatus = $this->getVerificationStatus($request);
                                    ...
                                    ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($request->missc_status != 'Accepted' && $canUpdateMissc): ?>
                                        <?php ob_start(); ?><ui-tooltip position="bottom center"  data-flux-tooltip >
        <?php ob_start(); ?>
                                            <?php ob_start(); ?><button type="button" class="relative items-center font-medium justify-center gap-2 whitespace-nowrap disabled:opacity-75 dark:disabled:opacity-75 disabled:cursor-default disabled:pointer-events-none justify-center h-6 text-xs rounded-md w-6 inline-flex  bg-[var(--color-accent)] hover:bg-[color-mix(in_oklab,_var(--color-accent),_transparent_10%)] text-[var(--color-accent-foreground)] border border-black/10 dark:border-0 shadow-[inset_0px_1px_--theme(--color-white/.2)] [[data-flux-button-group]_&amp;]:border-e-0 [:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-e-[1px] dark:[:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-e-0 dark:[:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-s-[1px] [:is([data-flux-button-group]&gt;&amp;:not(:first-child),_[data-flux-button-group]_:not(:first-child)&gt;&amp;)]:border-s-[color-mix(in_srgb,var(--color-accent-foreground),transparent_85%)] *:transition-opacity [&amp;[data-loading]&gt;:not([data-flux-loading-indicator])]:opacity-0 [&amp;[data-flux-loading]&gt;:not([data-flux-loading-indicator])]:opacity-0 [&amp;[data-loading]&gt;[data-flux-loading-indicator]]:opacity-100 [&amp;[data-flux-loading]&gt;[data-flux-loading-indicator]]:opacity-100 data-loading:pointer-events-none data-flux-loading:pointer-events-none [--color-accent:var(--color-green-600)] [--color-accent-content:var(--color-green-600)] [--color-accent-foreground:var(--color-white)] dark:[--color-accent:var(--color-green-600)] dark:[--color-accent-content:var(--color-green-400)] dark:[--color-accent-foreground:var(--color-white)] !p-1.5" data-flux-button="data-flux-button" data-flux-group-target="data-flux-group-target" wire:target="openMisscModal(<?php echo e($request->id); ?>)" wire:loading.attr="data-flux-loading" wire:click="openMisscModal(<?php echo e($request->id); ?>)">
...
<?php echo ltrim(ob_get_clean()); ?>
                                    <?php elseif($request->missc_status != 'Accepted'): ?>
                                        <?php ob_start(); ?><ui-tooltip position="bottom center"  data-flux-tooltip >
        <?php ob_start(); ?>
                    ...
                    <div popover="manual" class="relative py-2 px-2.5 rounded-md text-xs text-white font-medium bg-zinc-800 dark:bg-zinc-700 dark:border dark:border-white/10 p-0 overflow-visible" data-flux-tooltip-content>
    Cannot update MISSC Status - Verification must be Completed, Approved, or N/A first
...
<?php echo ltrim(ob_get_clean()); ?>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit uniform request')): ?>
                                    <?php
                                        // Cek lock status
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canEdit && $request->missc_status == 'Waiting'): ?>
                                        <?php ob_start(); ?><ui-tooltip position="bottom center"  data-flux-tooltip >
        <?php ob_start(); ?>
                                            <?php ob_start(); ?><a href="<?php echo e(route('prod.uniform.request.edit', $request->id)); ?>" data-flux-button="data-flux-button" class="relative items-center font-medium justify-center gap-2 whitespace-nowrap disabled:opacity-75 dark:disabled:opacity-75 disabled:cursor-default disabled:pointer-events-none justify-center h-6 text-xs rounded-md w-6 inline-flex  bg-[var(--color-accent)] hover:bg-[color-mix(in_oklab,_var(--color-accent),_transparent_10%)] text-[var(--color-accent-foreground)] border border-black/10 dark:border-0 shadow-[inset_0px_1px_--theme(--color-white/.2)] [[data-flux-button-group]_&amp;]:border-e-0 [:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-e-[1px] dark:[:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-e-0 dark:[:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-s-[1px] [:is([data-flux-button-group]&gt;&amp;:not(:first-child),_[data-flux-button-group]_:not(:first-child)&gt;&amp;)]:border-s-[color-mix(in_srgb,var(--color-accent-foreground),transparent_85%)]  [--color-accent:var(--color-yellow-400)] [--color-accent-content:var(--color-yellow-600)] [--color-accent-foreground:var(--color-yellow-950)] dark:[--color-accent:var(--color-yellow-400)] dark:[--color-accent-content:var(--color-yellow-400)] dark:[--color-accent-foreground:var(--color-yellow-950)] !p-1.5" data-flux-group-target="data-flux-group-target" wire:navigate="">
        <svg class="shrink-0 [:where(&amp;)]:size-4" data-flux-icon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true" data-slot="icon">
                                    ...
                                    <?php elseif($isLockedByOther): ?>
                                        ...
                                        <div x-data="{ showTooltip: false }" class="relative inline-block">
                                            ...
                                            <div x-show="showTooltip" 
                                                ...
                                                <p><strong><?php echo e($lockStatus['locked_by']); ?></strong></p>
                                                <p class="text-zinc-400 text-[10px] mt-0.5">
                                                    Expired: <?php echo e(\Carbon\Carbon::parse($lockStatus['expires_at'])->format('H:i:s')); ?>
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('feedback uniform request admin')): ?>
                                                    <div class="mt-2 pt-2 border-t border-zinc-700">
                                                        <button wire:click="forceReleaseLock(<?php echo e($request->id); ?>)" 
                                                            onclick="if(confirm('Yakin ingin melepas lock secara paksa?')){ window.Livewire.find('<?php echo e($_instance->getId()); ?>').call('forceReleaseLock', <?php echo e($request->id); ?>) }"
...
<?php $__attrs1e349890a464f9948f6af12013af6f7e = ['content' => e($disabledReason),'position' => 'bottom']; ?>
...
<?php $__blaze->popData(); ?>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete uniform request')): ?>
                                    <?php
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canDelete): ?>
                                        <?php ob_start(); ?><ui-tooltip position="bottom center"  data-flux-tooltip >
        <?php ob_start(); ?>
                                            <?php ob_start(); ?><button type="button" class="relative items-center font-medium justify-center gap-2 whitespace-nowrap disabled:opacity-75 dark:disabled:opacity-75 disabled:cursor-default disabled:pointer-events-none justify-center h-6 text-xs rounded-md w-6 inline-flex  bg-[var(--color-accent)] hover:bg-[color-mix(in_oklab,_var(--color-accent),_transparent_10%)] text-[var(--color-accent-foreground)] border border-black/10 dark:border-0 shadow-[inset_0px_1px_--theme(--color-white/.2)] [[data-flux-button-group]_&amp;]:border-e-0 [:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-e-[1px] dark:[:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-e-0 dark:[:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-s-[1px] [:is([data-flux-button-group]&gt;&amp;:not(:first-child),_[data-flux-button-group]_:not(:first-child)&gt;&amp;)]:border-s-[color-mix(in_srgb,var(--color-accent-foreground),transparent_85%)] *:transition-opacity [&amp;[data-loading]&gt;:not([data-flux-loading-indicator])]:opacity-0 [&amp;[data-flux-loading]&gt;:not([data-flux-loading-indicator])]:opacity-0 [&amp;[data-loading]&gt;[data-flux-loading-indicator]]:opacity-100 [&amp;[data-flux-loading]&gt;[data-flux-loading-indicator]]:opacity-100 data-loading:pointer-events-none data-flux-loading:pointer-events-none [--color-accent:var(--color-red-500)] [--color-accent-content:var(--color-red-600)] [--color-accent-foreground:var(--color-white)] dark:[--color-accent:var(--color-red-500)] dark:[--color-accent-content:var(--color-red-400)] dark:[--color-accent-foreground:var(--color-white)] !p-1.5" data-flux-button="data-flux-button" data-flux-group-target="data-flux-group-target" wire:target="delete(<?php echo e($request->id); ?>)" wire:loading.attr="data-flux-loading" wire:click="delete(<?php echo e($request->id); ?>)" wire:confirm="Are you sure you want to delete this request? Stock will be returned.">
        <div class="absolute inset-0 flex items-center justify-center opacity-0" data-flux-loading-indicator>
                <svg class="shrink-0 [:where(&amp;)]:size-4 animate-spin" data-flux-icon xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" aria-hidden="true" data-slot="icon">
    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
...
<?php if (isset($__slots1e349890a464f9948f6af12013af6f7e)) { $__slotsStack1e349890a464f9948f6af12013af6f7e[] = $__slots1e349890a464f9948f6af12013af6f7e; } ?>
<?php if (isset($__attrs1e349890a464f9948f6af12013af6f7e)) { $__attrsStack1e349890a464f9948f6af12013af6f7e[] = $__attrs1e349890a464f9948f6af12013af6f7e; } ?>
<?php $__attrs1e349890a464f9948f6af12013af6f7e = ['content' => e($deleteDisabledReason),'position' => 'bottom']; ?>
<?php $__slots1e349890a464f9948f6af12013af6f7e = []; ?>
<?php $__blaze->pushData($__attrs1e349890a464f9948f6af12013af6f7e); ?>
<?php ob_start(); ?>
                                            <span class="inline-flex items-center justify-center w-7 h-7 rounded-lg bg-gray-100 text-gray-400 dark:bg-gray-800 dark:text-gray-600 cursor-not-allowed">
...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <div x-data="{ 
        open: <?php if ((object) ('showMisscModal') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showMisscModal'->value()); ?>')<?php echo e('showMisscModal'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showMisscModal'); ?>')<?php endif; ?>, 
        closeModal() { 
            this.open = false; 
            $wire.closeMisscModal(); 
        },
        allItemsSigned: <?php echo json_encode($allItemsSigned ?? false, 15, 512) ?>
    }" 
    x-show="open" 
    x-cloak>
                ...
                <div class="p-6">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="px-3 py-2 bg-zinc-100 dark:bg-zinc-800 rounded-lg text-sm font-semibold">
                            <?php echo e($selectedRequestNumber); ?>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="px-3 py-2 bg-zinc-100 dark:bg-zinc-800 rounded-lg">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentMisscStatus == 'Waiting'): ?>
                            ...
                            <?php elseif($currentMisscStatus == 'On Process'): ?>
                    ...
                    <?php elseif($currentMisscStatus == 'On Process' && $allItemsSigned): ?>
                    ...
                    <div class="flex justify-end gap-2 mt-4">
                        ...
                        <button wire:click="confirmUpdateMisscStatus" 
                            ...
                            :disabled="<?php echo e($currentMisscStatus == 'On Process' && !$allItemsSigned ? 'true' : 'false'); ?>">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <!-- MODAL BULK ACTION -->
    <div x-data="{ 
        open: <?php if ((object) ('showBulkModal') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showBulkModal'->value()); ?>')<?php echo e('showBulkModal'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showBulkModal'); ?>')<?php endif; ?>, 
            ...
            <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-xl w-full max-w-6xl max-h-[95vh] flex flex-col">
                ...
                <div class="p-6 border-b border-zinc-200 dark:border-zinc-700 flex justify-between items-center flex-shrink-0">
                    <div>
                        ...
                        <p class="text-sm text-zinc-500 dark:text-zinc-400">
                            <?php echo e((count($bulkData['regular'] ?? []) + count($bulkData['new_employee'] ?? []))); ?> item(s) from <?php echo e(count($selectedRequests)); ?> selected request(s)
                        </p>
                    </div>
                ...
                <div class="p-6 overflow-y-auto flex-1">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($totalItems > 0): ?>
                        <!-- Regular Items -->
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($bulkData['regular'])): ?>
                        <div class="mb-6">
                            <div class="flex items-center gap-3 mb-3">
                                ...
                                <span class="text-xs bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 px-2 py-0.5 rounded-full">
                                    <?php echo e(count($bulkData['regular'])); ?> item(s)
                                </span>
                            </div>
                            ...
                            <div class="border rounded-lg overflow-hidden">
                                <div class="overflow-x-auto">
                                    <table class="w-full text-sm">
                                        ...
                                        <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $bulkData['regular']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors <?php echo e(!$item['can_be_processed'] ? 'opacity-60' : ''); ?>">
                                                <td class="px-4 py-3 text-center text-zinc-500 dark:text-zinc-400"><?php echo e($index + 1); ?></td>
                                                <td class="px-4 py-3 font-mono text-sm font-medium text-blue-600 dark:text-blue-400 whitespace-nowrap">
                                                    <span 
                                                        x-data="{ copied: false }"
                                                        @click="
                                                            navigator.clipboard.writeText('<?php echo e($item['item_code']); ?>');
                                                            copied = true;
                                                ...
                                                <td class="px-4 py-3 text-center">
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item['type'] === 'System'): ?>
                                                ...
                                                <td class="px-4 py-3 text-center">
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item['can_be_processed']): ?>
...
<?php if (isset($__slots1e349890a464f9948f6af12013af6f7e)) { $__slotsStack1e349890a464f9948f6af12013af6f7e[] = $__slots1e349890a464f9948f6af12013af6f7e; } ?>
<?php if (isset($__attrs1e349890a464f9948f6af12013af6f7e)) { $__attrsStack1e349890a464f9948f6af12013af6f7e[] = $__attrs1e349890a464f9948f6af12013af6f7e; } ?>
<?php $__attrs1e349890a464f9948f6af12013af6f7e = ['content' => e($item['reason_not_processed']),'position' => 'top']; ?>
<?php $__slots1e349890a464f9948f6af12013af6f7e = []; ?>
<?php $__blaze->pushData($__attrs1e349890a464f9948f6af12013af6f7e); ?>
<?php ob_start(); ?>
                                                                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php $__blaze->popData(); ?>
                                                ...
                                                <td class="px-4 py-3 text-xs text-zinc-500 dark:text-zinc-400">
                                                    <div class="flex flex-wrap gap-1 max-w-[150px]">
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $item['request_numbers']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reqNum): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        ...
                        <!-- New Employee Items -->
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($bulkData['new_employee'])): ?>
                        <div>
                            <div class="flex items-center gap-3 mb-3">
                                ...
                                <span class="text-xs bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-300 px-2 py-0.5 rounded-full">
                                    <?php echo e(count($bulkData['new_employee'])); ?> item(s)
                                </span>
                            </div>
                            ...
                            <div class="border rounded-lg overflow-hidden">
                                <div class="overflow-x-auto">
                                    <table class="w-full text-sm">
                                        ...
                                        <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $bulkData['new_employee']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors <?php echo e(!$item['can_be_processed'] ? 'opacity-60' : ''); ?>">
                                                <td class="px-4 py-3 text-center text-zinc-500 dark:text-zinc-400"><?php echo e($index + 1); ?></td>
                                                <td class="px-4 py-3 font-mono text-sm font-medium text-blue-600 dark:text-blue-400 whitespace-nowrap">
                                                    <span 
                        ...
                        <div class="mt-4 p-4 bg-zinc-50 dark:bg-zinc-800/50 rounded-lg border border-zinc-200 dark:border-zinc-700">
                            <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
                                <div>
                                    ...
                                    <p class="text-lg font-bold text-zinc-800 dark:text-zinc-200"><?php echo e($totalItems); ?></p>
                                </div>
                                <div>
                                    <p class="text-xs text-zinc-500 dark:text-zinc-400">Total Quantity</p>
                                    <p class="text-lg font-bold text-blue-600 dark:text-blue-400"><?php echo e($totalQty); ?></p>
                                </div>
                                <div>
                                    <p class="text-xs text-zinc-500 dark:text-zinc-400">System</p>
                                    <p class="text-lg font-bold text-blue-600 dark:text-blue-400"><?php echo e($systemCount); ?></p>
                                </div>
                                <div>
                                    <p class="text-xs text-zinc-500 dark:text-zinc-400">Manual</p>
                                    <p class="text-lg font-bold text-gray-600 dark:text-gray-400"><?php echo e($manualCount); ?></p>
                                </div>
                                <div>
                                    <p class="text-xs text-zinc-500 dark:text-zinc-400">New Employee</p>
                                    <p class="text-lg font-bold text-yellow-600 dark:text-yellow-400"><?php echo e($newEmployeeCount); ?></p>
                                </div>
                            </div>
                            
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canProcessCount < $totalItems): ?>
                            <div class="mt-3 pt-3 border-t border-zinc-200 dark:border-zinc-700">
                                <div class="flex items-center gap-2 text-sm text-yellow-600 dark:text-yellow-400">
                                    ...
                                    <span>
                                        <strong><?php echo e($totalItems - $canProcessCount); ?></strong> item(s) cannot be processed yet. 
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($systemCount > 0): ?>
...
</div><?php /**PATH /www/wwwroot/testings.siix-ems.co.id/siix-portal/resources/views/livewire/prod/uniform/uniform-request-index.blade.php ENDPATH**/ ?>