...
<section class="w-full">
    ...
    <?php ob_start(); ?><div class="font-medium [:where(&amp;)]:text-zinc-800 [:where(&amp;)]:dark:text-white text-sm [&amp;:has(+[data-flux-subheading])]:mb-2 [[data-flux-subheading]+&amp;]:mt-2 sr-only" data-flux-heading><?php ob_start(); ?>
        <?php echo e(__('Electrostatic Discharge - Ground Monitor Box Detail')); ?>
...
<?php if (isset($__slots028777b3eb06dbd0c29b11890d068895)) { $__slotsStack028777b3eb06dbd0c29b11890d068895[] = $__slots028777b3eb06dbd0c29b11890d068895; } ?>
<?php if (isset($__attrs028777b3eb06dbd0c29b11890d068895)) { $__attrsStack028777b3eb06dbd0c29b11890d068895[] = $__attrs028777b3eb06dbd0c29b11890d068895; } ?>
<?php $__attrs028777b3eb06dbd0c29b11890d068895 = ['href' => e(route('esd.ground-monitor-boxs')),'wire:navigate' => true,'separator' => 'slash']; ?>
<?php $__slots028777b3eb06dbd0c29b11890d068895 = []; ?>
<?php $__blaze->pushData($__attrs028777b3eb06dbd0c29b11890d068895); ?>
<?php ob_start(); ?>
                        Ground Monitor Box
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-center">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-base font-semibold text-zinc-800 dark:text-white">
                                <?php echo e($groundMonitorBox->register_no); ?>
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-base text-zinc-800 dark:text-white">
                                <?php echo e($groundMonitorBox->area); ?>
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-base text-zinc-800 dark:text-white">
                                <?php echo e($groundMonitorBox->location); ?>
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex justify-center">
                                ...
                                <span class="inline-flex px-3 py-1 rounded-full text-sm font-medium <?php echo e($statusColor); ?>">
                                    <?php echo e($groundMonitorBox->status); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>
        ...
        <?php echo ltrim(ob_get_clean()); ?>
                                ...
                                <div class="text-left">
                                    <div class="flex items-center gap-2 mb-2">
                                        <?php ob_start(); ?><svg class="shrink-0 [:where(&amp;)]:size-6 w-4 h-4 text-red-600 dark:text-red-400" data-flux-icon xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
                ...
                <div class="mb-4">
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
                        ...
                        <div class="order-2 sm:order-2">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create ground monitor box details')): ?>
                            ...
                            <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                                ...
                                <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'detail-'.e($detail->id).''; ?>wire:key="detail-<?php echo e($detail->id); ?>">
                                    <td class="px-4 py-3">
                                        ...
                                        ?>
                                        <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($g3Color); ?>">
                                            <?php echo e($detail->g_3); ?>
                                    ...
                                    <td class="px-4 py-3">
                                        ...
                                        ?>
                                        <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($g4Color); ?>">
                                            <?php echo e($detail->g_4); ?>
                                    ...
                                    <td class="px-4 py-3 text-right">
                                        <div class="flex items-center justify-end gap-1 whitespace-nowrap">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit ground monitor box details')): ?>
...
<?php echo ltrim(ob_get_clean()); ?>
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete ground monitor box details')): ?>
                    ...
                    <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                        <div class="p-6">
                            ...
                            <form wire:submit="save">
                                ...
                                <input type="hidden" wire:model="ground_monitor_box_id" value="<?php echo e($groundMonitorBox->id); ?>">
                                ...
                                <div class="mb-4 p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['g_3'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        ...
                                        <div>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['g_4'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
                ...
                <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
                    <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-xl w-full max-w-md p-6 text-center">
                        ...
                        <p class="text-gray-600 dark:text-gray-400 mb-6">
                            Are you sure you want to delete measurement for "<?php echo e($detailToDelete?->groundMonitorBox?->register_no ?? 'this Ground Monitor Box'); ?>"? This action cannot be undone.
                        </p>
...
<?php endif; ?>
</section><?php /**PATH /www/wwwroot/testings.siix-ems.co.id/siix-portal/resources/views/livewire/esd/gb/ground-monitor-box-show.blade.php ENDPATH**/ ?>