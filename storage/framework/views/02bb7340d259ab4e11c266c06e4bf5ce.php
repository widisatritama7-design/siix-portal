...
<section class="w-full">
    ...
    <?php ob_start(); ?><div class="font-medium [:where(&amp;)]:text-zinc-800 [:where(&amp;)]:dark:text-white text-sm [&amp;:has(+[data-flux-subheading])]:mb-2 [[data-flux-subheading]+&amp;]:mt-2 sr-only" data-flux-heading><?php ob_start(); ?>
        <?php echo e(__('Electrostatic Discharge - Locker Status Management')); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
                ...
                <div x-show="showFilters" 
                    ...
                    <div class="p-6">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($filterStatus || $filterDept || $filterDateFrom || $filterDateUntil || $search): ?>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm">
                            ...
                            <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $leftLockers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $locker): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <?php
                                ...
                                ?>
                                <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'locker-left-'.e($locker->id).''; ?>wire:key="locker-left-<?php echo e($locker->id); ?>">
                                    <td class="px-3 py-2">
                                        <span class="text-sm font-semibold text-zinc-800 dark:text-white font-mono">
                                            <?php echo e($locker->locker_number); ?>

                                        </span>
                                    </td>
                                    <td class="px-3 py-2 text-sm text-zinc-700 dark:text-zinc-300">
                                        <?php echo e($locker->nik ?? '-'); ?>

                                    </td>
                                    <td class="px-3 py-2 text-sm text-zinc-700 dark:text-zinc-300">
                                        <div class="max-w-[150px] truncate" title="<?php echo e($locker->name); ?>">
                                            <?php echo e($locker->name ?? '-'); ?>

                                        </div>
                                    </td>
                                    <td class="px-3 py-2 text-sm text-zinc-700 dark:text-zinc-300">
                                        <?php echo e($locker->dept ?? '-'); ?>

                                    </td>
                                    <td class="px-3 py-2" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'status-left-'.e($locker->id).''; ?>wire:key="status-left-<?php echo e($locker->id); ?>">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($editingId === $locker->id): ?>
                                            <select 
                                                wire:model.live="editingStatus"
                                                wire:keydown.enter="updateStatus(<?php echo e($locker->id); ?>)"
                                                wire:blur="updateStatus(<?php echo e($locker->id); ?>)"
                                        ...
                                        <?php else: ?>
                                            <div class="flex items-center gap-1">
                                                <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-<?php echo e($statusColor); ?>-100 text-<?php echo e($statusColor); ?>-800 dark:bg-<?php echo e($statusColor); ?>-900/30 dark:text-<?php echo e($statusColor); ?>-400">
                                                    <?php echo e($locker->status); ?>

                                                </span>
                                                <button 
                                                    wire:click="startEditingStatus(<?php echo e($locker->id); ?>, '<?php echo e($locker->status); ?>')"
...
<?php echo ltrim(ob_get_clean()); ?>
                                            ...
                                            <?php ob_start(); ?><button type="button" class="relative items-center font-medium justify-center gap-2 whitespace-nowrap disabled:opacity-75 dark:disabled:opacity-75 disabled:cursor-default disabled:pointer-events-none justify-center h-6 text-xs rounded-md w-6 inline-flex  bg-[var(--color-accent)] hover:bg-[color-mix(in_oklab,_var(--color-accent),_transparent_10%)] text-[var(--color-accent-foreground)] border border-black/10 dark:border-0 shadow-[inset_0px_1px_--theme(--color-white/.2)] [[data-flux-button-group]_&amp;]:border-e-0 [:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-e-[1px] dark:[:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-e-0 dark:[:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-s-[1px] [:is([data-flux-button-group]&gt;&amp;:not(:first-child),_[data-flux-button-group]_:not(:first-child)&gt;&amp;)]:border-s-[color-mix(in_srgb,var(--color-accent-foreground),transparent_85%)] *:transition-opacity [&amp;[data-loading]&gt;:not([data-flux-loading-indicator])]:opacity-0 [&amp;[data-flux-loading]&gt;:not([data-flux-loading-indicator])]:opacity-0 [&amp;[data-loading]&gt;[data-flux-loading-indicator]]:opacity-100 [&amp;[data-flux-loading]&gt;[data-flux-loading-indicator]]:opacity-100 data-loading:pointer-events-none data-flux-loading:pointer-events-none [--color-accent:var(--color-red-500)] [--color-accent-content:var(--color-red-600)] [--color-accent-foreground:var(--color-white)] dark:[--color-accent:var(--color-red-500)] dark:[--color-accent-content:var(--color-red-400)] dark:[--color-accent-foreground:var(--color-white)] !p-1.5" data-flux-button="data-flux-button" data-flux-group-target="data-flux-group-target" wire:target="confirmDelete(<?php echo e($locker->id); ?>)" wire:loading.attr="data-flux-loading" wire:click="confirmDelete(<?php echo e($locker->id); ?>)" x-on:click="$dispatch('open-modal', 'delete-locker-modal')" title="Delete locker">
        <div class="absolute inset-0 flex items-center justify-center opacity-0" data-flux-loading-indicator>
                <svg class="shrink-0 [:where(&amp;)]:size-4 animate-spin" data-flux-icon xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" aria-hidden="true" data-slot="icon">
    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
    ...
    <?php ob_start(); ?>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm">
                            ...
                            <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $rightLockers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $locker): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <?php
                                    $statusColor = match($locker->status) {
                                        'Filled' => 'success',
                                        'On Process Measure' => 'warning',
                                ...
                                ?>
                                <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'locker-right-'.e($locker->id).''; ?>wire:key="locker-right-<?php echo e($locker->id); ?>">
                                    <td class="px-3 py-2">
                                        <span class="text-sm font-semibold text-zinc-800 dark:text-white font-mono">
                                            <?php echo e($locker->locker_number); ?>
                                    ...
                                    <td class="px-3 py-2" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'status-right-'.e($locker->id).''; ?>wire:key="status-right-<?php echo e($locker->id); ?>">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($editingId === $locker->id): ?>
                                            <select 
                                                wire:model.live="editingStatus"
                                                wire:keydown.enter="updateStatus(<?php echo e($locker->id); ?>)"
            ...
            <div class="mt-4 flex justify-between items-center text-sm text-zinc-500 dark:text-zinc-400">
                <div class="flex items-center gap-2">
                    <span class="inline-flex items-center gap-1">
                        ...
                        Showing <?php echo e($allLockers->count()); ?> lockers
                    </span>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($allLockers->count() >= 20): ?>
                            ...
                            <form wire:submit="save">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['locker_number'];
                ...
                <div class="flex flex-col" style="height: auto; max-height: 85vh; overflow: hidden;">
                    ...
                    <div class="flex justify-between items-center px-6 py-4 border-b border-zinc-200 dark:border-zinc-700 flex-shrink-0">
                        <div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedLockerForActivity): ?>
                            <p class="text-sm text-zinc-500 dark:text-zinc-400 mt-1">
                                Locker: <span class="font-semibold"><?php echo e($selectedLockerForActivity->locker_number); ?></span>
                            </p>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    </div>
                ...
                <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
                    <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-xl w-full max-w-md p-6 text-center">
                        ...
                        <p class="text-gray-600 dark:text-gray-400 mb-6">
                            Are you sure you want to delete locker "<?php echo e($detailToDelete?->locker_number ?? 'this locker'); ?>"? This action cannot be undone.
                        </p>
...
<?php endif; ?>
</section><?php /**PATH /www/wwwroot/testings.siix-ems.co.id/siix-portal/resources/views/livewire/esd/locker/locker-status-management.blade.php ENDPATH**/ ?>