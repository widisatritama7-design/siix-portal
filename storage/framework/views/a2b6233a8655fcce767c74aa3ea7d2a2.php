...
<section class="w-full">
    ...
    <?php ob_start(); ?><div class="font-medium [:where(&amp;)]:text-zinc-800 [:where(&amp;)]:dark:text-white text-sm [&amp;:has(+[data-flux-subheading])]:mb-2 [[data-flux-subheading]+&amp;]:mt-2 sr-only" data-flux-heading><?php ob_start(); ?>
        <?php echo e(__('Electrostatic Discharge - Ionizer Measurement')); ?>
                ...
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="text-sm text-zinc-500 dark:text-zinc-400 mt-1">
                            Manage measurement records for ESD ionizers
                        </p>
                    </div>
                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mt-1 mb-4">
                    ...
                    <div class="flex-1">
                        ...
                        >
                            ...
                            <span x-show="filterIonizer || filterArea || filterLocation || filterDateFrom || filterDateUntil || filterNextDateFrom || filterNextDateUntil || search" 
                    ...
                    <div class="flex gap-2">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($filterIonizer || $filterArea || $filterLocation || $filterDateFrom || $filterDateUntil || $filterNextDateFrom || $filterNextDateUntil || $search): ?>
                ...
                <div class="bg-white dark:bg-zinc-800 rounded-xl p-4 border border-zinc-200 dark:border-zinc-700 shadow-sm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" 
                                wire:model.live="printRegisterNo" 
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($printRegisterNo || $printArea || $printLocation || $printDateFrom || $printDateUntil): ?>
                    ...
                    <table class="w-full whitespace-nowrap">
                        <thead>
                            <tr class="bg-zinc-50 dark:bg-zinc-800/50">
                                ...
                                <th class="px-4 py-3 text-left text-xs font-medium text-zinc-500 dark:text-zinc-400 uppercase tracking-wider min-w-[100px]">Location</th>
                            ...
                            <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'detail-'.e($detail->id).''; ?>wire:key="detail-<?php echo e($detail->id); ?>">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center gap-3">
                                        <div class="w-8 h-8 rounded-full bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center text-white font-medium shadow-lg flex-shrink-0 text-xs">
                                            <?php echo e(strtoupper(substr($detail->ionizer->register_no ?? '', 0, 1))); ?>

                                        </div>
                                        <span class="text-sm font-semibold text-zinc-800 dark:text-white truncate max-w-[180px]" title="<?php echo e($detail->ionizer->register_no ?? ''); ?>">
                                            <?php echo e($detail->ionizer->register_no ?? 'N/A'); ?>

                                        </span>
                                    </div>
                                </>
                                <td class="px-4 py-3 text-sm text-zinc-700 dark:text-zinc-300 truncate max-w-[200px]" title="<?php echo e($detail->ionizer->area ?? ''); ?>">
                                    <?php echo e($detail->ionizer->area ?? 'N/A'); ?>

                                </>
                                <td class="px-4 py-3 text-sm text-zinc-700 dark:text-zinc-300">
                                    <?php echo e($detail->ionizer->location ?? 'N/A'); ?>

                                </>
                                <td class="px-4 py-3">
                                    <?php
                                        $pm1Color = $detail->pm_1 == 'NO' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400';
                                    ?>
                                    <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($pm1Color); ?>">
                                        <?php echo e($detail->pm_1); ?>

                                    </span>
                                </>
                                <td class="px-4 py-3">
                                    <?php
                                        $pm2Color = $detail->pm_2 == 'OK' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400';
                                    ?>
                                    <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($pm2Color); ?>">
                                        <?php echo e($detail->pm_2); ?>

                                    </span>
                                </>
                                <td class="px-4 py-3">
                                    <?php
                                        $pm3Color = $detail->pm_3 == 'YES' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400';
                                    ?>
                                    <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($pm3Color); ?>">
                                        <?php echo e($detail->pm_3); ?>

                                    </span>
                                </>
                                <td class="px-4 py-3 text-sm text-zinc-700 dark:text-zinc-300 font-mono">
                                    <?php echo e($detail->c1_before); ?>

                                </>
                                <td class="px-4 py-3">
                                    <?php
                                        $judgeColor = $detail->judgement_c1_before == 'OK' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400';
                                    ?>
                                    <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($judgeColor); ?>">
                                        <?php echo e($detail->judgement_c1_before); ?>

                                    </span>
                                </>
                                <td class="px-4 py-3 text-sm text-zinc-700 dark:text-zinc-300 font-mono">
                                    <?php echo e($detail->c2_before); ?>

                                </>
                                <td class="px-4 py-3">
                                    <?php
                                        $judgeColor = $detail->judgement_c2_before == 'OK' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400';
                                    ?>
                                    <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($judgeColor); ?>">
                                ...
                                <td class="px-4 py-3 text-sm text-zinc-700 dark:text-zinc-300 font-mono">
                                    <?php echo e($detail->c3_before); ?>

                                </>
                                <td class="px-4 py-3">
                                    <?php
                                        $judgeColor = $detail->judgement_c3_before == 'OK' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400';
                                    ?>
                                    <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($judgeColor); ?>">
                                ...
                                <td class="px-4 py-3 text-sm text-zinc-700 dark:text-zinc-300 font-mono">
                                    <?php echo e($detail->c1); ?>

                                </>
                                <td class="px-4 py-3">
                                    <?php
                                        $judgeColor = $detail->judgement_c1 == 'OK' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400';
                                    ?>
                                    <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($judgeColor); ?>">
                                ...
                                <td class="px-4 py-3 text-sm text-zinc-700 dark:text-zinc-300 font-mono">
                                    <?php echo e($detail->c2); ?>

                                </>
                                <td class="px-4 py-3">
                                    <?php
                                        $judgeColor = $detail->judgement_c2 == 'OK' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400';
                                    ?>
                                    <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($judgeColor); ?>">
                                ...
                                <td class="px-4 py-3 text-sm text-zinc-700 dark:text-zinc-300 font-mono">
                                    <?php echo e($detail->c3); ?>

                                </>
                                <td class="px-4 py-3">
                                    <?php
                                        $judgeColor = $detail->judgement_c3 == 'OK' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400';
                                    ?>
                                    <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($judgeColor); ?>">
        ...
        <?php echo ltrim(ob_get_clean()); ?>
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-zinc-500 dark:text-zinc-400 mb-4">
                                                <?php echo e($search || $filterIonizer || $filterArea || $filterLocation ? 'Try adjusting your filters' : 'Get started by adding a new measurement'); ?>

                                            </p>
                                        </div>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($search || $filterIonizer || $filterArea || $filterLocation): ?>
                            ...
                            <form wire:submit="save">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select wire:model="ionizer_id"
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $ionizers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ionizer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            <option value="<?php echo e($ionizer->id); ?>"><?php echo e($ionizer->register_no); ?> - <?php echo e($ionizer->area); ?> - <?php echo e($ionizer->location); ?></option>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                    </select>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['ionizer_id'];
                                        ...
                                        <div>
                                            ...
                                            <div class="flex gap-4 mt-2">
                                                <label class="inline-flex items-center">
                                                    <input type="radio" wire:model="pm_1" value="FLASH" class="form-radio text-red-600">
                                                    <span class="ml-2">FLASH</span>
                                                </label>
                                                <label class="inline-flex items-center">
                                                    <input type="radio" wire:model="pm_1" value="NO" class="form-radio text-green-600">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        ...
                                        <div>
                                            ...
                                            <div class="flex gap-4 mt-2">
                                                <label class="inline-flex items-center">
                                                    <input type="radio" wire:model="pm_2" value="OK" class="form-radio text-green-600">
                                                    <span class="ml-2">OK</span>
                                                </label>
                                                <label class="inline-flex items-center">
                                                    <input type="radio" wire:model="pm_2" value="NO" class="form-radio text-red-600">
                                                    <span class="ml-2">NO</span>
                                                </label>
                                            </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        ...
                                        <div>
                                            ...
                                            <div class="flex gap-4 mt-2">
                                                <label class="inline-flex items-center">
                                                    <input type="radio" wire:model="pm_3" value="YES" class="form-radio text-green-600">
                                                    <span class="ml-2">YES</span>
                                                </label>
                                                <label class="inline-flex items-center">
                                                    <input type="radio" wire:model="pm_3" value="NO" class="form-radio text-red-600">
                                                    <span class="ml-2">NO</span>
                                                </label>
                                            </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <!-- C1 Before & C2 Before & C3 Before Section -->
                                <div class="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <input type="number" step="0.01" wire:model="c1_before" wire:keyup="resetJudgements"
                                                   class="w-full px-3 py-2 border rounded-lg dark:bg-zinc-800 dark:border-zinc-700 focus:ring-2 focus:ring-blue-500">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <div class="mt-1">
                                                <span class="inline-flex px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($judgement_c1_before == 'OK' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                                    Judgement: <?php echo e($judgement_c1_before ?: 'Auto'); ?>
                                        ...
                                        <div>
                                            ...
                                            <div class="text-xs text-blue-600 mb-1">Standard: &lt; 8.0 (Max 7.9 = OK)</div>
                                            <input type="number" step="0.01" wire:model="c2_before" wire:keyup="resetJudgements"
                                                   class="w-full px-3 py-2 border rounded-lg dark:bg-zinc-800 dark:border-zinc-700 focus:ring-2 focus:ring-blue-500">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <div class="mt-1">
                                                <span class="inline-flex px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($judgement_c2_before == 'OK' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                                    Judgement: <?php echo e($judgement_c2_before ?: 'Auto'); ?>
                                        ...
                                        <div>
                                            ...
                                            <input type="number" step="0.01" wire:model="c3_before" wire:keyup="resetJudgements"
                                                   class="w-full px-3 py-2 border rounded-lg dark:bg-zinc-800 dark:border-zinc-700 focus:ring-2 focus:ring-blue-500">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <div class="mt-1">
                                                <span class="inline-flex px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($judgement_c3_before == 'OK' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                                    Judgement: <?php echo e($judgement_c3_before ?: 'Auto'); ?>
                                ...
                                <div class="mb-6 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-xs text-blue-600 mb-1">Standard: &lt; 8.0 (Max 7.9 = OK)</div>
                                            <input type="number" step="0.01" wire:model="c1" wire:keyup="resetJudgements"
                                                   class="w-full px-3 py-2 border rounded-lg dark:bg-zinc-800 dark:border-zinc-700 focus:ring-2 focus:ring-blue-500">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <div class="mt-1">
                                                <span class="inline-flex px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($judgement_c1 == 'OK' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                                    Judgement: <?php echo e($judgement_c1 ?: 'Auto'); ?>
                                        ...
                                        <div>
                                            ...
                                            <div class="text-xs text-blue-600 mb-1">Standard: &lt; 8.0 (Max 7.9 = OK)</div>
                                            <input type="number" step="0.01" wire:model="c2" wire:keyup="resetJudgements"
                                                   class="w-full px-3 py-2 border rounded-lg dark:bg-zinc-800 dark:border-zinc-700 focus:ring-2 focus:ring-blue-500">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <div class="mt-1">
                                                <span class="inline-flex px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($judgement_c2 == 'OK' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                                    Judgement: <?php echo e($judgement_c2 ?: 'Auto'); ?>
                                        ...
                                        <div>
                                            ...
                                            <div class="text-xs text-green-600 mb-1">Standard: ± 35 (-34.9 to 34.9 = OK)</div>
                                            <input type="number" step="0.01" wire:model="c3" wire:keyup="resetJudgements"
                                                   class="w-full px-3 py-2 border rounded-lg dark:bg-zinc-800 dark:border-zinc-700 focus:ring-2 focus:ring-blue-500">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <div class="mt-1">
                                                <span class="inline-flex px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($judgement_c3 == 'OK' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                                    Judgement: <?php echo e($judgement_c3 ?: 'Auto'); ?>
                ...
                <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
                    <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-xl w-full max-w-md p-6 text-center">
                        ...
                        <p class="text-gray-600 dark:text-gray-400 mb-6">
                            Are you sure you want to delete measurement for "<?php echo e($detailToDelete?->ionizer?->register_no ?? 'this ionizer'); ?>"? This action cannot be undone.
                        </p>
...
<?php endif; ?>
</section><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/resources/views/livewire/esd/ionizer/ionizer-detail-management.blade.php ENDPATH**/ ?>