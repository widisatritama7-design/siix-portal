<?php
if (!function_exists('_fad05d57e1e0bf8b6251725acbf0d97e')):
function _fad05d57e1e0bf8b6251725acbf0d97e($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php $__attrs61bc94f66e133c8c88763f97d4c55076 = ['attributes' => $attributes]; ?>
...
<?php $__attrs456a8a952c91dd5f727236a9bcd63c5d = ['type' => $type,'attributes' => $attributes->class($classes),'dataFluxButton' => true]; ?>
...
<?php _ebfb27feae87a3d873cb5ef75a09aacc($__blaze, ['icon' => 'loading','variant' => $iconVariant,'class' => $iconClasses], [], ['variant', 'class'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php _ebfb27feae87a3d873cb5ef75a09aacc($__blaze, ['icon' => $iconTrailing,'variant' => $iconTrailingVariant,'class' => $iconTrailingClasses], [], ['icon', 'variant', 'class'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?><?php $blaze_memoized_html = ob_get_clean(); ?><?php if ($blaze_memoized_key !== null) { \Livewire\Blaze\Memoizer\Memo::put($blaze_memoized_key, $blaze_memoized_html); } ?><?php echo $blaze_memoized_html; ?><?php endif; ?>
...
<?php _456a8a952c91dd5f727236a9bcd63c5d($__blaze, $__attrs456a8a952c91dd5f727236a9bcd63c5d, $__slots456a8a952c91dd5f727236a9bcd63c5d, ['type', 'attributes', 'dataFluxButton'], ['dataFluxButton' => 'data-flux-button'], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php _61bc94f66e133c8c88763f97d4c55076($__blaze, $__attrs61bc94f66e133c8c88763f97d4c55076, $__slots61bc94f66e133c8c88763f97d4c55076, ['attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
} endif; ?><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/src/../stubs/resources/views/flux/button/index.blade.php ENDPATH**/ ?>