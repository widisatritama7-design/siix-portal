<?php
if (!function_exists('_e8e18624181a94b5261758492cdb71ab')):
function _e8e18624181a94b5261758492cdb71ab($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php _1d82c52e4a29cdddc4de99b92b462711($__blaze, ['attributes' => $paginationAttributes], [], ['attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
    <?php endif; ?>
</div>
<?php
echo ltrim(ob_get_clean());
} endif; ?><?php /**PATH D:\laragon\www\siix-portal-new\vendor\livewire\flux\stubs\resources\views\flux\table\index.blade.php ENDPATH**/ ?>