...
<section class="w-full" x-data="{ currentStep: 0, steps: [] }" x-init="steps = [
    ...
    <?php ob_start(); ?><div class="font-medium [:where(&amp;)]:text-zinc-800 [:where(&amp;)]:dark:text-white text-sm [&amp;:has(+[data-flux-subheading])]:mb-2 [[data-flux-subheading]+&amp;]:mt-2 sr-only" data-flux-heading><?php ob_start(); ?>
        <?php echo e(__('MTC - Create Daily Panasonic Inspection')); ?>
                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div class="w-full sm:w-auto">
                        ...
                        <p class="text-xs sm:text-sm text-zinc-500 dark:text-zinc-400 mt-1">
                            Create new inspection record for line <?php echo e($masterLine->line_number); ?>
    ...
    <?php ob_start(); ?>
                            ...
                            <div class="p-6 space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" wire:model.live="clamp_presure_sp_60" placeholder="Enter value or '-' for not applicable" class="w-full rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 <?php echo e($this->getFieldColorClass('clamp_presure_sp_60', $clamp_presure_sp_60)); ?>">
                                    <?php $validation = $this->validateNumericField('clamp_presure_sp_60', $clamp_presure_sp_60); ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$validation['valid'] && $clamp_presure_sp_60 !== null && $clamp_presure_sp_60 !== '' && $clamp_presure_sp_60 !== '-'): ?>
                                        <p class="text-xs text-red-600 mt-1"><?php echo e($validation['message']); ?></p>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-zinc-500 mt-1 mb-2">Details On Check : Check with Pressure Meter (write value) | Standard : 0.20 ~ 0.4 Mpa</p>
                                    <input type="text" wire:model.live="clamp_presure_spg_2" placeholder="Enter value or '-' for not applicable" class="w-full rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 <?php echo e($this->getFieldColorClass('clamp_presure_spg_2', $clamp_presure_spg_2)); ?>">
                                    <?php $validation = $this->validateNumericField('clamp_presure_spg_2', $clamp_presure_spg_2); ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$validation['valid'] && $clamp_presure_spg_2 !== null && $clamp_presure_spg_2 !== '' && $clamp_presure_spg_2 !== '-'): ?>
                                        <p class="text-xs text-red-600 mt-1"><?php echo e($validation['message']); ?></p>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" wire:model.live="squeege_sp_60" placeholder="Enter value or '-' for not applicable" class="w-full rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 <?php echo e($this->getFieldColorClass('squeege_sp_60', $squeege_sp_60)); ?>">
                                    <?php $validation = $this->validateNumericField('squeege_sp_60', $squeege_sp_60); ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$validation['valid'] && $squeege_sp_60 !== null && $squeege_sp_60 !== '' && $squeege_sp_60 !== '-'): ?>
                                        <p class="text-xs text-red-600 mt-1"><?php echo e($validation['message']); ?></p>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" wire:model.live="squeege_spg_2" placeholder="Enter value or '-' for not applicable" class="w-full rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 <?php echo e($this->getFieldColorClass('squeege_spg_2', $squeege_spg_2)); ?>">
                                    <?php $validation = $this->validateNumericField('squeege_spg_2', $squeege_spg_2); ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$validation['valid'] && $squeege_spg_2 !== null && $squeege_spg_2 !== '' && $squeege_spg_2 !== '-'): ?>
                                        <p class="text-xs text-red-600 mt-1"><?php echo e($validation['message']); ?></p>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
    ...
    <?php ob_start(); ?>
                            ...
                            <div class="p-6 space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" wire:model.live="vaccuum_pump" placeholder="Enter value or '-' for not applicable" class="w-full rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 <?php echo e($this->getFieldColorClass('vaccuum_pump', $vaccuum_pump)); ?>">
                                    <?php $validation = $this->validateNumericField('vaccuum_pump', $vaccuum_pump); ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$validation['valid'] && $vaccuum_pump !== null && $vaccuum_pump !== '' && $vaccuum_pump !== '-'): ?>
                                        <p class="text-xs text-red-600 mt-1"><?php echo e($validation['message']); ?></p>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
    ...
    <?php ob_start(); ?>
                            ...
                            <div class="p-6 space-y-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-zinc-500 mt-1 mb-2">Details On Check : Check with Pressure Meter (write value) | Standard : -87 ~ -100 Kpa</p>
                                    <input type="text" wire:model.live="vaccuum_pump_3" placeholder="Enter value or '-' for not applicable" class="w-full rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 <?php echo e($this->getFieldColorClass('vaccuum_pump_3', $vaccuum_pump_3)); ?>">
                                    <?php $validation = $this->validateNumericField('vaccuum_pump_3', $vaccuum_pump_3); ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$validation['valid'] && $vaccuum_pump_3 !== null && $vaccuum_pump_3 !== '' && $vaccuum_pump_3 !== '-'): ?>
                                        <p class="text-xs text-red-600 mt-1"><?php echo e($validation['message']); ?></p>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </div>
    ...
    <?php ob_start(); ?>
                            ...
                            <div class="p-6 space-y-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-zinc-500 mt-1 mb-2">Details On Check : Check with Pressure Meter (write value) | Standard : -87 ~ -100 Kpa</p>
                                    <input type="text" wire:model.live="vaccuum_pump_4" placeholder="Enter value or '-' for not applicable" class="w-full rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 <?php echo e($this->getFieldColorClass('vaccuum_pump_4', $vaccuum_pump_4)); ?>">
                                    <?php $validation = $this->validateNumericField('vaccuum_pump_4', $vaccuum_pump_4); ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$validation['valid'] && $vaccuum_pump_4 !== null && $vaccuum_pump_4 !== '' && $vaccuum_pump_4 !== '-'): ?>
                                        <p class="text-xs text-red-600 mt-1"><?php echo e($validation['message']); ?></p>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </div>
...
</style><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/resources/views/livewire/mtc/daily/panasonic/daily-panasonic-create.blade.php ENDPATH**/ ?>