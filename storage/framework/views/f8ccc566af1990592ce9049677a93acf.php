                ...
                <tr>
                    <td style="width: 50%; vertical-align: top;">
                        <table style="width: 100%;">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($machine_names)): ?>
                            <tr>
                                <td style="width: 100px;">Machine Filter</td>
                                <td colspan="3">: <?php echo e(implode(', ', $machine_names)); ?></td>
                            </tr>
