    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mt-2">
        <div>
            ...
            <p class="text-sm text-zinc-500 dark:text-zinc-400 mt-1">
                Manage Defect item master data
            </p>
        </div>

        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create deffect')): ?>
...
<?php $__blaze->pushData(['wire:model.live.debounce.300ms' => 'search','placeholder' => 'Search Defect item name...','icon' => 'magnifying-glass','clearable' => true]); ?>
<?php _5ae551d98c08f0bc67bd05455e08306c($__blaze, ['wire:model.live.debounce.300ms' => 'search','placeholder' => 'Search Defect item name...','icon' => 'magnifying-glass','clearable' => true], [], ['clearable'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
        </div>
    </div>
...
<?php echo ltrim(ob_get_clean()); ?>
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
            <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-xl w-full max-w-md">
                <div class="p-6">
                    ...
                    <form wire:submit="save" id="deffect-form">
                        <div class="mb-4">
    ...
    <?php ob_start(); ?>Defect Item Name<?php echo trim(ob_get_clean()); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
                            <?php $__blaze->ensureRequired('/www/wwwroot/testings.siix-ems.co.id/siix-portal/vendor/livewire/flux/src/../stubs/resources/views/flux/input/index.blade.php', $__blaze->compiledPath.'/5ae551d98c08f0bc67bd05455e08306c.php'); ?>
<?php $__blaze->pushData(['wire:model' => 'deffect_item_name','type' => 'text','placeholder' => 'Enter deffect item name','class' => 'uppercase']); ?>
<?php _5ae551d98c08f0bc67bd05455e08306c($__blaze, ['wire:model' => 'deffect_item_name','type' => 'text','placeholder' => 'Enter deffect item name','class' => 'uppercase'], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['deffect_item_name'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="p-6 pt-0 flex justify-end gap-2">
                    ...
                    <button type="submit" 
                        ...
                        wire:target="save">
                        <span wire:loading.remove wire:target="save"><?php echo e($deffect_id ? 'Update' : 'Create'); ?></span>
    ...
    <div x-data="{ open: false }" 
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
            <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-xl w-full max-w-lg">
                <div class="p-6">
                    <h2 class="text-xl font-bold mb-4">Defect Item Detail</h2>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($viewData): ?>
                    <div class="space-y-3">
                        <div>
                            <span class="text-xs text-zinc-500 dark:text-zinc-400">Defect Item Name</span>
                            <p class="text-sm font-semibold text-zinc-800 dark:text-white mt-1"><?php echo e($viewData->deffect_item_name); ?></p>
                        </div>
                        <div>
    ...
    <div x-data="{ open: false }" 
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
            <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-xl w-full max-w-md p-6">
                ...
                <h3 class="text-lg font-bold mb-2 text-center">Delete Defect Item</h3>
                <p class="text-gray-600 dark:text-gray-400 mb-4 text-center">
                    Are you sure you want to delete Defect item <span class="font-semibold"><?php echo e($deffectToDelete?->deffect_item_name); ?></span>?
                </p>
...
</div><?php /**PATH /www/wwwroot/testings.siix-ems.co.id/siix-portal/resources/views/livewire/qaqc/blind-test/deffect-management.blade.php ENDPATH**/ ?>