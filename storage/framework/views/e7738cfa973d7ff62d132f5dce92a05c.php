<?php
if (!function_exists('_e7738cfa973d7ff62d132f5dce92a05c')):
function _e7738cfa973d7ff62d132f5dce92a05c($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php _0f2a77fb6d4d542c1b97a0147f9e29a8($__blaze, ['icon' => $icon,'variant' => $iconVariant,'class' => $iconClasses,'dataFluxBadgeIcon' => true], [], ['icon', 'variant', 'class', 'dataFluxBadgeIcon'], ['dataFluxBadgeIcon' => 'data-flux-badge-icon'], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php $__blaze->popData(); ?><?php $blaze_memoized_html = ob_get_clean(); ?><?php if ($blaze_memoized_key !== null) { \Livewire\Blaze\Memoizer\Memo::put($blaze_memoized_key, $blaze_memoized_html); } ?><?php echo $blaze_memoized_html; ?><?php endif; ?>
    ...
    <?php endif; ?>
<?php $__slotsa707556c65f262d60ed9ba2d3f6fce52['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slotsa707556c65f262d60ed9ba2d3f6fce52); ?>
<?php _a707556c65f262d60ed9ba2d3f6fce52($__blaze, $__attrsa707556c65f262d60ed9ba2d3f6fce52, $__slotsa707556c65f262d60ed9ba2d3f6fce52, ['attributes', 'dataFluxBadge'], ['dataFluxBadge' => 'data-flux-badge'], $__this ?? (isset($this) ? $this : null)); ?>
