<?php
if (!function_exists('_fac5f31e0d344cf0c75d0ed78270eee2')):
function _fac5f31e0d344cf0c75d0ed78270eee2($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php _75022e6793246d7c0857d122fef03258($__blaze, [], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
            <?php endfor; ?>
        <?php else: ?>
            <?php echo e($slot); ?>
