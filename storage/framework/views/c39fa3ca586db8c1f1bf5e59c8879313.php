                        ...
                        <td style="padding: 20px; color: #333333; font-size: 16px; line-height: 1.5;">
                            ...
                            <table width="100%" cellpadding="5" cellspacing="0" style="border-collapse: collapse;">
                                ...
                                <tr style="background-color: #f9f9f9;">
                                    ...
                                    <td>: <?php echo e($submission->distributed_by); ?></td>
                                </tr>
                                <tr>
                                    <td style="font-weight: bold;">Distributed </td>
                                    <td>: <?php echo e($submission->distributed_at->format('d-m-Y H:i')); ?></td>
                                </tr>
                                <tr style="background-color: #f9f9f9;">
...
</html><?php /**PATH D:\laragon\www\siix-portal-new\resources\views\emails\DCC\submission_distributed.blade.php ENDPATH**/ ?>