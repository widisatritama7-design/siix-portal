...
<?php $__blaze->popData(); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($adminFeedbackFilter || $costingFeedbackFilter || $misscStatusFilter || $dateFrom || $dateTo || $search): ?>
            ...
            <table class="w-full">
                <thead>
                    <tr class="bg-zinc-50 dark:bg-zinc-800/50">
                        <th class="px-4 py-3 text-center text-xs font-medium text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">Request Number #</th>
                        ...
                        <th class="px-4 py-3 text-center text-xs font-medium text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">Admin Feedback</th>
                        <th class="px-4 py-3 text-center text-xs font-medium text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">Costing Feedback</th>
                        <th class="px-4 py-3 text-center text-xs font-medium text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">MISSC Status</th>
                ...
                <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                    ...
                    ?>
                    <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'row-'.e($index).''; ?>wire:key="row-<?php echo e($index); ?>">
                        ...
                        <td class="px-4 py-3 text-center">
                            ...
                            <div class="flex flex-col items-center gap-1">
                                <span class="inline-flex items-center gap-1 px-2 py-1 text-sm font-medium rounded-full bg-<?php echo e($statusColor); ?>-100 text-<?php echo e($statusColor); ?>-700 dark:bg-<?php echo e($statusColor); ?>-900/30 dark:text-<?php echo e($statusColor); ?>-300">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4">
                                        <path fill-rule="evenodd" d="<?php echo e($statusIcon); ?>" clip-rule="evenodd" />
                                    </svg>
                                    <?php echo e($status); ?>

                                </span>
                                
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($status == 'Accepted' && $request->missc_accept_at): ?>
                        ...
                        <td class="px-4 py-3 text-center">
                            <div class="flex items-center gap-3">
                                <div class="w-8 h-8 rounded-full bg-gradient-to-br from-green-500 to-emerald-600 flex items-center justify-center text-white font-medium shadow-lg flex-shrink-0 text-sm">
                                    <?php echo e(strtoupper(substr($request->created_by, 0, 1))); ?>

                                </div>
                                <div>
                                    <div class="text-sm font-medium text-zinc-800 dark:text-white"><?php echo e($request->created_by); ?></div>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="px-4 py-3 text-center">
                            <div class="text-sm">
                                <div><?php echo e($request->created_at ? $request->created_at->format('d M Y H:i') : '-'); ?></div>
                            </div>
                        </td>
                            ...
                            <div class="flex flex-col items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-zinc-500 dark:text-zinc-400 mb-4">
                                        <?php echo e($search ? 'Try adjusting your search query' : 'Get started by creating a new request'); ?>
