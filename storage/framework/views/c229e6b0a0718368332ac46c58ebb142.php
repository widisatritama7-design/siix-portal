...
<?php _f9ce25dced5c86c906351e8ca96b9cbb($__blaze, ['wire:model.live.debounce.300ms' => 'search','placeholder' => 'Search by request #...','icon' => 'magnifying-glass','clearable' => true], [], ['clearable'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
            </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($adminFeedbackFilter || $costingFeedbackFilter || $misscStatusFilter || $verificationFilter || $signatureFilter || $dateFrom || $dateTo || $search): ?>
    ...
    <!-- LEGEND CARD -->
    <?php ob_start(); ?><div class="[:where(&amp;)]:bg-white dark:[:where(&amp;)]:bg-white/10 border border-zinc-200 dark:border-white/10 [:where(&amp;)]:p-6 [:where(&amp;)]:rounded-xl p-4 shadow-sm mb-4" data-flux-card>
    <?php ob_start(); ?>
        <!-- Verification Status -->
        <div class="mb-4">
...
<?php echo ltrim(ob_get_clean()); ?>
                        ...
                        <td class="px-4 py-3 text-center whitespace-nowrap">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($verificationStatus['status'] == 'N/A'): ?>
                                <span class="inline-flex items-center gap-1 px-2 py-1 text-sm font-medium rounded-full bg-gray-100 text-gray-600 dark:bg-gray-800 dark:text-gray-400 whitespace-nowrap">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4 shrink-0">
                                        <path fill-rule="evenodd" d="<?php echo e($verificationIcon); ?>" clip-rule="evenodd" />
                                    </svg>
                                    N/A
                                    <?php ob_start(); ?><ui-tooltip position="top center"  data-flux-tooltip >
        <?php ob_start(); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
                            ...
                            <?php elseif($verificationStatus['status'] == 'Waiting'): ?>
...
<?php echo ltrim(ob_get_clean()); ?>
                            ...
                            <?php elseif($verificationStatus['status'] == 'On Process'): ?>
...
<?php echo ltrim(ob_get_clean()); ?>
                            ...
                            <?php elseif($verificationStatus['status'] == 'Approved'): ?>
...
<?php echo ltrim(ob_get_clean()); ?>
                            ...
                            <?php elseif($verificationStatus['status'] == 'Completed'): ?>
...
<?php echo ltrim(ob_get_clean()); ?>
                        ...
                        <td class="px-4 py-3 text-center whitespace-nowrap">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($costingStatus['status'] == 'Checked'): ?>
                                <span class="inline-flex items-center gap-1 px-2 py-1 text-sm font-medium text-green-700 bg-green-100 rounded-full dark:bg-green-900/30 dark:text-green-300 whitespace-nowrap">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4 shrink-0">
                                        <path fill-rule="evenodd" d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12Zm13.36-1.814a.75.75 0 1 0-1.22-.872l-3.236 4.53L9.53 12.22a.75.75 0 0 0-1.06 1.06l2.25 2.25a.75.75 0 0 0 1.14-.094l3.75-5.25Z" clip-rule="evenodd" />
                                    </svg>
                            ...
                            <?php elseif($costingStatus['status'] == 'On Process'): ?>
                                <span class="inline-flex items-center gap-1 px-2 py-1 text-sm font-medium text-yellow-700 bg-yellow-100 rounded-full dark:bg-yellow-900/30 dark:text-yellow-300 whitespace-nowrap">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4 shrink-0">
                                        <path fill-rule="evenodd" d="M4.755 10.059a7.5 7.5 0 0 1 12.548-3.364l1.903 1.903h-3.183a.75.75 0 1 0 0 1.5h4.992a.75.75 0 0 0 .75-.75V4.356a.75.75 0 0 0-1.5 0v3.18l-1.9-1.9A9 9 0 0 0 3.306 9.67a.75.75 0 1 0 1.45.388Zm15.408 3.352a.75.75 0 0 0-.919.53 7.5 7.5 0 0 1-12.548 3.364l-1.902-1.903h3.183a.75.75 0 0 0 0-1.5H2.984a.75.75 0 0 0-.75.75v4.992a.75.75 0 0 0 1.5 0v-3.18l1.9 1.9a9 9 0 0 0 15.059-4.035.75.75 0 0 0-.53-.918Z" clip-rule="evenodd" />
                                    </svg>
...
<?php echo ltrim(ob_get_clean()); ?>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update uniform request missc status')): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($request->missc_status != 'Accepted' && $adminStatus['status'] == 'Checked' && $costingStatus['status'] == 'Checked'): ?>
                                        <?php ob_start(); ?><ui-tooltip position="bottom center"  data-flux-tooltip >
        <?php ob_start(); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
        ...
        <?php ob_start(); ?>
                    ...
                    <div popover="manual" class="relative py-2 px-2.5 rounded-md text-xs text-white font-medium bg-zinc-800 dark:bg-zinc-700 dark:border dark:border-white/10 p-0 overflow-visible" data-flux-tooltip-content>
    Cannot update MISSC Status - Admin and Costing feedback must be checked first
...
<?php echo ltrim(ob_get_clean()); ?>
                                    <?php elseif($canEdit && $request->missc_status != 'Waiting'): ?>
...
<?php $__attrs808b9b4046ff2f9c00b5d65e5bd272e2 = ['content' => 'Cannot edit - MISSC status is '.e($request->missc_status),'position' => 'bottom']; ?>
...
<?php $__blaze->popData(); ?>
        ...
        <?php ob_start(); ?>
                    ...
                    <div popover="manual" class="relative py-2 px-2.5 rounded-md text-xs text-white font-medium bg-zinc-800 dark:bg-zinc-700 dark:border dark:border-white/10 p-0 overflow-visible" data-flux-tooltip-content>
    Cannot edit - feedback already exists
                        ...
                        <td colspan="10" class="px-4 py-12 text-center">
                            <div class="flex flex-col items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-zinc-500"><?php echo e($search ? 'Try adjusting your search query' : 'Get started by creating a new request'); ?></p>
                                </div>
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
            <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-xl w-full max-w-md">
                <div class="p-6">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedStatus == 'Accepted'): ?>
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
            <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-xl w-full max-w-4xl max-h-[90vh] flex flex-col">
                ...
                <div class="p-6 border-b border-zinc-200 dark:border-zinc-700 flex justify-between items-center flex-shrink-0">
                    <div>
                        ...
                        <p class="text-sm text-zinc-500 dark:text-zinc-400">
                            <?php echo e(count($bulkData)); ?> item(s) from <?php echo e(count($selectedRequests)); ?> selected request(s)
                        </p>
                    </div>
                ...
                <div class="p-6 overflow-y-auto flex-1">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($bulkData) > 0): ?>
                        <div class="border rounded-lg overflow-hidden">
                            <div class="overflow-x-auto">
                                <table class="w-full text-sm">
                                    ...
                                    <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $bulkData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors">
                                            ...
                                            <td class="px-4 py-3 text-center">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item['type'] == 'Create Missc'): ?>
                        ...
                        <div class="mt-4 p-4 bg-zinc-50 dark:bg-zinc-800/50 rounded-lg border border-zinc-200 dark:border-zinc-700">
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                <div>
                                    ...
                                    <p class="text-lg font-bold text-zinc-800 dark:text-zinc-200"><?php echo e(count($bulkData)); ?></p>
                                </div>
                                <div>
                                    <p class="text-xs text-zinc-500 dark:text-zinc-400">Total Quantity</p>
                                    <p class="text-lg font-bold text-blue-600 dark:text-blue-400"><?php echo e(array_sum(array_column($bulkData, 'qty'))); ?></p>
                                </div>
                                <div>
                                    <p class="text-xs text-zinc-500 dark:text-zinc-400">Create Missc</p>
                                    <p class="text-lg font-bold text-green-600 dark:text-green-400">
                                        <?php echo e(array_sum(array_column(array_filter($bulkData, function($item) { return $item['type'] == 'Create Missc'; }), 'qty'))); ?>
                                ...
                                <div>
                                    ...
                                    <p class="text-lg font-bold text-purple-600 dark:text-purple-400">
                                        <?php echo e(array_sum(array_column(array_filter($bulkData, function($item) { return $item['type'] == 'Create Stock Manual'; }), 'qty'))); ?>
...
</div><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/resources/views/livewire/prod/uniform/uniform-request-index.blade.php ENDPATH**/ ?>