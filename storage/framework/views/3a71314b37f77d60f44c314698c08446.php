...
<div class="p-1 space-y-2">
    <?php $__env->startSection('title', $requestId ? 'Edit Uniform Request' : 'Create Uniform Request'); ?>
...
<?php $__blaze->popData(); ?>
        <?php ob_start(); ?><div class="flex items-center text-sm font-medium group/breadcrumb font-semibold text-blue-600" data-flux-breadcrumbs-item>
            <div class="text-gray-500 dark:text-white/80">
                            <?php ob_start(); ?><?php echo e($requestId ? 'Edit' : 'Create'); ?><?php echo trim(ob_get_clean()); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mt-2">
        <div>
            <h1 class="text-3xl font-bold text-zinc-800 dark:text-white">
                <?php echo e($requestId ? 'Edit Uniform Request' : 'Create Uniform Request'); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$lockAcquired && $lockOwner): ?>
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-red-700 dark:text-red-300">
                            Oleh: <strong class="font-semibold"><?php echo e($lockOwner); ?></strong>
                        </p>
                ...
                <div class="flex items-center gap-3 flex-shrink-0 ml-4">
                    ...
                    <div class="bg-red-600 dark:bg-red-500 rounded-lg px-4 py-2 shadow-md">
                        <div class="flex items-center gap-2">
                            ...
                            <span x-data="{
                                expiresAt: <?php echo e($this->getLockExpiresAtTimestamp()); ?>,
                                timeLeft: 0,
                                interval: null,
                                init() {
                                    this.updateTimer();
                                ...
                                updateTimer() {
                                    ...
                                    if (this.timeLeft <= 0 && this.interval) {
                                        ...
                                        this.interval = null;
                                        window.location.href = '<?php echo e(route('prod.uniform.request.index')); ?>';
                                    }
                                },
                                formatTime(seconds) {
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isOneUser && !$isFullAccess && $userDepartment): ?>
            ...
            <div class="flex items-start gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-blue-600 dark:text-blue-400">
                        ...
                        <strong class="font-semibold"><?php echo e($userDepartment); ?></strong>
                    </p>
                </div>
            </div>
        </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canManual): ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-6">
            ...
            <div class="lg:col-span-8 xl:col-span-8 space-y-6">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($rows) > 0): ?>
                    ...
                    ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($existingType === 'manual'): ?>
                    ...
                    <?php elseif($existingType === 'normal'): ?>
                ...
                <?php ob_start(); ?><div class="[:where(&amp;)]:bg-white dark:[:where(&amp;)]:bg-white/10 border border-zinc-200 dark:border-white/10 [:where(&amp;)]:p-6 [:where(&amp;)]:rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300" data-flux-card>
    <?php ob_start(); ?>
                    ...
                    <div class="mb-4">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isManualMode): ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['current_request_date'];
                        ...
                        <?php else: ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <!-- Search Input -->
                                    <div x-data="{ search: <?php if ((object) ('employeeSearch') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('employeeSearch'->value()); ?>')<?php echo e('employeeSearch'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('employeeSearch'); ?>')<?php endif; ?> }">
                                        <input 
                                            type="text"
                                            x-model="search"
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['current_employee_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['current_group'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isManualMode): ?>
                            <!-- Results Table -->
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($employeeSearch) && strlen($employeeSearch) >= 2 && empty($current_employee_id)): ?>
                                    ...
                                    <div class="overflow-x-auto max-h-60 overflow-y-auto">
                                        <table class="w-full text-sm">
                                            ...
                                            <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $filteredEmployees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                    <?php
                                                        $isAlreadyAdded = in_array($employee['value'], $existingEmployeeIds);
                                                    ?>
                                                    <tr class="<?php echo e($isAlreadyAdded ? 'bg-gray-50 dark:bg-gray-800/50 cursor-not-allowed opacity-60' : 'hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors cursor-pointer'); ?>" 
                                                        <?php if(!$isAlreadyAdded): ?>
                                                            @click="$wire.set('current_employee_id', '<?php echo e($employee['value']); ?>'); $wire.set('employeeSearch', '<?php echo e(addslashes($employee['label'])); ?>');"
                                                        <?php endif; ?>
                                                    >
                                                        <td class="px-3 py-2 text-center"><?php echo e($employee['nik']); ?></td>
                                                        <td class="px-3 py-2 text-zinc-800 dark:text-zinc-200"><?php echo e($employee['name']); ?></td>
...
<?php $__attrsdc7b41944d7ad01d0a093ce0d326337c = ['size' => 'xs','color' => e($isAlreadyAdded ? 'gray' : 'sky')]; ?>
<?php $__slotsdc7b41944d7ad01d0a093ce0d326337c = []; ?>
<?php $__blaze->pushData($__attrsdc7b41944d7ad01d0a093ce0d326337c); ?>
<?php ob_start(); ?><?php echo e($employee['department']); ?><?php $__slotsdc7b41944d7ad01d0a093ce0d326337c['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
...
<?php $__blaze->popData(); ?>
                                                        ...
                                                        <td class="px-3 py-2 text-center">
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isAlreadyAdded): ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($filteredEmployees) > 0): ?>
                                        <div class="px-3 py-1.5 border-t border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800/50 text-xs text-zinc-500">
                                            Found <?php echo e(count($filteredEmployees)); ?> employee(s)
                                            <?php
                                                $addedCount = 0;
                                            ...
                                            ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($addedCount > 0): ?>
                                                <span class="text-blue-600 dark:text-blue-400">(<?php echo e($addedCount); ?> already added)</span>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($current_employee_id) && !empty($employeeSearch)): ?>
                                <div class="mt-3 p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
                                    <div class="flex items-center gap-3 text-sm">
                                        ...
                                        <span class="font-semibold text-green-800 dark:text-green-200"><?php echo e($employeeSearch); ?></span>
                                        <button type="button" 
                        ...
                        <div class="mt-4 pt-4 border-t border-zinc-200 dark:border-zinc-700">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isManualMode): ?>
                                ...
                                <button type="button" 
                                    ...
                                    <span>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasManualData): ?>
                            ...
                            <?php else: ?>
                                ...
                                <button type="button" 
                                    wire:click="toggleManualInput"
                                    <?php echo e($hasNormalData ? 'disabled' : ''); ?>

                                    class="w-full px-4 py-3 rounded-lg font-medium flex items-center justify-center gap-2 shadow-sm transition-colors
                                    <?php echo e($hasNormalData 
                                        ? 'bg-gray-300 dark:bg-gray-700 text-gray-500 dark:text-gray-400 cursor-not-allowed' 
                                        : 'bg-blue-600 text-white hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600'); ?>">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-5">
                                    ...
                                    <span>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasNormalData): ?>
    ...
    <?php ob_start(); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['manualName'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> 
                                <span class="text-red-500 text-xs block mt-1.5"><?php echo e($message); ?></span> 
                            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <select wire:model="manualDepartment" 
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $manualDepartmentOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!in_array($dept, ['Executive Officer', 'OS', 'President Director', 'TRAINING'])): ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['manualDepartment'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> 
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['manualTanggalPemberkasan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> 
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['manualDoj'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> 
...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <?php ob_start(); ?>
                        ...
                        <div class="border rounded-lg overflow-hidden mb-3">
                            <div class="overflow-x-auto" style="overflow-x: auto !important; white-space: nowrap !important;">
                                <table class="w-full text-sm" style="min-width: 750px;">
                                    ...
                                    <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $availableUniforms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uniform): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <?php
                                        ...
                                        ?>
                                        <tr class="<?php echo e($isOutOfStock || $isAlreadyAdded ? 'bg-gray-50 dark:bg-gray-800/50 opacity-60' : 'hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors'); ?>">
                                            <td class="px-3 py-2 text-sm font-mono whitespace-nowrap text-center"><?php echo e($uniform->item_code); ?></td>    
                                            <td class="px-3 py-2 text-sm whitespace-nowrap"><?php echo e($uniform->description); ?></td>
        ...
        <?php ob_start(); ?><?php echo e($uniform->size); ?><?php echo trim(ob_get_clean()); ?>

    </div>
<?php echo ltrim(ob_get_clean()); ?>
                                            </td>
                                            <td class="px-3 py-2 text-center whitespace-nowrap">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($uniform->status == 'Manual'): ?>
                                                    <?php ob_start(); ?><div data-flux-badge="data-flux-badge" class="inline-flex items-center font-medium whitespace-nowrap  [print-color-adjust:exact] text-sm py-1 **:data-flux-badge-icon:me-1.5 rounded-md px-2 text-blue-800 [&amp;_button]:text-blue-800! dark:text-blue-200 dark:[&amp;_button]:text-blue-200! bg-blue-400/20 dark:bg-blue-400/40 [&amp;:is(button)]:hover:bg-blue-400/30 dark:[button]:hover:bg-blue-400/50">
        <?php ob_start(); ?>Manual<?php echo trim(ob_get_clean()); ?>

    </div>
<?php echo ltrim(ob_get_clean()); ?>
                                                <?php elseif($uniform->status == 'System'): ?>
        ...
        <?php ob_start(); ?>System<?php echo trim(ob_get_clean()); ?>

    </div>
<?php echo ltrim(ob_get_clean()); ?>
                                                <?php elseif($uniform->status == 'Not Use'): ?>
        ...
        <?php ob_start(); ?>Not Use<?php echo trim(ob_get_clean()); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
        ...
        <?php ob_start(); ?><?php echo e($uniform->status); ?><?php echo trim(ob_get_clean()); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
                                            ...
                                            <td class="px-3 py-2 text-center whitespace-nowrap">
                                                <span class="text-sm font-semibold <?php echo e($uniform->available_qty <= 0 ? 'text-red-600 dark:text-red-400' : 'text-green-600 dark:text-green-400'); ?>">
                                                    <?php echo e($uniform->available_qty); ?>

                                                </span>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($uniform->available_qty <= 0 && $uniform->qty > 0): ?>
                                                    <span class="text-xs text-red-500 block">(Reserved: <?php echo e($uniform->reserved_qty); ?>)</span>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </td>
                                            <td class="px-3 py-2 text-center whitespace-nowrap">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($uniform->reserved_qty > 0): ?>
                                                    <span class="text-xs text-yellow-600 dark:text-yellow-400 font-medium">
                                                        <?php echo e($uniform->reserved_qty); ?>
                                            ...
                                            <td class="px-3 py-2 text-center whitespace-nowrap">
                                                ...
                                                <?php else: ?>
                                                    <button type="button" 
                                                        wire:click="$set('current_master_uniform_id', <?php echo e($uniform->id); ?>)"
                                        ...
                                        <tr>
                                            <td colspan="7" class="px-3 py-4 text-center text-sm text-zinc-500">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($uniformSearch): ?>
                                                    No uniforms found matching "<span class="font-medium"><?php echo e($uniformSearch); ?></span>"
                                                <?php else: ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($availableUniforms->hasPages()): ?>
                                <div class="px-3 py-2 border-t border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800/50">
                                    <?php echo e($availableUniforms->links()); ?>
                        ...
                        <div class="bg-zinc-50 dark:bg-zinc-800/50 rounded-lg border border-zinc-200 dark:border-zinc-700 overflow-hidden">
                            ...
                            <div class="px-3 py-2 <?php echo e($current_master_uniform_id ? 'bg-green-50 dark:bg-green-900/20 border-b border-green-200 dark:border-green-800' : 'bg-zinc-100 dark:bg-zinc-800 border-b border-zinc-200 dark:border-zinc-700'); ?>">
                                <div class="flex flex-wrap items-center justify-between gap-2">
                                    <div class="flex flex-wrap items-center gap-2">
                                        <span class="text-xs font-medium <?php echo e($current_master_uniform_id ? 'text-green-700 dark:text-green-300' : 'text-zinc-500 dark:text-zinc-400'); ?>">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($current_master_uniform_id): ?>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($current_master_uniform_id): ?>
                                            ...
                                            ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedUniform): ?>
                                                <span class="text-sm font-semibold text-green-700 dark:text-green-400"><?php echo e($selectedUniform->item_code); ?></span>
                                                <span class="text-xs text-green-600 dark:text-green-400">(Stock: <span class="font-semibold <?php echo e($selectedUniform->qty <= 5 ? 'text-red-600' : 'text-green-600'); ?>"><?php echo e($selectedUniform->qty); ?></span>)</span>
                                                <span class="text-xs text-green-300 dark:text-green-600">|</span>
                                                <span class="text-xs text-green-700 dark:text-green-300"><?php echo e($selectedUniform->description); ?></span>
                                                <span class="text-xs text-green-300 dark:text-green-600">|</span>
                                                <?php ob_start(); ?><div data-flux-badge="data-flux-badge" class="inline-flex items-center font-medium whitespace-nowrap  [print-color-adjust:exact] text-sm py-1 **:data-flux-badge-icon:me-1.5 rounded-md px-2 text-green-800 [&amp;_button]:text-green-800! dark:text-green-200 dark:[&amp;_button]:text-green-200! bg-green-400/20 dark:bg-green-400/40 [&amp;:is(button)]:hover:bg-green-400/30 dark:[button]:hover:bg-green-400/50">
        <?php ob_start(); ?><?php echo e($selectedUniform->size); ?><?php echo trim(ob_get_clean()); ?>

    </div>
<?php echo ltrim(ob_get_clean()); ?>
                                                <span class="text-xs text-green-300 dark:text-green-600">|</span>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedUniform->status == 'Manual'): ?>
                                                    <?php ob_start(); ?><div data-flux-badge="data-flux-badge" class="inline-flex items-center font-medium whitespace-nowrap  [print-color-adjust:exact] text-sm py-1 **:data-flux-badge-icon:me-1.5 rounded-md px-2 text-blue-800 [&amp;_button]:text-blue-800! dark:text-blue-200 dark:[&amp;_button]:text-blue-200! bg-blue-400/20 dark:bg-blue-400/40 [&amp;:is(button)]:hover:bg-blue-400/30 dark:[button]:hover:bg-blue-400/50">
        <?php ob_start(); ?>Manual<?php echo trim(ob_get_clean()); ?>

    </div>
<?php echo ltrim(ob_get_clean()); ?>
                                                <?php elseif($selectedUniform->status == 'System'): ?>
                                                    <?php ob_start(); ?><div data-flux-badge="data-flux-badge" class="inline-flex items-center font-medium whitespace-nowrap  [print-color-adjust:exact] text-sm py-1 **:data-flux-badge-icon:me-1.5 rounded-md px-2 text-green-800 [&amp;_button]:text-green-800! dark:text-green-200 dark:[&amp;_button]:text-green-200! bg-green-400/20 dark:bg-green-400/40 [&amp;:is(button)]:hover:bg-green-400/30 dark:[button]:hover:bg-green-400/50">
        <?php ob_start(); ?>System<?php echo trim(ob_get_clean()); ?>

    </div>
<?php echo ltrim(ob_get_clean()); ?>
                                                <?php elseif($selectedUniform->status == 'Not Use'): ?>
                                                    <?php ob_start(); ?><div data-flux-badge="data-flux-badge" class="inline-flex items-center font-medium whitespace-nowrap  [print-color-adjust:exact] text-sm py-1 **:data-flux-badge-icon:me-1.5 rounded-md px-2 text-zinc-700 [&amp;_button]:text-zinc-700! dark:text-zinc-200 dark:[&amp;_button]:text-zinc-200! bg-zinc-400/15 dark:bg-zinc-400/40 [&amp;:is(button)]:hover:bg-zinc-400/25 dark:[button]:hover:bg-zinc-400/50">
        <?php ob_start(); ?>Not Use<?php echo trim(ob_get_clean()); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
                                                <?php else: ?>
                                                    <?php ob_start(); ?><div data-flux-badge="data-flux-badge" class="inline-flex items-center font-medium whitespace-nowrap  [print-color-adjust:exact] text-sm py-1 **:data-flux-badge-icon:me-1.5 rounded-md px-2 text-yellow-800 [&amp;_button]:text-yellow-800! dark:text-yellow-200 dark:[&amp;_button]:text-yellow-200! bg-yellow-400/25 dark:bg-yellow-400/40 [&amp;:is(button)]:hover:bg-yellow-400/40 dark:[button]:hover:bg-yellow-400/50">
        <?php ob_start(); ?><?php echo e($selectedUniform->status); ?><?php echo trim(ob_get_clean()); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($reservedQty > 0): ?>
                                                    <span class="text-xs text-yellow-600 dark:text-yellow-400">
                                                        (Reserved: <?php echo e($reservedQty); ?> | Available: <?php echo e($availableQty); ?>)
                                                    </span>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <?php else: ?>
                            ...
                            <div class="p-3">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-3 items-end">
                                    ...
                                    <div class="col-span-1 sm:col-span-1 lg:col-span-2">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['current_qty'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs block mt-1 text-center"><?php echo e($message); ?></span> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                            ...
                                            <div class="flex gap-2 h-[42px]">
                                                ...
                                                <label class="flex-1 cursor-pointer">
                                                    ...
                                                    <div class="flex items-center justify-center gap-2 px-3 py-2 border-2 rounded-lg transition-all duration-200 h-full
                                                        ...
                                                        <?php echo e($current_reason_type === 'pergantian' ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' : ''); ?>">
                                                        ...
                                                        <span class="text-sm font-medium <?php echo e($current_reason_type === 'pergantian' ? 'text-blue-600 dark:text-blue-400' : 'text-zinc-600 dark:text-zinc-400'); ?>">Pergantian</span>
                                                    </div>
                                                </label>
                                                ...
                                                <label class="flex-1 cursor-pointer">
                                                    ...
                                                    <div class="flex items-center justify-center gap-2 px-3 py-2 border-2 rounded-lg transition-all duration-200 h-full
                                                        ...
                                                        <?php echo e($current_reason_type === 'ng_esd' ? 'border-red-500 bg-red-50 dark:bg-red-900/20' : ''); ?>">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5 <?php echo e($current_reason_type === 'ng_esd' ? 'text-red-500' : 'text-zinc-400 dark:text-zinc-500'); ?> flex-shrink-0">
                                                            <path fill-rule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25Zm-1.72 6.97a.75.75 0 1 0-1.06 1.06L10.94 12l-1.72 1.72a.75.75 0 1 0 1.06 1.06L12 13.06l1.72 1.72a.75.75 0 1 0 1.06-1.06L13.06 12l1.72-1.72a.75.75 0 1 0-1.06-1.06L12 10.94l-1.72-1.72Z" clip-rule="evenodd" />
                                                        </svg>
                                                        <span class="text-sm font-medium <?php echo e($current_reason_type === 'ng_esd' ? 'text-red-600 dark:text-red-400' : 'text-zinc-600 dark:text-zinc-400'); ?>">NG ESD</span>
                                                    </div>
                                                </label>
                                            </div>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div class="mt-3">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($current_reason_type === 'pergantian' && !$isManualMode): ?>
                                        ...
                                        <div>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['current_reason'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> 
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <?php elseif($current_reason_type === 'ng_esd' && !$isManualMode): ?>
                                        ...
                                        <div>
                                            ...
                                            <div <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'file-upload-ng-esd'; ?>wire:key="file-upload-ng-esd">
                                                <div class="relative">
                                                    <input type="file" 
                                                    ...
                                                    <div class="border-2 border-dashed rounded-lg p-4 sm:p-6 transition-all duration-200 text-center
                                                        <?php echo e($current_reason_file ? 'border-green-500 bg-green-50 dark:bg-green-900/20' : 'border-zinc-300 dark:border-zinc-600 hover:border-blue-400 dark:hover:border-blue-500'); ?>

                                                        <?php echo e($errors->has('current_reason_file') ? 'border-red-500 bg-red-50 dark:bg-red-900/20' : ''); ?>">
                                                        
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($current_reason_file): ?>
                                                            <div class="flex items-center justify-center gap-3 flex-wrap">
                                                                ...
                                                                <div class="text-left min-w-0">
                                                                    <p class="text-sm font-medium text-green-700 dark:text-green-300 truncate max-w-[150px] sm:max-w-[200px]">
                                                                        <?php echo e($current_reason_file->getClientOriginalName()); ?>

                                                                    </p>
                                                                    <p class="text-xs text-green-600 dark:text-green-400">
                                                                        <?php echo e(number_format($current_reason_file->getSize() / 1024, 1)); ?> KB
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['current_reason_file'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> 
...
<?php echo ltrim(ob_get_clean()); ?>
            ...
            <div class="lg:col-span-4 xl:col-span-4">
                ...
                <?php ob_start(); ?><div class="[:where(&amp;)]:bg-white dark:[:where(&amp;)]:bg-white/10 border border-zinc-200 dark:border-white/10 [:where(&amp;)]:p-6 [:where(&amp;)]:rounded-xl p-4 shadow-lg hover:shadow-xl transition-shadow duration-300" data-flux-card>
    <?php ob_start(); ?>
                    <!-- Header -->
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <span class="text-sm bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 px-3 py-1 rounded-full font-semibold">
                            <?php echo e(count($current_uniforms)); ?> item(s)
                        </span>
                    </div>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($current_uniforms) > 0): ?>
                        <!-- List dengan scroll jika > 3 item -->
                        <div class="<?php echo e(count($current_uniforms) > 3 ? 'max-h-[400px] overflow-y-auto pr-1' : ''); ?>">
                            <div class="space-y-3">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $current_uniforms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $uniform): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        ...
                                        <div class="flex items-start justify-between gap-3">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <div class="flex items-center gap-2 mb-1 flex-wrap">
                                                    <span class="text-sm font-semibold text-blue-600 dark:text-blue-400"><?php echo e($uniform['item_code']); ?></span>
                                                    <span class="text-xs text-zinc-400 dark:text-zinc-500">|</span>
                                                    <span class="text-xs font-medium text-zinc-600 dark:text-zinc-400"><?php echo e($uniform['size'] ?? '-'); ?></span>
                                                    <span class="text-xs text-zinc-400 dark:text-zinc-500">|</span>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($uniform['status'] == 'Manual'): ?>
                                                        <?php ob_start(); ?><div data-flux-badge="data-flux-badge" class="inline-flex items-center font-medium whitespace-nowrap  [print-color-adjust:exact] text-sm py-1 **:data-flux-badge-icon:me-1.5 rounded-md px-2 text-blue-800 [&amp;_button]:text-blue-800! dark:text-blue-200 dark:[&amp;_button]:text-blue-200! bg-blue-400/20 dark:bg-blue-400/40 [&amp;:is(button)]:hover:bg-blue-400/30 dark:[button]:hover:bg-blue-400/50">
        <?php ob_start(); ?>Manual<?php echo trim(ob_get_clean()); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
                                                ...
                                                <p class="text-sm text-zinc-700 dark:text-zinc-300 truncate"><?php echo e($uniform['description'] ?? $uniform['item_code']); ?></p>
                                                
                                                <!-- Reason Type & File -->
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($uniform['reason_type'])): ?>
                                                    <div class="flex items-center gap-2 mt-1.5 flex-wrap">
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($uniform['reason_type'] === 'ng_esd'): ?>
                                                            ...
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($uniform['reason_file'])): ?>
                                                                <span class="text-xs text-green-600 dark:text-green-400 flex items-center gap-1">
                                                                    ...
                                                                    <?php echo e($uniform['reason_file_name'] ?? 'PDF'); ?>

                                                                </span>
                                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                        <?php elseif($uniform['reason_type'] === 'new_employee'): ?>
                                                        ...
                                                        <?php else: ?>
                                                            ...
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($uniform['reason'])): ?>
                                                                <span class="text-xs text-zinc-500 dark:text-zinc-400 truncate max-w-[100px]">
                                                                    <?php echo e(Str::limit($uniform['reason'], 20)); ?>
                                            ...
                                            <div class="flex items-center gap-3 flex-shrink-0">
                                                <div class="text-center">
                                                    <span class="text-lg font-bold text-blue-600 dark:text-blue-400"><?php echo e($uniform['qty']); ?></span>
                                                    <span class="text-xs text-zinc-500 dark:text-zinc-400 block">Qty</span>
                                                </div>
                                                <button type="button" 
                                                    wire:click="removeUniformFromCurrent(<?php echo e($index); ?>)"
                        ...
                        <div class="mt-4 pt-3 border-t-2 border-zinc-200 dark:border-zinc-700">
                            <div class="grid grid-cols-2 gap-2">
                                <div class="bg-zinc-50 dark:bg-zinc-800/50 rounded-lg p-2 text-center">
                                    ...
                                    <p class="text-lg font-bold text-zinc-700 dark:text-zinc-300"><?php echo e(count($current_uniforms)); ?></p>
                                </div>
                                <div class="bg-zinc-50 dark:bg-zinc-800/50 rounded-lg p-2 text-center">
                                    <span class="text-xs text-zinc-500 dark:text-zinc-400">Total Quantity</span>
                                    <p class="text-lg font-bold text-blue-600 dark:text-blue-400"><?php echo e(array_sum(array_column($current_uniforms, 'qty'))); ?></p>
                                </div>
                            </div>
                        </div>
                    <?php else: ?>
                    ...
                    <div class="border-t pt-4 mt-4">
                        <button type="button" 
                            ...
                            <?php echo e(!$hasCartItems ? 'disabled' : ''); ?>

                            title="<?php echo e(!$hasCartItems ? 'Please add at least one uniform to cart' : 'Add Employee Request'); ?>">
...
<?php echo ltrim(ob_get_clean()); ?>
        ...
        <?php ob_start(); ?><div class="[:where(&amp;)]:bg-white dark:[:where(&amp;)]:bg-white/10 border border-zinc-200 dark:border-white/10 [:where(&amp;)]:p-6 [:where(&amp;)]:rounded-xl p-6 mb-6" data-flux-card>
    <?php ob_start(); ?>
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-lg font-semibold">Request Items</h2>
                <div class="text-sm text-zinc-500">
                    Total: <?php echo e($paginatedRows->total()); ?> row(s)
                </div>
            </div>
            ...
            <div class="overflow-x-auto" style="overflow-x: auto !important; white-space: nowrap !important;">
                <table class="w-full text-sm border" style="min-width: 1900px;">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $groupedRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <?php
                                $itemCount = count($group['items']);
                                $isFirst = true;
                            ?>
                            
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $group['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <?php
                                    $row = $itemData['row'];
                                ...
                                <tr class="border-t hover:bg-zinc-50 dark:hover:bg-zinc-800/50">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isFirst): ?>
                                        <td class="px-3 py-2 whitespace-nowrap align-middle" rowspan="<?php echo e($group['rowspan']); ?>">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($row['is_manual']) && $row['is_manual']): ?>
                                                <div class="flex items-center gap-1">
                                                    <span class="text-xs text-yellow-600 dark:text-yellow-400"></span>
                                                    <span><?php echo e($group['employee_nik']); ?></span>
                                                </div>
                                            <?php else: ?>
                                                <?php echo e($group['employee_nik']); ?>
                                        ...
                                        <td class="px-3 py-2 whitespace-nowrap align-middle" rowspan="<?php echo e($group['rowspan']); ?>">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($row['is_manual']) && $row['is_manual']): ?>
                                                <?php echo e($group['manual_name'] ?? $group['employee_name']); ?>

                                            <?php else: ?>
                                                <?php echo e($group['employee_name']); ?>
                                        ...
                                        <td class="px-3 py-2 whitespace-nowrap align-middle" rowspan="<?php echo e($group['rowspan']); ?>">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($row['is_manual']) && $row['is_manual']): ?>
                                                <?php echo e($group['manual_department'] ?? $group['employee_department']); ?>

                                            <?php else: ?>
                                                <?php echo e($group['employee_department']); ?>
                                        ...
                                        <td class="px-3 py-2 whitespace-nowrap align-middle" rowspan="<?php echo e($group['rowspan']); ?>">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($row['is_manual']) && $row['is_manual']): ?>
                                                <?php echo e(isset($group['manual_tanggal_pemberkasan']) ? \Carbon\Carbon::parse($group['manual_tanggal_pemberkasan'])->format('d/m/Y') : '-'); ?>
                                        ...
                                        <td class="px-3 py-2 whitespace-nowrap align-middle" rowspan="<?php echo e($group['rowspan']); ?>">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($row['is_manual']) && $row['is_manual']): ?>
                                                <?php echo e(isset($group['manual_doj']) ? \Carbon\Carbon::parse($group['manual_doj'])->format('d/m/Y') : '-'); ?>
                                    ...
                                    <td class="px-3 py-2 whitespace-nowrap"><?php echo e($row['item_code']); ?></td>
                                    <td class="px-3 py-2 whitespace-nowrap"><?php echo e($row['description']); ?></td>
                                    <td class="px-3 py-2 whitespace-nowrap"><?php echo e($row['size']); ?></td>
                                    <td class="px-3 py-2 text-center whitespace-nowrap">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($row['status'] == 'Manual'): ?>
                                            <?php ob_start(); ?><div data-flux-badge="data-flux-badge" class="inline-flex items-center font-medium whitespace-nowrap  [print-color-adjust:exact] text-sm py-1 **:data-flux-badge-icon:me-1.5 rounded-md px-2 text-blue-800 [&amp;_button]:text-blue-800! dark:text-blue-200 dark:[&amp;_button]:text-blue-200! bg-blue-400/20 dark:bg-blue-400/40 [&amp;:is(button)]:hover:bg-blue-400/30 dark:[button]:hover:bg-blue-400/50">
        <?php ob_start(); ?>Manual<?php echo trim(ob_get_clean()); ?>

    </div>
<?php echo ltrim(ob_get_clean()); ?>
                                        <?php elseif($row['status'] == 'System'): ?>
                                            <?php ob_start(); ?><div data-flux-badge="data-flux-badge" class="inline-flex items-center font-medium whitespace-nowrap  [print-color-adjust:exact] text-sm py-1 **:data-flux-badge-icon:me-1.5 rounded-md px-2 text-green-800 [&amp;_button]:text-green-800! dark:text-green-200 dark:[&amp;_button]:text-green-200! bg-green-400/20 dark:bg-green-400/40 [&amp;:is(button)]:hover:bg-green-400/30 dark:[button]:hover:bg-green-400/50">
        <?php ob_start(); ?>System<?php echo trim(ob_get_clean()); ?>

    </div>
<?php echo ltrim(ob_get_clean()); ?>
                                        <?php elseif($row['status'] == 'Not Use'): ?>
                                            <?php ob_start(); ?><div data-flux-badge="data-flux-badge" class="inline-flex items-center font-medium whitespace-nowrap  [print-color-adjust:exact] text-sm py-1 **:data-flux-badge-icon:me-1.5 rounded-md px-2 text-zinc-700 [&amp;_button]:text-zinc-700! dark:text-zinc-200 dark:[&amp;_button]:text-zinc-200! bg-zinc-400/15 dark:bg-zinc-400/40 [&amp;:is(button)]:hover:bg-zinc-400/25 dark:[button]:hover:bg-zinc-400/50">
        <?php ob_start(); ?>Not Use<?php echo trim(ob_get_clean()); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
                                        <?php else: ?>
                                            <?php ob_start(); ?><div data-flux-badge="data-flux-badge" class="inline-flex items-center font-medium whitespace-nowrap  [print-color-adjust:exact] text-sm py-1 **:data-flux-badge-icon:me-1.5 rounded-md px-2 text-yellow-800 [&amp;_button]:text-yellow-800! dark:text-yellow-200 dark:[&amp;_button]:text-yellow-200! bg-yellow-400/25 dark:bg-yellow-400/40 [&amp;:is(button)]:hover:bg-yellow-400/40 dark:[button]:hover:bg-yellow-400/50">
        <?php ob_start(); ?><?php echo e($row['status']); ?><?php echo trim(ob_get_clean()); ?>

    </div>
<?php echo ltrim(ob_get_clean()); ?>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </td>
                                    <td class="px-3 py-2 text-center whitespace-nowrap"><?php echo e($row['qty']); ?></td>
                                    <td class="px-3 py-2 min-w-[150px]">
                                        <?php
                                            $reasonType = isset($row['reason_type']) ? strtolower($row['reason_type']) : 'pergantian';
                                        ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($reasonType === 'ng_esd'): ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($row['reason'])): ?>
                                                <?php echo e(Str::limit($row['reason'], 30)); ?>

                                            <?php else: ?>
                                                <span class="text-xs text-zinc-400">-</span>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <?php elseif($reasonType === 'new_employee'): ?>
                                    ...
                                    <td class="px-3 py-2 whitespace-nowrap">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($row['reason_type'])): ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($row['reason_type'] === 'ng_esd'): ?>
        ...
        <?php ob_start(); ?>NG ESD<?php echo trim(ob_get_clean()); ?>

    </div>
<?php echo ltrim(ob_get_clean()); ?>
                                            <?php elseif($row['reason_type'] === 'new_employee'): ?>
                                                <?php ob_start(); ?><div data-flux-badge="data-flux-badge" class="inline-flex items-center font-medium whitespace-nowrap  [print-color-adjust:exact] text-sm py-1 **:data-flux-badge-icon:me-1.5 rounded-md px-2 text-green-800 [&amp;_button]:text-green-800! dark:text-green-200 dark:[&amp;_button]:text-green-200! bg-green-400/20 dark:bg-green-400/40 [&amp;:is(button)]:hover:bg-green-400/30 dark:[button]:hover:bg-green-400/50">
        <?php ob_start(); ?>New Employee<?php echo trim(ob_get_clean()); ?>

    </div>
<?php echo ltrim(ob_get_clean()); ?>
                                            <?php else: ?>
                                                <?php ob_start(); ?><div data-flux-badge="data-flux-badge" class="inline-flex items-center font-medium whitespace-nowrap  [print-color-adjust:exact] text-sm py-1 **:data-flux-badge-icon:me-1.5 rounded-md px-2 text-blue-800 [&amp;_button]:text-blue-800! dark:text-blue-200 dark:[&amp;_button]:text-blue-200! bg-blue-400/20 dark:bg-blue-400/40 [&amp;:is(button)]:hover:bg-blue-400/30 dark:[button]:hover:bg-blue-400/50">
        <?php ob_start(); ?>Pergantian<?php echo trim(ob_get_clean()); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
                                    ...
                                    <td class="px-3 py-2 whitespace-nowrap">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($row['reason_type']) && $row['reason_type'] === 'ng_esd' && !empty($row['reason_file'])): ?>
                                            <a href="<?php echo e(Storage::url($row['reason_file'])); ?>" target="_blank" 
                                                ...
                                                <?php echo e($row['reason_file_name'] ?? 'View PDF'); ?>
                                    ...
                                    <td class="px-3 py-2 whitespace-nowrap"><?php echo e($row['group']); ?></td>
                                    <td class="px-3 py-2 whitespace-nowrap"><?php echo e(\Carbon\Carbon::parse($row['request_date'])->format('d/m/Y')); ?></td>
                                    <td class="px-3 py-2 min-w-[100px]"><?php echo e(Str::limit($row['remarks'], 20) ?? '-'); ?></td>
                                    <td class="px-3 py-2 text-center whitespace-nowrap">
                                        <button type="button" wire:click="removeRow(<?php echo e($index); ?>)" class="text-red-600 hover:text-red-800">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($paginatedRows->hasPages()): ?>
            <div class="p-4 border-t border-zinc-200 dark:border-zinc-700">
                <?php echo e($paginatedRows->links()); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
        ...
        <div class="flex justify-end gap-3 mt-6">
            ...
            <button type="submit" 
                ...
                wire:target="save"
                <?php echo e(count($rows) == 0 ? 'disabled' : ''); ?>

                class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors inline-flex items-center gap-2 <?php echo e(count($rows) == 0 ? 'opacity-50 cursor-not-allowed' : ''); ?>">
                ...
                <span wire:loading.remove wire:target="save"><?php echo e($requestId ? 'Update Request' : 'Create Request'); ?></span>
    ...
    <script>
        document.addEventListener('livewire:init', function () {
            ...
            Livewire.on('startLockCheck', (data) => {
                setInterval(() => {
                    window.Livewire.find('<?php echo e($_instance->getId()); ?>').call('checkLockStatus');
                }, data.interval * 1000);
            });
            ...
            window.addEventListener('beforeunload', function() {
                window.Livewire.find('<?php echo e($_instance->getId()); ?>').call('releaseLock');
            });
        });
        document.addEventListener('livewire:init', function () {
...
</div><?php /**PATH /www/wwwroot/testings.siix-ems.co.id/siix-portal/resources/views/livewire/prod/uniform/uniform-request-form.blade.php ENDPATH**/ ?>