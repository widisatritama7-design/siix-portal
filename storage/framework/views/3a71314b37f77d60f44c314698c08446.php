                    ...
                    <div class="mb-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                <div class="flex justify-between items-center mb-1">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canManual): ?>
                                        <button type="button" 
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isManualInput): ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isManualInput && $canManual): ?>
                                    <!-- Manual Input Form -->
                                    <div class="space-y-2 p-3 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['manualNik'];
...
<?php echo ltrim(ob_get_clean()); ?>
                                            ...
                                            <td class="px-3 py-2 text-center whitespace-nowrap">
                                                <span class="text-sm font-semibold <?php echo e($uniform->available_qty <= 5 ? 'text-red-600 dark:text-red-400' : 'text-green-600 dark:text-green-400'); ?>">
                                                    <?php echo e($uniform->available_qty); ?>

                                                </span>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($uniform->available_qty <= 5 && $uniform->available_qty > 0): ?>
        ...
        <?php ob_start(); ?>Low<?php echo trim(ob_get_clean()); ?>

    </div>
<?php echo ltrim(ob_get_clean()); ?>
                                                <?php elseif($uniform->available_qty == 0): ?>
                                                    <?php ob_start(); ?><div data-flux-badge="data-flux-badge" class="inline-flex items-center font-medium whitespace-nowrap  [print-color-adjust:exact] text-sm py-1 **:data-flux-badge-icon:me-1.5 rounded-md px-2 text-red-700 [&amp;_button]:text-red-700! dark:text-red-200 dark:[&amp;_button]:text-red-200! bg-red-400/20 dark:bg-red-400/40 [&amp;:is(button)]:hover:bg-red-400/30 dark:[button]:hover:bg-red-400/50">
        <?php ob_start(); ?>Out<?php echo trim(ob_get_clean()); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
                            ...
                            <div class="p-2 border-t border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800/50">
                                <?php echo e($availableUniforms->appends(['uniformSearch' => $uniformSearch])->links()); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <div class="col-span-12 sm:col-span-4">
                                        <label class="block text-xs font-medium mb-1.5 text-zinc-600 dark:text-zinc-400">Reason <span class="text-red-500">*</span></label>
                                        <div class="flex gap-2">
                                            ...
                                            <label class="flex-1 cursor-pointer">
                                                <input type="radio" 
                                                    ...
                                                    value="others"
                                                    class="hidden peer">
                                                <div class="flex items-center justify-center gap-2 px-3 py-2 border-2 rounded-lg transition-all duration-200
                                                    ...
                                                    <?php echo e($current_reason_type === 'others' ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' : ''); ?>">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-5 <?php echo e($current_reason_type === 'others' ? 'text-blue-500' : 'text-zinc-400 dark:text-zinc-500'); ?>">
                                                    ...
                                                    <span class="text-sm font-medium <?php echo e($current_reason_type === 'others' ? 'text-blue-600 dark:text-blue-400' : 'text-zinc-600 dark:text-zinc-400'); ?>">Others</span>
                                                </div>
                                            </label>
                                            ...
                                            <label class="flex-1 cursor-pointer">
                                                ...
                                                <div class="flex items-center justify-center gap-2 px-3 py-2 border-2 rounded-lg transition-all duration-200
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-5 <?php echo e($current_reason_type === 'ng_esd' ? 'text-red-500' : 'text-zinc-400 dark:text-zinc-500'); ?>">
                                                        <path fill-rule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25Zm-1.72 6.97a.75.75 0 1 0-1.06 1.06L10.94 12l-1.72 1.72a.75.75 0 1 0 1.06 1.06L12 13.06l1.72 1.72a.75.75 0 1 0 1.06-1.06L13.06 12l1.72-1.72a.75.75 0 1 0-1.06-1.06L12 10.94l-1.72-1.72Z" clip-rule="evenodd" />
                                                    </svg>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($current_reason_type === 'others'): ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <?php else: ?>
                                    <!-- File Upload untuk NG ESD -->
                                    <div class="mt-3">
                                        <?php
                                            $uploadId = 'fileUpload_' . uniqid();
                                        ?>
                                        <div class="border-2 border-dashed rounded-lg p-6 transition-all duration-200 text-center
                                            ...
                                            onclick="document.getElementById('<?php echo e($uploadId); ?>').click()">
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($current_reason_file): ?>
                                                ...
                                                <div class="flex items-center justify-center gap-3">
                                                    ...
                                                    <div class="text-left">
                                                        <p class="text-sm font-medium text-green-700 dark:text-green-300 truncate max-w-[200px]">
                                                    ...
                                                    <button type="button" 
                                                        wire:click.stop="$set('current_reason_file', null)"
                                                        class="text-red-500 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300 p-1 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors">
                                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <?php else: ?>
                                                <!-- Tampilan Upload - Center -->
                                                <div class="flex flex-col items-center justify-center gap-2">
                                                    <svg class="w-12 h-12 text-zinc-400 dark:text-zinc-500 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-xs text-zinc-400 dark:text-zinc-500 mt-1">PDF files only (max 5MB)</p>
                                                    </div>
                                                </div>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            ...
                                            <!-- Hidden File Input -->
                                            <input type="file" 
                                                id="<?php echo e($uploadId); ?>"
                                                wire:model="current_reason_file" 
                                                accept=".pdf"
                                                class="hidden">
                                        </div>
...
<?php echo ltrim(ob_get_clean()); ?>
            ...
            <div class="lg:col-span-4 xl:col-span-4">
                <?php ob_start(); ?><div class="[:where(&amp;)]:bg-white dark:[:where(&amp;)]:bg-white/10 border border-zinc-200 dark:border-white/10 [:where(&amp;)]:p-6 [:where(&amp;)]:rounded-xl p-4 h-auto shadow-lg hover:shadow-xl transition-shadow duration-300" data-flux-card>
    <?php ob_start(); ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($current_uniforms) > 0): ?>
                        <div class="space-y-3 max-h-[400px] overflow-y-auto pr-1 uniform-list-scroll">
                                ...
                                <div class="bg-zinc-50 dark:bg-zinc-800/50 rounded-xl p-4 border border-zinc-200 dark:border-zinc-700 hover:border-blue-300 dark:hover:border-blue-700 transition-all duration-200 hover:shadow-md">
                                    <div class="flex items-start justify-between gap-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <p class="text-sm text-zinc-700 dark:text-zinc-300 truncate"><?php echo e($uniform['description']); ?></p>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $groupedRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $group['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                ...
                                <tr class="border-t hover:bg-zinc-50 dark:hover:bg-zinc-800/50">
                                    ...
                                    <td class="px-3 py-2 min-w-[150px]"><?php echo e(Str::limit($row['reason'], 30)); ?></td>
                                    <td class="px-3 py-2 whitespace-nowrap">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($row['reason_type']) && $row['reason_type'] === 'ng_esd'): ?>
                                            <?php ob_start(); ?><div data-flux-badge="data-flux-badge" class="inline-flex items-center font-medium whitespace-nowrap  [print-color-adjust:exact] text-sm py-1 **:data-flux-badge-icon:me-1.5 rounded-md px-2 text-red-700 [&amp;_button]:text-red-700! dark:text-red-200 dark:[&amp;_button]:text-red-200! bg-red-400/20 dark:bg-red-400/40 [&amp;:is(button)]:hover:bg-red-400/30 dark:[button]:hover:bg-red-400/50">
...
<?php echo ltrim(ob_get_clean()); ?>
        ...
        <?php ob_start(); ?>Others<?php echo trim(ob_get_clean()); ?>
