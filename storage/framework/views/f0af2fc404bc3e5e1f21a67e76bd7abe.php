<?php
if (!function_exists('_f0af2fc404bc3e5e1f21a67e76bd7abe')):
function _f0af2fc404bc3e5e1f21a67e76bd7abe($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
} endif; ?><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/stubs/resources/views/flux/icon/chevron-double-left.blade.php ENDPATH**/ ?>