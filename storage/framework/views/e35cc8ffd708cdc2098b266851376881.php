<?php
if (!function_exists('_e35cc8ffd708cdc2098b266851376881')):
function _e35cc8ffd708cdc2098b266851376881($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php _538207d94a2a0d938b501b023a5d0767($__blaze, ['variant' => $iconVariant], [], ['variant'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
<?php $__slots69a81dacd8cfa97fe31e5aacbe052106['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slots69a81dacd8cfa97fe31e5aacbe052106); ?>
<?php _69a81dacd8cfa97fe31e5aacbe052106($__blaze, $__attrs69a81dacd8cfa97fe31e5aacbe052106, $__slots69a81dacd8cfa97fe31e5aacbe052106, ['attributes', 'size', 'dataFluxClearButton'], ['xData' => 'x-data', 'xOn:click' => 'x-on:click', 'ariaLabel' => 'aria-label', 'dataFluxClearButton' => 'data-flux-clear-button'], $__this ?? (isset($this) ? $this : null)); ?>
