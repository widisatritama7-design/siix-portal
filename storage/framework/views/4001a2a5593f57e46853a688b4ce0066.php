                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div class="w-full sm:w-auto">
                        ...
                        <p class="text-xs sm:text-sm text-zinc-500 dark:text-zinc-400 mt-1">
                            Edit new inspection record for line <?php echo e($masterLine->line_number); ?>
...
</style><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/resources/views/livewire/mtc/daily/panasonic/daily-panasonic-edit.blade.php ENDPATH**/ ?>