...
<section class="w-full">
    ...
    <?php ob_start(); ?><div class="font-medium [:where(&amp;)]:text-zinc-800 [:where(&amp;)]:dark:text-white text-sm [&amp;:has(+[data-flux-subheading])]:mb-2 [[data-flux-subheading]+&amp;]:mt-2 sr-only" data-flux-heading><?php ob_start(); ?>
        <?php echo e(__('Electrostatic Discharge - Equipment Ground Detail')); ?>
...
<?php if (isset($__slots028777b3eb06dbd0c29b11890d068895)) { $__slotsStack028777b3eb06dbd0c29b11890d068895[] = $__slots028777b3eb06dbd0c29b11890d068895; } ?>
<?php if (isset($__attrs028777b3eb06dbd0c29b11890d068895)) { $__attrsStack028777b3eb06dbd0c29b11890d068895[] = $__attrs028777b3eb06dbd0c29b11890d068895; } ?>
<?php $__attrs028777b3eb06dbd0c29b11890d068895 = ['href' => e(route('esd.equipment-grounds')),'wire:navigate' => true,'separator' => 'slash']; ?>
<?php $__slots028777b3eb06dbd0c29b11890d068895 = []; ?>
<?php $__blaze->pushData($__attrs028777b3eb06dbd0c29b11890d068895); ?>
<?php ob_start(); ?>
                        Equipment Ground
                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div class="w-full sm:w-auto">
                        <h1 class="text-2xl sm:text-3xl font-bold text-zinc-800 dark:text-white">
                            View Equipment Ground
                        </h1>
                        <p class="text-xs sm:text-sm text-zinc-500 dark:text-zinc-400 mt-1">
                            View detailed information about equipment ground
                        </p>
                    </div>
                    <div class="w-full sm:w-auto">
...
<?php echo ltrim(ob_get_clean()); ?>
        ...
        <div class="-mt-2">
            <!-- Equipment Ground Information Card -->
    ...
    <?php ob_start(); ?>
                ...
                <div class="bg-blue-600 dark:bg-blue-500 px-6 py-4">
                    <div class="flex items-center gap-2">
                        ...
                        <h3 class="font-semibold text-base text-white">Equipment Ground Information</h3>
                    </div>
                </div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-center">
                        <!-- Machine Name -->
                        <div>
                            <label class="text-sm font-medium text-zinc-500 dark:text-zinc-400 block">Machine Name</label>
                            <p class="mt-1 text-base font-semibold text-zinc-800 dark:text-white">
                                <?php echo e($equipmentGround->machine_name); ?>
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-base text-zinc-800 dark:text-white">
                                <?php echo e($equipmentGround->area); ?>
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-base text-zinc-800 dark:text-white">
                                <?php echo e($equipmentGround->location); ?>
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex justify-center">
                                <?php
                                    ...
                                    $statusColor = $statusConfig[$equipmentGround->status] ?? 'bg-gray-100 text-gray-800';
                                ?>
                                <span class="inline-flex px-3 py-1 rounded-full text-sm font-medium <?php echo e($statusColor); ?>">
                                    <?php echo e($equipmentGround->status); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <?php ob_start(); ?>
                ...
                <div class="bg-blue-600 dark:bg-blue-500 px-6 py-4">
                    <div class="flex items-center gap-2">
                        ...
                        <h3 class="font-semibold text-base text-white">Standard Equipment Ground</h3>
                    </div>
                </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 0 1-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 0 1 4.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3M14.25 3.104c.251.023.501.05.75.082M19.8 15.3l-1.57.393A9.065 9.065 0 0 1 12 15a9.065 9.065 0 0 0-6.23-.693L5 14.5m14.8.8 1.402 1.402c1.232 1.232.65 3.318-1.067 3.611A48.309 48.309 0 0 1 12 21c-2.773 0-5.491-.235-8.135-.687-1.718-.293-2.3-2.379-1.067-3.61L5 14.5"/>
        ...
        <?php echo ltrim(ob_get_clean()); ?>
                                ...
                                <div class="text-center">
                                    <div class="flex items-center justify-center gap-2 mb-2">
                                        <?php ob_start(); ?><svg class="shrink-0 [:where(&amp;)]:size-6 w-4 h-4 text-yellow-600 dark:text-yellow-400" data-flux-icon xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
  <path stroke-linecap="round" stroke-linejoin="round" d="m3.75 13.5 10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75Z"/>
</svg>
...
<?php echo ltrim(ob_get_clean()); ?>
                ...
                <!-- Filters -->
                <div class="bg-white dark:bg-zinc-800 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-zinc-200 dark:border-zinc-700 p-4 mb-4">
                        ...
                        <table class="w-full whitespace-nowrap">
                            ...
                            <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                                ...
                                <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'detail-'.e($detail->id).''; ?>wire:key="detail-<?php echo e($detail->id); ?>">
                                    ...
                                    <td class="px-4 py-3 text-sm text-zinc-700 dark:text-zinc-300">
                                        <?php echo e($detail->measure_results_volts !== null 
                    ...
                    <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                        <div class="p-6">
                            ...
                            <form wire:submit="save">
                                <!-- Hidden Input for equipment_ground_id -->
                                <input type="hidden" wire:model="equipment_ground_id" value="<?php echo e($equipmentGround->id); ?>">
                                ...
                                <div class="mb-4 p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input type="number" 
                                                step="0.01" 
                                                wire:model="measure_results_ohm" 
                                                wire:keyup="resetJudgement"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-2">
                                                <span class="inline-flex px-3 py-1 rounded-full text-sm font-medium <?php echo e($judgement_ohm == 'OK' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400'); ?>">
                                ...
                                <div class="mb-4 p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input type="number" 
                                                step="0.001" 
                                                wire:model="measure_results_volts" 
                                                wire:keyup="resetJudgement"
                                                class="w-full px-3 py-2 border rounded-lg dark:bg-zinc-800 dark:border-zinc-700 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                                placeholder="Enter volts value (e.g., 1.234)">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-2">
                                                <span class="inline-flex px-3 py-1 rounded-full text-sm font-medium <?php echo e($judgement_volts == 'OK' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400'); ?>">
...
<?php endif; ?>
</section><?php /**PATH /www/wwwroot/testings.siix-ems.co.id/siix-portal/resources/views/livewire/esd/eg/equipment-ground-show.blade.php ENDPATH**/ ?>