...
<?php if (isset($__slots028777b3eb06dbd0c29b11890d068895)) { $__slotsStack028777b3eb06dbd0c29b11890d068895[] = $__slots028777b3eb06dbd0c29b11890d068895; } ?>
<?php if (isset($__attrs028777b3eb06dbd0c29b11890d068895)) { $__attrsStack028777b3eb06dbd0c29b11890d068895[] = $__attrs028777b3eb06dbd0c29b11890d068895; } ?>
<?php $__attrs028777b3eb06dbd0c29b11890d068895 = ['href' => e(route('ticket.list')),'wire:navigate' => true,'separator' => 'slash']; ?>
<?php $__slots028777b3eb06dbd0c29b11890d068895 = []; ?>
<?php $__blaze->pushData($__attrs028777b3eb06dbd0c29b11890d068895); ?>
<?php ob_start(); ?>
            Ticket List
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mt-2">
        <div>
            <div class="flex items-center gap-2">
                <a href="<?php echo e(route('ticket.list')); ?>" class="text-zinc-600 hover:text-zinc-800 dark:text-zinc-400 dark:hover:text-zinc-200">
            ...
            <p class="text-sm text-zinc-500 dark:text-zinc-400 mt-1">
                Ticket Number : <span class="font-mono font-semibold text-zinc-700 dark:text-zinc-300"><?php echo e($ticket->ticket_number); ?></span>
            </p>
        </div>
    </div>
    ...
    <?php ob_start(); ?>
                ...
                <div class="p-6">
                    ...
                    <div>
                        ...
                        <p class="text-gray-800 dark:text-gray-200 text-lg font-medium break-words"><?php echo e($ticket->title); ?></p>
                    </div>
                    ...
                    <!-- Attachments -->
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ticket->file && count($ticket->file) > 0): ?>
                    <div class="mt-4">
                        <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-2">Attachments (<?php echo e(count($ticket->file)); ?>)</label>
                        <div class="flex flex-wrap gap-3">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $ticket->file; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <?php
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isImage): ?>
                                    <div 
                                        wire:click="openImageModal('<?php echo e(Storage::url($file)); ?>', '<?php echo e($ticket->title); ?> - Attachment')"
                                ...
                                <?php else: ?>
                                    <a href="<?php echo e(Storage::url($file)); ?>" target="_blank" class="group">
                                        <div class="w-20 h-20 bg-gray-100 dark:bg-zinc-800 rounded-lg flex flex-col items-center justify-center border border-gray-200 dark:border-zinc-700 shadow-md hover:shadow-xl transition-all duration-200 group-hover:scale-105 group-hover:bg-gray-200 dark:group-hover:bg-zinc-700">
                                            ...
                                            <span class="text-xs text-gray-500 dark:text-gray-400 mt-1 uppercase"><?php echo e(strtoupper($fileExtension)); ?></span>
                                        </div>
                                    </a>
...
<?php echo ltrim(ob_get_clean()); ?>
            ...
            <!-- Image Modal -->
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showImageModal): ?>
                    ...
                    <div class="relative max-w-2xl max-h-[80vh] w-full" @click.stop>
                        ...
                        <div class="bg-white dark:bg-zinc-800 rounded-lg overflow-hidden shadow-xl border border-gray-200 dark:border-zinc-700">
                            ...
                            <div class="p-3 flex justify-center items-center bg-gray-100 dark:bg-zinc-800">
                                <img src="<?php echo e($imageModalUrl); ?>" 
                                    alt="<?php echo e($imageModalTitle); ?>"
                            ...
                            <div class="p-3 border-t border-gray-200 dark:border-zinc-700 flex justify-end">
                                <a href="<?php echo e($imageModalUrl); ?>" 
                                download
    ...
    <?php ob_start(); ?>
                ...
                <div class="bg-green-600 dark:bg-green-500 px-6 py-4">
                    <div class="flex justify-between items-center">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isLastFeedbackClosed): ?>
                            <button 
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $feedbacks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feedback): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <?php
                            ...
                            <div class="border-l-4 border-green-500 pl-4 py-2 group">
                                <div class="flex justify-between items-start mb-2">
                                    <div class="flex-1">
                                        <div class="flex items-center flex-wrap gap-2">
                                            <span class="font-semibold text-sm"><?php echo e($feedback->user->name ?? 'Status'); ?></span>
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border border-gray-200 dark:border-gray-700
                                                <?php echo e(match($feedback->status) {
                                                ...
                                                <?php echo e($feedback->status); ?>

                                            </span>
                                        </div>
                                    </div>
                                    <div class="flex items-center gap-2">
                                        <span class="text-xs text-gray-500"><?php echo e($createdDate); ?></span>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isMoreThan24Hours): ?>
                                            <div class="flex items-center gap-1">
                                                <button 
                                                    wire:click="editFeedback(<?php echo e($feedback->id); ?>)"
                                                ...
                                                <button 
                                                    wire:click="confirmDeleteFeedback(<?php echo e($feedback->id); ?>)"
                                ...
                                <div class="text-gray-700 dark:text-gray-300 text-sm mb-2">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasUrls): ?>
                                        <?php
                                            $textWithoutUrls = preg_replace($pattern, '', $comment);
                                            $textWithoutUrls = trim($textWithoutUrls);
                                        ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($textWithoutUrls): ?>
                                            <p class="mb-2"><?php echo e($textWithoutUrls); ?></p>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <div class="flex flex-wrap gap-2">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $urlMatches[0]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                <?php
                                                    $fullUrl = $url;
                                                ...
                                                ?>
                                                <a href="<?php echo e($fullUrl); ?>" target="_blank" rel="noopener noreferrer" 
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($feedback->photo): ?>
                                    <div class="flex flex-wrap gap-2 mt-3">
                                        <?php
                                            $photos = is_array($feedback->photo) ? $feedback->photo : json_decode($feedback->photo, true);
                                        ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($photos && is_array($photos)): ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                <div 
                                                    wire:click="openImageModal('<?php echo e(Storage::url($photo)); ?>', 'Feedback Image from <?php echo e($feedback->user->name ?? 'Status'); ?>')"
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($feedback->file): ?>
                                    <div class="flex flex-wrap gap-2 mt-3">
                                        <?php
                                            $files = is_array($feedback->file) ? $feedback->file : json_decode($feedback->file, true);
                                        ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($files && is_array($files)): ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                <a href="<?php echo e(Storage::url($file)); ?>" target="_blank" class="inline-flex items-center gap-1 px-3 py-1.5 bg-gray-100 dark:bg-zinc-800 text-gray-700 dark:text-gray-300 rounded-lg border border-gray-200 dark:border-zinc-700 hover:bg-gray-200 dark:hover:bg-zinc-700 transition-colors text-sm">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php echo ltrim(ob_get_clean()); ?>
            ...
            <!-- Edit Feedback Modal -->
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showEditFeedbackModal && $editingFeedback): ?>
            <div x-data="{ open: true }" 
                x-show="open"
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <div class="grid grid-cols-4 gap-2">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['Open', 'In Progress', 'Pending', 'Closed']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                <div 
                                                    wire:click="$set('editStatus', '<?php echo e($status); ?>')"
                                                    class="text-center px-3 py-2 border rounded-lg transition-all duration-200 cursor-pointer
                                                        <?php echo e($editStatus == $status ? 
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <div>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['editComments'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm mt-1 block"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium mb-2">Existing Photos (<?php echo e(count($existingPhotos)); ?>)</label>
                                        <div class="flex flex-wrap gap-2 max-h-48 overflow-y-auto p-2 border rounded-lg bg-gray-50 dark:bg-zinc-700/50">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $existingPhotos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photoIndex => $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                <div class="relative group flex-shrink-0" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'photo-'.e($photoIndex).''; ?>wire:key="photo-<?php echo e($photoIndex); ?>">
                                                    <img src="<?php echo e(Storage::url($photo)); ?>" 
                                                        class="w-20 h-20 object-cover rounded-lg border border-gray-200 dark:border-zinc-600 shadow-md">
                                                    <button 
                                                        type="button"
                                                        wire:click="removeExistingPhoto('<?php echo e($photo); ?>')"
                                    ...
                                    <!-- Existing Files -->
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($existingFiles) > 0): ?>
                                    <div>
                                        <label class="block text-sm font-medium mb-2">Existing Files (<?php echo e(count($existingFiles)); ?>)</label>
                                        <div class="space-y-1 max-h-48 overflow-y-auto p-2 border rounded-lg bg-gray-50 dark:bg-zinc-700/50">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $existingFiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fileIndex => $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                <div class="flex items-center justify-between bg-white dark:bg-zinc-700 p-2 rounded shadow-sm border border-gray-200 dark:border-zinc-600 group" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'file-'.e($fileIndex).''; ?>wire:key="file-<?php echo e($fileIndex); ?>">
                                                    <a href="<?php echo e(Storage::url($file)); ?>" target="_blank" class="text-sm text-blue-600 hover:text-blue-800 truncate flex-1">
                                                        <?php echo e(basename($file)); ?>

                                                    </a>
                                                    <button 
                                                        type="button"
                                                        wire:click="removeExistingFile('<?php echo e($file); ?>')"
                                    ...
                                    <div>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['editPhotos.*'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm mt-1 block"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($editTempPhotos && count($editTempPhotos) > 0): ?>
                                            <div class="mt-2 flex flex-wrap gap-2 max-h-32 overflow-y-auto p-2 border rounded-lg bg-gray-50 dark:bg-zinc-700/50">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $editTempPhotos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                    <div class="relative flex-shrink-0">
                                                        <img src="<?php echo e($photo->temporaryUrl()); ?>" class="w-20 h-20 object-cover rounded-lg shadow-md border border-gray-200 dark:border-zinc-600">
                                                        <button type="button" 
                                                                wire:click="removeEditTempPhoto(<?php echo e($index); ?>)"
                                    ...
                                    <div>
                                        ...
                                        <input type="file" 
                                            ...
                                            class="w-full px-3 py-2 border rounded-lg dark:bg-zinc-700 dark:border-zinc-600">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['editFiles.*'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm mt-1 block"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($editTempFiles && count($editTempFiles) > 0): ?>
                                            <div class="mt-2 space-y-1 max-h-32 overflow-y-auto p-2 border rounded-lg bg-gray-50 dark:bg-zinc-700/50">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $editTempFiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                    <div class="flex items-center justify-between bg-white dark:bg-zinc-700 p-2 rounded shadow-sm border border-gray-200 dark:border-zinc-600">
                                                        <span class="text-sm truncate flex-1"><?php echo e($file->getClientOriginalName()); ?></span>
                                                        <button type="button" 
                                                                wire:click="removeEditTempFile(<?php echo e($index); ?>)"
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showDeleteFeedbackModal && $feedbackToDelete): ?>
            <div x-data="{ open: true }" 
                x-show="open"
                ...
                <div class="p-4">
                    <div class="space-y-3 text-sm">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <?php else: ?>
                                <span class="font-medium"><?php echo e($categoryName); ?></span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-500">Created:</span>
                            <span><?php echo e($ticket->created_at instanceof \Carbon\Carbon ? $ticket->created_at->format('d M Y H:i') : \Carbon\Carbon::parse($ticket->created_at)->format('d M Y H:i')); ?></span>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ticket->closed_at): ?>
                        <div class="flex justify-between">
                            <span class="text-gray-500">Closed:</span>
                            <span><?php echo e($ticket->closed_at instanceof \Carbon\Carbon ? $ticket->closed_at->format('d M Y H:i') : \Carbon\Carbon::parse($ticket->closed_at)->format('d M Y H:i')); ?></span>
                        </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
                ...
                <div class="p-4">
                    <div class="space-y-3 text-sm">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border border-gray-200 dark:border-gray-700
                                <?php echo e(match($ticket->approval_user) {
                                    'Approved' => 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300',
                                    'Rejected' => 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300',
                                    default => 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300'
                                }); ?>">
                                <?php echo e($ticket->approval_user); ?>
    ...
    <?php ob_start(); ?>
                ...
                <div class="p-4">
                    <div class="space-y-1 text-sm">
                        <div class="font-medium"><?php echo e($ticket->creator->name ?? 'N/A'); ?></div>
                        <div class="text-gray-500"><?php echo e($ticket->email_user); ?></div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ticket->registration_no): ?>
                            <div class="text-gray-500 text-xs">Reg: <?php echo e($ticket->registration_no); ?></div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
            <?php echo trim(ob_get_clean()); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
            ...
            <!-- Assigned To -->
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ticket->assigned_role): ?>
            <?php ob_start(); ?><div class="[:where(&amp;)]:bg-white dark:[:where(&amp;)]:bg-white/10 border border-zinc-200 dark:border-white/10 [:where(&amp;)]:p-6 [:where(&amp;)]:rounded-xl p-0 shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden" data-flux-card>
    <?php ob_start(); ?>
                <div class="bg-amber-600 dark:bg-amber-500 px-4 py-3">
                    <div class="flex items-center gap-2">
                ...
                <div class="p-4">
                    <div class="text-sm">
                        ...
                        ?>
                        <?php echo e($roleMapping[$ticket->assigned_role] ?? $ticket->assigned_role); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <!-- Feedback Modal -->
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showFeedbackModal): ?>
                        ...
                        <div class="space-y-4" x-show="!processing">
                            <div>
                                ...
                                <div class="grid grid-cols-4 gap-2">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['Open', 'In Progress', 'Pending', 'Closed']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <div 
                                            wire:click="$set('status', '<?php echo e($status); ?>')"
                                            class="text-center px-3 py-2 border rounded-lg transition-all duration-200 cursor-pointer
                                                <?php echo e($this->status == $status ? 
                                                    ($status == 'Open' ? 'bg-red-100 border-red-500 dark:bg-red-900/50 text-red-900 dark:text-red-200 font-medium shadow-md ring-2 ring-red-400' :
                                                    ($status == 'In Progress' ? 'bg-yellow-100 border-yellow-500 dark:bg-yellow-900/50 text-yellow-900 dark:text-yellow-200 font-medium shadow-md ring-2 ring-yellow-400' :
                                                    ($status == 'Pending' ? 'bg-blue-100 border-blue-500 dark:bg-blue-900/50 text-blue-900 dark:text-blue-200 font-medium shadow-md ring-2 ring-blue-400' :
                                                    'bg-green-100 border-green-500 dark:bg-green-900/50 text-green-900 dark:text-green-200 font-medium shadow-md ring-2 ring-green-400'))) :
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tempPhotos): ?>
                                    <div class="mt-2 flex flex-wrap gap-2 max-h-32 overflow-y-auto p-2 border rounded-lg bg-gray-50 dark:bg-zinc-700/50">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $tempPhotos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            <div class="relative flex-shrink-0">
                                                <img src="<?php echo e($photo->temporaryUrl()); ?>" class="w-20 h-20 object-cover rounded-lg shadow-md border border-gray-200 dark:border-zinc-600">
                                                <button type="button" 
                                                        wire:click="removeTempPhoto(<?php echo e($index); ?>)"
                                                        class="absolute -top-2 -right-2 bg-red-500 text-white rounded-full w-5 h-5 flex items-center justify-center text-xs shadow-md hover:bg-red-600">
                                                    ×
                                                </button>
                                            </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div><?php /**PATH /www/wwwroot/testings.siix-ems.co.id/siix-portal/resources/views/livewire/ticket/ticket-view.blade.php ENDPATH**/ ?>