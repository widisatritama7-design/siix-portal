<?php
if (!function_exists('_a0ea2be269e2c2e9aec7761b0be605de')):
function _a0ea2be269e2c2e9aec7761b0be605de($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
} endif; ?><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/stubs/resources/views/flux/icon/currency-rupee.blade.php ENDPATH**/ ?>