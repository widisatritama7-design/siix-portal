...
<?php echo ltrim(ob_get_clean()); ?>
            ...
            <input
                ...
                class="w-full border rounded-lg block disabled:shadow-none dark:shadow-none appearance-none text-base sm:text-sm py-2 h-10 leading-[1.375rem] ps-3 pe-3 bg-white dark:bg-white/10 dark:disabled:bg-white/[7%] text-zinc-700 disabled:text-zinc-500 placeholder-zinc-400 disabled:placeholder-zinc-400/70 dark:text-zinc-300 dark:disabled:text-zinc-400 dark:placeholder-zinc-400 dark:disabled:placeholder-zinc-500 shadow-xs border-zinc-200 border-b-zinc-300/80 disabled:border-b-zinc-200 dark:border-white/10 dark:disabled:border-white/5 data-invalid:shadow-none data-invalid:border-red-500 dark:data-invalid:border-red-500 disabled:data-invalid:border-red-500 dark:disabled:data-invalid:border-red-500" wire:model.live="dateFrom" placeholder="From Date"
...
<?php echo ltrim(ob_get_clean()); ?>
            ...
            <input
                ...
                class="w-full border rounded-lg block disabled:shadow-none dark:shadow-none appearance-none text-base sm:text-sm py-2 h-10 leading-[1.375rem] ps-3 pe-3 bg-white dark:bg-white/10 dark:disabled:bg-white/[7%] text-zinc-700 disabled:text-zinc-500 placeholder-zinc-400 disabled:placeholder-zinc-400/70 dark:text-zinc-300 dark:disabled:text-zinc-400 dark:placeholder-zinc-400 dark:disabled:placeholder-zinc-500 shadow-xs border-zinc-200 border-b-zinc-300/80 disabled:border-b-zinc-200 dark:border-white/10 dark:disabled:border-white/5 data-invalid:shadow-none data-invalid:border-red-500 dark:data-invalid:border-red-500 disabled:data-invalid:border-red-500 dark:disabled:data-invalid:border-red-500" wire:model.live="dateTo" placeholder="To Date"
...
<?php echo ltrim(ob_get_clean()); ?>
        ...
        <div class="border-b border-zinc-200 dark:border-zinc-700">
            <div class="flex flex-wrap gap-1">
                <button 
                    ...
                    class="px-5 py-2.5 text-sm font-medium transition-all duration-200 relative <?php echo e($statusFilter === '' ? 'text-blue-600 dark:text-blue-400' : 'text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200'); ?>"
                >
                    All Tickets
                    <span class="ml-2 px-2 py-0.5 text-xs rounded-full <?php echo e($statusFilter === '' ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300' : 'bg-gray-100 text-gray-600 dark:bg-zinc-800 dark:text-gray-400'); ?>">
                        <?php echo e($totalTicketsCount ?? $tickets->total()); ?>
                ...
                <button 
                    ...
                    class="px-5 py-2.5 text-sm font-medium transition-all duration-200 relative <?php echo e($statusFilter === 'Open' ? 'text-red-600 dark:text-red-400' : 'text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200'); ?>"
                >
                    Open
                    <span class="ml-2 px-2 py-0.5 text-xs rounded-full <?php echo e($statusFilter === 'Open' ? 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-300' : 'bg-gray-100 text-gray-600 dark:bg-zinc-800 dark:text-gray-400'); ?>">
                        <?php echo e($statusCounts['Open'] ?? 0); ?>

                    </span>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($statusFilter === 'Open'): ?>
                ...
                <button 
                    ...
                    class="px-5 py-2.5 text-sm font-medium transition-all duration-200 relative <?php echo e($statusFilter === 'In Progress' ? 'text-yellow-600 dark:text-yellow-400' : 'text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200'); ?>"
                >
                    In Progress
                    <span class="ml-2 px-2 py-0.5 text-xs rounded-full <?php echo e($statusFilter === 'In Progress' ? 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-300' : 'bg-gray-100 text-gray-600 dark:bg-zinc-800 dark:text-gray-400'); ?>">
                        <?php echo e($statusCounts['In Progress'] ?? 0); ?>

                    </span>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($statusFilter === 'In Progress'): ?>
                ...
                <button 
                    ...
                    class="px-5 py-2.5 text-sm font-medium transition-all duration-200 relative <?php echo e($statusFilter === 'Pending' ? 'text-blue-600 dark:text-blue-400' : 'text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200'); ?>"
                >
                    Pending
                    <span class="ml-2 px-2 py-0.5 text-xs rounded-full <?php echo e($statusFilter === 'Pending' ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300' : 'bg-gray-100 text-gray-600 dark:bg-zinc-800 dark:text-gray-400'); ?>">
                ...
                <button 
                    ...
                    class="px-5 py-2.5 text-sm font-medium transition-all duration-200 relative <?php echo e($statusFilter === 'Closed' ? 'text-green-600 dark:text-green-400' : 'text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200'); ?>"
                >
                    Closed
                    <span class="ml-2 px-2 py-0.5 text-xs rounded-full <?php echo e($statusFilter === 'Closed' ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300' : 'bg-gray-100 text-gray-600 dark:bg-zinc-800 dark:text-gray-400'); ?>">
                        <?php echo e($statusCounts['Closed'] ?? 0); ?>

                    </span>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($statusFilter === 'Closed'): ?>
    ...
    <div class="p-6 h-full mt-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-6">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <div <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'ticket-'.e($ticket->id).''; ?>wire:key="ticket-<?php echo e($ticket->id); ?>" 
                ...
                <div class="p-4 pb-4">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isLongText): ?>
                            <div class="relative group/title inline-block w-full">
                                <h3 class="text-base font-bold text-gray-900 dark:text-white cursor-help line-clamp-2">
                                    <?php echo e(Str::limit($formattedTitle, 30)); ?>
                    ...
                    <div class="flex gap-2 mt-3">
                        ...
                        <span class="flex-1 inline-flex items-center justify-center px-2 py-1 rounded-lg text-xs font-medium <?php echo e($statusColor); ?>">
                            <?php echo e($ticket->status); ?>

                        </span>
                        
                        <span class="flex-1 inline-flex items-center justify-center px-2 py-1 rounded-lg text-xs font-medium <?php echo e($priorityColor); ?>">
                ...
                <div class="p-4 pt-2 space-y-1 relative z-10">
                    <div class="mt-10 space-y-0">
                        ...
                        <div class="flex items-center gap-2 text-sm">
                            ...
                            <?php else: ?>
                                <span class="text-gray-700 dark:text-gray-300 flex-1"><?php echo e($categoryName); ?></span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                        ...
                        <div class="flex items-center gap-2 text-sm">
                            ...
                            <div class="flex-1">
                                <div class="text-gray-700 dark:text-gray-300 font-medium"><?php echo e($ticket->creator->name ?? 'N/A'); ?></div>
                            </div>
                        </div>
...
<?php echo ltrim(ob_get_clean()); ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ticket->approval === 'Waiting Approval' && auth()->user()->can('approve tickets', $ticket)): ?>
                        <?php ob_start(); ?><ui-tooltip position="top center"  data-flux-tooltip >
        <?php ob_start(); ?>
                            <?php ob_start(); ?><button type="button" class="relative items-center font-medium justify-center gap-2 whitespace-nowrap disabled:opacity-75 dark:disabled:opacity-75 disabled:cursor-default disabled:pointer-events-none justify-center h-8 text-sm rounded-md w-8 inline-flex  bg-[var(--color-accent)] hover:bg-[color-mix(in_oklab,_var(--color-accent),_transparent_10%)] text-[var(--color-accent-foreground)] border border-black/10 dark:border-0 shadow-[inset_0px_1px_--theme(--color-white/.2)] [[data-flux-button-group]_&amp;]:border-e-0 [:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-e-[1px] dark:[:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-e-0 dark:[:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-s-[1px] [:is([data-flux-button-group]&gt;&amp;:not(:first-child),_[data-flux-button-group]_:not(:first-child)&gt;&amp;)]:border-s-[color-mix(in_srgb,var(--color-accent-foreground),transparent_85%)] *:transition-opacity [&amp;[data-loading]&gt;:not([data-flux-loading-indicator])]:opacity-0 [&amp;[data-flux-loading]&gt;:not([data-flux-loading-indicator])]:opacity-0 [&amp;[data-loading]&gt;[data-flux-loading-indicator]]:opacity-100 [&amp;[data-flux-loading]&gt;[data-flux-loading-indicator]]:opacity-100 data-loading:pointer-events-none data-flux-loading:pointer-events-none [--color-accent:var(--color-purple-500)] [--color-accent-content:var(--color-purple-600)] [--color-accent-foreground:var(--color-white)] dark:[--color-accent:var(--color-purple-500)] dark:[--color-accent-content:var(--color-purple-300)] dark:[--color-accent-foreground:var(--color-white)] !p-2" data-flux-button="data-flux-button" data-flux-group-target="data-flux-group-target" wire:target="openPicApprovalModal(<?php echo e($ticket->id); ?>)" wire:loading.attr="data-flux-loading" wire:click="openPicApprovalModal(<?php echo e($ticket->id); ?>)">
        <div class="absolute inset-0 flex items-center justify-center opacity-0" data-flux-loading-indicator>
...
<?php echo ltrim(ob_get_clean()); ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ticket->approval_user === 'Waiting Approval' && auth()->user()->can('check tickets', $ticket)): ?>
                        <?php ob_start(); ?><ui-tooltip position="top center"  data-flux-tooltip >
        <?php ob_start(); ?>
                            <?php ob_start(); ?><button type="button" class="relative items-center font-medium justify-center gap-2 whitespace-nowrap disabled:opacity-75 dark:disabled:opacity-75 disabled:cursor-default disabled:pointer-events-none justify-center h-8 text-sm rounded-md w-8 inline-flex  bg-[var(--color-accent)] hover:bg-[color-mix(in_oklab,_var(--color-accent),_transparent_10%)] text-[var(--color-accent-foreground)] border border-black/10 dark:border-0 shadow-[inset_0px_1px_--theme(--color-white/.2)] [[data-flux-button-group]_&amp;]:border-e-0 [:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-e-[1px] dark:[:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-e-0 dark:[:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-s-[1px] [:is([data-flux-button-group]&gt;&amp;:not(:first-child),_[data-flux-button-group]_:not(:first-child)&gt;&amp;)]:border-s-[color-mix(in_srgb,var(--color-accent-foreground),transparent_85%)] *:transition-opacity [&amp;[data-loading]&gt;:not([data-flux-loading-indicator])]:opacity-0 [&amp;[data-flux-loading]&gt;:not([data-flux-loading-indicator])]:opacity-0 [&amp;[data-loading]&gt;[data-flux-loading-indicator]]:opacity-100 [&amp;[data-flux-loading]&gt;[data-flux-loading-indicator]]:opacity-100 data-loading:pointer-events-none data-flux-loading:pointer-events-none [--color-accent:var(--color-teal-600)] [--color-accent-content:var(--color-teal-600)] [--color-accent-foreground:var(--color-white)] dark:[--color-accent:var(--color-teal-600)] dark:[--color-accent-content:var(--color-teal-400)] dark:[--color-accent-foreground:var(--color-white)] !p-2" data-flux-button="data-flux-button" data-flux-group-target="data-flux-group-target" wire:target="openUserApprovalModal(<?php echo e($ticket->id); ?>)" wire:loading.attr="data-flux-loading" wire:click="openUserApprovalModal(<?php echo e($ticket->id); ?>)">
        <div class="absolute inset-0 flex items-center justify-center opacity-0" data-flux-loading-indicator>
                <svg class="shrink-0 [:where(&amp;)]:size-5 animate-spin" data-flux-icon xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" aria-hidden="true" data-slot="icon">
    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
...
<?php echo ltrim(ob_get_clean()); ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!in_array($ticket->status, ['In Progress', 'Pending', 'Closed']) && $ticket->created_at > now()->subHours(24)): ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit tickets')): ?>
                        <?php ob_start(); ?><ui-tooltip position="top center"  data-flux-tooltip >
        <?php ob_start(); ?>
                            <?php ob_start(); ?><button type="button" class="relative items-center font-medium justify-center gap-2 whitespace-nowrap disabled:opacity-75 dark:disabled:opacity-75 disabled:cursor-default disabled:pointer-events-none justify-center h-8 text-sm rounded-md w-8 inline-flex  bg-white hover:bg-zinc-50 dark:bg-zinc-700 dark:hover:bg-zinc-600/75 text-zinc-800 dark:text-white border border-zinc-200 hover:border-zinc-200 border-b-zinc-300/80 dark:border-zinc-600 dark:hover:border-zinc-600 shadow-xs [[data-flux-button-group]_&amp;]:border-s-0 [:is([data-flux-button-group]&gt;&amp;:first-child,_[data-flux-button-group]_:first-child&gt;&amp;)]:border-s-[1px] *:transition-opacity [&amp;[data-loading]&gt;:not([data-flux-loading-indicator])]:opacity-0 [&amp;[data-flux-loading]&gt;:not([data-flux-loading-indicator])]:opacity-0 [&amp;[data-loading]&gt;[data-flux-loading-indicator]]:opacity-100 [&amp;[data-flux-loading]&gt;[data-flux-loading-indicator]]:opacity-100 data-loading:pointer-events-none data-flux-loading:pointer-events-none  !p-2" data-flux-button="data-flux-button" data-flux-group-target="data-flux-group-target" wire:target="editTicket(<?php echo e($ticket->id); ?>)" wire:loading.attr="data-flux-loading" wire:click="editTicket(<?php echo e($ticket->id); ?>)">
        <div class="absolute inset-0 flex items-center justify-center opacity-0" data-flux-loading-indicator>
                <svg class="shrink-0 [:where(&amp;)]:size-5 animate-spin" data-flux-icon xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" aria-hidden="true" data-slot="icon">
    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
...
<?php echo ltrim(ob_get_clean()); ?>
                        ...
                        <?php ob_start(); ?><ui-tooltip position="top center"  data-flux-tooltip >
        <?php ob_start(); ?>
                            <?php ob_start(); ?><button type="button" class="relative items-center font-medium justify-center gap-2 whitespace-nowrap disabled:opacity-75 dark:disabled:opacity-75 disabled:cursor-default disabled:pointer-events-none justify-center h-8 text-sm rounded-md w-8 inline-flex  bg-[var(--color-accent)] hover:bg-[color-mix(in_oklab,_var(--color-accent),_transparent_10%)] text-[var(--color-accent-foreground)] border border-black/10 dark:border-0 shadow-[inset_0px_1px_--theme(--color-white/.2)] [[data-flux-button-group]_&amp;]:border-e-0 [:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-e-[1px] dark:[:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-e-0 dark:[:is([data-flux-button-group]&gt;&amp;:last-child,_[data-flux-button-group]_:last-child&gt;&amp;)]:border-s-[1px] [:is([data-flux-button-group]&gt;&amp;:not(:first-child),_[data-flux-button-group]_:not(:first-child)&gt;&amp;)]:border-s-[color-mix(in_srgb,var(--color-accent-foreground),transparent_85%)] *:transition-opacity [&amp;[data-loading]&gt;:not([data-flux-loading-indicator])]:opacity-0 [&amp;[data-flux-loading]&gt;:not([data-flux-loading-indicator])]:opacity-0 [&amp;[data-loading]&gt;[data-flux-loading-indicator]]:opacity-100 [&amp;[data-flux-loading]&gt;[data-flux-loading-indicator]]:opacity-100 data-loading:pointer-events-none data-flux-loading:pointer-events-none [--color-accent:var(--color-red-500)] [--color-accent-content:var(--color-red-600)] [--color-accent-foreground:var(--color-white)] dark:[--color-accent:var(--color-red-500)] dark:[--color-accent-content:var(--color-red-400)] dark:[--color-accent-foreground:var(--color-white)] !p-2" data-flux-button="data-flux-button" data-flux-group-target="data-flux-group-target" wire:target="confirmDelete(<?php echo e($ticket->id); ?>)" wire:loading.attr="data-flux-loading" wire:click="confirmDelete(<?php echo e($ticket->id); ?>)">
        <div class="absolute inset-0 flex items-center justify-center opacity-0" data-flux-loading-indicator>
                <svg class="shrink-0 [:where(&amp;)]:size-5 animate-spin" data-flux-icon xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" aria-hidden="true" data-slot="icon">
    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
        ...
        <?php echo ltrim(ob_get_clean()); ?>
                    ...
                    <div>
                        ...
                        <p class="text-sm text-zinc-500 dark:text-zinc-400 mb-4">
                            <?php echo e($search ? 'Try adjusting your search query' : 'Get started by creating a new ticket'); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tickets->hasPages() && $perPage != $tickets->total()): ?>
        <div class="mt-8 pt-6 border-t border-dashed border-zinc-200 dark:border-zinc-700">
            <div class="flex flex-col items-center gap-4">
                <!-- Info Text -->
                <div class="text-center">
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                        Showing <span class="font-semibold text-gray-700 dark:text-gray-300"><?php echo e($tickets->firstItem()); ?></span> 
                        to <span class="font-semibold text-gray-700 dark:text-gray-300"><?php echo e($tickets->lastItem()); ?></span> 
                        of <span class="font-semibold text-gray-700 dark:text-gray-300"><?php echo e($tickets->total()); ?></span> tickets
                    </p>
                </div>
                
                <!-- Load More Buttons -->
                <div class="flex flex-wrap items-center justify-center gap-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tickets->onFirstPage()): ?>
                    ...
                    <div class="flex gap-2">
                        <button wire:click="setPage(1)" 
                                class="px-4 py-2 rounded-lg <?php echo e($tickets->currentPage() == 1 ? 'bg-blue-600 text-white' : 'bg-gray-200 dark:bg-zinc-700 text-gray-700 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-zinc-600'); ?>">
                            1
                        </button>
                        
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tickets->currentPage() > 3): ?>
                            <span class="px-2 py-2 text-gray-500">...</span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($i = max(2, $tickets->currentPage() - 1); $i <= min($tickets->lastPage() - 1, $tickets->currentPage() + 1); $i++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($i != 1 && $i != $tickets->lastPage()): ?>
                                <button wire:click="setPage(<?php echo e($i); ?>)" 
                                        class="px-4 py-2 rounded-lg <?php echo e($tickets->currentPage() == $i ? 'bg-blue-600 text-white' : 'bg-gray-200 dark:bg-zinc-700 text-gray-700 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-zinc-600'); ?>">
                                    <?php echo e($i); ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tickets->currentPage() < $tickets->lastPage() - 2): ?>
                            <span class="px-2 py-2 text-gray-500">...</span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tickets->lastPage() > 1): ?>
                            <button wire:click="setPage(<?php echo e($tickets->lastPage()); ?>)" 
                                    class="px-4 py-2 rounded-lg <?php echo e($tickets->currentPage() == $tickets->lastPage() ? 'bg-blue-600 text-white' : 'bg-gray-200 dark:bg-zinc-700 text-gray-700 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-zinc-600'); ?>">
                                <?php echo e($tickets->lastPage()); ?>

                            </button>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tickets->hasMorePages()): ?>
                ...
                <div class="flex gap-2 mt-2">
                    <button wire:click="$set('perPage', 10)" 
                            class="px-3 py-1 text-sm rounded-lg <?php echo e($perPage == 10 ? 'bg-purple-600 text-white' : 'bg-gray-200 dark:bg-zinc-700 text-gray-700 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-zinc-600'); ?>">
                        View 10
                    </button>
                    <button wire:click="$set('perPage', 20)" 
                            class="px-3 py-1 text-sm rounded-lg <?php echo e($perPage == 20 ? 'bg-purple-600 text-white' : 'bg-gray-200 dark:bg-zinc-700 text-gray-700 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-zinc-600'); ?>">
                        View 20
                    </button>
                    <button wire:click="$set('perPage', 50)" 
                            class="px-3 py-1 text-sm rounded-lg <?php echo e($perPage == 50 ? 'bg-purple-600 text-white' : 'bg-gray-200 dark:bg-zinc-700 text-gray-700 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-zinc-600'); ?>">
                        View 50
                    </button>
                    <button wire:click="$set('perPage', <?php echo e($tickets->total()); ?>)" 
                            class="px-3 py-1 text-sm rounded-lg <?php echo e($perPage == $tickets->total() ? 'bg-purple-600 text-white' : 'bg-gray-200 dark:bg-zinc-700 text-gray-700 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-zinc-600'); ?>">
                        View All
                    </button>
                </div>
            </div>
                        ...
                        <div class="flex items-center justify-between relative">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($i = 1; $i <= $totalSteps; $i++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <div class="flex flex-col items-center flex-1 relative z-10">
                                    <div class="relative">
                                        <div class="w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 
                                            <?php echo e($currentStep >= $i ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-lg' : 'bg-gray-200 dark:bg-zinc-700 text-gray-500'); ?>

                                            <?php echo e($currentStep == $i ? 'ring-4 ring-blue-200 dark:ring-blue-900/50 scale-110' : ''); ?>">
                                    ...
                                    <span class="mt-2 text-xs font-medium <?php echo e($currentStep >= $i ? 'text-blue-600 dark:text-blue-400' : 'text-gray-500'); ?>">
                                        <?php echo e($i == 1 ? 'Ticket Info' : ($i == 2 ? 'Details & Upload' : 'Categorization')); ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($i < $totalSteps): ?>
                                    <div class="flex-1 h-0.5 <?php echo e($currentStep > $i ? 'bg-gradient-to-r from-blue-500 to-blue-600' : 'bg-gray-200 dark:bg-zinc-700'); ?> relative -ml-2 -mr-2 z-0"></div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endfor; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </div>
                    </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div>
                                    ...
                                    <input type="email" 
                                        ...
                                        class="w-full px-3 py-2 border rounded-lg dark:bg-zinc-800 dark:border-zinc-700 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['email_user'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tempFiles): ?>
                                        <div class="mt-2 flex flex-wrap gap-2">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $tempFiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                <div class="relative group">
                                                    <img src="<?php echo e($file->temporaryUrl()); ?>" class="w-20 h-20 object-cover rounded-lg shadow-md">
                                                    <button type="button" 
                                                            wire:click="removeTempFile(<?php echo e($index); ?>)"
                            ...
                            <div class="space-y-4 animate-fadeIn">
                                <div>
                                    ...
                                    <div class="grid grid-cols-4 gap-2">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['Low', 'Medium', 'Urgent', 'Critical']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            <div 
                                                wire:click="$set('priority', '<?php echo e($prio); ?>')"
                                                class="text-center px-4 py-2 border rounded-lg transition-all duration-200 cursor-pointer
                                                    <?php echo e($priority == $prio ? 
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div>
                                    ...
                                    <select wire:model="assigned_role" class="w-full px-3 py-2 border rounded-lg dark:bg-zinc-800 dark:border-zinc-700 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('assign to other sections')): ?>
                                    ...
                                    <div class="grid grid-cols-2 gap-2 max-h-60 overflow-y-auto border rounded-lg p-2 bg-gray-50 dark:bg-zinc-800/50">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            <label class="flex items-center gap-2 p-2 rounded-lg cursor-pointer transition-all duration-200
                                                <?php echo e($category_id == $category->id ? 'bg-blue-50 dark:bg-blue-900/20 border border-blue-500 shadow-sm' : 'hover:bg-gray-100 dark:hover:bg-zinc-700 border border-transparent'); ?>">
                                                <input type="radio" 
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <!-- MODAL VIEW TICKET -->
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showViewModal && $selectedTicket): ?>
                ...
                <div class="p-6">
                    <div class="flex justify-between items-start mb-4">
                        <div>
                            ...
                            <p class="text-sm text-gray-500">#<?php echo e($selectedTicket->ticket_number); ?></p>
                        </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="lg:col-span-2 space-y-4">
                            <div>
                                ...
                                <p class="text-gray-700 dark:text-gray-300"><?php echo e($selectedTicket->title); ?></p>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="prose dark:prose-invert max-w-none bg-gray-50 dark:bg-zinc-800 p-4 rounded-lg">
                                    <?php echo nl2br(e($selectedTicket->description)); ?>

                                </div>
                            </div>
                            
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedTicket->file): ?>
                            <div>
                                <h3 class="font-semibold mb-2 text-sm text-gray-600 dark:text-gray-400">Attachments</h3>
                                <div class="flex flex-wrap gap-2">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $selectedTicket->file; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <a href="<?php echo e(Storage::url($file)); ?>" target="_blank" class="block">
                                            <img src="<?php echo e(Storage::url($file)); ?>" class="w-24 h-24 object-cover rounded-lg hover:opacity-80 transition-opacity">
                                        </a>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                </div>
                            </div>
...
<?php $__attrs6b0011e2f83d04930b97e5f6feda22dd = ['size' => 'sm','color' => e(match($selectedTicket->status) {
                                            'Open' => 'danger',
                                            'In Progress' => 'warning',
                                            'Pending' => 'info',
                                            'Closed' => 'success',
...
<?php ob_start(); ?>
                                            <?php echo e($selectedTicket->status); ?>
...
<?php if (isset($__slots6b0011e2f83d04930b97e5f6feda22dd)) { $__slotsStack6b0011e2f83d04930b97e5f6feda22dd[] = $__slots6b0011e2f83d04930b97e5f6feda22dd; } ?>
<?php if (isset($__attrs6b0011e2f83d04930b97e5f6feda22dd)) { $__attrsStack6b0011e2f83d04930b97e5f6feda22dd[] = $__attrs6b0011e2f83d04930b97e5f6feda22dd; } ?>
<?php $__attrs6b0011e2f83d04930b97e5f6feda22dd = ['size' => 'sm','color' => e(match($selectedTicket->priority) {
                                            'Low' => 'gray',
                                            'Medium' => 'warning',
                                            'Urgent' => 'danger',
                                            'Critical' => 'primary',
...
<?php $__blaze->popData(); ?>
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <span class="font-medium"><?php echo e($selectedTicket->category->name ?? '-'); ?></span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-gray-500">Created:</span>
                                        <span><?php echo e($selectedTicket->created_at->format('d M Y H:i')); ?></span>
                                    </div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedTicket->closed_at): ?>
                                    <div class="flex justify-between">
                                        <span class="text-gray-500">Closed:</span>
                                        <span><?php echo e($selectedTicket->closed_at->format('d M Y H:i')); ?></span>
                                    </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </div>
...
<?php if (isset($__slots6b0011e2f83d04930b97e5f6feda22dd)) { $__slotsStack6b0011e2f83d04930b97e5f6feda22dd[] = $__slots6b0011e2f83d04930b97e5f6feda22dd; } ?>
<?php if (isset($__attrs6b0011e2f83d04930b97e5f6feda22dd)) { $__attrsStack6b0011e2f83d04930b97e5f6feda22dd[] = $__attrs6b0011e2f83d04930b97e5f6feda22dd; } ?>
<?php $__attrs6b0011e2f83d04930b97e5f6feda22dd = ['size' => 'sm','color' => e(match($selectedTicket->approval) {
                                            'Approved' => 'success',
                                            'Rejected' => 'danger',
                                            default => 'warning'
                                        })]; ?>
...
<?php $__blaze->pushData($__attrs6b0011e2f83d04930b97e5f6feda22dd); ?>
<?php ob_start(); ?>
                                            <?php echo e($selectedTicket->approval); ?>
...
<?php if (isset($__slots6b0011e2f83d04930b97e5f6feda22dd)) { $__slotsStack6b0011e2f83d04930b97e5f6feda22dd[] = $__slots6b0011e2f83d04930b97e5f6feda22dd; } ?>
<?php if (isset($__attrs6b0011e2f83d04930b97e5f6feda22dd)) { $__attrsStack6b0011e2f83d04930b97e5f6feda22dd[] = $__attrs6b0011e2f83d04930b97e5f6feda22dd; } ?>
<?php $__attrs6b0011e2f83d04930b97e5f6feda22dd = ['size' => 'sm','color' => e(match($selectedTicket->approval_user) {
                                            'Approved' => 'success',
                                            'Rejected' => 'danger',
                                            default => 'warning'
                                        })]; ?>
...
<?php $__blaze->pushData($__attrs6b0011e2f83d04930b97e5f6feda22dd); ?>
<?php ob_start(); ?>
                                            <?php echo e($selectedTicket->approval_user); ?>
...
<?php $__blaze->popData(); ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedTicket->approval_at): ?>
                                    <div class="flex justify-between">
                                        <span class="text-gray-500">PIC Approval Date:</span>
                                        <span><?php echo e($selectedTicket->approval_at->format('d M Y H:i')); ?></span>
                                    </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedTicket->approval_user_at): ?>
                                    <div class="flex justify-between">
                                        <span class="text-gray-500">User Approval Date:</span>
                                        <span><?php echo e($selectedTicket->approval_user_at->format('d M Y H:i')); ?></span>
                                    </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="bg-gray-50 dark:bg-zinc-800 p-4 rounded-lg">
                                ...
                                <div class="space-y-1 text-sm">
                                    <div class="font-medium"><?php echo e($selectedTicket->creator->name ?? 'N/A'); ?></div>
                                    <div class="text-gray-500"><?php echo e($selectedTicket->email_user); ?></div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedTicket->registration_no): ?>
                                        <div class="text-gray-500 text-xs">Reg: <?php echo e($selectedTicket->registration_no); ?></div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </div>

                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedTicket->assigned_role): ?>
                            <div class="bg-gray-50 dark:bg-zinc-800 p-4 rounded-lg">
                                ...
                                <div class="text-sm">
                                    ...
                                    ?>
                                    <?php echo e($roleMapping[$selectedTicket->assigned_role] ?? $selectedTicket->assigned_role); ?>
    ...
    <!-- MODAL EDIT TICKET -->
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showEditModal && $selectedTicket): ?>
                    ...
                    <div class="flex justify-between items-center mb-6">
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                                Ticket #: <span class="font-mono font-semibold text-blue-600 dark:text-blue-400"><?php echo e($selectedTicket->ticket_number ?? ''); ?></span>
                            </p>
                        </div>
                        <button @click="if(!processing) { open = false; $wire.closeModal() }" 
                                class="text-gray-500 hover:text-gray-700 transition-colors">
...
<?php $__blaze->pushData($__attrs6b0011e2f83d04930b97e5f6feda22dd); ?>
<?php ob_start(); ?>
                                            <?php echo e($selectedTicket->status ?? 'N/A'); ?>
...
<?php $__blaze->popData(); ?>
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-sm text-gray-700 dark:text-gray-300">
                                            <?php echo e($selectedTicket ? $selectedTicket->created_at->format('d M Y H:i') : 'N/A'); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="bg-gray-50 dark:bg-zinc-800/50 rounded-lg p-4">
                                ...
                                <div class="grid grid-cols-2 gap-4 text-sm">
                                    <div>
                                        ...
                                        <p class="font-mono font-semibold text-gray-900 dark:text-white mt-1"><?php echo e($selectedTicket->ticket_number ?? 'N/A'); ?></p>
                                    </div>
                                    <div>
                                        <span class="text-gray-500 dark:text-gray-400">Last Updated:</span>
                                        <p class="text-gray-900 dark:text-white mt-1"><?php echo e($selectedTicket ? $selectedTicket->updated_at->format('d M Y H:i') : 'N/A'); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showDeleteModal && $ticketToDelete): ?>
    <div x-data="{ open: true }" 
         x-show="open"
         @keydown.escape.window="open = false; $wire.closeModal()"
         x-cloak>
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
            <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-xl w-full max-w-md p-6 text-center">
                ...
                <p class="text-gray-600 dark:text-gray-400 mb-6">
                    Are you sure you want to delete ticket <strong>"<?php echo e($ticketToDelete->ticket_number); ?>"</strong>?
                    <br>
    ...
    <!-- MODAL APPROVAL PIC -->
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showApprovalPicModal && $selectedTicket): ?>
    <?php ob_start(); ?><ui-modal wire:model.self="showApprovalPicModal" data-flux-modal>
    
    <dialog
        wire:ignore.self 
        class="p-6 [:where(&amp;)]:max-w-xl [:where(&amp;)]:min-w-xs shadow-lg rounded-xl bg-white dark:bg-zinc-800 ring ring-black/5 dark:ring-zinc-700 shadow-lg rounded-xl w-full max-w-lg"
                    ...
                    <div class="bg-gray-50 dark:bg-zinc-800 rounded-lg p-4">
                        ...
                        <div class="space-y-2 text-sm">
                            <div class="flex justify-between">
                                ...
                                <span class="font-medium text-gray-900 dark:text-white"><?php echo e($selectedTicket->title); ?></span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-500">Requester:</span>
                                <span class="font-medium text-gray-900 dark:text-white"><?php echo e($selectedTicket->creator->name ?? 'N/A'); ?></span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-500">Priority:</span>
                                <?php $__blaze->ensureRequired('/www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/src/../stubs/resources/views/flux/badge/index.blade.php', $__blaze->compiledPath.'/6b0011e2f83d04930b97e5f6feda22dd.php'); ?>
...
<?php $__blaze->popData(); ?>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <button type="button"
                                    ...
                                    class="px-4 py-3 rounded-lg border-2 transition-all duration-200 flex items-center justify-center gap-2
                                        <?php echo e($approval_status === 'Approved' ? 
                            ...
                            <button type="button"
                                    ...
                                    class="px-4 py-3 rounded-lg border-2 transition-all duration-200 flex items-center justify-center gap-2
                                        <?php echo e($approval_status === 'Rejected' ? 
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['approval_status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm mt-1 block"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            rows="4"
                            class="w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all <?php $__errorArgs = ['comment_manager'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['comment_manager'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <!-- MODAL APPROVAL USER -->
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showApprovalUserModal && $selectedTicket): ?>
    <?php ob_start(); ?><ui-modal wire:model.self="showApprovalUserModal" data-flux-modal>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <button type="button"
                                    ...
                                    class="px-4 py-3 rounded-lg border-2 transition-all duration-200 flex items-center justify-center gap-2
                                        <?php echo e($approval_user_status === 'Approved' ? 
                                            'border-green-500 bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-300' : 
                                            'border-gray-300 dark:border-zinc-700 hover:border-green-300 text-gray-700 dark:text-gray-300'); ?>">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                            ...
                            <button type="button"
                                    ...
                                    class="px-4 py-3 rounded-lg border-2 transition-all duration-200 flex items-center justify-center gap-2
                                        <?php echo e($approval_user_status === 'Rejected' ? 
                                            'border-red-500 bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-300' : 
                                            'border-gray-300 dark:border-zinc-700 hover:border-red-300 text-gray-700 dark:text-gray-300'); ?>">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['approval_user_status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm mt-1 block"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            rows="4"
                            class="w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all <?php $__errorArgs = ['comment_user'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['comment_user'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> 
...
</div><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/resources/views/livewire/ticket/ticket-manager.blade.php ENDPATH**/ ?>