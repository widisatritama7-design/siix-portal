<?php # [BlazeFolded]:{flux::menu.item}:{D:\laragon\www\siix-portal-new\vendor\livewire\flux\src/../stubs/resources/views/flux/menu/item.blade.php}:{1774988736} ?>
<?php # [BlazeFolded]:{flux::menu.radio.group}:{D:\laragon\www\siix-portal-new\vendor\livewire\flux\src/../stubs/resources/views/flux/menu/radio/group.blade.php}:{1774988736} ?>
...
<?php ob_start(); ?><ui-dropdown position="bottom start"  data-flux-dropdown>
    <?php ob_start(); ?>
    <?php $__blaze->ensureRequired('D:\laragon\www\siix-portal-new\vendor\livewire\flux\src/../stubs/resources/views/flux/sidebar/profile.blade.php', $__blaze->compiledPath.'/e7ec8dc3880e3f4162ddc751f6faad8b.php'); ?>
<?php $__blaze->pushData(['name' => auth()->user()->name,'initials' => auth()->user()->firstInitial(),'dataTest' => 'sidebar-menu-button']); ?>
<?php _e7ec8dc3880e3f4162ddc751f6faad8b($__blaze, ['name' => auth()->user()->name,'initials' => auth()->user()->firstInitial(),'dataTest' => 'sidebar-menu-button'], [], ['name', 'initials'], ['dataTest' => 'data-test'], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php echo ltrim(ob_get_clean()); ?><?php /**PATH D:\laragon\www\siix-portal-new\resources\views\components\desktop-user-menu.blade.php ENDPATH**/ ?>