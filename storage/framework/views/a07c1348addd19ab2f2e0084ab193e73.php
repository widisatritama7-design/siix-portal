                ...
                <tr>
                    <td style="width: 50%; vertical-align: top;">
                        <table style="width: 100%;">
                            ...
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item_filter): ?>
                            <tr>
                                <td>Item Filter</td>
                                <td colspan="3">: <?php echo e($item_filter); ?></td>
                            </tr>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center"><?php echo e($detail->worksurface->register_no ?? 'N/A'); ?></td>
                    <td class="text-center"><?php echo e($detail->worksurface->area ?? '-'); ?></td>
                    <td class="text-center"><?php echo e($detail->worksurface->location ?? '-'); ?></td>
                    <td class="text-center text-uppercase"><?php echo e($detail->worksurface->category ?? '-'); ?></td>
                    <td class="text-center text-uppercase"><?php echo e($detail->item ?? '-'); ?></td>
                    <td class="text-center"><?php echo e($detail->a1_scientific ?? '-'); ?></td>
                    <td class="text-center">
                        <span class="<?php echo e($detail->judgement_a1 == 'OK' ? 'badge-ok' : 'badge-ng'); ?>">
                    ...
                    <td class="text-center">
                        <span class="<?php echo e($detail->judgement_a2 == 'OK' ? 'badge-ok' : 'badge-ng'); ?>">
...
</html><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/resources/views/livewire/esd/worksurface/worksurface-detail-pdf.blade.php ENDPATH**/ ?>