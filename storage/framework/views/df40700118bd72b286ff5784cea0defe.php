    ...
    <?php ob_start(); ?>
                                    ...
                                    <div class="p-6 space-y-6">
                                        ...
                                        <div>
                                            <label class="text-sm font-medium text-zinc-700 dark:text-zinc-300">
                                                Clamp Pressure (9)
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->isFieldRequired('clamp_presure')): ?>
                                                    <span class="text-red-500">*</span>
                                                <?php else: ?>
                                                    <span class="text-gray-400 text-xs font-normal">(Disabled)</span>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            ...
                                            <input type="text" 
                                                   wire:model.live="clamp_presure" 
                                                   placeholder="<?php echo e($this->isNAAllowed() ? 'Enter value or - for NA' : 'Enter value'); ?>" 
                                                   class="w-full rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 <?php echo e($this->getFieldColorClass('clamp_presure', $clamp_presure)); ?>" 
                                                   <?php echo e($this->isFieldDisabled('clamp_presure') ? 'disabled' : ''); ?>>
                                            <?php $validation = $this->validateNumericField('clamp_presure', $clamp_presure); ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$validation['valid'] && $clamp_presure !== null && $clamp_presure !== '' && !$this->isFieldDisabled('clamp_presure')): ?>
                                                <p class="text-xs text-red-600 mt-1"><?php echo e($validation['message']); ?></p>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                        ...
                                        <div>
                                            <label class="text-sm font-medium text-zinc-700 dark:text-zinc-300">
                                                Squeege Upper (10)
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->isFieldRequired('squeege_upper')): ?>
                                                    <span class="text-red-500">*</span>
                                                <?php else: ?>
                                                    <span class="text-gray-400 text-xs font-normal">(Disabled)</span>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            ...
                                            <input type="text" 
                                                   wire:model.live="squeege_upper" 
                                                   placeholder="<?php echo e($this->isNAAllowed() ? 'Enter value or - for NA' : 'Enter value'); ?>" 
                                                   class="w-full rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 <?php echo e($this->getFieldColorClass('squeege_upper', $squeege_upper)); ?>" 
                                                   <?php echo e($this->isFieldDisabled('squeege_upper') ? 'disabled' : ''); ?>>
                                            <?php $validation = $this->validateNumericField('squeege_upper', $squeege_upper); ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$validation['valid'] && $squeege_upper !== null && $squeege_upper !== '' && !$this->isFieldDisabled('squeege_upper')): ?>
                                                <p class="text-xs text-red-600 mt-1"><?php echo e($validation['message']); ?></p>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
    ...
    <?php ob_start(); ?>
                                    ...
                                    <div class="p-6 space-y-6">
                                        ...
                                        <div>
                                            <label class="text-sm font-medium text-zinc-700 dark:text-zinc-300">
                                                Vaccuum Pump (13.a)
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->isFieldRequired('vaccuum_pump_1')): ?>
                                                    <span class="text-red-500">*</span>
                                                <?php else: ?>
                                                    <span class="text-gray-400 text-xs font-normal">(Disabled)</span>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            ...
                                            <input type="text" 
                                                   wire:model.live="vaccuum_pump_1" 
                                                   placeholder="<?php echo e($this->isNAAllowed() ? 'Enter value or - for NA' : 'Enter value'); ?>" 
                                                   class="w-full rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 <?php echo e($this->getFieldColorClass('vaccuum_pump_1', $vaccuum_pump_1)); ?>" 
                                                   <?php echo e($this->isFieldDisabled('vaccuum_pump_1') ? 'disabled' : ''); ?>>
                                            <?php $validation = $this->validateNumericField('vaccuum_pump_1', $vaccuum_pump_1); ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$validation['valid'] && $vaccuum_pump_1 !== null && $vaccuum_pump_1 !== '' && !$this->isFieldDisabled('vaccuum_pump_1')): ?>
                                                <p class="text-xs text-red-600 mt-1"><?php echo e($validation['message']); ?></p>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                        ...
                                        <div>
                                            <label class="text-sm font-medium text-zinc-700 dark:text-zinc-300">
                                                Box (13.b)
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->isFieldRequired('box_1')): ?>
                                                    <span class="text-red-500">*</span>
                                                <?php else: ?>
                                                    <span class="text-gray-400 text-xs font-normal">(Disabled)</span>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            ...
                                            <div class="flex gap-6">
                                                <label class="inline-flex items-center gap-2">
                                                    <input type="radio" wire:model.live="box_1" value="checked" class="rounded border-zinc-300 text-blue-600 focus:ring-blue-500" <?php echo e($this->isFieldDisabled('box_1') ? 'disabled' : ''); ?>>
                                                    <span class="text-sm <?php echo e($this->isFieldDisabled('box_1') ? 'text-gray-400' : ''); ?>">Checked ✓</span>
                                                </label>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->isNAAllowed()): ?>
                                                <label class="inline-flex items-center gap-2">
                                                    <input type="radio" wire:model.live="box_1" value="na" class="rounded border-zinc-300 text-blue-600 focus:ring-blue-500" <?php echo e($this->isFieldDisabled('box_1') ? 'disabled' : ''); ?>>
                                                    <span class="text-sm <?php echo e($this->isFieldDisabled('box_1') ? 'text-gray-400' : ''); ?>">N/A</span>
                                                </label>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            <label class="text-sm font-medium text-zinc-700 dark:text-zinc-300">
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->isFieldRequired('vaccuum_parameter_1')): ?>
                                                    <span class="text-red-500">*</span>
                                                <?php else: ?>
                                                    <span class="text-gray-400 text-xs font-normal">(Disabled)</span>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            ...
                                            <div class="flex gap-6">
                                                <label class="inline-flex items-center gap-2">
                                                    <input type="radio" wire:model.live="vaccuum_parameter_1" value="checked" class="rounded border-zinc-300 text-blue-600 focus:ring-blue-500" <?php echo e($this->isFieldDisabled('vaccuum_parameter_1') ? 'disabled' : ''); ?>>
                                                    <span class="text-sm <?php echo e($this->isFieldDisabled('vaccuum_parameter_1') ? 'text-gray-400' : ''); ?>">Checked ✓</span>
                                                </label>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->isNAAllowed()): ?>
                                                <label class="inline-flex items-center gap-2">
                                                    <input type="radio" wire:model.live="vaccuum_parameter_1" value="na" class="rounded border-zinc-300 text-blue-600 focus:ring-blue-500" <?php echo e($this->isFieldDisabled('vaccuum_parameter_1') ? 'disabled' : ''); ?>>
                                                    <span class="text-sm <?php echo e($this->isFieldDisabled('vaccuum_parameter_1') ? 'text-gray-400' : ''); ?>">N/A</span>
                                                </label>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            <label class="text-sm font-medium text-zinc-700 dark:text-zinc-300">
                                                Expire Date (14)
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->isFieldRequired('expire_date_1')): ?>
                                                    <span class="text-red-500">*</span>
                                                <?php else: ?>
                                                    <span class="text-gray-400 text-xs font-normal">(Disabled)</span>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            ...
                                            <div class="flex gap-6">
                                                <label class="inline-flex items-center gap-2">
                                                    <input type="radio" wire:model.live="expire_date_1" value="checked" class="rounded border-zinc-300 text-blue-600 focus:ring-blue-500" <?php echo e($this->isFieldDisabled('expire_date_1') ? 'disabled' : ''); ?>>
                                                    <span class="text-sm <?php echo e($this->isFieldDisabled('expire_date_1') ? 'text-gray-400' : ''); ?>">Checked ✓</span>
                                                </label>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->isNAAllowed()): ?>
                                                <label class="inline-flex items-center gap-2">
                                                    <input type="radio" wire:model.live="expire_date_1" value="na" class="rounded border-zinc-300 text-blue-600 focus:ring-blue-500" <?php echo e($this->isFieldDisabled('expire_date_1') ? 'disabled' : ''); ?>>
                                                    <span class="text-sm <?php echo e($this->isFieldDisabled('expire_date_1') ? 'text-gray-400' : ''); ?>">N/A</span>
                                                </label>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </div>
                                        </div>
    ...
    <?php ob_start(); ?>
                                    ...
                                    <div class="p-6">
                                        <div>
                                            <label class="text-sm font-medium text-zinc-700 dark:text-zinc-300">
                                                Fan Unit 1 (25)
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->isFieldRequired('fan_unit_1')): ?>
                                                    <span class="text-red-500">*</span>
                                                <?php else: ?>
                                                    <span class="text-gray-400 text-xs font-normal">(Disabled)</span>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            ...
                                            <div class="flex gap-6">
                                                <label class="inline-flex items-center gap-2">
                                                    <input type="radio" wire:model.live="fan_unit_1" value="checked" class="rounded border-zinc-300 text-blue-600 focus:ring-blue-500" <?php echo e($this->isFieldDisabled('fan_unit_1') ? 'disabled' : ''); ?>>
                                                    <span class="text-sm <?php echo e($this->isFieldDisabled('fan_unit_1') ? 'text-gray-400' : ''); ?>">Checked ✓</span>
                                                </label>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->isNAAllowed()): ?>
                                                <label class="inline-flex items-center gap-2">
                                                    <input type="radio" wire:model.live="fan_unit_1" value="na" class="rounded border-zinc-300 text-blue-600 focus:ring-blue-500" <?php echo e($this->isFieldDisabled('fan_unit_1') ? 'disabled' : ''); ?>>
                                                    <span class="text-sm <?php echo e($this->isFieldDisabled('fan_unit_1') ? 'text-gray-400' : ''); ?>">N/A</span>
                                                </label>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </div>
                                        </div>
    ...
    <?php ob_start(); ?>
                                    ...
                                    <div class="p-6">
                                        <div>
                                            <label class="text-sm font-medium text-zinc-700 dark:text-zinc-300">
                                                Fan Unit 2 (26)
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->isFieldRequired('fan_unit_2')): ?>
                                                    <span class="text-red-500">*</span>
                                                <?php else: ?>
                                                    <span class="text-gray-400 text-xs font-normal">(Disabled)</span>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            ...
                                            <div class="flex gap-6">
                                                <label class="inline-flex items-center gap-2">
                                                    <input type="radio" wire:model.live="fan_unit_2" value="checked" class="rounded border-zinc-300 text-blue-600 focus:ring-blue-500" <?php echo e($this->isFieldDisabled('fan_unit_2') ? 'disabled' : ''); ?>>
                                                    <span class="text-sm <?php echo e($this->isFieldDisabled('fan_unit_2') ? 'text-gray-400' : ''); ?>">Checked ✓</span>
                                                </label>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->isNAAllowed()): ?>
                                                <label class="inline-flex items-center gap-2">
                                                    <input type="radio" wire:model.live="fan_unit_2" value="na" class="rounded border-zinc-300 text-blue-600 focus:ring-blue-500" <?php echo e($this->isFieldDisabled('fan_unit_2') ? 'disabled' : ''); ?>>
                                                    <span class="text-sm <?php echo e($this->isFieldDisabled('fan_unit_2') ? 'text-gray-400' : ''); ?>">N/A</span>
                                                </label>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </div>
                                        </div>
