            ...
            <table class="w-full table-auto">
                ...
                <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                    ...
                    <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors <?php echo e($rowClass); ?>"
                        ...
                        <td class="px-4 py-3 text-center whitespace-nowrap">
                            <div class="text-sm">
                                <div class="font-medium text-zinc-900 dark:text-white"><?php echo e($submission->description); ?></div>
                                ...
                                <div class="text-xs text-zinc-500 dark:text-zinc-400 mt-1"><?php echo e(Str::limit($submission->remarks, 50)); ?></div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        </td>
                        ...
                        <td class="px-4 py-3 text-center whitespace-nowrap">
                            <div class="text-sm">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($submission->received_by || $submission->received_at): ?>
                                    <div class="text-zinc-700 dark:text-zinc-300">
                                        <?php echo e($submission->received_by ?? '-'); ?>

                                    </div>
                                    <div class="text-xs text-zinc-500 dark:text-zinc-400 mt-0.5">
                                        <?php echo e($submission->received_at ? \Carbon\Carbon::parse($submission->received_at)->format('d M Y H:i') : '-'); ?>
                        ...
                        <td class="px-4 py-3 text-center whitespace-nowrap">
                            <div class="text-sm">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($submission->distributed_by || $submission->distributed_at): ?>
                                    <div class="text-zinc-700 dark:text-zinc-300">
                                        <?php echo e($submission->distributed_by ?? '-'); ?>

                                    </div>
                                    <div class="text-xs text-zinc-500 dark:text-zinc-400 mt-0.5">
                                        <?php echo e($submission->distributed_at ? \Carbon\Carbon::parse($submission->distributed_at)->format('d M Y H:i') : '-'); ?>
                        ...
                        <td class="px-4 py-3 text-center whitespace-nowrap">
                            <div class="text-sm">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($submission->pic || $submission->created_at): ?>
                                    <div class="text-zinc-700 dark:text-zinc-300">
                                        <?php echo e($submission->pic ?? 'N/A'); ?>

                                    </div>
                                    <div class="text-xs text-zinc-500 dark:text-zinc-400 mt-0.5">
                                        <?php echo e($submission->created_at ? \Carbon\Carbon::parse($submission->created_at)->format('d M Y H:i') : '-'); ?>
