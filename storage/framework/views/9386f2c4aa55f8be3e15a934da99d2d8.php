<?php
if (!function_exists('_9386f2c4aa55f8be3e15a934da99d2d8')):
function _9386f2c4aa55f8be3e15a934da99d2d8($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
} endif; ?><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/stubs/resources/views/flux/icon/ellipsis-horizontal-circle.blade.php ENDPATH**/ ?>