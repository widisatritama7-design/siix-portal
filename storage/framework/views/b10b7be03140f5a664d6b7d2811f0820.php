<?php
if (!function_exists('_b10b7be03140f5a664d6b7d2811f0820')):
function _b10b7be03140f5a664d6b7d2811f0820($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
} endif; ?><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/stubs/resources/views/flux/icon/cake.blade.php ENDPATH**/ ?>