<?php
if (!function_exists('_4bbb403eced778db5258fb7bdd6d39b0')):
function _4bbb403eced778db5258fb7bdd6d39b0($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
} endif; ?><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/vendor/livewire/flux/stubs/resources/views/flux/icon/document-currency-dollar.blade.php ENDPATH**/ ?>