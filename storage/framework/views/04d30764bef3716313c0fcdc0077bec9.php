...
<div class="p-1 space-y-2">
    <?php $__env->startSection('title', 'Stock Management - Uniform'); ?>
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            <button type="button" 
                                ...
                                class="flex-1 px-4 py-2 rounded-lg transition-all inline-flex items-center justify-center gap-2 <?php echo e($transactionType === 'in' ? 'bg-green-600 text-white shadow-md' : 'bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-400'); ?>">
                            ...
                            <button type="button" 
                                ...
                                class="flex-1 px-4 py-2 rounded-lg transition-all inline-flex items-center justify-center gap-2 <?php echo e($transactionType === 'opname' ? 'bg-purple-600 text-white shadow-md' : 'bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-400'); ?>">
                                <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    ...
    <?php ob_start(); ?>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($searchUniform && strlen($searchUniform) >= 2 && count($uniforms) > 0): ?>
                                ...
                                <div class="max-h-60 overflow-y-auto">
                                    <table class="w-full text-sm">
                                        ...
                                        <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $uniforms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uniform): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                <tr wire:click="selectUniform(<?php echo e($uniform->id); ?>)" 
                                                    class="hover:bg-blue-50 dark:hover:bg-blue-900/20 cursor-pointer transition-colors">
                                                    <td class="px-3 py-2 font-mono text-sm"><?php echo e($uniform->item_code); ?></td>
                                                    <td class="px-3 py-2 text-sm"><?php echo e($uniform->description); ?></td>
...
<?php echo ltrim(ob_get_clean()); ?>
                                                    ...
                                                    <td class="px-3 py-2 text-center">
                                                        <span class="text-sm font-semibold <?php echo e($uniform->qty <= 5 ? 'text-red-600' : 'text-green-600'); ?>">
                                                            <?php echo e(number_format($uniform->qty)); ?>

                                                        </span>
                                                    </td>
                                                    <td class="px-3 py-2 text-center text-sm">
                                                        Rp <?php echo e(number_format($uniform->price, 0, ',', '.')); ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($uniforms) > 5): ?>
                                    <div class="bg-zinc-50 dark:bg-zinc-800/50 px-3 py-1.5 text-center text-xs text-zinc-500 border-t border-zinc-200 dark:border-zinc-700">
                                        Showing <?php echo e(count($uniforms)); ?> results
                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        <?php elseif($searchUniform && strlen($searchUniform) >= 2 && count($uniforms) == 0): ?>
                        ...
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['currentUniformId'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentUniform): ?>
                        <div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border border-blue-200 dark:border-blue-800">
                            <div class="flex justify-between items-start">
                                <div>
                                    <p class="text-xs text-blue-600 dark:text-blue-400">Selected Uniform</p>
                                    <p class="font-semibold"><?php echo e($currentUniform->item_code); ?> - <?php echo e($currentUniform->description); ?></p>
                                    <p class="text-sm text-zinc-600 dark:text-zinc-400 mt-1">Size: <?php echo e($currentUniform->size); ?> | Price: Rp <?php echo e(number_format($currentUniform->price, 0, ',', '.')); ?></p>
                                </div>
                                <div class="text-right">
                                    <p class="text-sm text-zinc-500">Current Stock</p>
                                    <p class="text-xl font-bold <?php echo e($currentUniform->qty <= 5 ? 'text-red-600' : 'text-green-600'); ?>">
                                        <?php echo e(number_format($currentUniform->qty)); ?>
                    ...
                    <div>
                        <label class="block text-sm font-medium mb-1">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($transactionType === 'in'): ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php else: ?>
                            <div>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['currentOpnameQty'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
                            ...
                            <div class="bg-gray-50 dark:bg-zinc-800/50 rounded-lg p-3 relative group">
                                ...
                                <div class="pr-6">
                                    <div class="flex justify-between items-start mb-2">
                                        <div>
                                            <span class="font-mono text-xs text-gray-500"><?php echo e($item['uniform']->item_code); ?></span>
                                            <p class="text-sm font-medium"><?php echo e($item['uniform']->description); ?></p>
                                        </div>
                                        <span class="px-2 py-1 rounded-full text-xs font-bold <?php echo e($transactionType === 'in' ? 'bg-green-100 text-green-800' : 'bg-purple-100 text-purple-800'); ?>">
                                            <?php echo e(strtoupper($transactionType === 'in' ? 'IN' : 'OPNAME')); ?>

                                        </span>
                                    </div>
                                    <div class="flex justify-between items-center text-sm">
                                        <span>Qty: <strong><?php echo e(number_format($item['qty'])); ?></strong></span>
                                        <span class="text-gray-500"><?php echo e($transactionType === 'in' ? 'Add' : 'Set to'); ?> <?php echo e(number_format($item['qty'])); ?></span>
                                    </div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($transactionType === 'opname'): ?>
                                        <div class="text-xs text-gray-500 mt-1">
                                            Old Stock: <?php echo e(number_format($item['old_qty'])); ?> → New Stock: <?php echo e(number_format($item['qty'])); ?>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($diff > 0): ?>
                                                <span class="text-green-600">(+<?php echo e($diff); ?>)</span>
                                            <?php elseif($diff < 0): ?>
                                                <span class="text-red-600">(<?php echo e($diff); ?>)</span>
                                            <?php else: ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item['description']): ?>
                                        <p class="text-xs text-gray-500 mt-1 truncate"><?php echo e($item['description']); ?></p>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
...
</div><?php /**PATH /www/wwwroot/testings.siix-ems.co.id/siix-portal/resources/views/livewire/prod/uniform/uniform-stock-management.blade.php ENDPATH**/ ?>