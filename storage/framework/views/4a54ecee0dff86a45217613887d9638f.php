...
<?php _1dd1a2f2e7623778145c2b391a78c09f($__blaze, ['name' => 'name','label' => __('Name'),'value' => old('name'),'type' => 'text','required' => true,'autofocus' => true,'autocomplete' => 'name','placeholder' => __('Full name')], [], ['label', 'value', 'required', 'autofocus', 'placeholder'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php _1dd1a2f2e7623778145c2b391a78c09f($__blaze, ['name' => 'email','label' => __('Email address'),'value' => old('email'),'type' => 'email','required' => true,'autocomplete' => 'email','placeholder' => 'email@example.com'], [], ['label', 'value', 'required'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\siix-portal-new\resources\views\livewire\auth\register.blade.php ENDPATH**/ ?>