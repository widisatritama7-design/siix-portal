...
<div class="p-1 space-y-2">
    <?php $__env->startSection('title', $reportId ? 'Edit Absence Report' : 'Create Absence Report'); ?>
...
<?php $__blaze->popData(); ?>
        <?php ob_start(); ?><div class="flex items-center text-sm font-medium group/breadcrumb font-semibold text-blue-600" data-flux-breadcrumbs-item>
            <div class="text-gray-500 dark:text-white/80">
                            <?php ob_start(); ?><?php echo e($reportId ? 'Edit' : 'Create'); ?><?php echo trim(ob_get_clean()); ?>
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mt-2">
        <div>
            <h1 class="text-3xl font-bold text-zinc-800 dark:text-white">
                <?php echo e($reportId ? 'Edit Absence Report' : 'Create Absence Report'); ?>
                        ...
                        <div x-data="{ show: false, search: <?php if ((object) ('employeeSearch') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('employeeSearch'->value()); ?>')<?php echo e('employeeSearch'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('employeeSearch'); ?>')<?php endif; ?> }" class="relative">
                            ...
                            <div x-show="show" x-transition @click.outside="show = false"
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $this->employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <div x-show="'<?php echo e(strtolower($label)); ?>'.includes(search.toLowerCase()) || '<?php echo e($value); ?>'.includes(search)"
                                        @click="$wire.set('current_employee_id', '<?php echo e($value); ?>'); $wire.set('employeeSearch', '<?php echo e($label); ?>'); search = '<?php echo e($label); ?>'; show = false;"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="mb-4">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['current_line'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs"><?php echo e($message); ?></span> <?php unset($message);
                ...
                <div>
                    <div class="mb-4">
                        ...
                        <select wire:model="current_jenis_ketidakhadiran" class="w-full px-3 py-2 border rounded-lg dark:bg-zinc-800">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $jenisOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <option value="<?php echo e($key); ?>"><?php echo e($value); ?></option>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </select>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['current_jenis_ketidakhadiran'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs"><?php echo e($message); ?></span> <?php unset($message);
...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <?php ob_start(); ?>
            <div class="flex justify-between items-center mb-4">
                ...
                <div class="text-sm text-zinc-500">Total: <?php echo e($totalRows); ?> row(s)</div>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm border min-w-[800px]">
                    ...
                    <tbody>
                        ...
                        <tr class="border-t">
                            <td class="px-3 py-2"><?php echo e($row['employee_nik']); ?></td>
                            <td class="px-3 py-2"><?php echo e($row['employee_name']); ?></td>
                            <td class="px-3 py-2"><?php echo e($row['group']); ?></td>
                            <td class="px-3 py-2"><?php echo e($row['line']); ?></td>
                            <td class="px-3 py-2">
                                <?php
                                    $jenisMap = [
                                ...
                                <span class="inline-flex px-2 py-1 text-xs rounded-full bg-purple-100 text-purple-700">
                                    <?php echo e($jenisDisplay); ?>

                                </span>
                            </td>
                            <td class="px-3 py-2"><?php echo e(Str::limit($row['keterangan'], 30) ?? '-'); ?></td>
            ...
            <div class="flex justify-between items-center mt-4 pt-4 border-t">
                ...
                <div class="flex gap-2">
                    <button type="button" wire:click="$set('page', <?php echo e($currentPage - 1); ?>)" <?php if($currentPage <= 1): ?> disabled <?php endif; ?>
                        class="px-3 py-1 border rounded-lg <?php echo e($currentPage <= 1 ? 'opacity-50 cursor-not-allowed' : ''); ?>">
                        Previous
                    </button>
                    <span class="px-3 py-1 border rounded-lg bg-blue-50">Page <?php echo e($currentPage); ?> of <?php echo e($lastPage); ?></span>
                    <button type="button" wire:click="$set('page', <?php echo e($currentPage + 1); ?>)" <?php if($currentPage >= $lastPage): ?> disabled <?php endif; ?>
                        class="px-3 py-1 border rounded-lg <?php echo e($currentPage >= $lastPage ? 'opacity-50 cursor-not-allowed' : ''); ?>">
                        Next
                    </button>
                </div>
            </div>
...
<?php echo ltrim(ob_get_clean()); ?>
        ...
        <div class="flex justify-end gap-3 mt-6">
            <a href="<?php echo e(route('prod.absence.report.index')); ?>" wire:navigate class="px-4 py-2 bg-white border rounded-lg hover:bg-gray-50">
                Cancel
            </a>
            <button type="submit" wire:loading.attr="disabled" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center gap-2">
                ...
                <span wire:loading.remove wire:target="save"><?php echo e($reportId ? 'Update Report' : 'Create Report'); ?></span>
...
</div><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/resources/views/livewire/prod/absence/absence-report-form.blade.php ENDPATH**/ ?>