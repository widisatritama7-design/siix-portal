...
<head>
    ...
    <style>
        * {
        ...
        .col-no { width: 5%; }
        .col-register { width: 20%; }
        .col-result { width: 15%; }
        .col-judge { width: 8%; }
        .col-remarks { width: 20%; }
        .col-date { width: 12%; }
        .col-next-date { width: 12%; }
        .col-created-by { width: 15%; }
    ...
    <div class="container">
        ...
        <div class="report-info">
            ...
            <div style="margin-top: 10px; padding: 6px 8px; background: #e8f0fe; border-radius: 4px; font-size: 8pt; text-align: left; border-top: 1px solid #ddd;">
                <strong>STANDARD ESD OF INSULATIVE SUPPORT SURFACE</strong><br>
                <div style="margin-top: 4px;">
                    <div>• Resistance Point To Point : > 1.00E+12 Ohm</div>
                </div>
            </div>
        </div>
        ...
        <table class="data-table">
            ...
            <tbody>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $check): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <tr>
                    <td class="text-center"><?php echo e($index + 1); ?></td>
                    <td class="text-center"><?php echo e($check->register_no ?? 'N/A'); ?></td>
                    <td class="text-center"><?php echo e($check->result_scientific ?? '-'); ?></td>
                    <td class="text-center">
                        <span class="<?php echo e($check->judgement == 'OK' ? 'badge-ok' : 'badge-ng'); ?>">
                            <?php echo e($check->judgement ?? '-'); ?>

                        </span>
                    </td>
                    <td class="wrap-text"><?php echo e($check->remarks ?? '-'); ?></td>
                    <td class="text-center"><?php echo e($check->created_at ? $check->created_at->format('d M Y') : '-'); ?></td>
                    <td class="text-center"><?php echo e($check->next_date ? \Carbon\Carbon::parse($check->next_date)->format('d M Y') : '-'); ?></td>
                    <td class="wrap-text"><?php echo e($check->creator->name ?? 'N/A'); ?></td>
                </tr>
...
</html><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/resources/views/livewire/esd/insulatif/insulatif-check-pdf.blade.php ENDPATH**/ ?>