...
<div class="p-1 space-y-2">
    <?php $__env->startSection('title', 'Generate Absence Control'); ?>
...
<?php if (isset($__slotsb843a539037c1542dedc5bd82236e28a)) { $__slotsStackb843a539037c1542dedc5bd82236e28a[] = $__slotsb843a539037c1542dedc5bd82236e28a; } ?>
<?php if (isset($__attrsb843a539037c1542dedc5bd82236e28a)) { $__attrsStackb843a539037c1542dedc5bd82236e28a[] = $__attrsb843a539037c1542dedc5bd82236e28a; } ?>
<?php $__attrsb843a539037c1542dedc5bd82236e28a = ['href' => e(route('prod.absence.control')),'wire:navigate' => true,'separator' => 'slash']; ?>
<?php $__slotsb843a539037c1542dedc5bd82236e28a = []; ?>
<?php $__blaze->pushData($__attrsb843a539037c1542dedc5bd82236e28a); ?>
<?php ob_start(); ?>Control<?php $__slotsb843a539037c1542dedc5bd82236e28a['slot'] = new \Illuminate\View\ComponentSlot(trim(ob_get_clean()), []); ?>
<?php $__blaze->pushSlots($__slotsb843a539037c1542dedc5bd82236e28a); ?>
<?php _b843a539037c1542dedc5bd82236e28a($__blaze, $__attrsb843a539037c1542dedc5bd82236e28a, $__slotsb843a539037c1542dedc5bd82236e28a, ['wire:navigate'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStackb843a539037c1542dedc5bd82236e28a)) { $__slotsb843a539037c1542dedc5bd82236e28a = array_pop($__slotsStackb843a539037c1542dedc5bd82236e28a); } ?>
<?php if (! empty($__attrsStackb843a539037c1542dedc5bd82236e28a)) { $__attrsb843a539037c1542dedc5bd82236e28a = array_pop($__attrsStackb843a539037c1542dedc5bd82236e28a); } ?>
<?php $__blaze->popData(); ?>
        <?php ob_start(); ?><div class="flex items-center text-sm font-medium group/breadcrumb font-semibold text-blue-600" data-flux-breadcrumbs-item>
            <div class="text-gray-500 dark:text-white/80">
                            <?php ob_start(); ?>Generate<?php echo trim(ob_get_clean()); ?>
...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <div class="mb-2 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
        <div class="flex items-center gap-2">
            ...
            <div>
                ...
                <p class="text-xs text-blue-700 dark:text-blue-400">You can only generate data for department: <strong><?php echo e($userDepartment); ?></strong></p>
            </div>
        </div>
    </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($generatedMessage): ?>
    <div class="p-4 rounded-lg <?php echo e($generatedMessage['type'] === 'success' ? 'bg-green-100 text-green-800 border-green-300' : 'bg-red-100 text-red-800 border-red-300'); ?> border">
        <?php echo e($generatedMessage['message']); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isOneUserAccess): ?>
                <input type="hidden" wire:model="selectedDepartment" value="<?php echo e($userDepartment); ?>">
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['selectedDepartment'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs"><?php echo e($message); ?></span> <?php unset($message);
...
<?php echo ltrim(ob_get_clean()); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedDepartment && count($currentPageEmployees) > 0): ?>
    ...
    <?php ob_start(); ?>
        <div class="p-4 border-b bg-zinc-50 dark:bg-zinc-800/50">
            <div class="flex justify-between items-center flex-wrap gap-4">
                <div>
                    <h2 class="font-semibold text-zinc-800 dark:text-white">Employees in <?php echo e($selectedDepartment); ?></h2>
        ...
        <div class="overflow-x-auto">
            <table class="w-full border-collapse text-sm">
                ...
                <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $currentPageEmployees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php
                        $isSelected = in_array($employee->id, $selectedEmployees);
                    ?>
                    <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors <?php echo e(!$isSelected ? 'opacity-60 bg-gray-50 dark:bg-gray-900/30' : ''); ?>">
                        <td class="px-4 py-2 text-center">
                            <input type="checkbox" wire:model.live="selectedEmployees" value="<?php echo e($employee->id); ?>" class="rounded border-zinc-300">
                        </td>
                        <td class="px-4 py-2"><?php echo e(($employeesPaginated->currentPage() - 1) * $employeesPaginated->perPage() + $loop->iteration); ?></td>
                        <td class="px-4 py-2 font-mono"><?php echo e($employee->nik); ?></td>
                        <td class="px-4 py-2"><?php echo e($employee->name); ?></td>
                        <td class="px-4 py-2">
                            <?php
                                $statusText = [
                                    '1' => 'Permanent',
                            ...
                            ?>
                            <span class="px-2 py-1 text-xs rounded-full <?php echo e($statusColor); ?>">
                        ...
                        <td class="px-4 py-2">
                            <span class="px-2 py-1 text-xs rounded-full bg-gray-100 dark:bg-zinc-700">
                                <?php echo e($employee->actual_group ?? '-'); ?>

                            </span>
                        </td>
                        <td class="px-4 py-2">
                            <select wire:model="employeeGroups.<?php echo e($employee->id); ?>" 
                                class="px-3 py-1 text-sm border border-zinc-300 dark:border-zinc-700 rounded-lg bg-white dark:bg-zinc-800 <?php echo e(!$isSelected ? 'opacity-50 cursor-not-allowed' : ''); ?>"
                                <?php echo e(!$isSelected ? 'disabled' : ''); ?>>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $groupOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        ...
                        <td class="px-4 py-2">
                            <span class="px-2 py-1 text-xs rounded-full bg-gray-100 dark:bg-zinc-700">
                                <?php echo e($employee->actual_shift ?? '-'); ?>

                            </span>
                        </td>
                        <td class="px-4 py-2">
                            <select wire:model="employeeShifts.<?php echo e($employee->id); ?>" 
                                class="px-3 py-1 text-sm border border-zinc-300 dark:border-zinc-700 rounded-lg bg-white dark:bg-zinc-800 <?php echo e(!$isSelected ? 'opacity-50 cursor-not-allowed' : ''); ?>"
                                <?php echo e(!$isSelected ? 'disabled' : ''); ?>>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $shiftOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <option value="<?php echo e($value); ?>"><?php echo e($label); ?></option>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            </select>
                        </td>
        ...
        <div class="px-4 py-2 border-t bg-blue-50 dark:bg-blue-900/20">
            <div class="flex justify-between items-center flex-wrap gap-2">
                <span class="text-sm text-blue-700 dark:text-blue-300">
                    ...
                    Selected: <strong><?php echo e(count($selectedEmployees)); ?></strong> employee(s)
                </span>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($employeesPaginated->hasPages()): ?>
        <div class="px-4 py-3 border-t border-zinc-200 dark:border-zinc-700">
            <?php echo e($employeesPaginated->links()); ?>
    ...
    <div class="flex flex-col md:flex-row gap-4">
        <div class="flex items-center gap-2">
            <button wire:click="generate" wire:loading.attr="disabled" 
                ...
                <span wire:loading.remove>Generate Selected (<?php echo e(count($selectedEmployees)); ?>)</span>
                <span wire:loading>Generating...</span>
            </button>
            
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($selectedEmployees) > 0 && count($selectedEmployees) < $employeesPaginated->total()): ?>
            <button wire:click="generateAll" wire:loading.attr="disabled"
                ...
                Generate All (<?php echo e($employeesPaginated->total()); ?>)
            </button>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </div>
    <?php elseif($selectedDepartment && count($currentPageEmployees) == 0): ?>
...
</div><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/resources/views/livewire/prod/absence/absence-control-generate.blade.php ENDPATH**/ ?>