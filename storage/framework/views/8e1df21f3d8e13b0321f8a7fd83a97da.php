...
<head>
    <meta charset="utf-8">
    <title>Admin Feedback Imported</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h2>Admin Feedback Imported</h2>
        </div>
        
        <div class="content">
            <p>Dear Requester,</p>
            
            <p>Data berikut sudah di feedback oleh Admin, mohon untuk segera di veriikasi:</p>
            ...
            <div class="info-box">
                ...
                <div class="info-row">
                    ...
                    <div class="info-value">
                        <span class="status-pending">⏳ Waiting Verification Employee</span>
                    </div>
                </div>
            </div>
            ...
            <p>Please check it for the verification process.</p>
...
</html><?php /**PATH /www/wwwroot/testings.siix-ems.co.id/siix-portal/resources/views/emails/prod/admin-feedback-imported.blade.php ENDPATH**/ ?>