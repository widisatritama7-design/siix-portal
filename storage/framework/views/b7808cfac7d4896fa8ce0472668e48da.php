        ...
        <form wire:submit="processReceive" class="p-6">
            ...
            <div class="mb-6 p-4 bg-zinc-50 dark:bg-zinc-700/50 rounded-lg">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="text-sm font-medium text-zinc-900 dark:text-white"><?php echo e($receivingSubmission->description); ?></p>
                    </div>
                    <div>
                        <label class="text-xs text-zinc-500 dark:text-zinc-400">Department</label>
                        <p class="text-sm font-medium text-zinc-900 dark:text-white"><?php echo e($receivingSubmission->department->dept_name ?? 'N/A'); ?></p>
                    </div>
                    <div>
                        <label class="text-xs text-zinc-500 dark:text-zinc-400">Category</label>
                        <p class="text-sm font-medium text-zinc-900 dark:text-white"><?php echo e($receivingSubmission->category_document); ?></p>
                    </div>
                    <div>
                        <label class="text-xs text-zinc-500 dark:text-zinc-400">PIC</label>
                        <p class="text-sm font-medium text-zinc-900 dark:text-white"><?php echo e($receivingSubmission->pic); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <button 
                            ...
                            class="flex-1 relative flex items-center justify-center gap-3 px-6 py-4 rounded-xl border-2 transition-all duration-200
                                <?php echo e($receiveStatus === 'Received' 
                        ...
                        >
                            <div class="flex items-center gap-3">
                                ...
                                <div class="text-left">
                                    <p class="text-lg font-semibold 
                                        <?php echo e($receiveStatus === 'Received' ? 'text-green-600 dark:text-green-400' : 'text-zinc-700 dark:text-zinc-300'); ?>">
                                        Received
                                    </p>
                                    <p class="text-sm 
                                        <?php echo e($receiveStatus === 'Received' ? 'text-green-500 dark:text-green-500' : 'text-zinc-500 dark:text-zinc-400'); ?>">
                            ...
                            <!-- Selected Check Icon -->
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($receiveStatus === 'Received'): ?>
                        ...
                        <button 
                            ...
                            class="flex-1 relative flex items-center justify-center gap-3 px-6 py-4 rounded-xl border-2 transition-all duration-200
                                <?php echo e($receiveStatus === 'Rejected' 
                        ...
                        >
                            <div class="flex items-center gap-3">
                                ...
                                <div class="text-left">
                                    <p class="text-lg font-semibold 
                                        <?php echo e($receiveStatus === 'Rejected' ? 'text-red-600 dark:text-red-400' : 'text-zinc-700 dark:text-zinc-300'); ?>">
                                        Rejected
                                    </p>
                                    <p class="text-sm 
                                        <?php echo e($receiveStatus === 'Rejected' ? 'text-red-500 dark:text-red-500' : 'text-zinc-500 dark:text-zinc-400'); ?>">
                            ...
                            <!-- Selected Check Icon -->
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($receiveStatus === 'Rejected'): ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['receiveStatus'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    ></textarea>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['receiveReason'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> 
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="flex justify-end gap-3 mt-8 pt-6 border-t border-zinc-200 dark:border-zinc-700">
                ...
                <button 
                    type="submit"
                    wire:loading.attr="disabled"
                    wire:target="processReceive"
                    class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                        'px-6 py-2 text-sm font-medium text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-zinc-900 transition-colors duration-200 flex items-center gap-2',
                    ...
                    <?php if(!$receiveStatus || $isLoading): ?> disabled <?php endif; ?>
                >
                    <!-- Loading Spinner -->
                    <span wire:loading wire:target="processReceive" class="inline-block">
                    ...
                    <span wire:loading.remove wire:target="processReceive">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($receiveStatus === 'Received'): ?>
                            Accept Submission
                        <?php elseif($receiveStatus === 'Rejected'): ?>
                            Reject Submission
                        <?php else: ?>
                            Process Submission
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <span wire:loading wire:target="processReceive">
                        Processing...
                    </span>
                </button>
            </div>
...
</div><?php /**PATH /www/wwwroot/test.siix-ems.co.id/siix-portal/resources/views/livewire/dcc/pages/receive.blade.php ENDPATH**/ ?>