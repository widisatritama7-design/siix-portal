...
class DailyFujiStandardCheck extends Model
{
    use HasFactory;

    protected $table = 'tb_mtc_daily_fuji_standard_checks';
    ...
    protected $fillable = [
        ...
        'clamp_presure_required',
        'squeege_upper_required',
        ...
        'vaccuum_pump_1_required',
        'box_1_required',
        'vaccuum_parameter_1_required',
        'expire_date_1_required',
    ...
    protected $casts = [
        ...
        'ionizer_air_presure_required' => 'boolean',
        ...
        'clamp_presure_required' => 'boolean',
        'squeege_upper_required' => 'boolean',
        ...
        'vaccuum_pump_1_required' => 'boolean',
        'box_1_required' => 'boolean',
        'vaccuum_parameter_1_required' => 'boolean',
        'expire_date_1_required' => 'boolean',
        ...
        'n2_air_presure_valve_required' => 'boolean',
        'fan_unit_1_required' => 'boolean',
        'fan_unit_2_required' => 'boolean',
    ...
    {
        return $this->hasMany(DailyFujiStandardCheckHistory::class, 'standard_check_id')
            ->orderBy('created_at', 'desc');
    }

    /**
     * Get list of required fields for a specific line (Fuji only)
     */
    public static function getRequiredFields($masterLineId)
    {
        ...
        foreach ($fillable as $field) {
            if (str_ends_with($field, '_required') && $standard->{$field}) {
                // Convert body_cover_required -> body_cover
    ...
    /**
     * Get default required fields (semua required)
     */
