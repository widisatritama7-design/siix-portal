...
class LedTestScanner extends Component
{
    public $serialNumber = '';
    ...
    {
        $this->recentScans = ScanLog::where('process', 'led_test')
    ...
    public function processScan()
    {
        ...
        try {
            ...
            ScanLog::create([
                ...
                'result' => 'ok',
                'box_type' => 'OK',
                'notes' => 'LED Test completed successfully'
            ]);

            DB::commit();

            $this->showResult('success', 'PCB ' . $serialNumber . ' passed LED Test successfully!');
    ...
    {
        return view('livewire.prod.fct.led-test-scanner');
    }
}