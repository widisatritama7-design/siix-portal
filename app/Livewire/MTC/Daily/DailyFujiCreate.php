...
class DailyFujiCreate extends Component
{
    public $masterLineId;
    public $masterLine;
    ...
    /**
     * Lakukan judgement/validasi berdasarkan model DailyFuji
     */
    ...
    /**
     * Cek semua field sesuai dengan rules di model DailyFuji
     */
    ...
    public function save()
    {
        ...
        session()->flash('message', 'Daily Fuji inspection created successfully!');
