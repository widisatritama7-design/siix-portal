...
class DailyPanasonicEdit extends Component
{
    public $dailyPanasonicId;
    public $masterLineId;
    public $masterLine;
    public $dailyPanasonic;
    ...
    public function mount($masterLineId, $dailyPanasonicId)
    {
    ...
    public function save()
    {
        ...
        $this->dailyPanasonic->update($data);
        
        session()->flash('message', 'Daily Panasonic inspection updated successfully!');
    ...
    {
        return view('livewire.mtc.daily.panasonic.daily-panasonic-edit');
    }
}